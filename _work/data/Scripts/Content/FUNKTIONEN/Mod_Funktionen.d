var int Mod_Götterlevel_Adanos;
var int Mod_Götterlevel_Innos;
var int Mod_Götterlevel_Beliar;
...
FUNC VOID B_Göttergefallen (var int GefallenArt, var int GefallenCounter)
{
	...
	{
		Mod_Götterlevel_Beliar = Innos_Gefallen - Beliar_Gefallen;
		Mod_Götterlevel_Adanos = Innos_Gefallen - Adanos_Gefallen;
		
		if (Mod_Götterlevel_Beliar >= 100)
		&& (Mod_Götterlevel_Adanos >= 100)
		{
			Mod_Gottstatus = 9;

			Npc_SetTalentSkill (hero, NPC_TALENT_GOTTSTATUS, 9);
		}
		else if (Mod_Götterlevel_Beliar >= 50)
		&& (Mod_Götterlevel_Adanos >= 50)
		{
			Mod_Gottstatus = 10;

			Npc_SetTalentSkill (hero, NPC_TALENT_GOTTSTATUS, 10);
		}
		else if (Mod_Götterlevel_Beliar >= 20)
		&& (Mod_Götterlevel_Adanos >= 20)
		{	
			Mod_Gottstatus = 11;
	...
	{
		Mod_Götterlevel_Adanos = Beliar_Gefallen - Adanos_Gefallen;
		Mod_Götterlevel_Innos = Beliar_Gefallen - Innos_Gefallen;
		
		if (Mod_Götterlevel_Adanos >= 100)
		&& (Mod_Götterlevel_Innos >= 100)
		{
			Mod_Gottstatus = 1;

			Npc_SetTalentSkill (hero, NPC_TALENT_GOTTSTATUS,1);
		}
		else if (Mod_Götterlevel_Innos >= 50)
		&& (Mod_Götterlevel_Adanos >= 50)
		{
			Mod_Gottstatus = 2;
		...
		else if (Mod_Götterlevel_Adanos >= 20)
		&& (Mod_Götterlevel_Innos >= 20)
		{	
			Mod_Gottstatus = 3;
	...
	{
		Mod_Götterlevel_Beliar = Adanos_Gefallen - Beliar_Gefallen;
		Mod_Götterlevel_Innos = Adanos_Gefallen - Innos_Gefallen;
