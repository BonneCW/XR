...
// HUMAN
	...
	BLOOD_EMITTER			[GIL_HUMAN] = "BFX_Preset1";
	BLOOD_TEXTURE			[GIL_HUMAN] = "BQM_Scavenger2.tga";
...
//	JUMPUP_HEIGHT 			[GIL_MINECRAWLER] = 200;
	...
	SLIDE_ANGLE		 		[GIL_MINECRAWLER] = 1000;
	DISABLE_AUTOROLL 		[GIL_MINECRAWLER] = 0;
...
// Spinne
	...
	SWIM_TIME				[GIL_SPIDER] = 0;
	DIVE_TIME		 		[GIL_SPIDER] = 0;
	WATER_DEPTH_KNEE 		[GIL_SPIDER] = 0;
	WATER_DEPTH_CHEST		[GIL_SPIDER] = 0;

	STEP_HEIGHT		 		[GIL_SPIDER] = 50;
	JUMPLOW_HEIGHT 			[GIL_SPIDER] = 105;
	JUMPMID_HEIGHT 			[GIL_SPIDER] = 200;
	
	SLIDE_ANGLE		 		[GIL_SPIDER] = 50;
	DISABLE_AUTOROLL 		[GIL_SPIDER] = 1;
	SURFACE_ALIGN	 		[GIL_SPIDER] = 1;
	TURN_SPEED				[GIL_SPIDER] = 180;

	// Fallhöhe / Fallschaden
	FALLDOWN_HEIGHT			[GIL_SPIDER] = 400;
	FALLDOWN_DAMAGE			[GIL_SPIDER] = 10;

	// Kampf
	FIGHT_RANGE_BASE		[GIL_SPIDER] = 130;
	FIGHT_RANGE_FIST		[GIL_SPIDER] = 95;
	FIGHT_RANGE_G			[GIL_SPIDER] = 200;
	
	// Bluteffekte by KaiRo
	BLOOD_EMITTER			[GIL_SPIDER] = "BFX_Preset2";
	BLOOD_TEXTURE			[GIL_SPIDER] = "BQM_Meatbug.tga";
	//BLOOD_FLOW				[GIL_SPIDER] = 1;
	BLOOD_AMOUNT			[GIL_SPIDER] = 10;
	BLOOD_MAX_DISTANCE		[GIL_SPIDER] = 100;
