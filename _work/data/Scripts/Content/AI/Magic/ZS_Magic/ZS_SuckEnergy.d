...
{	
	...
	if (Npc_GetStateTime(self) != self.aivar[AIV_SuckEnergyStateTime])
	{
		...
		if (self.attribute[ATR_HITPOINTS] > SPL_SuckEnergy_DAMAGE/10)
		|| (self.guild > GIL_SEPERATOR_HUM)
		{
			B_MagicHurtNpc 		(other,	self, SPL_SuckEnergy_DAMAGE/10);
			Npc_ChangeAttribute	(other, ATR_HITPOINTS, SPL_SuckEnergy_DAMAGE/10);
