...
func int B_StopMagicSleep()
{
	...
	&& (Mod_HQ_Daemonisch == 5)
	{
		...
		{
			B_StartOtherRoutine	(Mod_753_NOV_Ulf_NW, "DAEMONISCH2");
		}
		else if (Mod_HQ_Daemonisch_SP_02 == 2)
		{
			B_StartOtherRoutine	(Mod_541_NONE_Till_NW, "DAEMONISCH2");
		}
		else if (Mod_HQ_Daemonisch_SP_03 == 2)
		{
			B_StartOtherRoutine	(Mod_754_NONE_Valentino_NW, "DAEMONISCH2");
		};

		Wld_InsertNpc	(Mod_7422_NONE_Frau_NW, "FARM1");

		B_StartOtherRoutine	(Mod_538_RDW_Diego_NW, "DAEMONISCH2");
	};
