...
func void Spine_InitEarthquakeHooks() {
	if (GOTHIC_BASE_VERSION == 2 && SPINE_EARTHQUAKE_VIBRATION) {
		HookEngine (SPINE_ADDRESS_TRIGGEREARTHQUAKE, SPINE_OFFSETT_TRIGGEREARTHQUAKE, "SPINE_EARTHQUAKE_TRIGGER");
		HookEngine (SPINE_ADDRESS_UNTRIGGEREARTHQUAKE, SPINE_OFFSETT_UNTRIGGEREARTHQUAKE, "SPINE_EARTHQUAKE_UNTRIGGER");
	};
};
