...
// ------ Gegner attackiert mich ------
INSTANCE FA_ENEMY_PREHIT_58 (C_FightAI)
{
 	move[0] = MOVE_ATTACK;
...
// ------ Gegner macht Sturmattacke ------
INSTANCE FA_ENEMY_STORMPREHIT_58 (C_FightAI)
{
 	move[0] = MOVE_ATTACK;
};
...
// ------ Ich renne auf den Gegner zu ------
INSTANCE FA_MY_W_RUNTO_58 (C_FightAI)
{
	move[0] = MOVE_TURN; // --- Stehenbleiben ---
};

// ------- Ich Strafe gerade ------
INSTANCE FA_MY_W_STRAFE_58 (C_FightAI)
{
 	move[0] = MOVE_STRAFE; // --- STANDARDEINTRAG ---
};

// ------- Ich habe Gegner im Fokus (kann treffen) -------
INSTANCE FA_MY_W_FOCUS_58 (C_FightAI)
{
 	move[0] = MOVE_ATTACK;
 	move[1] = MOVE_ATTACK;
 	//move[1] = MOVE_WAIT;
...
// ------- Ich habe Gegner NICHT im Fokus -------
INSTANCE FA_MY_W_NOFOCUS_58 (C_FightAI)
{
	move[0] = MOVE_TURN; // --- STANDARDEINTRAG ---
};
...
// ------ Ich renne auf den Gegner zu (kann treffen) ------
INSTANCE FA_MY_G_RUNTO_58 (C_FightAI)
{
 	move[0] = MOVE_ATTACK; //Sturmattacke
};

// ------- Ich Strafe gerade ------
INSTANCE FA_MY_G_STRAFE_58 (C_FightAI)
{
 	 move[0] = MOVE_STRAFE; // --- STANDARDEINTRAG ---
};

// ------- Ich habe Gegner im Fokus -------
INSTANCE FA_MY_G_FOCUS_58 (C_FightAI)
{
 	move[0] = MOVE_RUN; // --- STANDARDEINTRAG ---
};
...
// ------- Ich habe Gegner im Fokus -------
INSTANCE FA_MY_FK_FOCUS_58 (C_FightAI)
{
	move[0] = MOVE_RUN; // --- STANDARDEINTRAG ---
};

// ------- Ich habe Gegner NICHT im Fokus (gilt auch für G-Distanz!) -------
INSTANCE FA_MY_G_FK_NOFOCUS_58 (C_FightAI)
{
	move[0] = MOVE_TURN; // --- STANDARDEINTRAG ---
};
...
// ------ Gegner im Fokus ------
INSTANCE FA_MY_FK_FOCUS_FAR_58 (C_FightAI)
{
	move[0] = MOVE_ATTACK; // --- STANDARDEINTRAG ---
};

// ------ Gegner NICHT im Fokus ------
INSTANCE FA_MY_FK_NOFOCUS_FAR_58 (C_FightAI)
{
	move[0] = MOVE_TURN; // --- STANDARDEINTRAG ---
};
...
// ------ Gegner im Fokus ------
INSTANCE FA_MY_FK_FOCUS_MAG_58 (C_FightAI)
{
	move[0] = MOVE_ATTACK; // --- STANDARDEINTRAG ---
	move[1] = MOVE_WAIT_LONGER;
	move[2] = MOVE_WAIT_LONGER;
...
// ------ Gegner NICHT im Fokus -------
INSTANCE FA_MY_FK_NOFOCUS_MAG_58 (C_FightAI)
{
	move[0] = MOVE_TURN; // --- STANDARDEINTRAG ---
};
...
// ------ Gegner attackiert mich ------
INSTANCE FA_ENEMY_PREHIT_56 (C_FightAI)
{
 	move[0] = MOVE_JUMPBACK;
...
// ------ Gegner macht Sturmattacke ------
INSTANCE FA_ENEMY_STORMPREHIT_56 (C_FightAI)
{
 	move[0] = MOVE_STRAFE;
};
...
// ------ Ich renne auf den Gegner zu ------
INSTANCE FA_MY_W_RUNTO_56 (C_FightAI)
{
	move[0] = MOVE_TURN; // --- Stehenbleiben ---
};

// ------- Ich Strafe gerade ------
INSTANCE FA_MY_W_STRAFE_56 (C_FightAI)
{
 	move[0] = MOVE_STRAFE; // --- STANDARDEINTRAG ---
};

// ------- Ich habe Gegner im Fokus (kann treffen) -------
INSTANCE FA_MY_W_FOCUS_56 (C_FightAI)
{
 	move[0] = MOVE_ATTACK;
 	move[1] = MOVE_JUMPBACK;
};
...
// ------- Ich habe Gegner NICHT im Fokus -------
INSTANCE FA_MY_W_NOFOCUS_56 (C_FightAI)
{
	move[0] = MOVE_JUMPBACK;
...
// ------ Ich renne auf den Gegner zu (kann treffen) ------
INSTANCE FA_MY_G_RUNTO_56 (C_FightAI)
{
 	//move[0] = MOVE_ATTACK; //Sturmattacke
 	move[0] = MOVE_RUN;
};
...
// ------- Ich Strafe gerade ------
INSTANCE FA_MY_G_STRAFE_56 (C_FightAI)
{
 	 move[0] = MOVE_STRAFE; // --- STANDARDEINTRAG ---
};

// ------- Ich habe Gegner im Fokus -------
INSTANCE FA_MY_G_FOCUS_56 (C_FightAI)
{
 	move[0] = MOVE_RUN; // --- STANDARDEINTRAG ---
};
...
// ------- Ich habe Gegner im Fokus -------
INSTANCE FA_MY_FK_FOCUS_56 (C_FightAI)
{
	move[0] = MOVE_RUN; // --- STANDARDEINTRAG ---
};

// ------- Ich habe Gegner NICHT im Fokus (gilt auch für G-Distanz!) -------
INSTANCE FA_MY_G_FK_NOFOCUS_56 (C_FightAI)
{
	move[0] = MOVE_TURN; // --- STANDARDEINTRAG ---
};
...
// ------ Gegner im Fokus ------
INSTANCE FA_MY_FK_FOCUS_FAR_56 (C_FightAI)
{
	move[0] = MOVE_ATTACK; // --- STANDARDEINTRAG ---
};

// ------ Gegner NICHT im Fokus ------
INSTANCE FA_MY_FK_NOFOCUS_FAR_56 (C_FightAI)
{
	move[0] = MOVE_TURN; // --- STANDARDEINTRAG ---
};
...
// ------ Gegner im Fokus ------
INSTANCE FA_MY_FK_FOCUS_MAG_56 (C_FightAI)
{
	move[0] = MOVE_ATTACK; // --- STANDARDEINTRAG ---
	move[1] = MOVE_WAIT_LONGER;
	move[2] = MOVE_WAIT_LONGER;
...
// ------ Gegner NICHT im Fokus -------
INSTANCE FA_MY_FK_NOFOCUS_MAG_56 (C_FightAI)
{
	move[0] = MOVE_TURN; // --- STANDARDEINTRAG ---
};
