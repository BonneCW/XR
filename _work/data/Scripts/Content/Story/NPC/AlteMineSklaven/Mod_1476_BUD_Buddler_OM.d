instance Mod_1476_BUD_Buddler_OM (Npc_Default)
{
	//-------- primary data --------
	...
	Mdl_SetVisualBody (self,"hum_body_Naked0",3,1,"Hum_Head_Bald", 91,  1, VLK_ARMOR_L);
	...
	//-------------Daily Routine-------------
	daily_routine = Rtn_start_1476;
	};

FUNC VOID Rtn_start_1476 ()
{
	TA_Pick_Ore		(00,00,23,00,"OM_PICKORE_12");
	TA_Pick_Ore		(23,00,24,00,"OM_PICKORE_12");
};

FUNC VOID Rtn_Pause_1476 ()
{
