var int Sagitta_IR_ItemsGiven_Chapter_1;
var int Sagitta_IR_ItemsGiven_Chapter_2;
var int Sagitta_IR_ItemsGiven_Chapter_3;
var int Sagitta_IR_ItemsGiven_Chapter_4;
var int Sagitta_IR_ItemsGiven_Chapter_5;

FUNC VOID B_GiveTradeInv_Mod_Sagitta_IR (var C_NPC slf)
{
	...
	if ((Kapitel >= 1)
	&& (Sagitta_IR_ItemsGiven_Chapter_1 == FALSE))
	{
		...
		Sagitta_IR_ItemsGiven_Chapter_1 = TRUE;
	};
	
	if ((Kapitel >= 2)
	&& (Sagitta_IR_ItemsGiven_Chapter_2 == FALSE))
	{
		CreateInvItems (slf, ItMi_Gold, 100); 
		...
		Sagitta_IR_ItemsGiven_Chapter_2 = TRUE;
	};

	if ((Kapitel >= 3)
	&& (Sagitta_IR_ItemsGiven_Chapter_3 == FALSE))
	{
		...
		Sagitta_IR_ItemsGiven_Chapter_3 = TRUE;
	};

	if ((Kapitel >= 4)
	&& (Sagitta_IR_ItemsGiven_Chapter_4 == FALSE))
	{
		...
		Sagitta_IR_ItemsGiven_Chapter_4 = TRUE;
	};

	if ((Kapitel >= 5)
	&& (Sagitta_IR_ItemsGiven_Chapter_5 == FALSE))
	{
		...
		Sagitta_IR_ItemsGiven_Chapter_5 = TRUE;
	};
};
