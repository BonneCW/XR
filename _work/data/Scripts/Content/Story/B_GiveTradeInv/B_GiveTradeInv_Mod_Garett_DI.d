var int Garett_DI_ItemsGiven_Chapter_1;
var int Garett_DI_ItemsGiven_Chapter_2;
var int Garett_DI_ItemsGiven_Chapter_3;
var int Garett_DI_ItemsGiven_Chapter_4;
var int Garett_DI_ItemsGiven_Chapter_5;

FUNC VOID B_GiveTradeInv_Mod_Garett_DI (var C_NPC slf)
{
	if ((Kapitel >= 1)
	&& (Garett_DI_ItemsGiven_Chapter_1 == FALSE))
	{
		...
		Garett_DI_ItemsGiven_Chapter_1 = TRUE;
	};
	
	if ((Kapitel >= 2)
	&& (Garett_DI_ItemsGiven_Chapter_2 == FALSE))
	{
		...
		Garett_DI_ItemsGiven_Chapter_2 = TRUE;
	};

	if ((Kapitel >= 3)
	&& (Garett_DI_ItemsGiven_Chapter_3 == FALSE))
	{
		...
		Garett_DI_ItemsGiven_Chapter_3 = TRUE;
	};

	if ((Kapitel >= 4)
	&& (Garett_DI_ItemsGiven_Chapter_4 == FALSE))
	{
		...
		Garett_DI_ItemsGiven_Chapter_4 = TRUE;
	};

	if ((Kapitel >= 5)
	&& (Garett_DI_ItemsGiven_Chapter_5 == FALSE))
	{
		CreateInvItems (slf, ItMi_Gold, 200); 
	
		Garett_DI_ItemsGiven_Chapter_5 = TRUE;
	};
};
