var int Bernd_ItemsGiven_Chapter_1;
var int Bernd_ItemsGiven_Chapter_2;
var int Bernd_ItemsGiven_Chapter_3;
var int Bernd_ItemsGiven_Chapter_4;
var int Bernd_ItemsGiven_Chapter_5;

FUNC VOID B_GiveTradeInv_Mod_Bernd_MT (var C_NPC slf)
{
	if ((Kapitel >= 1)
	&& (Bernd_ItemsGiven_Chapter_1 == FALSE))
	{
		...
		Bernd_ItemsGiven_Chapter_1 = TRUE;
	};
	
	if ((Kapitel >= 2)
	&& (Bernd_ItemsGiven_Chapter_2 == FALSE))
	{
		...
		Bernd_ItemsGiven_Chapter_2 = TRUE;
	};

	if ((Kapitel >= 3)
	&& (Bernd_ItemsGiven_Chapter_3 == FALSE))
	{
		...
		Bernd_ItemsGiven_Chapter_3 = TRUE;
	};

	if ((Kapitel >= 4)
	&& (Bernd_ItemsGiven_Chapter_4 == FALSE))
	{
		...
		Bernd_ItemsGiven_Chapter_4 = TRUE;
	};

	if ((Kapitel >= 5)
	&& (Bernd_ItemsGiven_Chapter_5 == FALSE))
	{
		...
		Bernd_ItemsGiven_Chapter_5 = TRUE;
	};
};
