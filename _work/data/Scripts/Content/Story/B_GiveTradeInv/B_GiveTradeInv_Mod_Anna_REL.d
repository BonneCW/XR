var int Anna_ItemsGiven_Chapter_1;
var int Anna_ItemsGiven_Chapter_2;
var int Anna_ItemsGiven_Chapter_3;
var int Anna_ItemsGiven_Chapter_4;
var int Anna_ItemsGiven_Chapter_5;

FUNC VOID B_GiveTradeInv_Mod_Anna_REL (var C_NPC slf)
{
	if ((Kapitel >= 1)
	&& (Anna_ItemsGiven_Chapter_1 == FALSE))
	{
		...
		Anna_ItemsGiven_Chapter_1 = TRUE;
	};
	
	if ((Kapitel >= 2)
	&& (Anna_ItemsGiven_Chapter_2 == FALSE))
	{
		CreateInvItems (slf, ItMi_Gold, 100); 
		...
		Anna_ItemsGiven_Chapter_2 = TRUE;
	};

	if ((Kapitel >= 3)
	&& (Anna_ItemsGiven_Chapter_3 == FALSE))
	{
		...
		Anna_ItemsGiven_Chapter_3 = TRUE;
	};

	if ((Kapitel >= 4)
	&& (Anna_ItemsGiven_Chapter_4 == FALSE))
	{
		...
		Anna_ItemsGiven_Chapter_4 = TRUE;
	};

	if ((Kapitel >= 5)
	&& (Anna_ItemsGiven_Chapter_5 == FALSE))
	{
		...
		Anna_ItemsGiven_Chapter_5 = TRUE;
	};
};
