var int Alberto_ItemsGiven_Chapter_1;
var int Alberto_ItemsGiven_Chapter_2;
var int Alberto_ItemsGiven_Chapter_3;
var int Alberto_ItemsGiven_Chapter_4;
var int Alberto_ItemsGiven_Chapter_5;

FUNC VOID B_GiveTradeInv_Mod_Alberto_OM (var C_NPC slf)
{
	if ((Kapitel >= 1)
	&& (Alberto_ItemsGiven_Chapter_1 == FALSE))
	{
		...
		Alberto_ItemsGiven_Chapter_1 = TRUE;
	};
	
	if ((Kapitel >= 2)
	&& (Alberto_ItemsGiven_Chapter_2 == FALSE))
	{
		...
		Alberto_ItemsGiven_Chapter_2 = TRUE;
	};

	if ((Kapitel >= 3)
	&& (Alberto_ItemsGiven_Chapter_3 == FALSE))
	{
		...
		Alberto_ItemsGiven_Chapter_3 = TRUE;
	};

	if ((Kapitel >= 4)
	&& (Alberto_ItemsGiven_Chapter_4 == FALSE))
	{
		...
		Alberto_ItemsGiven_Chapter_4 = TRUE;
	};

	if ((Kapitel >= 5)
	&& (Alberto_ItemsGiven_Chapter_5 == FALSE))
	{
		...
		Alberto_ItemsGiven_Chapter_5 = TRUE;
	};
};
