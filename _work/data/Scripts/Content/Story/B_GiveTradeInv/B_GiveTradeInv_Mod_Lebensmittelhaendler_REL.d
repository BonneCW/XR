var int Lebensmittelhaendler_ItemsGiven_Chapter_1;
var int Lebensmittelhaendler_ItemsGiven_Chapter_2;
var int Lebensmittelhaendler_ItemsGiven_Chapter_3;
var int Lebensmittelhaendler_ItemsGiven_Chapter_4;
var int Lebensmittelhaendler_ItemsGiven_Chapter_5;

FUNC VOID B_GiveTradeInv_Mod_Lebensmittelhaendler_REL (var C_NPC slf)
{
	if ((Kapitel >= 1)
	&& (Lebensmittelhaendler_ItemsGiven_Chapter_1 == FALSE))
	{
	...
	if ((Kapitel >= 2)
	&& Lebensmittelhaendler_ItemsGiven_Chapter_2 == FALSE)
	{
		...
		Lebensmittelhaendler_ItemsGiven_Chapter_2 = TRUE;
	};	
	
	if ((Kapitel >= 3)
	&& (Lebensmittelhaendler_ItemsGiven_Chapter_3 == FALSE))
	{
		CreateInvItems (slf, ItMi_Gold, 100); 
		CreateInvItems (slf, ItPl_Forestberry, 3); 
		...
		Lebensmittelhaendler_ItemsGiven_Chapter_3 = TRUE;
	};

	if ((Kapitel >= 4)
	&& (Lebensmittelhaendler_ItemsGiven_Chapter_4 == FALSE))
	{
		...
		Lebensmittelhaendler_ItemsGiven_Chapter_4 = TRUE;
	};

	if ((Kapitel >= 5)
	&& (Lebensmittelhaendler_ItemsGiven_Chapter_5 == FALSE))
	{
		...
		Lebensmittelhaendler_ItemsGiven_Chapter_5 = TRUE;
	};
};
