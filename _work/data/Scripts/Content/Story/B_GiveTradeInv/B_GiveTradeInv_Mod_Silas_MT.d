...
var int Silas_ItemsGiven_Chapter_3;
var int Silas_ItemsGiven_Chapter_4;
var int Silas_ItemsGiven_Chapter_5;

FUNC VOID B_GiveTradeInv_Mod_Silas_MT (var C_NPC slf)
{
	if ((Kapitel >= 1)
	...
	if ((Kapitel >= 3)
	&& (Silas_ItemsGiven_Chapter_3 == FALSE))
	{
		CreateInvItems (slf, ItMi_Gold, 50); 
		CreateInvItems (slf, ItFo_Wine, 8); 
		...
		Silas_ItemsGiven_Chapter_3 = TRUE;
	};

	if ((Kapitel >= 4)
	&& (Silas_ItemsGiven_Chapter_4 == FALSE))
	{
		...
		Silas_ItemsGiven_Chapter_4 = TRUE;
	};

	if ((Kapitel >= 5)
	&& (Silas_ItemsGiven_Chapter_5 == FALSE))
	{
		CreateInvItems (slf, ItMi_Gold, 150); 
		...
		Silas_ItemsGiven_Chapter_5 = TRUE;
	};
};
