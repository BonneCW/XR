...
CONST STRING MOBNAME_BENCH			= "Bank";						//Bank
CONST STRING MOBNAME_ANVIL			= "Amboss";					//Amboss
CONST STRING MOBNAME_BUCKET			= "Wassereimer";			//Wassereimer
CONST STRING MOBNAME_FORGE			= "Schmiedefeuer";			//Schmiede
...
CONST STRING MOBNAME_SEAT			= "Sessel";						//Sessel
CONST STRING MOBNAME_THRONE			= "Thron";						//Thron
...
CONST STRING MOBNAME_ERZ			= "Erzklumpen";				//Erzmobsi
CONST STRING MOBNAME_WINEMAKER		= "";						//Weinstampfe
CONST STRING MOBNAME_ORCDRUM		= "Orktrommel";						//Orkische Kriegstrommel
...
const string MOBNAME_HOCKER		= "Hocker";
...
CONST STRING MOBNAME_MIX_01			= "Matteos Allerlei";
CONST STRING MOBNAME_MIX_02			= "Halvors Fischstube 'zur glitschigen Forelle'";
...
CONST STRING MOBNAME_SALANDRIL		= "Salandrils Tränke";
...
const string MOBNAME_ADDON_FORTUNO				= "Fortunos Truhe"; 
...
const string MOBNAME_ADDON_TELEPORT_02 = "zur Echsenstadt";
...
const string MOBNAME_XR_ADANOS	=	"Adanosschrein";
const string MOBNAME_XR_RANGAR	=	"Rangars Truhe";
const string MOBNAME_XR_LEHMAR	=	"Lehmars Truhe";
const string MOBNAME_XR_OPFERALTAR	=	"Opferaltar";
const string MOBNAME_XR_RUNENSTEIN	=	"Runensteinbrocken";
const string MOBNAME_XR_REISLORDCHEST	=	"Reislords Truhe";
const string MOBNAME_XR_CUTTERSTRUHE	=	"Cutters Truhe";
const string MOBNAME_XR_HSBRUNNEN	=	"Freudenspender-Brunnen";
const string MOBNAME_XR_FELD	= "Feld";
const string MOBNAME_XR_HOCHOFEN	= "Hochofen";
const string MOBNAME_XR_KORB	= "Korb";
const string MOBNAME_XR_RUPRECHT	= "Ruprechts Truhe";
const string MOBNAME_XR_GERBKESSEL	= "Gerbkessel";
const string MOBNAME_XR_KLO	= "Toilette";
const string MOBNAME_XR_SARG	= "Sarg";
const string MOBNAME_XR_SALZ	= "Salzader";
const string MOBNAME_XR_BUECHERREGAL	= "Bücherregal";
const string MOBNAME_XR_TRUEMMER	= "Trümmer";
...
CONST STRING MOBNAME_Theater 		= "Theater";
CONST STRING MOBNAME_Holzsarg		= "Holzsarg";					
CONST STRING MOBNAME_Steinsarg		= "Steinsarg";					
...
CONST STRING MOBNAME_XR_TUG_TAVERNE	= "Taverne";
CONST STRING MOBNAME_XR_TUG_HOTEL	= "Unterkunft";
CONST STRING MOBNAME_XR_REL_SCHNEIDER	= "Schneider Versage";
CONST STRING MOBNAME_XR_REL_BAECKER	= "Bäcker";
CONST STRING MOBNAME_XR_REL_BRAUER	= "Brauerei";
CONST STRING MOBNAME_XR_REL_METZGER	= "Metzger";
CONST STRING MOBNAME_XR_REL_KNEIPE	= "Kneipe";
CONST STRING MOBNAME_XR_REL_TAVERNE	= "Gasthaus";
CONST STRING MOBNAME_XR_MOOR_KNEIPE	= "Schenke zur Goldenen Gülle";

// XR - Wegweiser

const string MOBNAME_XR_WEG_KHORATA	= "Nach Khorata";
const string MOBNAME_XR_WEG_MOOR	= "Zum Moor";
const string MOBNAME_XR_WEG_HOFSTAAT	= "Zum Hofstaat";
const string MOBNAME_XR_WEG_PASS	= "Zum Pass nach Khorinis";
const string MOBNAME_XR_WEG_RUINE	= "Zur Ruine";
const string MOBNAME_XR_WEG_MINE	= "Zur Mine";

// Loren-Winden

const string MOBNAME_XR_LORE_MINE	= "zur Mine fahren";
const string MOBNAME_XR_LORE_STONEHENGE	= "zum Steinkreis fahren";
const string MOBNAME_XR_LORE_SW	= "zum Süd-West-Eck fahren";
const string MOBNAME_XR_LORE_SO	= "zum Süd-Ost-Eck fahren";
const string MOBNAME_XR_LORE_NW	= "zum Nord-West-Eck fahren";
const string MOBNAME_XR_LORE_NO	= "zum Nord-Ost-Eck fahren";
...
const string TXT_SPELLS[MAX_SPELL] =
{
	...
	"Uriziels Welle des Todes",			// 44	SPL_MassDeath
	...
	"Orkischer Teleportzauber",	//101	SPL_Teleport4
	"Teleport",			//102	SPL_Teleport5
	"Totenbeschwörers Armee",
	"Berserk",
	"Großer Feuerball",
	"Eisblock",
	"Windfaust",
	...
	"Eisregen",
	"Drache beschwören",
	"Eisgoblin beschwören",
	"Goblin-Krieger beschwören",
	"Pyrokinese",
	"Nach Patherion",
	"Eisball",
	"Manaentzug",
	...
	"Schwächen",
	"Teleport",
	"Teleport vor altes Lager",
	"untoten Sumpfhai erschaffen",
	"Unsichtbarkeit",
	"Feuerlanze",
	"Ratten beschwören",
	"Teleport",
	...
	"zur Klosterruine",
	"Teleport-Obelisk",
	"zum Marktplatz von Khorata",
	"Teleport zu Torgan",
	"zum Bauernhof",
	"zum Pass in Relendel",
	"zum Räuberlager",
	"zum großen See",
	"Hasen rufen",
	"zum Waldläuferlager",
	...
	"zum Banditenlager",
	"zum Dorf in Gelato",
	"Lord Hagens Spruchrolle",
	"Schaf für Troll beschwören",
	"Fackel an/aus",
	"zu Xeres Palast",
	"Geist rufen",
	"Giftteppich",
...
const string NAME_SPL_BeliarCity		= "Täuschung";
const string NAME_SPL_Schwaechen		= "Schwächen";
...
const string NAME_SPL_TeleportBergfestung	= "Teleport zur Bergfestung";
const string NAME_SPL_TeleportKlosterruine	= "Teleport zur Klosterruine";
const string NAME_SPL_TeleportSonnenkreis	= "Teleport zum Sonnenkreis";
const string NAME_SPL_TeleportTaverne		= "Teleport zur Taverne";
const string NAME_SPL_TeleportRELHofstaat		= "Teleport zum Hofstaat";
const string NAME_SPL_Teleport_3			= "NAME_SPL_TELEPORT_3";
const string NAME_SPL_TeleportDemonTower			= "Teleport zum Dämonenturm";
const string NAME_SPL_TeleportPsicamp	= "Teleport zum Sumpflager";
const string NAME_SPL_TeleportOldcamp		= "Teleport zum alten Lager";
const string NAME_SPL_TeleportNewcamp			= "Teleport zum Neuen Lager";
const string NAME_SPL_Teleport_Pat			= "Teleport nach Patherion";
const string NAME_SPL_TeleportPatBack			= "Teleport nach Khorinis";
const string NAME_SPL_Teleport_Pat_01			= "Teleport zur Kapelle";
const string NAME_SPL_Teleport_Pat_02			= "Teleport zur Kirche";
const string NAME_SPL_TeleportObelisk			= "Teleport-Obelisk";
const string NAME_SPL_TeleportKhorata			= "Teleport zum Marktplatz von Khorata";
const string NAME_SPL_TeleportRELBauernhof		= "Teleport zum Bauernhof in Relendel";
const string NAME_SPL_TeleportRELPass			= "Teleport zum Pass in Relendel";
const string NAME_SPL_TeleportRELRaeuber		= "Teleport zum Räuberlager";
const string NAME_SPL_TeleportRELSee			= "Teleport zum großen See";
...
const string NAME_SPL_Unsichtbarkeit				= "Unsichtbarkeit";
...
const string NAME_SPL_InstantIceball		= "Eisball";
...
const string NAME_SPL_SummonRabbit			= "Hasen rufen";
const string NAME_SPL_SummonUDSwampshark			= "untoten Sumpfhai beschwören";
...
const string NAME_SPL_TrfSkeleton2		= "Verwandlung Skelett";
const string NAME_SPL_Charm					= "Vergessen";
const string NAME_SPL_Zerfleischen					= "Zerfleischen";
...
const string NAME_SPL_SummonRats				= "Ratten beschwören";
...
const string NAME_SPL_SummonFeuerbeast	=	"Feuerläufer beschwören";
const string NAME_SPL_SummonFireGolem			= "Feuergolem erwecken";
const string NAME_SPL_SummonIceGolem			= "Eisgolem erwecken";
const string NAME_SPL_Zaehmen	=	"Monster zähmen";
...
const string NAME_SPL_IceRain	= "Eisregen";
const string NAME_SPL_SummonDragon			= "Drache beschwören";
const string NAME_SPL_SummonEisgoblin			= "Eisgoblin beschwören";
const string NAME_SPL_SummonGoblinKrieger			= "Goblin-Krieger beschwören";
const string NAME_SPL_ManaEntzug			= "Manaentzug";
const string NAME_SPL_TeleportSektis	= "Teleport der Sektenspinner";
...
CONST STRING TXT_TALENTS [NPC_TALENT_MAX] =
{
	...
	"Spezialfähigkeit",							//raus //NPC_TALENT_REGENERATE	= 9;
	...
	"Gesinnung",							//NPC_TALENT_C					= 19;
	"Schürfen",							//NPC_TALENT_D					= 20;
	"Handeln"
};
...
CONST STRING TXT_TALENTS_SKILLS	[NPC_TALENT_MAX] =
{
	...
	"-|Beliars' Avatar|Extrem Böse|Sehr Böse|Böse|Adanos' Avatar|Extrem Neutral|Sehr Neutral|Neutral|Innos' Avatar|Extrem Gut|Sehr Gut|Gut",												//NPC_TALENT_C					= 19;
	"Anfänger|pass. Schürfer|erf. Schürfer|wahr. Buddler|gut. Buddler|Meister Buddler|Buddler Guru",												//NPC_TALENT_D					= 20;
	"-|Lehrling|Kl. Händler|Händler|Guter Händler|Perf. Händler"											//NPC_TALENT_E					= 21;
};
...
const string NAME_Magier		= "Feuermagier";
...
const string NAME_Organisator	= "Söldner";
const string NAME_Schlaeger	= "Schläger";
const string NAME_Wasserkrieger	= "Wasserkrieger";
const string NAME_Schuerfer	= "Schürfer";
const string NAME_SchwarzerKrieger	= "Schwarzer Krieger";
const string NAME_SchwarzerMagier	= "Schwarzer Magier";
const string NAME_Firemage	= "Feuermagier";
...
const string NAME_Orkjaeger	= "Orkjäger";
const string NAME_Jaeger	= "Jäger";
...
const string NAME_Range		= "Reichweite";
...
const string NAME_ADDON_BONUS_BOW					= "Bogen Talent - Bonus";
...
const string PRINT_LearnScrolls				= "Lerne: Spruchrollen herstellen";
...
const string PRINT_LearnSTR3				= "Stärke + 3";
...
const string PRINT_LearnDEX3				= "Geschicklichkeit + 3";
...
const string PRINT_LearnHP1				= "Lebenspunkte + 1";
const string PRINT_LearnHP3				= "Lebenspunkte + 3";
const string PRINT_LearnHP5				= "Lebenspunkte + 5";
const string PRINT_LearnHP10				= "Lebenspunkte + 10";
...
const string PRINT_SekretSuccess			= "Sekret abgefüllt!";
const string PRINT_TiergiftSuccess			= "Tiergift abgefüllt!";
const string PRINT_GewaechsgiftSuccess			= "Gewächsgift abgefüllt!";
const string PRINT_KesselSuccess			= "Gericht zubereitet!";
...
const string PRINT_JointSuccess				= "Sumpfkraut - Stängel gedreht!";
...
const string PRINT_Joint_Herkules_Success	= "Herkulesstängel gedreht!"; //ADDON
...
const string PRINT_BlessAdanosSTR					= "Adanos schenkt dir: Stärke + ";
const string PRINT_BlessAdanosDEX					= "Adanos schenkt dir: Geschicklichkeit + ";
const string PRINT_BlessAdanosMANA_MAX			= "Adanos schenkt dir: Mana + ";
const string PRINT_BlessAdanosHitpoints_MAX		= "Adanos schenkt dir: Lebensenergie + ";
const string PRINT_BlessAdanosMANA				= "Du bist erfüllt von geistiger Klarheit.";
const string PRINT_BlessAdanosHitpoints			= "Adanos erhört dich und heilt dich.";
const string Print_BlessAdanosMana_Hit			= "Du fühlst dich wie neugeboren.";
...
const string PRINT_Eat21						= "Du fühlst dich gut";
const string PRINT_Eat22						= "Schmeckt süß";
const string PRINT_Eat23						= "Du fühlst dich gut und geschickt!";
...
const string PRINT_NewLogEntry_2			= "Neue Tagebucheinträge";
