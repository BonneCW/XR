...
{
	// ------ B_Say_GuildGreetings ---------------------------------------------------------------------------------------
	MILGreetings				= 	"SVM_0_MILGreetings"				;//Für den König!
	PALGreetings				=	"SVM_0_PALGreetings"				;//Für Innos!
	BELGreetings				=	"SVM_0_BELGreetings"				;//Beliar zu ehren!
	AdanosGreetings				=	"SVM_0_AdanosGreetings"				;//Adanos sei mit dir!
	Weather						= 	"SVM_0_Weather"						;//So ein Mistwetter!
	// ------ B_Say_AttackReason -----------------------------------------------------------------------------------------
	IGetYouStill				= 	"SVM_0_IGetYouStill"				;//Krieg ich dich DOCH noch!
	DieEnemy					=	"SVM_0_DieEnemy"					;//Jetzt bist du dran!
	DieMonster					=	"SVM_0_DieMonster"					;//Da ist wieder eins von diesen Drecksviechern!
	DirtyThief					=	"SVM_0_DirtyThief"					;//Na warte, du dreckiger Dieb!
	HandsOff					=	"SVM_0_HandsOff"					;//Finger weg da!
	SheepKiller					=	"SVM_0_SheepKiller"					;//Der Mistkerl schlachtet unsere Schafe!
	SheepKillerMonster			=	"SVM_0_SheepKillerMonster"			;//Das verdammte Mistvieh frisst unsere Schafe!
	YouMurderer					=	"SVM_0_YouMurderer"					;//Mörder!
	DieStupidBeast				=	"SVM_0_DieStupidBeast"				;//Hier kommen keine Viecher rein!
	YouDareHitMe				=	"SVM_0_YouDareHitMe"				;//Na warte, du Mistkerl!
	YouAskedForIt				=	"SVM_0_YouAskedForIt"				;//Du hast es so gewollt!
	ThenIBeatYouOutOfHere		=	"SVM_0_ThenIBeatYouOutOfHere"		;//Dann muss ich dich eben rausprügeln!
	WhatDidYouDoInThere			=	"SVM_0_WhatDidYouDoInThere"			;//Was hattest DU denn da drin zu suchen, he!?
	WillYouStopFighting			=	"SVM_0_WillYouStopFighting"			;//Wollt ihr wohl damit aufhören!?
	// ------ B_Say_AttackEND ---------------------------------------------------------------------------------------------
	KillEnemy					= 	"SVM_0_KillEnemy"					;//Stirb, Mistkerl!
	EnemyKilled					=	"SVM_0_EnemyKilled"					;//Das war's für dich, Penner.
	MonsterKilled				=	"SVM_0_MonsterKilled"				;//Ein Mistvieh weniger!
	ThiefDown					=	"SVM_0_ThiefDown"					;//Versuch nie wieder, mich zu bestehlen!
	Berzerk						=	"SVM_0_Berzerk"						;//UUAAARRGGGHHH!!!
	rumfummlerDown				=	"SVM_0_rumfummlerDown"				;//Lass in Zukunft die Finger von Sachen, an denen du nichts zu suchen hast!
	SheepAttackerDown			=	"SVM_0_SheepAttackerDown"			;//Tu das nie wieder! Das sind unsere Schafe!
	KillMurderer				=	"SVM_0_KillMurderer"				;//Stirb, Mörder!
	StupidBeastKilled			=	"SVM_0_StupidBeastKilled"			;//So ein saublödes Vieh!
	NeverHitMeAgain				=	"SVM_0_NeverHitMeAgain"				;//Leg dich nie wieder mit mir an!
	YouBetterShouldHaveListened	=	"SVM_0_YouBetterShouldHaveListened"	;//Du hättest auf mich hören sollen!
	GetUpAndBeGone				=	"SVM_0_GetUpAndBeGone"				;//Und jetzt mach, dass du hier rauskommst!
	NeverEnterRoomAgain			=	"SVM_0_NeverEnterRoomAgain"			;//Und dass ich dich nie wieder da drin erwische!
	ThereIsNoFightingHere		=	"SVM_0_ThereIsNoFightingHere"		;//Hier wird nicht gekämpft, klar!? Lass dir das eine Lehre sein!
	// ------ C_WantToFlee -------------------------------------------------------------------------------------------------
	RunAway						= 	"SVM_0_RunAway"						;//Scheiße! Nichts wie weg!
	// ------ C_WantToCallGuardsToFight --------------------------------------------------------------------------------------
	Alarm						=	"SVM_0_Alarm"						;//ALARM!
	Guards						=	"SVM_0_Guards"						;//WACHE!
	Help						=	"SVM_0_Help"						;//Hilfe!
	// ------ B_AssessMurder -----------------------------------------------------------------------------------------------
	GoodMonsterKill				=	"SVM_0_GoodMonsterKill"				;//(ruft zu) Gut gemacht - ein Drecksvieh weniger!
	GoodKill					= 	"SVM_0_GoodKill"					;//(ruft) Ja, mach das Schwein fertig!
	// ------ B_AssessTalk -----------------------------------------------------------------------------------------------
	NOTNOW						= 	"SVM_0_NOTNOW"						;//Lass mich in Ruhe!
	// ------ ZS_Attack ----------------------------------------------------------------------------------------------------
	RunCoward					=	"SVM_0_RunCoward"					;//(ruft laut) Bleib stehen, du Lump!
	// ------ ZS_ClearRoom -------------------------------------------------------------------------------------------------
	GetOutOfHere				=	"SVM_0_GetOutOfHere"				;//Raus hier!
	WhyAreYouInHere				=	"SVM_0_WhyAreYouInHere"				;//Was suchst du hier!? Geh!
	YesGoOutOfHere				= 	"SVM_0_YesGoOutOfHere"				;//Ja, mach, dass du wegkommst!
	// ------ ZS_ObservePlayer ---------------------------------------------------------------------------------------------
	WhatsThisSupposedToBe		=	"SVM_0_WhatsThisSupposedToBe"		;//Hey du! Was schleichst du da rum.
	YouDisturbedMySlumber		=	"SVM_0_YouDisturbedMySlumber"		;//(wacht auf) Verdammt, was ist los?
	// ------ ZS_RansackBody -----------------------------------------------------------------------------------------------
	ITookYourGold				=	"SVM_0_ITookYourGold"				;//Gold! Das ist schon mal meins ...
	ShitNoGold					=	"SVM_0_ShitNoGold"					;//Der Mistkerl hat noch nicht mal Gold dabei.
	ITakeYourWeapon				=	"SVM_0_ITakeYourWeapon"				;//Deine Waffe nehm' ich mal lieber mit.
	// ------ ZS_ReactToDamage ---------------------------------------------------------------------------------------------
	WhatAreYouDoing				=	"SVM_0_WhatAreYouDoing"				;//(warnt) Hey! Pass auf!
	// ------ ZS_ReactToWeapon ---------------------------------------------------------------------------------------------
	LookingForTroubleAgain		=	"SVM_0_LookingForTroubleAgain"		;//(aggressiv) Hast du immer noch nicht genug?!
	StopMagic					=	"SVM_0_StopMagic"					;//Geh bloß weg mit deiner Magie!
	ISaidStopMagic				=	"SVM_0_ISaidStopMagic"				;//Weg mit der Magie! Hörst du schlecht!?
	WeaponDown					=	"SVM_0_WeaponDown"					;//Weg mit der Waffe!
	ISaidWeaponDown				=	"SVM_0_ISaidWeaponDown"				;//Hörst du schlecht? Ich sagte: Weg mit der Waffe!
	WiseMove					=	"SVM_0_WiseMove"					;//Na bitte, geht doch!
	// ------ ZS_Unconscious ------------------------------------------------------------------------------------------------
	NextTimeYoureInForIt		=	"SVM_0_NextTimeYoureInForIt"		;//(zu sich selbst) Darüber reden wir noch ...
	OhMyHead					=	"SVM_0_OhMyHead"					;//(zu sich selbst) Oh, mein Schädel ...
	// ------ ZS_WatchFight -------------------------------------------------------------------------------------------------
	TheresAFight				=	"SVM_0_TheresAFight"				;//(gierig) Jetzt geht's zur Sache!
	OhMyGodItsAFight			=	"SVM_0_OhMyGodItsAFight"			;//(bestürzt) Die hauen sich den Schädel ein ...
	GoodVictory					=	"SVM_0_GoodVictory"					;//(böse lachend) Das hat er verdient.
	NotBad						= 	"SVM_0_NotBad"						;//(anerkennend) Gar nicht so übel ...
	OhMyGodHesDown				=	"SVM_0_OhMyGodHesDown"				;//(zu sich selbst) Was für ein brutaler Kerl ...
	CheerFriend01				=	"SVM_0_CheerFriend01"				;//Ja, so ist's gut!
	CheerFriend02				=	"SVM_0_CheerFriend02"				;//Na, mach schon!
	CheerFriend03				=	"SVM_0_CheerFriend03"				;//Immer feste drauf!
	Ooh01						=	"SVM_0_Ooh01"						;//Lass dir nichts gefallen!
	Ooh02						=	"SVM_0_Ooh02"						;//Den wirst du ja wohl schaffen!
	Ooh03						=	"SVM_0_Ooh03"						;//Das gibt's doch gar nicht!
	// ----------------------------------------------------------------------------------------------------------------------
	WhatWasThat					= "SVM_0_WhatWasThat"					;//(zu sich selbst, wacht auf) Was WAR das!?
	// ----------------------------------------------------------------------------------------------------------------------
	GetOutOfMyBed				= "SVM_0_GetOutOfMyBed"					;//Raus aus meinem Bett!
	Awake						= "SVM_0_Awake"							;//(herzhaftes Gähnen)
	// ----------------------------------------------------------------------------------------------------------------------
	TOUGHGUY_ATTACKLOST			= "SVM_0_TOUGHGUY_ATTACKLOST"			;//Ist ja schon gut, du hast gewonnen. Was willst du?
	TOUGHGUY_ATTACKWON			= "SVM_0_TOUGHGUY_ATTACKWON"			;//(selbstgefällig) Muss ich dir noch mal zeigen, wer hier der Herr ist?
	TOUGHGUY_PLAYERATTACK		= "SVM_0_TOUGHGUY_PLAYERATTACK"			;//Willst du dich noch mal mit mir anlegen oder was?
	// ----------------------------------------------------------------------------------------------------------------------
	GOLD_1000					= "SVM_0_GOLD_1000"						;//1000 Goldstücke.
	GOLD_950					= "SVM_0_GOLD_950"						;//950 Goldstücke.
	GOLD_900					= "SVM_0_GOLD_900"						;//900 Goldstücke.
	GOLD_850					= "SVM_0_GOLD_850"						;//850 Goldstücke.
	GOLD_800					= "SVM_0_GOLD_800"						;//800 Goldstücke.
	GOLD_750					= "SVM_0_GOLD_750"						;//750 Goldstücke.
	GOLD_700					= "SVM_0_GOLD_700"						;//700 Goldstücke.
	GOLD_650					= "SVM_0_GOLD_650"						;//650 Goldstücke.
	GOLD_600					= "SVM_0_GOLD_600"						;//600 Goldstücke.
	GOLD_550					= "SVM_0_GOLD_550"						;//550 Goldstücke.
	GOLD_500					= "SVM_0_GOLD_500"						;//500 Goldstücke.
	GOLD_450					= "SVM_0_GOLD_450"						;//450 Goldstücke.
	GOLD_400					= "SVM_0_GOLD_400"						;//400 Goldstücke.
	GOLD_350					= "SVM_0_GOLD_350"						;//350 Goldstücke.
	GOLD_300					= "SVM_0_GOLD_300"						;//300 Goldstücke.
	GOLD_250					= "SVM_0_GOLD_250"						;//250 Goldstücke.
	GOLD_200					= "SVM_0_GOLD_200"						;//200 Goldstücke.
	GOLD_150					= "SVM_0_GOLD_150"						;//150 Goldstücke.
	GOLD_100					= "SVM_0_GOLD_100"						;//100 Goldstücke.
	GOLD_90						= "SVM_0_GOLD_90"						;//90 Goldstücke.
	GOLD_80						= "SVM_0_GOLD_80"						;//80 Goldstücke.
	GOLD_70						= "SVM_0_GOLD_70"						;//70 Goldstücke.
	GOLD_60						= "SVM_0_GOLD_60"						;//60 Goldstücke.
	GOLD_50						= "SVM_0_GOLD_50"						;//50 Goldstücke.
	GOLD_40						= "SVM_0_GOLD_40"						;//40 Goldstücke.
	GOLD_30						= "SVM_0_GOLD_30"						;//30 Goldstücke.
	GOLD_20						= "SVM_0_GOLD_20"						;//20 Goldstücke.
	GOLD_10						= "SVM_0_GOLD_10"						;//10 Goldstücke.
	// -----------------------------------------------------------------------------------------------------------------------
	Smalltalk01					= "SVM_0_Smalltalk01"					;//... glaubst du wirklich ...
	Smalltalk02					= "SVM_0_Smalltalk02"					;//... möglich ist alles ...
	Smalltalk03					= "SVM_0_Smalltalk03"					;//... das hätte er doch besser wissen müssen ...
	Smalltalk04					= "SVM_0_Smalltalk04"					;//... als ob ich nicht schon genug Probleme hätte ...
	Smalltalk05					= "SVM_0_Smalltalk05"					;//... wer erzählt denn so was ...
	Smalltalk06					= "SVM_0_Smalltalk06"					;//... das gibt doch nur noch mehr Ärger ...
	Smalltalk07					= "SVM_0_Smalltalk07"					;//... man erzählt sich ja so einiges ...
	Smalltalk08					= "SVM_0_Smalltalk08"					;//... ich hätte das nicht gemacht ...
	Smalltalk09					= "SVM_0_Smalltalk09"					;//... das sind doch alles nur Gerüchte ...
	Smalltalk10					= "SVM_0_Smalltalk10"					;//... man muss eben aufpassen, was man so rumerzählt ...
	Smalltalk11					= "SVM_0_Smalltalk11"					;//... das hätte ich dir vorher sagen können ...
	Smalltalk12					= "SVM_0_Smalltalk12"					;//... mich fragt ja keiner ...
	Smalltalk13					= "SVM_0_Smalltalk13"					;//... der arme Kerl kann einem Leid tun ...
	Smalltalk14					= "SVM_0_Smalltalk14"					;//... das ist doch nichts Neues ...
	Smalltalk15					= "SVM_0_Smalltalk15"					;//... das liegt doch auf der Hand ...
	Smalltalk16					= "SVM_0_Smalltalk16"					;//... mich brauchst du das nicht zu fragen ...
	Smalltalk17					= "SVM_0_Smalltalk17"					;//... das kann ja nicht ewig so weitergehen ...
	Smalltalk18					= "SVM_0_Smalltalk18"					;//... meine Meinung kennst du ja schon ...
	Smalltalk19					= "SVM_0_Smalltalk19"					;//... genau das hab ich auch gesagt ...
	Smalltalk20					= "SVM_0_Smalltalk20"					;//... daran wird sich nie etwas ändern ...
	Smalltalk21					= "SVM_0_Smalltalk21"					;//... warum erfahre ich das erst jetzt ...
	Smalltalk22					= "SVM_0_Smalltalk22"					;//... lass uns mal abwarten, was daraus wird ...
	Smalltalk23					= "SVM_0_Smalltalk23"					;//... einige Probleme erledigen sich von selbst ...
	Smalltalk24					= "SVM_0_Smalltalk24"					;//... ich kann das nicht mehr hören ...
	//ToughGuy (SLD/MIL/DJG)                                                                                                                        
	Smalltalk25					= "SVM_0_Smalltalk25"					;//... der war doch sturzbetrunken ...
	Smalltalk26					= "SVM_0_Smalltalk26"					;//... mit mir kann man so was nicht machen ...
	Smalltalk27					= "SVM_0_Smalltalk27"					;//... alle sind gerannt wie die Hasen, ich war ganz allein ...
	//ProInnos (NOV/KDF/PAL)                                                                                                                        
	Smalltalk28					= "SVM_0_Smalltalk28"					;//... so steht es in den heiligen Schriften ...
	Smalltalk29					= "SVM_0_Smalltalk29"					;//... ich handle stets in Innos' Namen ...
	Smalltalk30					= "SVM_0_Smalltalk30"					;//... niemand darf gegen die göttliche Ordnung verstoßen ...
	SmalltalkKhorataAnnaQuest01			= "SVM_0_SmalltalkKhorataAnnaQuest01"; //... er hat sie alle abgemetzelt ...
	SmalltalkKhorataAnnaQuest02			= "SVM_0_SmalltalkKhorataAnnaQuest02"; //... nach dem, was er dem Richter angetan hat, würde ich ihn nicht mehr in mein Haus lassen ...
	SmalltalkKhorataAnnaQuest03			= "SVM_0_SmalltalkKhorataAnnaQuest03"; //... ich trauere nicht um die Schöppen ...
	SmalltalkKhorataAnnaQuest04			= "SVM_0_SmalltalkKhorataAnnaQuest04"; //... Ulrich ist mir immer schon komisch vorgekommen ...
	SmalltalkKhorataAnnaQuest05			= "SVM_0_SmalltalkKhorataAnnaQuest05"; //... würde wetten, dass Ulrich auch ein Hexer war ...
	SmalltalkKhorataAnnaQuest06			= "SVM_0_SmalltalkKhorataAnnaQuest06"; //... ich hätte mich niemals auf die Seite des Richters geschlagen ...
	SmalltalkKhorataDichter01			= "SVM_0_SmalltalkKhorataDichter01"; //... an den Gedichten kann es nicht gelegen haben ...
	SmalltalkKhorataDichter02			= "SVM_0_SmalltalkKhorataDichter02"; //... er hat jetzt aufgehört zu schreiben ...
	SmalltalkKhorataDichter03			= "SVM_0_SmalltalkKhorataDichter03"; //... mir hat er noch nie geholfen ...
	SmalltalkKhorataDichter04			= "SVM_0_SmalltalkKhorataDichter04"; //... ich habe ihn schon lange nicht mehr gesehen ...
	SmalltalkKhorataDichter05			= "SVM_0_SmalltalkKhorataDichter05"; //... ich vermisse seine Geschichten so sehr ...
	SmalltalkKhorataEndres01			= "SVM_0_SmalltalkKhorataEndres01"; //... schon die Sache mit Julianas Mann gehört? ...
	SmalltalkKhorataEndres02			= "SVM_0_SmalltalkKhorataEndres02"; //... o Adanos, jetzt werden in Khorata Menschen entführt ...
	SmalltalkKhorataEndres03			= "SVM_0_SmalltalkKhorataEndres03"; //... kann mir nicht vorstellen, dass er noch lebt ...
	SmalltalkKhorataEndres04			= "SVM_0_SmalltalkKhorataEndres04"; //... aber wer heilt uns denn nun? ...
	SmalltalkKhorataEndres05			= "SVM_0_SmalltalkKhorataEndres05"; //... ich kann nicht glauben, dass er schuldig war ...
	SmalltalkKhorataEndres06			= "SVM_0_SmalltalkKhorataEndres06"; //... er hat auch nicht besser gehandelt als der Heiler ...
	SmalltalkKhorataEndres07			= "SVM_0_SmalltalkKhorataEndres07"; //... der Namenlose ist für mich ein Held ...
	SmalltalkKhorataFrauenkleider01			= "SVM_0_SmalltalkKhorataFrauenkleider01"; //... Melvin trägt Frauenkleider! ...
	SmalltalkKhorataFrauenkleider02			= "SVM_0_SmalltalkKhorataFrauenkleider02"; //... Will der ernst genommen werden? ...
	SmalltalkKhorataFrauenkleider03			= "SVM_0_SmalltalkKhorataFrauenkleider03"; //... Mir hat Melvin die Unterwäsche geklaut! ...

	SmalltalkKhorataUnruhen01			= "SVM_0_SmalltalkKhorataUnruhen01"; //... Das wird schon wieder ...
	SmalltalkKhorataUnruhen02			= "SVM_0_SmalltalkKhorataUnruhen02"; //... Früher wäre das ganz anders gelaufen ...
	SmalltalkKhorataUnruhen03			= "SVM_0_SmalltalkKhorataUnruhen03"; //... Wir sollten sie in der Nacht überwältigen ...
	SmalltalkKhorataUnruhen04			= "SVM_0_SmalltalkKhorataUnruhen04"; //... Das haben sie nicht anders verdient ...
	SmalltalkKhorataUnruhen05			= "SVM_0_SmalltalkKhorataUnruhen05"; //... Tyrus und Dalton sind tot! ...
	SmalltalkKhorataUnruhen06			= "SVM_0_SmalltalkKhorataUnruhen06"; //... Na und? Was interessiert mich das? ...
	SmalltalkKhorataUnruhen07			= "SVM_0_SmalltalkKhorataUnruhen07"; //... Ich trau mich kaum noch auf die Straße ...
	SmalltalkKhorataUnruhen08			= "SVM_0_SmalltalkKhorataUnruhen08"; //... So eine Scheiße ...
	SmalltalkKhorataUnruhen09			= "SVM_0_SmalltalkKhorataUnruhen09"; //... Lukas sollte neuer Stadthalter werden ...
	SmalltalkKhorataUnruhen10			= "SVM_0_SmalltalkKhorataUnruhen10"; //... Ich denke, Wendel wäre besser ...
	SmalltalkKhorataUnruhen11			= "SVM_0_SmalltalkKhorataUnruhen11"; //... Bloß nicht Theodorus! ...

	SmalltalkKhorataUnruhenTheodorus01		= "SVM_0_SmalltalkKhorataUnruhenTheodorus01"; //... Eine ganz schlechte Entscheidung ...
	SmalltalkKhorataUnruhenTheodorus02		= "SVM_0_SmalltalkKhorataUnruhenTheodorus02"; //... Schlimmer konnte es nicht kommen ...
	SmalltalkKhorataUnruhenTheodorus03		= "SVM_0_SmalltalkKhorataUnruhenTheodorus03"; //... Krieg dich mal wieder ein ...
	SmalltalkKhorataUnruhenTheodorus04		= "SVM_0_SmalltalkKhorataUnruhenTheodorus04"; //... Ich werde die Stadt verlassen ...

	SmalltalkKhorataUnruhenWendel01			= "SVM_0_SmalltalkKhorataUnruhenWendel01"; //... Bin ich froh, dass die Streitereien vorbei sind ...
	SmalltalkKhorataUnruhenWendel02			= "SVM_0_SmalltalkKhorataUnruhenWendel02"; //... Bei Wendel muss immer alles korrekt laufen ...
	SmalltalkKhorataUnruhenWendel03			= "SVM_0_SmalltalkKhorataUnruhenWendel03"; //... Endlich traue ich mich wieder auf die Straße ...
	SmalltalkKhorataUnruhenWendel04			= "SVM_0_SmalltalkKhorataUnruhenWendel04"; //... Die Buddler sind viel zu gut davongekommen! ...

	SmalltalkKhorataUnruhenLukas01			= "SVM_0_SmalltalkKhorataUnruhenLukas01"; //... Wieso dürfen wir keinen Freudenspender mehr nehmen? ...
	SmalltalkKhorataUnruhenLukas02			= "SVM_0_SmalltalkKhorataUnruhenLukas02"; //... Lukas ist immerhin besser als Wendel ...
	SmalltalkKhorataUnruhenLukas03			= "SVM_0_SmalltalkKhorataUnruhenLukas03"; //... Sie haben die Buddler alle umgebracht! ...
	SmalltalkKhorataUnruhenLukas04			= "SVM_0_SmalltalkKhorataUnruhenLukas04"; //... Lukas ist einfach nur dumm ...

	SmalltalkKhorataDiebeGrusel01			= "SVM_0_SmalltalkKhorataDiebeGrusel01"; //... Hast du schon gehört, dieses verlassene Haus am Rande der Stadt? ...
	SmalltalkKhorataDiebeGrusel02			= "SVM_0_SmalltalkKhorataDiebeGrusel02"; //... Ja, grauenvoll Dinge sollen dort geschehen sein. ...
	SmalltalkKhorataDiebeGrusel03			= "SVM_0_SmalltalkKhorataDiebeGrusel03"; //... Und die Mächte des Bösen lauern noch immer dort. ...
	SmalltalkKhorataDiebeGrusel04			= "SVM_0_SmalltalkKhorataDiebeGrusel04"; //... Die beiden wollen dort tatsächlich ein Restaurant eröffnen. ...
	SmalltalkKhorataDiebeGrusel05			= "SVM_0_SmalltalkKhorataDiebeGrusel05"; //... Lebensmüde! Also ich werde dort bestimmt keinen Fuß hineinsetzen. ...
	SmalltalkKhorataDiebeGrusel06			= "SVM_0_SmalltalkKhorataDiebeGrusel06"; //... Und ich werde nicht mal in die Nähe des Gebäudes gehen. ...

	SmalltalkKhorataDiebeBib01			= "SVM_0_SmalltalkKhorataDiebeBib01"; //... Hast du schon gehört, der Gelehrte ...
	SmalltalkKhorataDiebeBib02			= "SVM_0_SmalltalkKhorataDiebeBib02"; //... Ja, wertvolle Dokumente soll er aus der Bibliothek gestohlen haben ...
	SmalltalkKhorataDiebeBib03			= "SVM_0_SmalltalkKhorataDiebeBib03"; //... Und es gibt mehrere Zeugen, darunter sogar der Stadthalter ...
	SmalltalkKhorataDiebeBib04			= "SVM_0_SmalltalkKhorataDiebeBib04"; //... Und er behauptet ernsthaft die ganze Zeit zu Hause gewesen zu sein ...
	SmalltalkKhorataDiebeBib05			= "SVM_0_SmalltalkKhorataDiebeBib05"; //... Da hat ihn aber natürlich niemand gesehen ...
	SmalltalkKhorataDiebeBib06			= "SVM_0_SmalltalkKhorataDiebeBib06"; //... Wie er vor dem Diebstahl durch die Stadt gerannt ist aber schon ...
	SmalltalkKhorataDiebeBib07			= "SVM_0_SmalltalkKhorataDiebeBib07"; //... Bedeckt mit faulem Obst ...
	SmalltalkKhorataDiebeBib08			= "SVM_0_SmalltalkKhorataDiebeBib08"; //... Der muss echt den Verstand verloren haben ...

	SmalltalkKhorataNormal01			= "SVM_0_SmalltalkKhorataNormal01"; //... Ich hab schon lange keine zünftige Hexenverbrennung mehr erlebt! ...
	SmalltalkKhorataNormal02			= "SVM_0_SmalltalkKhorataNormal02"; //... Einen trink ich noch ...
	SmalltalkKhorataNormal03			= "SVM_0_SmalltalkKhorataNormal03"; //... Die nächste Runde geht auf mich! ...
	SmalltalkKhorataNormal04			= "SVM_0_SmalltalkKhorataNormal04"; //... Morgen ist auch noch ein Tag - aber besser wird er nicht ...
	SmalltalkKhorataNormal05			= "SVM_0_SmalltalkKhorataNormal05"; //... Die Zauberer sollst du nicht leben lassen ...
	SmalltalkKhorataNormal06			= "SVM_0_SmalltalkKhorataNormal06"; //... Die Würfel sind gefallen ...

	// Khorinis

	SmalltalkRangar01			= "SVM_0_SmalltalkRangar01"; //... jetzt soll sogar die Miliz Kunde in der roten Laterne sein ...
	SmalltalkRangar02			= "SVM_0_SmalltalkRangar02"; //... hast du von Rangar und Alwins Schaf gehört? ...

	SmalltalkMatteo01			= "SVM_0_SmalltalkMatteo01"; //... Warst du schon bei Matteo? ...
	SmalltalkMatteo02			= "SVM_0_SmalltalkMatteo02"; //... Matteo? Der heiratet doch auch bald, oder? ...
	SmalltalkMatteo03			= "SVM_0_SmalltalkMatteo03"; //... überall gibt es nur noch faulige Äpfel ...
	SmalltalkMatteo04			= "SVM_0_SmalltalkMatteo04"; //... ich kaufe jetzt bei Matteo, bei dem bekommt man noch frisches Obst ...

	SmalltalkKhorinisMario01			= "SVM_0_SmalltalkKhorinisMario01"; //... Die Paladine metzeln sich schon gegenseitig nieder ...
	SmalltalkKhorinisMario02			= "SVM_0_SmalltalkKhorinisMario02"; //... An Garonds Tod soll dieser Unbekannte auch nicht ganz schuldlos sein. ...
	SmalltalkKhorinisMario03			= "SVM_0_SmalltalkKhorinisMario03"; //... Diese zwei Kerle könnten noch immer in der Stadt sein und ihr Unwesen treiben! ...
	SmalltalkKhorinisMario04			= "SVM_0_SmalltalkKhorinisMario04"; //... Die Miliz hat an ihren Aufgaben versagt, das ist meine Meinung ...

	SmalltalkFellan01			= "SVM_0_SmalltalkFellan01"; //... Ich könnte Fellan umbringen! Morgens um 7 hämmert der schon wie ein Irrer. ...
	SmalltalkFellan02			= "SVM_0_SmalltalkFellan02"; //... Tock, tock, tock ...

	SmalltalkMikaPflanzen01			= "SVM_0_SmalltalkMikaPflanzen01"; //... Mika bietet gerade Heilpflanzen für einen Spottpreis an! ...
	SmalltalkMikaPflanzen02			= "SVM_0_SmalltalkMikaPflanzen02"; //... Diese Rübennase sammelt mir alle Pflanzen vor der Nase weg! ...

	// ----------------------------------------------------------------------------------------------------------------------
	NoLearnNoPoints				= "SVM_0_NoLearnNoPoints"			;//Komm wieder, wenn du mehr Erfahrung hast.
	NoLearnOverPersonalMAX		= "SVM_0_NoLearnOverPersonalMAX"	;//Du verlangst mehr von mir, als ich dir beibringen kann.
	NoLearnYoureBetter			= "SVM_0_NoLearnYoureBetter"		;//Ich kann dir nichts mehr beibringen. Du bist schon zu gut.
	YouLearnedSomething			= "SVM_0_YouLearnedSomething"		;//Siehst du, du bist schon besser geworden ...
	// ----------------------------------------------------------------------------------------------------------------------
	UNTERSTADT					= "SVM_0_UNTERSTADT"				;//Du bist jetzt in der Unterstadt.
	OBERSTADT					= "SVM_0_OBERSTADT"					;//Du bist jetzt in der Oberstadt.
	TEMPEL						= "SVM_0_TEMPEL"					;//Du bist jetzt am Tempel.
	MARKT						= "SVM_0_MARKT"						;//Du bist jetzt am Marktplatz.
	GALGEN						= "SVM_0_GALGEN"					;//Du bist jetzt am Galgenplatz vor der Kaserne.
	KASERNE						= "SVM_0_KASERNE"					;//Das hier ist die Kaserne.
	HAFEN						= "SVM_0_HAFEN"						;//Du bist hier im Hafenviertel.
	// -----------------------
	WHERETO						= "SVM_0_WHERETO"					;//Wo willst du hin?
	// -----------------------
	OBERSTADT_2_UNTERSTADT		= "SVM_0_OBERSTADT_2_UNTERSTADT"	;//Geh von hier aus durch das innere Stadttor und du kommst in die Unterstadt.
	UNTERSTADT_2_OBERSTADT		= "SVM_0_UNTERSTADT_2_OBERSTADT"	;//Am südlichen Stadttor gibt es eine Treppe, die zum inneren Stadttor hochführt. Dort beginnt die Oberstadt.
	UNTERSTADT_2_TEMPEL			= "SVM_0_UNTERSTADT_2_TEMPEL"		;//Geh vom Schmied aus durch die Unterführung und du kommst zum Tempelplatz.
	UNTERSTADT_2_HAFEN			= "SVM_0_UNTERSTADT_2_HAFEN"		;//Geh vom Schmied aus die Hafenstraße runter, dann kommst du zum Hafen.
	TEMPEL_2_UNTERSTADT			= "SVM_0_TEMPEL_2_UNTERSTADT"		;//Vom Tempelplatz aus gibt es eine Unterführung, die in die Unterstadt führt.
	TEMPEL_2_MARKT				= "SVM_0_TEMPEL_2_MARKT"			;//Wenn du vorm Tempel stehst, geh links hoch und an der Stadtmauer entlang, dann kommst du zum Markt.
	TEMPEL_2_GALGEN				= "SVM_0_TEMPEL_2_GALGEN"			;//Wenn du vom Tempel aus gesehen links an der Kneipe vorbei gehst, kommst du zum Galgenplatz.
	MARKT_2_TEMPEL				= "SVM_0_MARKT_2_TEMPEL"			;//Wenn du vom Marktplatz aus an der hohen Stadtmauer entlang gehst, kommst du zum Tempel.
	MARKT_2_KASERNE				= "SVM_0_MARKT_2_KASERNE"			;//Die Kaserne ist das riesengroße Gebäude. Geh einfach die Treppen gegenüber dem Hotel rauf.
	MARKT_2_GALGEN				= "SVM_0_MARKT_2_GALGEN"			;//Geh einfach an der großen Kaserne entlang und du kommst zum Galgenplatz.
	GALGEN_2_TEMPEL				= "SVM_0_GALGEN_2_TEMPEL"			;//Geh vom Galgenplatz aus die Gasse runter und du kommst zum Tempelplatz.
	GALGEN_2_MARKT				= "SVM_0_GALGEN_2_MARKT"			;//Geh einfach an der großen Kaserne entlang und du kommst zum Markt.
	GALGEN_2_KASERNE			= "SVM_0_GALGEN_2_KASERNE"			;//Die Kaserne ist das riesengroße Gebäude. Geh einfach die Treppen rauf.
	KASERNE_2_MARKT				= "SVM_0_KASERNE_2_MARKT"			;//Geh einfach die Treppe am Haupteingang links runter, dann kommst du zum Marktplatz.
	KASERNE_2_GALGEN			= "SVM_0_KASERNE_2_GALGEN"			;//Geh einfach die Treppe am Haupteingang rechts runter, dann kommst du zum Galgenplatz.
	HAFEN_2_UNTERSTADT			= "SVM_0_HAFEN_2_UNTERSTADT"		;//Geh von der Kaimauer aus die Hafenstraße hoch, dann kommst du in die Unterstadt.
	// -------------------------------------------------------------------------------------
	...
	ADDON_WRONGARMOR			= "SVM_0_Addon_WrongArmor";				//Das ist nicht deine Kleidung. Ich rede nicht mit dir.
	ADDON_WRONGARMOR_SLD		= "SVM_0_ADDON_WRONGARMOR_SLD";			//Wie läufst du denn rum? Zieh dir was Vernünftiges an.
	ADDON_WRONGARMOR_MIL		= "SVM_0_ADDON_WRONGARMOR_MIL";			//Du bist Soldat! Kleide dich entsprechend.
	ADDON_WRONGARMOR_KDF		= "SVM_0_ADDON_WRONGARMOR_KDF";			//Deine Kleidung ist unserem Orden nicht angemessen. Zieh dich um.
	ADDON_NOARMOR_BDT			= "SVM_0_ADDON_ADDON_NOARMOR_BDT";		//Hast ja noch nicht mal 'ne Rüstung. Verschwinde!

	ADDON_DIEBANDIT				= "SVM_0_ADDON_DIEBANDIT";				//Stirb, du dreckiger Bandit!
	ADDON_DIRTYPIRATE			= "SVM_0_ADDON_DIRTYPIRATE";			//Piratenpack!

	RELMINE01			= "SVM_0_RELMINE01";			//Ich halt das nicht mehr aus!
	RELMINE02			= "SVM_0_RELMINE02";			//Wenn ich doch nur was zu essen hätte ...
	RELMINE03			= "SVM_0_RELMINE03";			//Schlag auf Schlag, den ganzen Tag ...
	RELMINE04			= "SVM_0_RELMINE04";			//Ein schwerer Brocken ist das.
	RELMINE05			= "SVM_0_RELMINE05";			//Wann kommt die Ablösung endlich?
	RELMINE06			= "SVM_0_RELMINE06";			//Die reinste Ausbeutung ist das!
	RELMINE07			= "SVM_0_RELMINE07";			//Morgen komme ich nicht wieder, das versprech ich ...
	RELMINE08			= "SVM_0_RELMINE08";			//So ein schönes Steinchen!
	RELMINE09			= "SVM_0_RELMINE09";			//Meine Frau weiß schon gar nicht mehr, wie ich aussehe ...
	RELMINE10			= "SVM_0_RELMINE10";			//'n Humpen wär jetzt das Richtige ...
	RELMINE11			= "SVM_0_RELMINE11";			//Das soll wohl ein Ersatz für die Strafkolonie sein.
	RELMINE12			= "SVM_0_RELMINE12";			//(summt) Nimm Freudenspender, dann ist es okay.

	NoLearnGold			= "SVM_0_NoLearnGold";			//Komm wieder, wenn du mehr Gold hast.

	// Witze

	WITZ_01_01			= "SVM_0_WITZ_01_01";			//Ein Jäger geht in den Wald.
	WITZ_01_02			= "SVM_0_WITZ_01_02";			//Kommt ihm ein Ork mit einem Wildschwein auf der Schulter entgegen.
	WITZ_01_03			= "SVM_0_WITZ_01_03";			//Ein paar Schritte weiter trifft er auf einen Söldner, der ebenfalls ein Wildschwein auf der Schulter trägt.
	WITZ_01_04			= "SVM_0_WITZ_01_04";			//Und noch ein paar Meter weiter sieht er einen Goblin.
	WITZ_01_05			= "SVM_0_WITZ_01_05";			//Frage ....... und was hat wohl der Goblin?
	WITZ_01_06			= "SVM_0_WITZ_01_06";			//Zahnfleischbluten, denn jeder Dritte hat Zahnfleischbluten.

	WITZ_02_01			= "SVM_0_WITZ_02_01";			//Kämpfen zwei Zombies um ihr Leben.

	WITZ_03_01			= "SVM_0_WITZ_03_01";			//Was ist der unterschied zwischen Mud und 'ner Fleischwanze?
	WITZ_03_02			= "SVM_0_WITZ_03_02";			//Fleischwanzen bringt 10 Erfahrung.

	WITZ_04_01			= "SVM_0_WITZ_04_01";			//Ein Dieb bricht nachts in ein Haus ein.
	WITZ_04_02			= "SVM_0_WITZ_04_02";			//Als er gerade durch das stockfinstere Wohnzimmer schleicht, hört er eine Stimme:
	WITZ_04_03			= "SVM_0_WITZ_04_03";			//"Ich sehe dich und Innos sieht dich auch!"
	WITZ_04_04			= "SVM_0_WITZ_04_04";			//Er erschrickt zu Tode und entzündet eine Kerze.
	WITZ_04_05			= "SVM_0_WITZ_04_05";			//Er blickt auf und sieht auf einer Stange in der Ecke einen Papageien sitzen:
	WITZ_04_06			= "SVM_0_WITZ_04_06";			//Meint der Einbrecher erleichtert:
	WITZ_04_07			= "SVM_0_WITZ_04_07";			//"Hast Du mich aber erschreckt. Wie heißt Du denn ?"
	WITZ_04_08			= "SVM_0_WITZ_04_08";			//"Mud!"
	WITZ_04_09			= "SVM_0_WITZ_04_09";			//"Mud ist doch wohl wirklich ein selten blöder Name für einen Papagei!"
	WITZ_04_10			= "SVM_0_WITZ_04_10";			//Grinst der Vogel: "Na und, Innos ist auch ein selten blöder Name für einen Warg."

	WITZ_05_01			= "SVM_0_WITZ_05_01";			//Steigen zwei Skelette aus ihren Gräbern und klauen Pferde.
	WITZ_05_02			= "SVM_0_WITZ_05_02";			//Packt das eine seinen Grabstein drauf.
	WITZ_05_03			= "SVM_0_WITZ_05_03";			//Fragt das andere: "Wozu das?"
	WITZ_05_04			= "SVM_0_WITZ_05_04";			//Sagt das andere: "Glaubst du ich fahr ohne Papiere"

	WITZ_06_01			= "SVM_0_WITZ_06_01";			//Kommt ein Skelett während nem Sturm in Coragons Kneipe und sagt:
	WITZ_06_02			= "SVM_0_WITZ_06_02";			//"Ich bin nass bis auf die Knochen"

	WITZ_07_01			= "SVM_0_WITZ_07_01";			//Sagt die Snappermutter: "Kinder, heute gibt's frischen Paladin."
	WITZ_07_02			= "SVM_0_WITZ_07_02";			//Sagt das Snapperkind: "Ich hasse Dosenfutter."

	WITZ_08_01			= "SVM_0_WITZ_08_01";			//Was ist das für eine rote, glitschige Substanz zwischen den Flanken eines Sumpfhaies?
	WITZ_08_02			= "SVM_0_WITZ_08_02";			//Langsamer Novize.

	WITZ_09_01			= "SVM_0_WITZ_09_01";			//Was geht einem Ork als erstes durch den Kopf, wenn er ein Adanos-Kloster betritt?
	WITZ_09_02			= "SVM_0_WITZ_09_02";			//Eine Eislanze.

	WITZ_10_01			= "SVM_0_WITZ_10_01";			//Hör dir mal den an ...
	WITZ_10_02			= "SVM_0_WITZ_10_02";			//Ja?
	WITZ_10_03			= "SVM_0_WITZ_10_03";			//Also ...
	WITZ_10_04			= "SVM_0_WITZ_10_04";			//Das Schaf Lisl vom Hirten Pepe ist krank.
	WITZ_10_05			= "SVM_0_WITZ_10_05";			//Besorgt fragt er den Schäfer Balthasar:
	WITZ_10_06			= "SVM_0_WITZ_10_06";			//"Was hast du denn damals deinem Schaf gegeben als sie so krank war?"
	WITZ_10_07			= "SVM_0_WITZ_10_07";			//"Ich habe meiner Clara damals Lou’s doppelten Hammer gegeben", sagt dieser.
	WITZ_10_08			= "SVM_0_WITZ_10_08";			//Gesagt, getan. Als Pepe zwei Tage später wieder Balthasar besucht, trauert er:
	WITZ_10_09			= "SVM_0_WITZ_10_09";			//"Meine Lisl ist tot." Darauf Balthasar: "Meine Clara damals auch."
	WITZ_10_10			= "SVM_0_WITZ_10_10";			//(belustigt) Ja, hähä. Wenn man den Viechern das Zeug zum Saufen gibt.

	// Taschendiebstahl

	PICKPOCKET_BESTECHUNG_01	=	"SVM_0_PICKPOCKET_BESTECHUNG_01";	//Gut, aber jetzt verzieh dich!
	PICKPOCKET_HERAUSREDEN_01	=	"SVM_0_PICKPOCKET_HERAUSREDEN_01";	//Da hab ich mich wohl geirrt ...
	PICKPOCKET_HERAUSREDEN_02	=	"SVM_0_PICKPOCKET_HERAUSREDEN_02";	//Du warst doch eindeutig an meiner Tasche ...
};
