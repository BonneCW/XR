...
{
	AI_Output(hero, self, "Info_Mod_REL_Buerger_19_Rundschreiben_15_00"); //Ich hab hier ein Rundschreiben für dich.
...
{
	AI_Output(hero, self, "Info_Mod_REL_Buerger_19_FreudenspenderMachtBlind_15_00"); //Du nimmst Freudenspender?
	AI_Output(self, hero, "Info_Mod_REL_Buerger_19_FreudenspenderMachtBlind_19_01"); //Ja ...
	AI_Output(hero, self, "Info_Mod_REL_Buerger_19_FreudenspenderMachtBlind_15_02"); //Hast du keine Angst?
	AI_Output(self, hero, "Info_Mod_REL_Buerger_19_FreudenspenderMachtBlind_19_03"); //Wovor?
	AI_Output(hero, self, "Info_Mod_REL_Buerger_19_FreudenspenderMachtBlind_15_04"); //Na du weißt doch ... Freudenspender macht blind.
	AI_Output(self, hero, "Info_Mod_REL_Buerger_19_FreudenspenderMachtBlind_19_05"); //Was??? Das Scheißzeug!
...
{	
	AI_Output (hero, self, "DIA_REL_Buerger_19_PEOPLE_15_00"); //Wer sind hier die wichtigen Persönlichkeiten?
	AI_Output (self, hero, "DIA_REL_Buerger_19_PEOPLE_19_01"); //Anselm ist hier der Stadthalter. Er sorgt hier auch für Recht und Ordnung.
	AI_Output (self, hero, "DIA_REL_Buerger_19_PEOPLE_19_02"); //Außerdem gibt es noch Robert, den besten Schmied im Lande.
};
