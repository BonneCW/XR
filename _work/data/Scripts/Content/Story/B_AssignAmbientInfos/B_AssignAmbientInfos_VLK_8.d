...
INSTANCE Info_VLK_08_Flugblätter (C_INFO) // E1
{
	nr			= 5;
	condition	= Info_VLK_08_Flugblätter_Condition;
	information	= Info_VLK_08_Flugblätter_Info;
	permanent	= 1;
	description = "Ich hab hier ein Flugblatt für dich.";
};                       

FUNC INT Info_VLK_08_Flugblätter_Condition()
{
...
FUNC VOID Info_VLK_08_Flugblätter_Info()
{
	B_Say (hero, self, "$MATTEOPAPER");

	B_GiveInvItems	(hero, self, MatteoFlugblätter, 1);

	AI_Output(self, hero, "Info_Mod_VLK_08_Flugblätter_08_01"); //(uninteressiert) Aha.
...
FUNC VOID B_AssignAmbientInfos_VLK_8 (var c_NPC slf)
{
	...
	Info_VLK_08_Flugblätter.npc				= Hlp_GetInstanceID(slf);
