...
FUNC VoID Info_Mod_Gerbrandt_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Hi_03_01"); //Stör mich nicht.
};
...
FUNC VOID Info_Mod_Gerbrandt_Person_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Person_03_01"); //Das stimmt. Vor etwa zwei Wochen war ein Freund bei mir. Er ist erst spät abends nach Hause gegangen.
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Person_03_02"); //Als ich am nächsten Tag zu ihm wollte war er nicht da. Ich habe sofort die Miliz benachrichtigt, doch sie haben nichts gefunden.
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Person_03_03"); //Danach kamen der Wassermagier Vatras und ein paar seiner Anhänger zu mir und befragten mich über meinen Freund.
};
...
FUNC VOID Info_Mod_Gerbrandt_Infos_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Infos_03_01"); //Er hat mir viele Fragen gestellt.
	AI_Output(hero, self, "Info_Mod_Gerbrandt_Infos_15_02"); //Was für Fragen?
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Infos_03_03"); //Zuerst hat er gefragt wie mein Freund heißt und ich hab ihm gesagt, dass er Fred heißt.
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Infos_03_04"); //Dann wollte er wissen um wieviel Uhr er gegangen sei. Ich hab die Uhrzeit nicht genau gewusst, weil wir schon einiges an Wein getrunken hatten, aber es war um etwa 23 Uhr.
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Infos_03_05"); //Am Schluss hat er noch gefragt wo Fred gewohnt hat. Dann hab ich ihn zu dem Haus geführt.
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Infos_03_06"); //Das war alles.
...
FUNC VOId Info_Mod_Gerbrandt_Wo_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Wo_03_01"); //Klar, sag bescheid wenn wir losgehen können.
};
...
FUNC VOID Info_Mod_Gerbrandt_Los_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Los_03_01"); //Ok, folge mir.
...
{
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Da_03_00"); //Da sind wir.
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Da_03_01"); //Schau dich ruhig um, ich gehe wieder zurück. Wenn du noch Hilfe brauchst, du weißt ja wo du mich findest.
...
FUNC VOID Info_Mod_Gerbrandt_Cornelius_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Cornelius_03_01"); //Kannst du das auch beweisen?
	AI_Output(hero, self, "Info_Mod_Gerbrandt_Cornelius_15_02"); //Nein.
	AI_Output(self, hero, "Info_Mod_Gerbrandt_Cornelius_03_03"); //Dann verschwende nicht meine Zeit mit deinen Anschuldigungen oder ich rufe die Miliz.
...
FUNC VOID Info_Mod_Gerbrandt_SonjaFreier_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gerbrandt_SonjaFreier_03_01"); //Was für eine Frage! Natürlich nicht!
};
