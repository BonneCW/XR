...
{
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath_39_00"); //(erfreut) Das gibt’s doch nicht, du hier?
	AI_Output(hero, self, "Info_Mod_Velaya_NW_Irdorath_15_01"); //Ohh, ich bin auch überrascht dich hier anzutreffen ...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath_39_02"); //Naja, ohne dich könnte ich ja auch nicht hier sein, würde immer noch im Minental sitzen, mich beim Baden begaffen lassen und das Bett mit den Erzbaronen teilen ... auch wenn es nicht ganz so schlimm war, wie zu Zeiten von Gomez.
	AI_Output(hero, self, "Info_Mod_Velaya_NW_Irdorath_15_03"); //(halblaut) Hmm, da werden Erinnerungen wach ...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath_39_04"); //Was sagst du?
	...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath_39_06"); //Seereise? Die große weite Welt? Wie herrlich ...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath_39_07"); //Ach, wenn ich dich doch nur begleiten könnte ...
	...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath_39_10"); //(freundlich, ironisch) Ach hör schon auf den Kavalier geben. Ich habe in den letzten Wochen einiges gelernt ...
	AI_Output(hero, self, "Info_Mod_Velaya_NW_Irdorath_15_11"); //Nun, ich vermute, du meinst nicht die Feldarbeit ...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath_39_12"); //Tja, mit meinem Bogen kann ich einem Eber auf 10m das Auge ausschießen ...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath_39_13"); //... und aufdringlichen Kerlen mit dem Degen Zurückhaltung lehren, wenn es dahin geht, wo es weh tut ...
...
FUNC VOID Info_Mod_Velaya_NW_Irdorath2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath2_39_01"); //Toll! Und das Schiff, ist das das fantastische große hinten im Hafen?
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath2_39_02"); //Man, dass muss ich mir gleich näher ansehen.
...
FUNC VOID Info_Mod_Velaya_NW_Irdorath3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath3_39_01"); //Schade. Ich gehe dann wieder zurück. Du weißt wo du mich findest, wenn doch noch ein Platz frei werden sollte.
...
FUNC VOID Info_Mod_Velaya_NW_Irdorath4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Velaya_NW_Irdorath4_39_01"); //Sehr gut, ich bin dann wieder am Hafen.
