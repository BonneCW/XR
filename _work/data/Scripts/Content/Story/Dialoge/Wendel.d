...
FUNC VOID Info_Mod_Wendel_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Hi_23_00"); //Wendel. Ich bin zuständig für die Wasserversorgung hier in Khorata.
	AI_Output(self, hero, "Info_Mod_Wendel_Hi_23_01"); //Wie du siehst, läuft die Wasserverteilung nicht ganz so einfach, sondern mit Hilfe von Pumpen und Schleusen, oberirdisch sowie unterirdisch.
	AI_Output(self, hero, "Info_Mod_Wendel_Hi_23_02"); //Dafür können wir eine optimale Versorgung der Bevölkerung gewährleisten.
	AI_Output(self, hero, "Info_Mod_Wendel_Hi_23_03"); //Solch ein kompliziertes System bedarf selbstverständlich ständiger Überwachung und Reparatur.
};
...
{
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_23_00"); //Oh nein! Wir haben ein ernstzunehmendes Problem!
	AI_Output(hero, self, "Info_Mod_Wendel_Endres_15_01"); //Was ist passiert?
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_23_02"); //Das wüsste ich auch gern! Der Wasserkreislauf ist unterbrochen.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_23_03"); //Irgendetwas scheint die Rohre zu verstopfen.
	AI_Output(hero, self, "Info_Mod_Wendel_Endres_15_04"); //Was kann man dagegen tun?
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_23_05"); //Entweder, wir nehmen alle Rohre auseinander und prüfen sie ... oder wir schmieren sie von innen mit Fett ein, in der Hoffnung, dass sich der Pfropfen von alleine löst.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_23_06"); //Übernimmst du das Einfetten?
...
FUNC VOID Info_Mod_Wendel_Endres_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_A_23_01"); //Das ist die nächste Fragestellung. Ich glaube, da hilft nur Trollfett, das ist extra schmierig. Und extra selten.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_A_23_02"); //Du hast aber Glück, es soll ein Troll hier in Relendel gesichtet worden sein.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_A_23_03"); //Erleg ihn einfach und nimm ihm so viel von seinem Fett ab, wie du tragen kannst!
	AI_Output(hero, self, "Info_Mod_Wendel_Endres_A_15_04"); //Kleiner habt ihr's nicht?
	AI_Output(self, hero, "Info_Mod_Wendel_Endres_A_23_05"); //Nun beeil dich schon, ehe wir noch in Engpässe geraten!
...
FUNC VOID Info_Mod_Wendel_Endres02_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres02_23_01"); //Sehr gut! Und nun gieß es in den Abort im Haus der Feuermagier.
...
FUNC VOID Info_Mod_Wendel_Endres02_Optional_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres02_Optional_23_01"); //Es liegt in der gleichen Straße wie Peters Gasthaus und die Brauerei. Nun aber los!
};
...
{
	AI_Output(self, hero, "Info_Mod_Wendel_Endres03_23_00"); //(verstört) Grundgütiger! Das ... das ist doch Endres!
	AI_Output(hero, self, "Info_Mod_Wendel_Endres03_15_01"); //Wer?
	AI_Output(self, hero, "Info_Mod_Wendel_Endres03_23_02"); //Endres, der Baumeister! Julianas Mann, der vermisst wurde. Er hat die Rohre verstopft. (würgt)
	AI_Output(self, hero, "Info_Mod_Wendel_Endres03_23_03"); //(Pause) Ich ... oh, bei Adanos, er wurde ermordet!
...
FUNC VOID Info_Mod_Wendel_Endres04_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres04_23_01"); //Er war ein wenig verschroben ... und genial, könnte man sagen.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres04_23_02"); //Von ihm stammen die rätselhaften Skulpturen in der Stadt, und er half, das Wasserversorgungssystem zu planen.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres04_23_03"); //Ohne ihn wären wir bedeutend rückständiger.
	AI_Output(hero, self, "Info_Mod_Wendel_Endres04_15_04"); //Wer könnte ihn umbringen wollen?
	AI_Output(self, hero, "Info_Mod_Wendel_Endres04_23_05"); //Woher soll ich das wissen? Er hatte bestimmt Neider, aber mehr weiß ich beim besten Willen nicht. Ich kannte ihn nie gut.
	AI_Output(hero, self, "Info_Mod_Wendel_Endres04_15_06"); //Dann werde ich mich weiter umhören.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres04_23_07"); //Erzähl Juliana von dem Vorfall. Ich fühle mich nicht gut.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres04_23_08"); //Ach ... was das Wasserwerk anbelangt: da läuft wieder alles ... wie geschmiert ...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres04_23_09"); //Danke für deine Hilfe.
...
FUNC VOID Info_Mod_Wendel_Endres05_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres05_23_01"); //Wieso das?
	AI_Output(hero, self, "Info_Mod_Wendel_Endres05_15_02"); //Beantworte einfach die Fragen.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres05_23_03"); //(nervös) Na schön.
};
...
FUNC VOID Info_Mod_Wendel_Endres06_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres06_23_01"); //Ähm ... ich war wie immer mit meinem Assistenten unterwegs, dem Monteur.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres06_23_02"); //Wie immer seit morgens in der Früh.
...
FUNC VOID Info_Mod_Wendel_Endres07_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres07_23_01"); //Ich kann nicht sagen, ob sie sich überhaupt näher gekannt haben. Sicher waren sie keine guten Freunde.
...
FUNC VOID Info_Mod_Wendel_Endres08_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Endres08_23_01"); //Das Verhältnis von Juliana zu Endres schien etwas belastet.
	AI_Output(self, hero, "Info_Mod_Wendel_Endres08_23_02"); //Er war ein Genie, das ist für den Partner nicht immer einfach.
...
FUNC VOID Info_Mod_Wendel_Nagelnachschub_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Nagelnachschub_23_01"); //(zittrig) Wer hat dir den Brief gegeben?
...
FUNC VOID Info_Mod_Wendel_Nagelnachschub_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Nagelnachschub_B_23_01"); //Zu schade. Dann kann ich ja gar nicht antworten.
...
FUNC VOID Info_Mod_Wendel_Nagelnachschub_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Nagelnachschub_A_23_01"); //Du bist der Überbringer der besten Nachricht meines Lebens! Nimm das als Dank!
...
FUNC VOID Info_Mod_Wendel_Unruhen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen_23_01"); //Das ehrt mich sehr. Allerdings bin ich mir nicht sicher, der Richtige zu sein.
};
...
FUNC VOID Info_Mod_Wendel_Unruhen2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen2_23_01"); //Die ist äußerst prekär. Wir dürfen nichts mehr unternehmen, das die Bergleute weiter reizen könnte, sondern sollten die Verständigungsgespräche umgehend wieder aufnehmen.
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen2_23_02"); //Noch mehr Tote müssen verhindert werden!
...
FUNC VOID Info_Mod_Wendel_Unruhen3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen3_23_01"); //Darum geht es nicht. Beide Parteien haben Fehler begangen.
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen3_23_02"); //Unser Ziel muss es sein, die Bergarbeiter so in unsere Gesellschaft einzugliedern, dass wir alle zufrieden sind.
};
...
FUNC VOID Info_Mod_Wendel_Unruhen4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_23_01"); //Ich weiß nicht, ob ich mich darüber freuen soll.
	AI_Output(hero, self, "Info_Mod_Wendel_Unruhen4_15_02"); //Du machst das schon.
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_23_03"); //Mit deiner Unterstützung. Lass uns sofort loslegen. Es gibt einiges zu tun.
	AI_Output(hero, self, "Info_Mod_Wendel_Unruhen4_15_04"); //Wo fangen wir an?
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_23_05"); //Selbstverständlich bei den Bergleuten. Der Konflikt muss unblutig beendet werden.
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_23_06"); //Eigentlich wäre das ein Fall für das Gericht. Aber, unter uns, ich halte nicht viel von dem Richter und den Schöffen.
	AI_Output(hero, self, "Info_Mod_Wendel_Unruhen4_15_07"); //Verständlich.
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_23_08"); //Ich denke, wir sollten einen Vertreter der Städter und einen der Buddler zusammensetzen;
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_23_09"); //die beiden würden über die Lösungsmöglichkeiten beratschlagen, überwacht von einem unparteiischen Außenstehenden - dir.
	AI_Output(hero, self, "Info_Mod_Wendel_Unruhen4_15_10"); //Wer soll die Städter und wer die Buddler repräsentieren?
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_23_11"); //Da ich nun das Oberhaupt Khoratas bin, maße ich mir an, für die Bürger zu sprechen.
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_23_12"); //Was die Buddler betrifft - ich schlage vor, du suchst dir einen Freiwilligen unter ihnen.
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen4_23_13"); //Wir treffen uns anschließend im Rathaus.
...
FUNC VOID Info_Mod_Wendel_Unruhen8_B()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Wendel_Unruhen8_B_23_01"); //Es tut mir Leid, dir das sagen zu müssen, aber unter einem Unparteiischen stelle ich mir nicht das vor, was du uns hier gezeigt hast.
		AI_Output(self, hero, "Info_Mod_Wendel_Unruhen8_B_23_02"); //Ich bin mit dem Verlauf des Gesprächs nicht zufrieden und würde vorschlagen, es später noch einmal zu versuchen.

		Mod_REL_WendelS = 17;
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Wendel_Unruhen8_B_23_03"); //Ja, das ist mir bewusst. Wir werden schon eine Lösung finden.
		AI_Output(self, hero, "Info_Mod_Wendel_Unruhen8_B_23_04"); //Vielleicht könnten wir die Entschädigungen ein wenig in die Zukunft verschieben, um erst mal den Haushalt zu sanieren. Wäre das in Ordnung?
...
{
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen9_23_00"); //Wir scheinen die gröbsten Probleme aus dem Weg geräumt zu haben. Ich hoffe, jetzt wird alles in geregelten Bahnen verlaufen.
	AI_Output(self, hero, "Info_Mod_Wendel_Unruhen9_23_01"); //Danke für deine Hilfe.
...
FUNC VOID Info_Mod_Wendel_Plagenquest_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_23_01"); //Ja, wir hatten schon einen ganzen Trupp Hammerjäger durch die Stadt geschickt.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_23_02"); //Aber auch mit ihren Hämmern konnten sie dem Ungeziefer keinen Einhalt gebieten.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_23_03"); //Egal wie oft man drauf schlägt, sie kommen wieder und in Gesellschaft vieler ihrer Artgenossen.
	B_Say	(hero, self, "$PLAGENQUEST02");
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_23_05"); //In der Tat, ich forsche gerade in den Chroniken der Stadt nach und bin da tatsächlich auf etwas gestoßen ...
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_23_06"); //Es wird aber noch ein Weilchen dauern, bis ich mir den Text vollständig erschlossen habe.
	B_Say	(hero, self, "$PLAGENQUEST03");
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_23_08"); //Ja, du kannst mal dein Glück als Hammerjäger im Gerichtsgebäude versuchen, wo sich im Moment besonders viele Drecksviecher tummeln.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_23_09"); //Vielleicht hast du ja mehr Erfolg.
...
{
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_00"); //Ahh, gut, dass du vorbeikommst, ich habe etwas wichtiges entdeckt.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_01"); //Die Plage, die zurzeit die Stadt heimsucht, hatte es bereits vor vielen Jahrhunderten gegeben – nicht lange, nach der Stadtgründung.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_02"); //Um der Stadt und ihrer Umgebung den Segen der Götter zu sichern, wurde damals den Göttern mit Tieropfern gehuldigt.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_03"); //Jeder hatte die Pflicht eine bestimmte Anzahl an Tieren zu opfern.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_04"); //Einer ihrer Gründerväter war jedoch so geizig, dass er nicht Schafe oder Molerat, sondern Insekten opferte.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_05"); //Die Götter waren darüber so erzürnt, dass sie den Wunsch der Menschen nach reicher Tierpopulation vor allem auf die Insekten der Umgebung übertrugen.

	B_Say	(hero, self, "$PLAGENQUEST04");

	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_07"); //Nun, mit der chemischen Keule.

	B_Say	(hero, self, "$PLAGENQUEST05");

	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_09"); //Ja, lange Zeit war man völlig ratlos und es schien so, als müsse man die Stadt aufgeben.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_10"); //Doch dann wurde einem rechtschaffenden und ehrbaren Bürger namens Chemos ein Traum gesandt.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_11"); //Er erhielt die Anleitung zum Bau einer Waffe, welche die Plagegeister bannen konnte.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_12"); //Daher muss auch unser Brauch mit den Stadthämmern zum Kampf gegen die Insekten kommen.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_13"); //Damals unterschieden sich Hämmer und Keulen nämlich noch nicht grundlegend.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_14"); //Unser Gesetz dazu stammt erst aus etwas späterer Zeit, als die Hämmer ihre charakteristische Form erhielten und die Keulen aus praktischen Gründen ablösten.

	B_Say	(hero, self, "$PLAGENQUEST06");

	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_16"); //Nein, leider nicht mehr. Und die Anfertigung einer solchen Waffe ist nicht ganz unkompliziert. Ich habe die Anleitung gefunden ...

	B_Say	(hero, self, "$PLAGENQUEST07");

	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_18"); //Hier hast du eine Abschrift davon.
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_21"); //(erfreut) Wirklich? Du würdest uns allen einen großen Dienst damit erweisen.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_22"); //Sobald du alles zusammen hast, begib dich wieder hier her und händige die Materialien unserem Schmied aus.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_02_23_23"); //Und eine Keule werden wir schon irgendwo in der Stadt auftreiben. Ich danke dir.
...
{
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_03_23_00"); //Ich habe gehört, du hast die Keule. Jetzt ist es an der Zeit die Plagegeister aus der Stadt zu verjagen.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_03_23_01"); //Am Marktplatz haben sich besonders viele von den Viechern gesammelt. Nimm die chemische Keule und vernichte sie.
...
FUNC VOID Info_Mod_Wendel_Plagenquest_04_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_04_23_01"); //Das ist großartig und der erste Schritt um das Übel endgültig zu bannen.
	B_Say	(hero, self, "$PLAGENQUEST11");
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_04_23_03"); //Ja, leider mussten wir feststellen, dass weiterhin neue Parasiten aus den umliegenden Wäldern kommen.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_04_23_04"); //Irgendwo dort muss die Wurzel des Übels sein ... der ominöse Riesenbug, von dem die Quellen sprachen.
	B_Say	(hero, self, "$PLAGENQUEST12");
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_04_23_06"); //Es gibt da aber etwas, besser gesagt jemanden, der dir dabei helfen könnte.
	B_Say	(hero, self, "$PLAGENQUEST13");
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_04_23_08"); //Ein Bürger unserer Stadt. Sein Name ist Axon und er trägt das chemische Blut in sich, wie ich vor ein paar Stunden herausgefunden habe.
	B_Say	(hero, self, "$PLAGENQUEST14");
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_04_23_10"); //Nun, zum einen geben die Stammbäume klare Hinweise darauf und dann ... nun ...
	B_Say	(hero, self, "$PLAGENQUEST15");
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_04_23_12"); //... dann haben wir noch die chemische Keule bei ihm gefunden. Sie hing die ganze Zeit im Wohnzimmer seines Hauses.
	B_Say	(hero, self, "$PLAGENQUEST16");
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_04_23_14"); //Jedenfalls sollte er dir dabei helfen können das Käfergetier zu erspüren, den Riesenbug zu entdecken und zu vernichten. Er wartet bereits vor der Stadt auf dich.
...
FUNC VOID Info_Mod_Wendel_Plagenquest_05_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_05_23_01"); //Das ist großartig. Du hast unserer Stadt einen Dienst von unschätzbarem Wert erwiesen und das Übel gebannt.
	AI_Output(self, hero, "Info_Mod_Wendel_Plagenquest_05_23_02"); //Nimm, dieses Gold und den Stadthammer zum Dank. Der Segen der Götter möge dich begleiten.
...
{
	AI_Output(self, hero, "Info_Mod_Wendel_Andre_23_00"); //Guten Morgen, Soldat. Oder sollte ich dich lieber Hauptmann nennen?
	B_Say	(hero, self, "$HEROBOTQUEST01");
	AI_Output(self, hero, "Info_Mod_Wendel_Andre_23_02"); //Lord Andre's Plan hat funktioniert, allerdings gab es keine Möglichkeit einen Ausgang in den Hochofen zu implementieren, deshalb hat er dich überwältigt, selbst das Kostüm angezogen und den Roboter in den Hochofen gelockt.
	AI_Output(self, hero, "Info_Mod_Wendel_Andre_23_03"); //Wir haben einen versiegelten Umschlag neben dir gefunden. Darin erklärte Andre die ganze Angelegenheit und hat dich zu seinem Nachfolger ernannt.
	AI_Output(self, hero, "Info_Mod_Wendel_Andre_23_04"); //Aber hier ... die Details kannst du selbst nachlesen.

	B_GiveInvItems	(self, hero, ItWr_AndreAbschied, 1);

	AI_Output(self, hero, "Info_Mod_Wendel_Andre_23_05"); //Und diesen Schlüssel soll ich dir geben. Vermutlich zu seiner Kiste im Hauptmannzimmer.

	B_GiveInvItems	(self, hero, ItKe_Andre, 1);

	B_Say	(hero, self, "$HEROBOTQUEST02");
	AI_Output(self, hero, "Info_Mod_Wendel_Andre_23_06"); //Genau. Die Trauerfeier hast du verpasst, du haben geschlagene 32 Stunden durchgeschlafen. Der alte Haudegen scheint in ganz guter Form gewesen zu sein.
	AI_Output(self, hero, "Info_Mod_Wendel_Andre_23_07"); //Wenn du dich verabschieden willst, Andre liegt mittlerweile am Friedhof. Zumindest seine Asche. Aber ruh' dich zuerst aus, er läuft dir schon nicht weg.
	AI_Output(self, hero, "Info_Mod_Wendel_Andre_23_08"); //Ach ja, bevor ich's vergesse: Der Betreiber des Hochofens hat nach dir gefragt, schau mal bei ihm vorbei.
...
FUNC VOID Info_Mod_Wendel_Freudenspender_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wendel_Freudenspender_23_01"); //Was ist das?
	AI_Output(hero, self, "Info_Mod_Wendel_Freudenspender_15_02"); //Ein Weg zur Spiritualität.
	AI_Output(self, hero, "Info_Mod_Wendel_Freudenspender_23_03"); //(lacht) Versuch's besser bei den alten Frauen.
};
