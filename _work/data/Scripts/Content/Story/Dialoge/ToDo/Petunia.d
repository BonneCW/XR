...
{
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_16_00"); //Was? Wie kommst du hier rein?
...
FUNC VOID Info_Mod_Petunia_Hi_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_B_16_01"); //Verdammt, da hat jemand an der Rolle gepfuscht! Aber danke für den Tipp.
...
FUNC VOID Info_Mod_Petunia_Hi_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_A_16_01"); //ICH stelle hier die Fragen. Ich glaube nicht, dass du dir erlauben kannst, frech zu werden, Bübchen.
...
{
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_E_16_00"); //Nun geh mir aus dem Weg, ich habe zu tun.
...
FUNC VOID Info_Mod_Petunia_Hi_D()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_D_16_01"); //Euren Untergang besiedeln! Und dann werde ich einen Tee trinken. Ich liebe Tee.
...
FUNC VOID Info_Mod_Petunia_Hi_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_C_16_01"); //Mein Name tut nichts zur Sache, aber ich denke meine Taten zeichnen mich aus.
...
FUNC VOID Info_Mod_Petunia_Hi_G()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_G_16_01"); //Fast. Aber das macht nichts, dann wirst du halt aus dem Weg gegangen. (kichert)
...
{
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_J_16_00"); //Die ganze Falle. Der Trunk, die anschließende Vision und das deponierte Blütenblatt. Einfach alles!
	AI_Output(hero, self, "Info_Mod_Petunia_Hi_J_15_01"); //Danke für die Information, ich muss dann auch schon wieder gehen.
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_J_16_02"); //Du glaubst doch nicht, dass ich dich jetzt einfach gehen lasse? Du kennst schließlich meinen Plan.
	AI_Output(hero, self, "Info_Mod_Petunia_Hi_J_15_03"); //Das hatte ich eigentlich gedacht ...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_J_16_04"); //Sehr witzig, Bübchen. Männer, blast ihm das Licht aus. (kichert)
...
FUNC VOID Info_Mod_Petunia_Hi_F()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_F_16_01"); //Ach ja? (lacht hysterisch) Niemand kann mich jetzt noch aufhalten! Es ist alles vorbereitet!
...
FUNC VOID Info_Mod_Petunia_Hi_I()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_I_16_01"); //Schnappt ihn euch!
...
FUNC VOID Info_Mod_Petunia_Hi_H()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_H_16_01"); //Ich will aber nicht reden. Außerdem bringt das jetzt auch nichts mehr, dazu ist es zu spät.
	AI_Output(hero, self, "Info_Mod_Petunia_Hi_H_15_02"); //Was ist zu spät?
	AI_Output(self, hero, "Info_Mod_Petunia_Hi_H_16_03"); //Es ist alles vorbereitet!
...
FUNC VOID Info_Mod_Petunia_Pruefung_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_16_01"); //Du bist gar nicht mal so schwächlich wie du aussiehst.
	AI_Output(hero, self, "Info_Mod_Petunia_Pruefung_15_02"); //Ich denke, es ist Zeit, dass du mir erklärst, was hier gespielt wird.
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_16_03"); //Du kennst den Plan. Was willst du noch wissen?
...
{
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_C_16_00"); //Die Verwandlungsmagier haben mein Leben zerstört!
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_C_16_01"); //Ich war eine von ihnen, aber ich wurde nie als vollwertiges Mitglied behandelt. Wahrscheinlich, weil ich eine Frau bin. Pah!
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_C_16_02"); //Irgendwann habe ich dann halt angefangen, gegen sie zu arbeiten. So einfach ist das.
	AI_Output(hero, self, "Info_Mod_Petunia_Pruefung_C_15_03"); //Was haben sie dir denn getan?
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_C_16_04"); //Bei den kleinsten Vergehen haben sie schon die höchsten Strafen gegen mich verhängt. So was von unfair!
...
FUNC VOID Info_Mod_Petunia_Pruefung_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_B_16_01"); //Mein Name ist Petunia.
	AI_Output(hero, self, "Info_Mod_Petunia_Pruefung_B_15_02"); //Vielleicht ein bisschen mehr?
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_B_16_03"); //Wie du willst. Die ganze Geschichte.
...
FUNC VOID Info_Mod_Petunia_Pruefung_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_A_16_01"); //Warum? Das kann ich dir sagen!
...
FUNC VOID Info_Mod_Petunia_Pruefung_E()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_E_16_01"); //Endlich mal jemand, der mich versteht!
...
{
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_H_16_00"); //Was erlaubst du dir? Ich schütte dir mein Herz aus und du lässt es in diesem elenden Boden versickern!
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_H_16_01"); //Was habe ich dir denn getan?
...
FUNC VOID Info_Mod_Petunia_Pruefung_D()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_D_16_01"); //Ja. Da habe ich aus Versehen mal eine Herde Schafe gebraten oder Wölfen das Fell abgezogen, wenn mir kalt war. Das muss doch wohl drin sein!
...
FUNC VOID Info_Mod_Petunia_Pruefung_F()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_F_16_01"); //Vielen Dank, das werde ich dir nie vergessen!
...
FUNC VOID Info_Mod_Petunia_Pruefung_J()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_J_16_01"); //Ach komm. Du hast doch alles wieder gerade gebogen. Das kannst du mir wirklich nicht anlasten.
...
FUNC VOID Info_Mod_Petunia_Pruefung_I()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_I_16_01"); //Was soll ich denn bitte tun? Du hast alles kaputt gemacht. Du kennst den Plan.
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_I_16_02"); //Geh und tu', was immer du jetzt für nötig hältst.
...
FUNC VOID Info_Mod_Petunia_Pruefung_L()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_L_16_01"); //Tu' das.
...
FUNC VOID Info_Mod_Petunia_Pruefung_K()
{
	...
	AI_Output(self, hero, "Info_Mod_Petunia_Pruefung_K_16_01"); //Wenn du das für richtig hältst ...
