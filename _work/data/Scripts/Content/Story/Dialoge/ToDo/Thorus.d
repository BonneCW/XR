...
FUNC VOID Info_Mod_Thorus_Diebe_Info()
{
	...
	AI_Output(hero, self, "Info_Mod_Thorus_Diebe_15_02"); //Bloodwyn stiehlt die Sachen und Cutter steht Schmiere. Aber ich glaube, dass Cutter das nicht ganz freiwillig macht, denn er gab mir einen Hinweis, sie zu entlarven.
...
FUNC VOID Info_Mod_Thorus_Zettel_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Thorus_Zettel_12_01"); //Gut, Bloodwyn und Cutter sitzen im Kerker. Wir hoffen, wir werden erfahren, wer ihre Kontaktpersonen sind.
...
{
	AI_Output(hero, self, "Info_Mod_Thorus_Verloren_15_00"); //Beim Kampf mit dem Unbekannten wurde ich plötzlich schwächer, obwohl er mich nicht angegriffen hat.
...
FUNC VOID Info_Mod_Thorus_OrikDabei_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Thorus_OrikDabei_12_01"); //Ja, ich weiß. Damit war zu rechnen. Aber ich habe die Lage unter Kontrolle. Wir werden, im Falle eines Angriffs, das Lager verschließen.
