...
{
	AI_Output(self, hero, "Info_Mod_Zahit_Kill_07_00"); //Du wärst besser nicht hierher gekommen!
...
{
	AI_Output(self, hero, "Info_Mod_Zahit_Amir_07_00"); //(überrascht) Was willst Du denn hier? Hat dich Amir etwa hieher gebracht?
	AI_Output(hero, self, "Info_Mod_Zahit_Amir_15_01"); //Ja, das hat er.
	AI_Output(self, hero, "Info_Mod_Zahit_Amir_07_02"); //(wütend) Was bildet sich der Kerl denn überhaupt ein?
	AI_Output(self, hero, "Info_Mod_Zahit_Amir_07_03"); //Nur, weil er in der Stadt ist, heißt das noch lange nicht, dass er unsere Regeln missachten und wildfremde Leute hieher schleifen kann.
	...
	AI_Output(self, hero, "Info_Mod_Zahit_Amir_07_05"); //(lauernd) Aha, du hast Amir geholfen. Soso mein Freund, was musstest du tun? Fleischwanzen erlegen?
	...
	AI_Output(self, hero, "Info_Mod_Zahit_Amir_07_07"); //(staunt) Du als Schwächling hast solche Begabungen? Das spricht für dich, das muss man sagen.
	AI_Output(hero, self, "Info_Mod_Zahit_Amir_15_08"); //Was ist jetzt, kann ich mich euch anschließen?
	AI_Output(self, hero, "Info_Mod_Zahit_Amir_07_09"); //Nicht so hastig, mein Freund. Du hast zwar Amir überzeugen können, doch um überhaupt ein Assassine werden zu können, musst du noch einiges erledigen.
	AI_Output(self, hero, "Info_Mod_Zahit_Amir_07_10"); //Da liegt noch ein weiter Weg vor dir, mein Junge.
};
...
FUNC VOID Info_Mod_Zahit_Aufnahme_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_01"); //Nun, um zu einem Assassinen werden zu können bedarf es einer sehr wichtigen Sache.
	AI_Output(hero, self, "Info_Mod_Zahit_Aufnahme_15_02"); //Die wäre?
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_03"); //Vertrauen.
	AI_Output(hero, self, "Info_Mod_Zahit_Aufnahme_15_04"); //Aha. Und weiter?
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_05"); //Um ein Mitglied des Lagers werden zu können, musst du zuerst das Vertrauen der niederen Assassinenmitgliedern erwerben, den sogenannten Gaunern.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_06"); //Ihr Viertel liegt hinter dieser Tür.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_07"); //Dahinter kommt dann das Viertel der Krieger und danach das der Magier und des Hohen Rates.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_08"); //Um die zwei letzten Viertel überhaupt betreten zu können, musst du jedoch ein Gauner sein.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_09"); //Wenn du diesen Weg, der sehr schwirieg sein wird, tatsächlich einschlägst, dann hast du die Möglichkeit dich den Magiern oder den Kriegern anzuschließen.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_10"); //Doch vorher wirst du dich dafür schweren Prüfungen unterziehen müssen.
	AI_Output(hero, self, "Info_Mod_Zahit_Aufnahme_15_11"); //Das hört sich sehr motivierend an.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_12"); //(streng) Sei froh, dass du überhaupt die Möglichkeit bekommst, dich uns anzuschließen.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_13"); //Nur wenige Außenstehende haben bisher diese Ehre erhalten, also zügle dein freches Mundwerk.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_14"); //Wenn du den Magiern oder Kriegern so begegnest, werden sie dir Manieren beibringen.
	AI_Output(hero, self, "Info_Mod_Zahit_Aufnahme_15_15"); //(trocken) Ich werde es mir merken.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_16"); //Gut. Also du kannst jetzt das erste Viertel betreten.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_17"); //Sprich mit den Gauern und erledige ihre Aufgaben, um aufgenommen zu werden.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_18"); //Wenn du alle überzeugt hast, bekommst du die Chance mit den Magiern und Kriegern zu reden.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_19"); //Der Anführer ist Obergauner Shakir. Rede mit ihm, um Weiteres zu erfahren.
	AI_Output(hero, self, "Info_Mod_Zahit_Aufnahme_15_20"); //Danke, das werde ich tun.
	AI_Output(self, hero, "Info_Mod_Zahit_Aufnahme_07_21"); //Und mach keinen Ärger, dass wir uns da richtig verstanden haben!
...
{
	AI_Output(self, hero, "Info_Mod_Zahit_Assassinengold_07_00"); //Da bist du endlich. Alle warten auf dich. Mach hin.
	AI_Output(hero, self, "Info_Mod_Zahit_Assassinengold_15_01"); //Etwas Respekt vor einem Magier, Bursche!
	AI_Output(self, hero, "Info_Mod_Zahit_Assassinengold_07_02"); //Tschuldigung. Vor Kurzem warst du noch ein Nichts.
...
FUNC VOID Info_Mod_Zahit_PosWechsel_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Zahit_PosWechsel_07_01"); //Habe Amir als Beobachter abgelöst.
	AI_Output(hero, self, "Info_Mod_Zahit_PosWechsel_15_02"); //Und was ist so wichtig?
	AI_Output(self, hero, "Info_Mod_Zahit_PosWechsel_07_03"); //Du musst sofort zu Mustafa gehen. Scheint wichtig zu sein.
...
FUNC VOID Info_Mod_Zahit_Gefunden_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Zahit_Gefunden_07_01"); //Wie meinst du das?
	AI_Output(hero, self, "Info_Mod_Zahit_Gefunden_15_02"); //Ich glaube kaum, dass bisher noch niemand diese Höhle erforscht hat.
	AI_Output(self, hero, "Info_Mod_Zahit_Gefunden_07_03"); //Das ist bisher selten passiert und die, die hieher kamen, konnten es niemandem mehr berichten.
	AI_Output(hero, self, "Info_Mod_Zahit_Gefunden_15_04"); //Also habt ihr sie getötet?
	AI_Output(self, hero, "Info_Mod_Zahit_Gefunden_07_05"); //Ja, wir wollen doch nicht das Paladine und Milizen hieher anrücken.
...
FUNC VOID Info_Mod_Zahit_Hergekommen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Zahit_Hergekommen_07_01"); //Auf dem Festland herrscht ja bekanntlich das vollkommene Chaos.
	AI_Output(hero, self, "Info_Mod_Zahit_Hergekommen_15_02"); //Ja, davon habe ich auch gehört.
	AI_Output(self, hero, "Info_Mod_Zahit_Hergekommen_07_03"); //Wir haben es dort nicht mehr ausgehalten. Deshalb beschlossen unsere weisen Anführer diesem Wahnsinn zu entfliehen.
	AI_Output(self, hero, "Info_Mod_Zahit_Hergekommen_07_04"); //Mittels eines starken Teleportzaubers haben es die Magier von uns geschafft uns alle nach Khorinis zu telepotieren.
	AI_Output(self, hero, "Info_Mod_Zahit_Hergekommen_07_05"); //Wir suchten nach einem Versteck und fanden diese Höhle hier unbenutzt vor.
	AI_Output(self, hero, "Info_Mod_Zahit_Hergekommen_07_06"); //Wir beschlossen hier zu bleiben und seither ist dies unser Lager.
	AI_Output(self, hero, "Info_Mod_Zahit_Hergekommen_07_07"); //Wir wollen aber in nächster Zeit versuchen, unseren Einfluss auszuweiten.
	...
	AI_Output(self, hero, "Info_Mod_Zahit_Hergekommen_07_09"); //Keine Ursache.
};
