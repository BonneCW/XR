...
FUNC VOID Info_Mod_Sly_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sly_Hi_28_01"); //(angetrunken) Bleib mal ganz ruhig, Bruder. Warum setzt du dich nicht dazu und hast ein bisschen Spaß mit uns?
};
...
FUNC VOID Info_Mod_Sly_WasPassiert_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sly_WasPassiert_28_01"); //Nichts weiter ... denk ich. Solange Cutter uns nicht zur Arbeit auf den Feldern einteilt, können wir auch nichts machen.
	AI_Output(self, hero, "Info_Mod_Sly_WasPassiert_28_02"); //Na gut, ab und zu geht mal jemand jagen. Aber das lag mir eh noch nie, und ich will nicht als Wolfsfutter enden.
};
...
FUNC VOID Info_Mod_Sly_LagerLeerer_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sly_LagerLeerer_28_01"); //Ein bisschen schon. Bei den meisten weiß man nicht, was aus ihnen geworden ist.
	AI_Output(self, hero, "Info_Mod_Sly_LagerLeerer_28_02"); //Manche wollten zum Jagen losziehen und sind nie wiedergekommen.
	AI_Output(self, hero, "Info_Mod_Sly_LagerLeerer_28_03"); //Entweder hat's die armen Schweine erwischt, oder die Dreckskerle haben sich abgesetzt.
	AI_Output(self, hero, "Info_Mod_Sly_LagerLeerer_28_04"); //Seit kurzem dürfen wir deshalb ohne Genehmigung das Lager nicht mehr verlassen.
	AI_Output(self, hero, "Info_Mod_Sly_LagerLeerer_28_05"); //Na ja, wer wirklich raus will, lässt sich von dem Verbot natürlich nicht behindern.
};
...
FUNC VOID Info_Mod_Sly_Arena_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sly_Arena_28_01"); //Die Arena wär schon was für mich ... immer wenn Kämpfe sind, stelle ich mir vor, ich wäre an der Stelle einer der Kämpfer.
	AI_Output(self, hero, "Info_Mod_Sly_Arena_28_02"); //Aber ich bin nur ein einfacher Schatten und hatte schon seit langem kein Schwert mehr in der Hand.
	AI_Output(self, hero, "Info_Mod_Sly_Arena_28_03"); //Früher war ich mal gut, zählte zu den Besten im Lager. Aber jetzt?
	AI_Output(self, hero, "Info_Mod_Sly_Arena_28_04"); //So was wie mich verputzen die in der Arena zum Frühstück.
};
...
FUNC VOID Info_Mod_Sly_Arena2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sly_Arena2_28_01"); //(abschätzend) Du siehst schon aus, als hättest du was auf dem Kasten. Meinetwegen.
	AI_Output(self, hero, "Info_Mod_Sly_Arena2_28_02"); //Wenn ich an der Arena erfolgreich bin, wirst du am Gewinn beteiligt.
	AI_Output(hero, self, "Info_Mod_Sly_Arena2_15_03"); //Schön. Wann willst du anfangen?
	AI_Output(self, hero, "Info_Mod_Sly_Arena2_28_04"); //Lass mich erst mal ganz nüchtern werden. Morgen Früh können wir uns, äh, auf dem Rasenstück zwischen dem kleinen Tümpel da vorn und dem Marktplatz treffen.
	AI_Output(self, hero, "Info_Mod_Sly_Arena2_28_05"); //Dort sollte genügend Platz sein.
...
{
	AI_Output(self, hero, "Info_Mod_Sly_Arena3_28_00"); //Na, komm endlich. Ich bin schon ganz heiß! Wie wollen wir anfangen?
	...
	AI_Output(self, hero, "Info_Mod_Sly_Arena3_28_03"); //(jammert) Laufen? Ich dachte, wir perfektionieren meinen Schwertkampf?
	...
	AI_Output(self, hero, "Info_Mod_Sly_Arena3_28_05"); //Na schön, wenn's sein muss ...
...
{
	AI_Output(self, hero, "Info_Mod_Sly_Arena4_28_00"); //(nach Luft ringend) Ah, ich sterbe!
	AI_Output(hero, self, "Info_Mod_Sly_Arena4_15_01"); //Vorher müssen wir uns noch duellieren. Hast du eine Waffe?
	AI_Output(self, hero, "Info_Mod_Sly_Arena4_28_02"); //(keuchend) Ja, ja, alles dabei. Hab auch was für dich, damit du mir nicht allzu sehr weh tust.
	...
	AI_Output(self, hero, "Info_Mod_Sly_Arena4_28_04"); //Ok.
...
FUNC VOID Info_Mod_Sly_Arena5_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sly_Arena5_28_01"); //(ächzt) Wenn du mit Gefühlen die Schmerzen meinst, dann auf jeden Fall.
	AI_Output(self, hero, "Info_Mod_Sly_Arena5_28_02"); //Hast du noch irgendwelche Tipps für mich?
...
{
	AI_Output(self, hero, "Info_Mod_Sly_Arena5_C_28_00"); //Gut. Vielen Dank für deine Hilfe. Ich glaube, ich hab's langsam wieder raus. Ich werd Scatty mal Bescheid sagen, dass er mich auf die Liste setzen soll.
	AI_Output(self, hero, "Info_Mod_Sly_Arena5_C_28_01"); //Wenn ich gewinnen sollte, kriegst du die Hälfte meiner Bezahlung.
	AI_Output(self, hero, "Info_Mod_Sly_Arena5_C_28_02"); //Jetzt werde ich noch ein wenig üben.
...
FUNC VOID Info_Mod_Sly_Arena6_Info()
{
	if (Mod_Sly_Arena == 5)
	{
		AI_Output(self, hero, "Info_Mod_Sly_Arena6_28_00"); //Schade, ich hätte diesen Karanto fast besiegt. Das schreit nach einer Revanche!
		AI_Output(hero, self, "Info_Mod_Sly_Arena6_15_01"); //Du bleibst also dabei?
		AI_Output(self, hero, "Info_Mod_Sly_Arena6_28_02"); //Na klar! Der soll sich nur warm anziehen!

		B_GivePlayerXP	(50);
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Sly_Arena6_28_03"); //Mann, ohne deinen Hinweis mit der Defensive hätte ich Gor Karanto nicht geknackt. Knapp, aber verdient, würde ich sagen.
		AI_Output(hero, self, "Info_Mod_Sly_Arena6_15_04"); //Glückwunsch.
		AI_Output(self, hero, "Info_Mod_Sly_Arena6_28_05"); //Hier hast du deinen Anteil.

		B_GiveInvItems	(self, hero, ItMi_Gold, 150);

		AI_Output(self, hero, "Info_Mod_Sly_Arena6_28_06"); //Ich fiebere schon meinen nächsten Duell entgegen.
...
FUNC VOID Info_Mod_Sly_SLDSpy_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sly_SLDSpy_28_01"); //Warum fragst du?
	...
	AI_Output(self, hero, "Info_Mod_Sly_SLDSpy_28_03"); //Ahh, ein frischer harziger Stängel.

	B_UseItem	(self, ItMi_Joint);

	AI_Output(self, hero, "Info_Mod_Sly_SLDSpy_28_04"); //Ach ja, wegen der Neuigkeiten. Hab gehört, dass die Gardisten in den nächsten Tagen was Großes planen.
	AI_Output(self, hero, "Info_Mod_Sly_SLDSpy_28_05"); //Irgendeinen Angriff in der Morgendämmerung, hieß es. Bin schon mächtig gespannt ...
