...
{
	AI_Output(self, hero, "Info_Mod_Brody_Hi_03_00"); //(schwach krächzend) Hey, Wasser. Bitte Wasser.
...
FUNC VOID Info_Mod_Brody_Hi_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Brody_Hi_B_03_00"); //Macht nix. Ich mach's eh nicht mehr lange. (lacht trocken und haucht dabei sein Leben aus)
...
FUNC VOID Info_Mod_Brody_Hi_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Brody_Hi_A_03_01"); //Ahhhh! Danke, Freundchen.
...
FUNC VOID Info_Mod_Brody_WhoAreYou_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_01"); //Ich bin ein Wüstenpirat.

	AI_DrawWeapon	(hero);

	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_02"); //(eilig) Nein, nein, ich tue dir nichts. Bin doch viel zu schwach dazu.

	AI_RemoveWeapon	(hero);

	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_03"); //Ich war Mitglied einer ganzen Gruppe. Unser Lager war dort hinten, gegenüber vom Tempel.
	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_04"); //Unsere Lieblingsbeschäftigung war es, die Piraten zu ärgern.
	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_05"); //Wir haben ihnen Essen und Plunder geklaut, Boote zerstört, vor Gregs Hütte gespuckt und in ihren Grog gepinkelt.
	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_06"); //Eines Nachts wurde ich von einem Schrei geweckt.
	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_07"); //Diese Sumpfratten von Piraten hatten unser Lager entdeckt und meuchelten einen nach dem anderen von uns ab!
	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_08"); //Ich entkam als Einziger, ohne Ausrüstung, ohne was zu saufen. Und seitdem brate ich hier.
	AI_Output(self, hero, "Info_Mod_Brody_WhoAreYou_03_09"); //Raus aus dem Canyon komme ich nicht. Die Berge sind zu hoch und der Ausgang, den ich kenne, wird ständig bewacht.
...
FUNC VOID Info_Mod_Brody_AndererWeg_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Brody_AndererWeg_03_01"); //Wirklich? Wo?
...
{
	AI_Output(self, hero, "Info_Mod_Brody_AmZiel_03_00"); //Freundchen ... ich weiß gar nicht, wie ich dir danken kann.
	AI_Output(self, hero, "Info_Mod_Brody_AmZiel_03_01"); //Aber du hast Glück genug, dass ich nicht bei Kräften war, als du mich gefunden hast.
	AI_Output(self, hero, "Info_Mod_Brody_AmZiel_03_02"); //Dann hätte das Gespräch eine ganz andere Wendung genommen, glaub mir.
	AI_Output(self, hero, "Info_Mod_Brody_AmZiel_03_03"); //Mach's gut, und sei froh, wenn du nicht mehr von mir hörst!
...
{
	AI_Output(self, hero, "Info_Mod_Brody_FalscherWeg_03_00"); //Freundchen ... da geht's zum Piratenlager. Du willst mich denen wohl ausliefern.
	AI_Output(self, hero, "Info_Mod_Brody_FalscherWeg_03_01"); //Entweder du zeigst mir einen anderen Weg oder du wirst mächtig Ärger bekommen.
...
{
	AI_Output(self, hero, "Info_Mod_Brody_PechGehabt_03_00"); //Ich hab dich gewarnt.
