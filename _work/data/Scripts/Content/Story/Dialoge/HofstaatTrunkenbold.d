...
{
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_28_00"); //(gähnt) Guten Morgen Majestät. Ist schon wieder die Zeit des Festes?
	...
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_28_02"); //Jaja, das weiß ich noch (gähnt) Da hat sie von meinem Spezialtrunken gekostet, hehe. Niemand verträgt meinen Spezialtrunken.
	AI_Output(hero, self, "Info_Mod_HofstaatTrunkenbold_Geliebte_15_03"); //Gib ihn mir.
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_28_04"); //Nein.
	AI_Output(hero, self, "Info_Mod_HofstaatTrunkenbold_Geliebte_15_05"); //Was nein.
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_28_06"); //Geht nicht. Hab keinen mehr.
	AI_Output(hero, self, "Info_Mod_HofstaatTrunkenbold_Geliebte_15_07"); //Dann mach welchen.
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_28_08"); //Natürlich, sobald ich richtig wach bin. Den zu machen dauert aber ein Weilchen.
...
FUNC VOID Info_Mod_HofstaatTrunkenbold_Geliebte_B()
{
	...
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_B_28_01"); //Jawohl Hoheit. Ihr braucht Trunken, viiiieeel Trunken.  Dann braucht ihr eine seltsame, grüne Frucht, das ist alles.
	AI_Output(hero, self, "Info_Mod_HofstaatTrunkenbold_Geliebte_B_15_02"); //Woher bekomme ich den Trunken?
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_B_28_03"); //Den bekommt man in einer Stadt. Die Ausländer nennen Trunken "Schnaps" oder auch "Wacholder". Ts ... lächerlich.
	AI_Output(hero, self, "Info_Mod_HofstaatTrunkenbold_Geliebte_B_15_04"); //Was für eine grüne Frucht?
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_B_28_05"); //Sie wird "Melone" genannt. Ihr bekommst sie in Khorata. Schüttet den Trunken an einem Alchemietisch in die Melone.
...
FUNC VOID Info_Mod_HofstaatTrunkenbold_Geliebte_A()
{
	...
	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_A_28_01"); //Gut,gut. (gähnt) Ich mach' mich auf den Weg.

	AI_GotoWP	(self, "REL_262");
	AI_GotoWP	(self, "REL_272");

	AI_Output(self, hero, "Info_Mod_HofstaatTrunkenbold_Geliebte_A_28_02"); //Es ist nicht die Zeit des Festes ... und du bist nicht der König! STIIRB!
