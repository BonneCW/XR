...
{
	AI_Output(self, hero, "Info_Mod_Mika_Hi_28_00"); //Hey, dich habe ich hier noch die gesehen. Du musst neu in der Stadt sein.
	AI_Output(hero, self, "Info_Mod_Mika_Hi_15_01"); //Schon möglich.
	AI_Output(self, hero, "Info_Mod_Mika_Hi_28_02"); //Ich will dir den Rat geben gut auf dich aufzupassen, wenn du die Stadt verlässt.
	AI_Output(self, hero, "Info_Mod_Mika_Hi_28_03"); //In letzter Zeit häufen sich nämlich die Berichte über recht unheimliche Begebenheiten.
...
FUNC VOID Info_Mod_Mika_Hi_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Mika_Hi_B_28_01"); //Nun, es wird gemunkelt, dass dunkle Mächte ihr Unwesen treiben. Leute verschwinden, andere erkranken plötzlich schwer.
	AI_Output(self, hero, "Info_Mod_Mika_Hi_B_28_02"); //Und manch einer hat gar berichtet, dass die Toten sich aus ihren Gräbern erheben und als Untote ihr Unwesen treiben.
...
{
	AI_Output(self, hero, "Info_Mod_Mika_Hi_E_28_00"); //Ok, wie du meinst. Komm dann aber bloß nicht angelaufen, wenn Untote oder andere finstere Gestalten hinter dir her sind.
...
{
	AI_Output(self, hero, "Info_Mod_Mika_Hi_D_28_00"); //Und erst vor einiger Zeit habe ich von weitem eine unheimliche, finstere Gestalt aus dem Talkessel vor der Stadt kommen sehen.
	AI_Output(hero, self, "Info_Mod_Mika_Hi_D_15_01"); //Eine finstere Gestalt? Wohin ist sie gegangen?
	AI_Output(self, hero, "Info_Mod_Mika_Hi_D_28_02"); //Weiter den Weg hinauf. Entweder in Richtung Akils Hof, der links vom Weg liegt, oder gerade aus Richtung Taverne.
	AI_Output(self, hero, "Info_Mod_Mika_Hi_D_28_03"); //War mir gar nicht geheuer, dieser Geselle.
...
FUNC VOID Info_Mod_Mika_Yasin_Info()
{
	...
	if (!Npc_KnowsInfo(hero, Info_Mod_Urnol_WerBistDu))
	{
		...
		AI_Output(self, hero, "Info_Mod_Mika_Yasin_28_03"); //Wollen die in die Stadt? Sag schon.
		AI_Output(hero, self, "Info_Mod_Mika_Yasin_15_04"); //Ich denke ja. Sie lungern da vorn in der Höhle rum, links vom Weg.
		AI_Output(self, hero, "Info_Mod_Mika_Yasin_28_05"); //Du musst wahnsinnig sein, aber gut, viel Glück!
	}
	else
	{
		...
		AI_Output(self, hero, "Info_Mod_Mika_Yasin_28_07"); //Erzähl.
	...
	AI_Output(self, hero, "Info_Mod_Mika_Yasin_28_10"); //Da will ich doch gleich mal nachsehen, zu was bin ich schließlich hier? Gibst du mir Rückendeckung?
...
{
	AI_Output(self, hero, "Info_Mod_Mika_Yasin2_28_00"); //Hier ist niemand. Die Vögel sind wohl ausgeflogen.
	AI_Output(hero, self, "Info_Mod_Mika_Yasin2_15_01"); //Nicht ganz. Einer ist noch hier.
	AI_Output(self, hero, "Info_Mod_Mika_Yasin2_28_02"); //Wo denn?
...
FUNC VOID Info_Mod_Mika_Banditen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Mika_Banditen_28_01"); //Seit Tagen schon jagt die Miliz einer kleinen Gruppe Banditen hinterher, die ständig die Händler überfallen.
	AI_Output(self, hero, "Info_Mod_Mika_Banditen_28_02"); //Bevor wir sie zu fassen bekommen verschwinden sie immer in den Wäldern bei Akil Hof.
	AI_Output(self, hero, "Info_Mod_Mika_Banditen_28_03"); //Wir gehen da auf keinen Fall rein. Da wimmelts nur so von Viechern.
	AI_Output(hero, self, "Info_Mod_Mika_Banditen_15_04"); //Was würdest du mir geben, wenn ich diese Banditen töten würde!
	AI_Output(self, hero, "Info_Mod_Mika_Banditen_28_05"); //Nun, 100 Goldstücke wären für dich drin. Heißt das, du tötest die Kerle?
	AI_Output(hero, self, "Info_Mod_Mika_Banditen_15_06"); //Ja, das heißt es!
	AI_Output(self, hero, "Info_Mod_Mika_Banditen_28_07"); //Du musst wahnsinnig sein, aber gut, viel Glück!
...
FUNC VOID Info_Mod_Mika_BanditenTot_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Mika_BanditenTot_28_01"); //Ich hätte nicht gedacht, dass du das alleine schaffst, Kleiner. Hier hast du das versprochene Gold!
...
{
	AI_Output(self, hero, "Info_Mod_Mika_Randolph_28_00"); //Du machst besser, dass du schnell in die Stadt kommst.
	AI_Output(self, hero, "Info_Mod_Mika_Randolph_28_01"); //Hier draußen treiben sich zurzeit Dämonen umher, die keinen am Leben lassen, der ihren Weg kreuzt.
	AI_Output(hero, self, "Info_Mod_Mika_Randolph_15_02"); //Dämonen? Woher stammen diese?
	AI_Output(self, hero, "Info_Mod_Mika_Randolph_28_03"); //Keine Ahnung, sie sind hier überall in den Wäldern nahe der Stadt. Und in der Nähe von Lobarts Hof treibt sich zudem eine obskure Gestalt umher.
	AI_Output(self, hero, "Info_Mod_Mika_Randolph_28_04"); //Egal, ich muss jetzt aufpassen und habe keine Zeit mich weiter zu unterhalten.
};
...
{
	AI_Output(self, hero, "Info_Mod_Mika_RandolphWeg_28_00"); //Gute Nachrichten. Die Dämonen scheinen sich wieder verzogen zu haben.
	AI_Output(self, hero, "Info_Mod_Mika_RandolphWeg_28_01"); //(hochmütig) Dürften wohl erkannt haben, dass sie es mit uns nicht aufnehmen können.
	AI_Output(self, hero, "Info_Mod_Mika_RandolphWeg_28_02"); //Du kannst also wieder unbesorgt vor die Stadt gehen.
...
FUNC VOID Info_Mod_Mika_Dokumente_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Mika_Dokumente_28_01"); //Korrekt.
	AI_Output(hero, self, "Info_Mod_Mika_Dokumente_15_02"); //Und sie befinden sich noch in deinem Besitz?
	AI_Output(self, hero, "Info_Mod_Mika_Dokumente_28_03"); //Richtig.
...
FUNC VOID Info_Mod_Mika_Dokumente_C()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Mika_Dokumente_C_28_01"); //Ach, nimm sie schon, ich kann damit nichts anfangen.
	...
	{
		AI_Output(self, hero, "Info_Mod_Mika_Dokumente_C_28_02"); //200 Gold oder keine Zettel.
...
{
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_28_00"); //Warte mal einen Augenblick.
	AI_Output(hero, self, "Info_Mod_Mika_VinoBrennerei_15_01"); //Was ist?
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_28_02"); //Du bist doch viel da draußen unterwegs. Hast du zufällig Vino irgendwo gesehen?
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_28_03"); //Lobart macht sich große Sorgen, weil er vor zwei Tagen den Hof verlassen hat und noch nicht zurückgekommen ist.
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_28_04"); //Und ich kann mich dunkel erinnern, dass er hier das Stadttor passiert hat.
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_28_05"); //Wohin er danach gegangen ist, weiß ich allerdings nicht mehr.
	AI_Output(hero, self, "Info_Mod_Mika_VinoBrennerei_15_06"); //Nein, zuletzt habe ich ihn auch nicht gesehen.
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_28_07"); //Ach, dass auf Lobart’s Hof auch keiner wissen will, wohin er gegangen ist.
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_28_08"); //Er steht doch mit den anderen Landarbeitern den ganzen Tag auf dem Feld.
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_28_09"); //Da müsste doch eigentlich einer was mitbekommen haben.
	AI_Output(self, hero, "Info_Mod_Mika_VinoBrennerei_28_10"); //Und ich darf mir dann hier die Beine ich den Bauch stehen und jeden Fragen, der vorbeikommt.
...
{
	AI_Output(self, hero, "Info_Mod_Mika_AndreVermaechtnis_28_00"); //Verdammt ...
	AI_Output(hero, self, "Info_Mod_Mika_AndreVermaechtnis_15_01"); //Was haben wir den hier? Heiße Ware?
	AI_Output(self, hero, "Info_Mod_Mika_AndreVermaechtnis_28_02"); //(stammelt) Ich ... ähhh ... scheiße, nichts wie weg.
...
{
	AI_Output(self, hero, "Info_Mod_Mika_AndreVermaechtnis2_28_00"); //Scheiße, wir sitzen in der Falle. Kämpf um dein Leben, sonst ergeht es uns wie Yasin.
...
{
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_28_00"); //He, bleib mal stehen!
	AI_Output(hero, self, "Info_Mod_Mika_Pflanzensammler_15_01"); //Was ist denn los?
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_28_02"); //Die Kräutersammler haben sich darüber beschwert, du würdest dauernd alle Heilpflanzen in der Gegend aufsammeln und für dich behalten.
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_28_03"); //Die vorhandenen würden kaum ausreichen, den Bedarf zu decken.
	...
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_28_05"); //Du gibst mir 50 Heilpflanzen und ich bezahle dich fast so gut wie einer der Händler.
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_28_06"); //Dafür kriegst du keinen Ärger mehr.
...
FUNC VOID Info_Mod_Mika_Pflanzensammler_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_B_28_01"); //Ich bedaure deine Entscheidung.
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_B_28_02"); //Sie zwingt mich, dir meine Hilfe aufzukündigen für den Fall, dass du vor den Stadttoren angegriffen wirst.
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_B_28_03"); //Und nun: geh.
...
FUNC VOID Info_Mod_Mika_Pflanzensammler_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Mika_Pflanzensammler_A_28_01"); //Eine kluge Entscheidung. Ich wünsche einen angenehmen Tag.
