...
FUNC VOID Info_Mod_Regis_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Regis_Hi_03_01"); //Ich bin Regis. Ich weiß am besten bescheid, was hier in der Stadt passiert.
};
...
FUNC VOID Info_Mod_Regis_Paladine_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Regis_Paladine_03_01"); //Zuerst kamen sie nur gelegentlich nach Khorinis um einen Gefangenen in die Strafkolonie zu werfen oder um mit den Sträflingen zu verhandeln.
	AI_Output(self, hero, "Info_Mod_Regis_Paladine_03_02"); //Doch nachdem die Barriere zusammengebrochen ist, hat der König einen Trupp hierher geschickt, um die Stadt zu beschüzen.
	AI_Output(self, hero, "Info_Mod_Regis_Paladine_03_03"); //Seitdem haben sie die Kontrolle über die Stadt übernommen. Sie befürchten das die Söldner aus dem Minental die Stadt einnehmen.
	AI_Output(self, hero, "Info_Mod_Regis_Paladine_03_04"); //Der Anführer der Söldner soll damals ein Problem mit dem König gehabt haben und ist deswegen gegen die Paladine und versucht sie mit seinen Söldnern auszuschalten, um mit dem Paladinschiff nach Myrtana zu segeln und sich am König zu rächen.
};
...
FUNC VOID Info_Mod_Regis_MehrPaladine_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Regis_MehrPaladine_03_01"); //Ich hab dir alles gesagt was ich weiß.
	AI_Output(self, hero, "Info_Mod_Regis_MehrPaladine_03_02"); //Wenn du mehr erfahren willst, dann solltest du mit den Paladinen im Oberen Viertel sprechen.
};
...
FUNC VOID Info_Mod_Regis_Flugblaetter_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Regis_Flugblaetter_03_01"); //Danke, für das Blatt ... auch, wenn ich ja sowieso schon den ganzen Tag vor seinem Laden herumsitze.
