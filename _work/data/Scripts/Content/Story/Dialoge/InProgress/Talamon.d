...
FUNC VOID Info_Mod_Talamon_Hi_Info()
{
	...
	if (Kapitel < 5)
	{
		AI_Output(self, hero, "Info_Mod_Talamon_Hi_16_01"); //Ich bin Talamon, Wächter der Bilbiothek.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Talamon_Hi_16_02"); //Ich bin Talamon, Stellvertreter für Pyrokar.
	};
};
...
{
	AI_Output(self, hero, "Info_Mod_Talamon_Patherion_16_00"); //Gut, dass du kommst, Bruder! Garan hat mir einen Boten geschickt. Deine Anwesenheit in Patherion ist erwünscht.
...
FUNC VOID Info_Mod_Talamon_Befoerderung_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Talamon_Befoerderung_16_01"); //Du hast Innos deine Loyalität bewiesen und da Pyrokar mich dazu befugt hat, ernenne ich dich hiermit zum Ordenspriester Innos'.
...
FUNC VOID Info_Mod_Talamon_Ruestung_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Talamon_Ruestung_16_02"); //Ich habe gehört, dass beim Pass zum Minental ein Feuersnapper sein soll. Mit dessen Haut könnte ich deine Feuernovizenrobe sicher ein wenig verbessern.
	...
	{
		AI_Output(self, hero, "Info_Mod_Talamon_Ruestung_16_03"); //Ich habe gehört, dass beim Weg zur Ausgrabungsstätte der Wassermagier ein Feuerläufer sein soll. Mit dessen Fell könnte ich deine Feuermagierrobe sicher ein wenig verbessern.
...
FUNC VOID Info_Mod_Talamon_Ruestung_KDF_S ()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Talamon_Ruestung_KDF_S_16_03"); //Wenn du nicht das Feuerläuferfell hast, kann ich deine Robe nicht verbessern.
	};
