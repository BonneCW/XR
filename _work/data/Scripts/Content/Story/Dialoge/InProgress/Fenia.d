...
{
	AI_Output(self, hero, "Info_Mod_Fenia_Hi_19_00"); //Hallo, ich bin Fenia. Brauchst du was zu essen?
...
{
	AI_Output(self, hero, "Info_Mod_Fenia_Daemonisch_19_00"); //Mann, der ist aber schnell zum Südtor gerannt.
...
FUNC VOID Info_Mod_Fenia_Wanzen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Fenia_Wanzen_19_01"); //(fühlt sich erwischt) Äh ... gar nichts.
	AI_Output(hero, self, "Info_Mod_Fenia_Wanzen_15_02"); //Du hast nicht zufällig was mit den Wanzen in Eddas Hütte zu tun, oder?
	AI_Output(self, hero, "Info_Mod_Fenia_Wanzen_19_03"); //Äh ... ich?
	AI_Output(hero, self, "Info_Mod_Fenia_Wanzen_15_04"); //Ja, du.
	AI_Output(self, hero, "Info_Mod_Fenia_Wanzen_19_05"); //Nun, äh ... es ist anders, also du denkst.
	AI_Output(hero, self, "Info_Mod_Fenia_Wanzen_15_06"); //Wie ist es denn?
	AI_Output(self, hero, "Info_Mod_Fenia_Wanzen_19_07"); //Edda hat es nicht anders verdient, weißt du? Sie hat versucht, sich an meinen Mann ranzumachen.
	...
	AI_Output(self, hero, "Info_Mod_Fenia_Wanzen_19_09"); //Bitte verrate mich nicht.
	AI_Output(hero, self, "Info_Mod_Fenia_Wanzen_15_10"); //Wieso sollte ich das nicht tun?
	AI_Output(self, hero, "Info_Mod_Fenia_Wanzen_19_11"); //Ich kann dich bezahlen. Ich bin Händlerin, ich hab Gold.
...
FUNC VOID Info_Mod_Fenia_Wanzen_Fenia()
{
	...
	AI_Output(self, hero, "Info_Mod_Fenia_Wanzen_Fenia_19_01"); //Danke, Edda hätte mich umgebracht. Hier ist dein Gold.
...
FUNC VOID Info_Mod_Fenia_Wanzen_Edda()
{
	...
	AI_Output(self, hero, "Info_Mod_Fenia_Wanzen_Edda_19_01"); //Oh nein, sie wird mich umbringen.
...
FUNC VOID Info_Mod_Fenia_AllesKlar_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Fenia_AllesKlar_19_01"); //Sehe ich etwa so bedrückt aus? Das wäre schlecht fürs Geschäft.
	AI_Output(hero, self, "Info_Mod_Fenia_AllesKlar_15_02"); //Was belastet dich denn?
	AI_Output(self, hero, "Info_Mod_Fenia_AllesKlar_19_03"); //Ich erwische meinen Mann Halvor immer wieder dabei, dass er fremden Frauen nachschaut.
	AI_Output(self, hero, "Info_Mod_Fenia_AllesKlar_19_04"); //Aber ich habe auch das Gefühl, dass alle Weiber versuchen, mir meinen Halvor abspenstig zu machen.
	AI_Output(hero, self, "Info_Mod_Fenia_AllesKlar_15_05"); //Hast du ihn mal darauf angesprochen?
	AI_Output(self, hero, "Info_Mod_Fenia_AllesKlar_19_06"); //Mal? Ich stelle ihn immer zur Rede, aber er streitet alles vehement ab und redet sich mit Verkaufsgesprächen und so weiter heraus.
	AI_Output(self, hero, "Info_Mod_Fenia_AllesKlar_19_07"); //Ich werde ihn schon noch auf frischer Tat ertappen ...
};
...
{
	AI_Output(self, hero, "Info_Mod_Fenia_BH_19_00"); //Du schmieriger Lump! Wirst du wohl die Finger von meinem ... meinem ... lassen!
	AI_Output(hero, self, "Info_Mod_Fenia_BH_15_01"); //Aber ...
	AI_Output(self, hero, "Info_Mod_Fenia_BH_19_02"); //Zu dieser Aktion fällt dir jetzt wohl auch noch eine Ausrede ein, was?!
	AI_Output(self, hero, "Info_Mod_Fenia_BH_19_03"); //Halt bloß den Mund und bleib mir fern!
...
{
	AI_Output(self, hero, "Info_Mod_Fenia_BH2_19_00"); //Vergessen wir die Sache mit meinem ... meinem ..., ja?
