...
{
	AI_Output(self, hero, "Info_Mod_Hakon_Hi_03_00"); //Hallo Fremder, ich bin Hakon der Waffenhändler. Wenn du ein Schwert brauchst bist du bei mir richtig.
...
FUNC VOID Info_Mod_Hakon_Ueberfall_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hakon_Ueberfall_03_01"); //He, pass auf, was du sagst. Ich habe hier nur hochwertige Ware.
	...
	AI_Output(self, hero, "Info_Mod_Hakon_Ueberfall_03_04"); //Junge, du überspannst hier gerade den Bogen. Pass bloß auf, sonst passiert was!
	...
	AI_Output(self, hero, "Info_Mod_Hakon_Ueberfall_03_06"); //Ok, jetzt reicht's!
...
FUNC VOID Info_Mod_Hakon_Weglocken_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hakon_Weglocken_03_01"); //Ja, was ist es?
...
FUNC VOID Info_Mod_Hakon_Weglocken_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Hakon_Weglocken_C_03_01"); //Was noch?! Als ob ich nichts besseres zu tun hätte, mir etwas vor der Stadt anzuschauen ...
...
FUNC VOID Info_Mod_Hakon_Weglocken_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Hakon_Weglocken_B_03_01"); //Ein großer Schatz in einer Höhle vor der Stadt? Ne, Jungchen, Märchenstunde ist erst heute Abend.
...
FUNC VOID Info_Mod_Hakon_Weglocken_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Hakon_Weglocken_A_03_01"); //Zwei Gobbos? Ha, lächerlich. Bring mich zu der Höhle. Die Waffen muss ich mir unbedingt ansehen.
...
{
	AI_Output(self, hero, "Info_Mod_Hakon_Neugier_03_00"); //Ähh, na ja, vielleicht doch ein kurzer Blick. Bring mich hin. Aber wehe, es ist nichts Interessantes.
...
FUNC VOID Info_Mod_Hakon_Falle_Info()
{
	if (Mod_HakonUeberfall == 3)
	{
		AI_Output(self, hero, "Info_Mod_Hakon_Falle_03_00"); //Also, wo ist jetzt die Höhle mit Waffen und Goblin’s?
	...
	{
		AI_Output(self, hero, "Info_Mod_Hakon_Falle_03_02"); //Also, wo ist jetzt das, was du mir zeigen wolltest?
		AI_Output(hero, self, "Info_Mod_Hakon_Falle_15_03"); //Einen Banditen.
	};

	AI_Output(self, hero, "Info_Mod_Hakon_Falle_03_04"); //Was, wo?
...
FUNC VOID Info_Mod_Hakon_Blutkelch_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Hakon_Blutkelch_03_01"); //Da kann ich dir auch nicht helfen. Ich handle mit Waffen.
...
{
	AI_Output(self, hero, "Info_Mod_Hakon_Mario_03_00"); //Oh Mann, bin ich gerade sauer. Irgendein Idiot hat mich angezeigt, dass ich gestohlene Ware verkaufen würde.
	AI_Output(hero, self, "Info_Mod_Hakon_Mario_15_01"); //Solche Störenfriede gibt es immer wieder.
	AI_Output(self, hero, "Info_Mod_Hakon_Mario_03_02"); //Das Problem ist, dass ich tatsächlich nicht ganz ... legale Waffen dabei hatte.
	AI_Output(self, hero, "Info_Mod_Hakon_Mario_03_03"); //Aber ich hatte sie nicht einmal ausgelegt. Einer meiner Mittelsmänner muss geplaudert haben. So ein Schwein!
	AI_Output(self, hero, "Info_Mod_Hakon_Mario_03_04"); //Jetzt durfte ich erst mal ordentlich Strafgeld blechen.
};
...
FUNC VOID Info_Mod_Hakon_Anschlagtafel_Info()
{
	...
	&& (Npc_HasItems(hero, ItMw_1H_quantarie_Schwert_01) >= Mod_Anschlagtafel_Khorinis_Hakon_Schwert)
	{
		...
		AI_Output(self, hero, "Info_Mod_Hakon_Anschlagtafel_03_00"); //Was? Zeig her ... Tatsächlich, alles dabei. Ausgesprochen gut gemacht.
		AI_Output(self, hero, "Info_Mod_Hakon_Anschlagtafel_03_01"); //Hier ist deine Entlohnung.

		B_GiveInvItems	(self, hero, ItMi_Gold, Mod_Anschlagtafel_Khorinis_Hakon_Gold);

		AI_Output(self, hero, "Info_Mod_Hakon_Anschlagtafel_03_02"); //Hat mich gefreut mit dir Geschäfte zu machen.
