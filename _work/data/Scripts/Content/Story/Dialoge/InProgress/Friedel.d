...
FUNC VOID Info_Mod_Friedel_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Hi_03_00"); //Ich bin Friedel und unterrichte die jungen Männer im Kampf.

	if (Mod_Schwierigkeit != 4)
	{
		AI_Output(hero, self, "Info_Mod_Friedel_Hi_15_01"); //Kannst du auch mir etwas beibringen?
		AI_Output(self, hero, "Info_Mod_Friedel_Hi_03_02"); //Solange du unerfahren bist, werde ich dir sicher den einen oder anderen Kniff zeigen können.
...
FUNC VOID Info_Mod_Friedel_Wettstreit_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_03_01"); //Schön! Damit hätten wir einen dritten Teilnehmer.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_03_02"); //Die anderen beiden werden meine Lehrlinge sein, die bei der Rattenjagd ihre Abschlussprüfung ablegen.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_03_03"); //Können wir dann starten?
	AI_Output(hero, self, "Info_Mod_Friedel_Wettstreit_15_04"); //Ich würde gern die Regeln kennen.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_03_05"); //Das lässt sich einrichten!
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_03_06"); //Hier am Seeufer wimmelt es immer von Ratten.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_03_07"); //Die Teilnehmer starten gleichzeitig und müssen alle Ratten um den See herum töten.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_03_08"); //Wer dabei am erfolgreichsten ist, gewinnt und erhält einen Geldpreis.
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_03_09"); //Wenn du bereit bist, können wir beginnen.
...
FUNC VOID Info_Mod_Friedel_Wettstreit_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit_A_03_01"); //Dann verlier keine Zeit!
...
FUNC VOID Info_Mod_Friedel_Wettstreit2_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit2_03_00"); //Alle Achtung, gegen dich hätte sogar ich es schwer gehabt.
		AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit2_03_01"); //Dafür sollst du belohnt werden.
	...
	{
		AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit2_03_02"); //Heute hat es nicht gereicht.

		if (Mod_REL_Wettstreit_Verloren == 0)
		{
			AI_Output(self, hero, "Info_Mod_Friedel_Wettstreit2_03_03"); //Aber da wir dieses Jahr so viele Ratten haben, können wir morgen noch einen Wettstreit veranstalten. Vielleicht bist du dann erfolgreicher.
...
{
	AI_Output(self, hero, "Info_Mod_Friedel_Buerger_03_00"); //Ein neuer in unseren Reihen. Hier hast du das Startkapital.
	...
	if (Mod_Verhandlungsgeschick > 0)
	{
		...
		{
			AI_Output(self, hero, "Info_Mod_Friedel_Buerger_03_02"); //Da hast du schon Recht. Aber das hier muss reichen!
		...
		{
			AI_Output(self, hero, "Info_Mod_Friedel_Buerger_03_03"); //Das soll auch nicht für den Rest deines Lebens reichen! Geh arbeiten!
		};
	};
};
...
FUNC VOID Info_Mod_Friedel_Unruhen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Unruhen_03_01"); //Na schön, auch wenn es so nicht richtig ist.
...
FUNC VOID Info_Mod_Friedel_Freudenspender_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Freudenspender_03_01"); //Sag mal, willst du mich verarschen? Nein, will ich nicht!
};
...
FUNC VOID Info_Mod_Friedel_Lernen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Friedel_Lernen_03_01"); //Was willst du lernen?
