...
{
	AI_Output(self, hero, "Info_Mod_Dexter_Hi_28_00"); //Was hast du hier verloren?
	...
	|| (Mod_AnzahlNebengilden >= MaxNebengilden)
	{
		...
		AI_Output(self, hero, "Info_Mod_Dexter_Hi_28_05"); //Ein echter Bandit kannst du nun nicht mehr werden. Die Gefahr, dass du Informationen von uns weitergibst ist mir zu groß.
		AI_Output(self, hero, "Info_Mod_Dexter_Hi_28_06"); //Es steht dir aber frei unser Lager zu betreten und mit den Jungs zu handeln.
...
FUNC VOID Info_Mod_Dexter_Aufnahme_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_Aufnahme_28_01"); //Hier ist deine Rüstung. Du kannst dich jetzt im Lager nützlich machen.
...
FUNC VOID Info_Mod_Dexter_WhatToDo_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_WhatToDo_28_01"); //Die sind sehr vielfältig und abwechslungsreich.
	AI_Output(self, hero, "Info_Mod_Dexter_WhatToDo_28_02"); //Natürlich planen und führen wir in erster Linie Überfälle aus und schauen sonst, wo es etwas zu holen gibt mit etwas Geschick.
	AI_Output(self, hero, "Info_Mod_Dexter_WhatToDo_28_03"); //Erst vor wenigen Tagen haben wir einem kleinen Trupp feindlicher Orks aufgelauert, die auf dem Weg in die Orkstadt im Südwesten waren.
	AI_Output(self, hero, "Info_Mod_Dexter_WhatToDo_28_04"); //Dabei fiel uns ein recht wertvolles Artefakt in die Hände. Aber darauf gehe ich ein andermal näher ein.
	AI_Output(self, hero, "Info_Mod_Dexter_WhatToDo_28_05"); //Jedenfalls würde uns ohne Abnehmer und Hehler, an welche wir unsere erbeuteten Güter weiterverkaufen könnten, eine zentrale Einnahmequelle fehlen.
	AI_Output(self, hero, "Info_Mod_Dexter_WhatToDo_28_06"); //Wir haben Kontakte und Abnehmer in ganz Khorinis. Wir fungieren daher auch als Händler, Boten, und nehmen hin und wieder sogar Aufträge an, die anderen zu heiß sind.
	AI_Output(self, hero, "Info_Mod_Dexter_WhatToDo_28_07"); //Wenn du dich erst mal im Lager bewährt hast, wird für dich auch manch guter Fisch abfallen. Das Leben als Bandit wird dir gefallen.
};
...
FUNC VOID Info_Mod_Dexter_Job_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_Job_28_01"); //Vorerst nicht. Komm vielleicht in paar Tagen wieder.
...
FUNC VOID Info_Mod_Dexter_TimeOver_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_00"); //Du hast unserem Lager schon gute Dienste erwiesen und dich als geschickter und würdiger Bandit gezeigt.
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_01"); //Daher habe ich eine äußerst wichtige Aufgabe für dich.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_02"); //Bislang hast du noch nichts wirklich Großes für unser Lager geleistet.
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_03"); //Da du aber das alte Lager von früher gut kennst und keiner von deiner Zugehörigkeit zu uns weiß, kannst du endlich mal etwas Wichtiges für uns tun.
	};

	AI_Output(hero, self, "Info_Mod_Dexter_TimeOver_15_04"); //Worum geht es?
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_05"); //Ich hatte dir ja bereits vor einigen Tagen in unserem Gespräch davon erzählt, dass wir ein bedeutendes Artefakt von den Orks erbeutet hatten.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_06"); //Nun, bei diesem Gegenstand handelte es sich um ein magisches Amulett.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_07"); //Aus einem Buch über verschollene Schätze aus den alten Tagen erfuhren wir, dass dieses Schmuckstück einer Reihe mächtiger Gegenstände angehörte, die einst auf göttliche Weisung in den Schmelzöfen Nordmars geschaffen worden sein sollen, lange vor der Gründung der Clans.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_08"); //Wir traten darüber in Verhandlung mit den Verwandlungsmagiern, die großes Interesse an dem Amulett zeigten.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_09"); //Sie gaben uns sogar vor Ort bereits einige wertvolle Spruchrollen, um den Handel zu besiegeln.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_10"); //Nun sollte Quentin gestern das Amulett zu ihnen bringen, nachdem Oschust ihm noch frischen Glanz verliehen hatte. Er ist eigentlich ein fähiger Mann und einer unser besten Kämpfer.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_11"); //Unterwegs machte er aber noch halt im Alten Lager, um bei einigen Arenakämpfen zuzusehen. Dabei Trank er den einen oder anderen Schluck und geriet mit einem fremden Kämpfer in Streit.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_12"); //Na ja, um auf den Punkt zu kommen, sie überboten sich mit ihren Wetteinsätzen, den anderen auf den Arenaboden schicken zu können und dieser Idiot Quentin bot zuletzt das Amulett an.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_13"); //Der Kampf dauerte nicht lange, Quentin sank nach wenigen Hieben seines Gegners in den Staub und war das Amulett los.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_14"); //Das ist ein schwerer Schlag für unser gesamtes Lager, denn einige der Spruchrollen, die uns die Magier gaben, haben wir bei einer Aufklärungsmission verbraucht.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_15"); //So lässt sich das Geschäft nicht einfach rückgängig machen und der Ruf unserer Zuverlässigkeit steht auf dem Spiel.

	if (Kapitel >= 4)
	{
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_16"); //Und dass das alte Lager nun in den Händen der Orks ist, macht es eben auch nicht gerade einfacher.
	};

	AI_Output(hero, self, "Info_Mod_Dexter_TimeOver_15_17"); //Und ich soll das Amulett wiederbeschaffen?
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_18"); //Genau, du verstehst schon, worum es geht.
	...
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_20"); //Wir haben in Erfahrung gebracht, dass der Kämpfer den Namen Sabitsch trägt und ein alter Bekannter von Thorus ist, aus den Tagen vor der Kolonie.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_21"); //Er war viel unterwegs und soll schon in zahlreichen Arenen der bekannten Welt Siege errungen haben.
	AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_22"); //Nachdem er von dem Fall der Barriere erfuhr und von der Herrschaft seines alten Freundes Thorus über das Lager, kam er wohl als Glücksritter hierher, um sich einen Teil der Schätze dieses Tales zu holen.

	if (Kapitel < 4)
	{
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_23"); //Es ist also viel Fingerspitzenfertigkeit gefordert bei deiner Aufgabe, da er nicht nur ein berüchtigter Kämpfer, sondern auch ein guter Bekannter von Thorus ist und wir wollen es uns nicht mit dem Alten Lager verscherzen.
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_24"); //Versuch am besten so viel über ihn zu erfahren, wie möglich, sprich mit den Leuten, die oft mit ihm zu tun haben – natürlich nicht gerade mit Thorus.
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_25"); //Und dann tue alles, um wieder in den Besitz des Amulettes zu kommen ... vorallem hinterlasse möglichst wenig spuren, wenn es auf eine Art geschehen müsste, die zu Konflikten führen könnte mit dem Alten Lager.
	...
	{
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_26"); //Tja, ist wohl nicht so gut gelaufen für ihn, wie er gehofft hat.
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_27"); //Obwohl er ein exzellenter Kämpfer war, dürfte er wohl kaum eine Chance gegen die 200 Orks gehabt haben, die dort jetzt rumsitzen.
		AI_Output(hero, self, "Info_Mod_Dexter_TimeOver_15_28"); //Acha, und was soll ich da jetzt ausrichten?
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_29"); //Reingehen, die Arena finden, die Leiche durchwühlen, das Amulett bergen und zu uns bringen.
		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_30"); //Jedoch vielleicht lieber in einer weniger auffälligen Gestalt.

		B_Say	(hero, self, "$WASMEINSTDU");

		AI_Output(self, hero, "Info_Mod_Dexter_TimeOver_28_31"); //Sprich mit Quentin. Er hat etwas für dich.
...
FUNC VOID Info_Mod_Dexter_AmulettBack_Info()
{
	...
	if (Kapitel < 4)
	{
		...
		{
			AI_Output(self, hero, "Info_Mod_Dexter_AmulettBack_28_01"); //Sehr gut. Damit hast du unserem Lager einen großen Dienst erwiesen.
			AI_Output(self, hero, "Info_Mod_Dexter_AmulettBack_28_02"); //Nimm das als Belohnung.
		...
		{
			AI_Output(self, hero, "Info_Mod_Dexter_AmulettBack_28_03"); //Nun, du wurdest zwar bei dem Diebstahl erwischt, aber das regelt sich schon irgendwann von selbst und Hauptsache, wir haben das Amulett.
			AI_Output(self, hero, "Info_Mod_Dexter_AmulettBack_28_04"); //Du hast dir eine Belohnung verdient.
	...
	{
		AI_Output(self, hero, "Info_Mod_Dexter_AmulettBack_28_05"); //Erstaunlich! Dir ist es wirklich gelungen. Damit hast du unserem Lager einen großen Dienst erwiesen. Nimm das als Belohnung.
	...
	AI_Output(self, hero, "Info_Mod_Dexter_AmulettBack_28_06"); //Jedenfalls werde ich Quentin eine zweite Chance geben. Er wird das Amulett zu den Magiern bringen und den Handel abschließen.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_28_00"); //Verdammter Mist.
	AI_Output(hero, self, "Info_Mod_Dexter_QuentinsBack_15_01"); //Was ist geschehen.
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_28_02"); //Als Quentin das Amulett dem Magier Albert übergab, begutachtete dieser das Stück einige Minuten.
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_28_03"); //Dann warf er des Quentin plötzlich vor die Füße, war außer sich, sprach von Täuschung und Betrug.
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_28_04"); //Er könne zwar noch den Rest magischer Aura des echten Amulettes spüren, das sei aber eindeutig eine Fälschung.
	AI_Output(hero, self, "Info_Mod_Dexter_QuentinsBack_15_05"); //Wie ist das möglich?
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_28_06"); //Nun, völlig dämlich bin ich auch nicht. Ich bin alles noch mal durchgegangen und zu dem einzigen Schluss gekommen, dass dieser dreckige Oschust dahinter stecken muss.
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_28_07"); //Als wir ihm das Amulett zum Aufpolieren gaben, muss er noch in selber Nacht eine exakte Kopie erstellt haben, welche er uns dann am nächsten Tag übergab.
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_28_08"); //Das Original muss er irgendwo versteckt haben. Ich kann jetzt aber nicht einfach zu ihm gehen und ihn in stücke hauen. Wir brauchen ihn noch.
	AI_Output(hero, self, "Info_Mod_Dexter_QuentinsBack_15_09"); //Was bleibt zu tun?
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_28_10"); //Das überlasse ich dir. Kümmere du dich um Oschust. Bringe ihn mit etwas "Diplomatie" dazu, dir Auskunft über den Standort des Amulettes zu geben.
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_28_11"); //Aber er soll danach noch weiterhin dazu in der Lage sein, seinem Fälscherhandwerk nachzugehen. Du verstehst?
	AI_Output(self, hero, "Info_Mod_Dexter_QuentinsBack_28_12"); //Gut. Erstatte mir danach wieder Bericht.
...
FUNC VOID Info_Mod_Dexter_FakeAmulett_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_FakeAmulett_28_01"); //Ich trage es bei mir. Hier, du kannst es haben, da du es auch dem Alten Lager entrissen hast.

	B_GiveInvItems	(self, hero, ItAm_MegaAmulett, 1);

	AI_Output(self, hero, "Info_Mod_Dexter_FakeAmulett_28_02"); //Für uns hat es keinen Wert mehr.
};
...
FUNC VOID Info_Mod_Dexter_OschustAmulett_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_28_01"); //Sehr gut. Wie kooperativ war Oschust?
	...
	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_28_03"); //Ja?
	AI_Output(hero, self, "Info_Mod_Dexter_OschustAmulett_15_04"); //In der Höhle wimmelt es jetzt von Orks und Warg.
	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_28_05"); //Was, schon wieder die Orks?! So nah am Lager ... das ist nicht gut.
	AI_Output(hero, self, "Info_Mod_Dexter_OschustAmulett_15_06"); //Und was unternehmen wir wegen des Amulettes?
	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_28_07"); //(nachdenklich) Für einen frontalen Angriff haben wir nicht genügend Schlagkraft ... und ein nächtlicher Überfall würde an den wachsamen Orkhunden scheitern.
	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_28_08"); //Außerdem brauche ich meine Männer hier zum Schutz des Lagers, so häufig, wie sich zurzeit hier Orks herumtreiben ...
	AI_Output(hero, self, "Info_Mod_Dexter_OschustAmulett_15_09"); //Heißt das, ich wäre mal wieder auf mich allein gestellt?
	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_28_10"); //(nachdenlich) Nun… nicht zwangsläufig. Du könntest zum einen versuchen einige Orkjäger im Neuen Lager anzuheuern.
	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_28_11"); //Wird aber nicht billig. Hier hast du etwas Gold.

	B_GiveInvItems	(self, hero, ItMi_Gold, 500);

	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_28_12"); //Vielleicht gelingt es dir aber auch einen Bekloppten zu finden, der Lockvogel spielt und die Orks aus der Höhle herauslockt.
	AI_Output(self, hero, "Info_Mod_Dexter_OschustAmulett_28_13"); //Naja, ich bin mir sicher du findest einen Weg. Viel Glück!
...
FUNC VOID Info_Mod_Dexter_OschustTot_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_OschustTot_28_01"); //(außer sich) Was ...?! Das hast du ja toll hinbekommen. Nun ... da du so schlau warst: viel Spaß beim Suchen!
...
FUNC VOID Info_Mod_Dexter_Amulett2Gefunden_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_Amulett2Gefunden_28_01"); //Ausgezeichnet. Gehe nun auf direktem Wege zu dem Verwandlungsmagier Albert und übergib es ihm.
...
FUNC VOID Info_Mod_Dexter_AmulettAbgegeben_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_AmulettAbgegeben_28_01"); //Sehr gut. Hat er dir den Rest des vereinbarten Preises gegeben?
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_AmulettAbgegeben_C_28_00"); //Wie dem auch sei, nachdem ganzen Ärger die letzten Tage muss erst mal ein Ausgleich her. Hier, trink einen Schluck.

	CreateInvItems	(hero, ItFo_Addon_Grog, 1);

	B_UseItem	(hero, ItFo_Addon_Grog);

	AI_Output(self, hero, "Info_Mod_Dexter_AmulettAbgegeben_C_28_01"); //Echter guter Seemannsgrog, den unsere Jungs mal einem Händler auf Khorinis abgenommen haben.
	AI_Output(self, hero, "Info_Mod_Dexter_AmulettAbgegeben_C_28_02"); //Dazu gibt’s noch exquisiten Schinken und knusprig gebratenes Fleisch. Heute Nacht wird durchgezecht ohne Pardon. (lacht)
...
FUNC VOID Info_Mod_Dexter_AmulettAbgegeben_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_AmulettAbgegeben_B_28_01"); //Verdammt, das hatte ich fast befürchtet. Naja, trotzdem danke für deine Bemühungen.
...
FUNC VOID Info_Mod_Dexter_AmulettAbgegeben_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_AmulettAbgegeben_A_28_01"); //Ausgezeichnet. Zur Belohnung für deine Dienste um das Lager darfst du die Keilerspruchrolle und 200 Gold behalten.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_BanditenKidnapped_28_00"); //Was ist geschehen, wo sind die anderen Banditen?
	...
	{
		AI_Output(self, hero, "Info_Mod_Dexter_BanditenKidnapped_28_02"); //Was wie ist das möglich? Ich dachte er sei tot ...
	...
	AI_Output(self, hero, "Info_Mod_Dexter_BanditenKidnapped_28_05"); //Verdammt, das ist eine Katastrophe. Ich muss nachdenken ... Also, es gibt keine Zeit zu verlieren, da unser stark geschwächtes Lager jeder Zeit angegriffen werden kann.
	AI_Output(self, hero, "Info_Mod_Dexter_BanditenKidnapped_28_06"); //Begib dich schnell zur alten Bergfestung. Dort findest du Orks, mit welchen wir in Handlesbeziehungen stehen.
	AI_Output(self, hero, "Info_Mod_Dexter_BanditenKidnapped_28_07"); //Wende dich an Ur Shak. Vielleicht können wir mehr von ihm erfahren.
	...
	|| (Npc_KnowsInfo(hero, Info_Mod_Oschust_BadOne_Plan))
	{
		...
		AI_Output(self, hero, "Info_Mod_Dexter_BanditenKidnapped_28_10"); //Hmm, in diesem Fall kannst du dich auch sofort an die Verwandlungsmagier wenden. Sprich mit Albert, aber beeil dich.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_28_00"); //(außer Atem) Das war im allerletzten Augenblick, aber ihr habt es geschafft.
	...
	if (Mod_Survivors >= 6)
	{
		AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_28_01"); //Ausgezeichnet, wie ich sehe konntest du auch die meisten retten.
		...
		AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_28_03"); //Großartige Leistung. Hier hast du 500 Goldmünzen.

		B_GiveInvItems	(self, hero, ItMi_Gold, 500);

		AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_28_04"); //Das muss gefeiert werden. Aber nicht heute.
		AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_28_05"); //So ein Gefecht wie heute reibt sogar den stärksten Banditen auf.
	...
	{
		AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_28_06"); //Ohh, wie ich sehe haben es leider einige nicht geschafft.
		AI_Output(hero, self, "Info_Mod_Dexter_AngriffVorbei_15_07"); //Die Orks haben uns sehr zugesetzt und einige fanden den Tod.
		AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_28_08"); //Sehr bedauerlich, viele gute Männer. Aber im Kampf gegen Horden von Orks ist natürlich mit Verlusten zu rechnen.
	...
	{
		AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_28_09"); //Aber wo sind die anderen Banditen. Konntest du den gar keinen von ihnen retten?
		AI_Output(hero, self, "Info_Mod_Dexter_AngriffVorbei_15_10"); //Es waren einfach zu viele Orks, die uns angriffen.
		AI_Output(self, hero, "Info_Mod_Dexter_AngriffVorbei_28_11"); //Das ist eine Katastrophe! Verfluchte Orks! Wie soll es jetzt nur weiter mit unserem Lager gehen ...
...
{
	AI_Output(self, hero, "B_Dexter_SayNewArmor_28_00"); //Diese alte Banditenrüstung mag äußerlich sicherlich nicht den besten Eindruck machen, ist aber wie geschaffen für längere Raubzüge auch in schwierigem Terrain ... und du bist ja viel unterwegs.
	AI_Output(self, hero, "B_Dexter_SayNewArmor_28_01"); //Sie ist aus widerstandsfähigem Material und dicht gewebt, sodass sie allen Einflüssen von Außen gleichermaßen standhält.
	AI_Output(self, hero, "B_Dexter_SayNewArmor_28_02"); //Viel Spaß damit!
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_PartyNachRettung_28_00"); //(leicht ironisch) Ahh, unser Erretter. Komm her und trink einen Schluck.

	if (Mod_Import_Dexter == LOG_SUCCESS)
	|| (Mod_Import_Dexter == -1)
	{
		AI_Output(self, hero, "Info_Mod_Dexter_PartyNachRettung_28_01"); //Ach übrigens: Es hat etwas gedauert, aber ich habe dich doch erkannt.
		AI_Output(hero, self, "Info_Mod_Dexter_PartyNachRettung_15_02"); //Dann weißt du, dass ich damals den Schl ...
		AI_Output(self, hero, "Info_Mod_Dexter_PartyNachRettung_28_03"); //Ja, wie du mir damals das Rezept für den Trank  vom verrückten Kalom besorgt hast. Ich habe hier etwas davon. Nimm einen Schluck ...
	...
	else
	{
		...
		AI_Output(self, hero, "Info_Mod_Dexter_PartyNachRettung_28_04"); //Ich habe da etwas Nettes für dich herausgestöbert.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_Wolkenwelt_28_00"); //Da bist du ja wieder. Während du im Land der Träume unterwegs warst, habe ich etwas Nettes für dich herausgestöbert.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_Alissandro_28_00"); //Was geht hier vor?
	AI_Output(hero, self, "Info_Mod_Dexter_Alissandro_15_01"); //Die Wache will mich nicht reinlassen ohne Passwort.
	AI_Output(self, hero, "Info_Mod_Dexter_Alissandro_28_02"); //Ich kenne dich, du kannst reinkommen. Lass uns ins Lager gehen, dort können wir besser reden.
...
FUNC VOID Info_Mod_Dexter_Botschaft_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_Botschaft_28_01"); //Gut, was ist mit dem eigentlichen Botschafter passiert?
	...
	AI_Output(self, hero, "Info_Mod_Dexter_Botschaft_28_03"); //Bartholos Leute wollten uns auch schon auf ihre Seite ziehen und waren vor wenigen Tagen hier.
...
FUNC VOID Info_Mod_Dexter_Plan_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Dexter_Plan_28_01"); //Unter Umständen, ist allerdings ziemlich riskant.
	AI_Output(hero, self, "Info_Mod_Dexter_Plan_15_02"); //Und wie lautet er?
	AI_Output(self, hero, "Info_Mod_Dexter_Plan_28_03"); //Gegen alle Gardisten zusammen haben wir keine Chance, wir müssen sie alle auf einen Streich töten.
	AI_Output(hero, self, "Info_Mod_Dexter_Plan_15_04"); //Und wie sollen wir das schaffen?
	AI_Output(self, hero, "Info_Mod_Dexter_Plan_28_05"); //Mach einfach das, was ich sage. Als erstes lockst du einen Gardisten zu mir. Ich belege ihn mit einer "Schlaf" Spruchrolle.
	AI_Output(hero, self, "Info_Mod_Dexter_Plan_15_06"); //Wie soll ich ihn anlocken?
	AI_Output(self, hero, "Info_Mod_Dexter_Plan_28_07"); //Alle Gardisten bewachen den Eingang, deshalb ist es schwer, einen wegzulocken. Allerdings ist einer etwas innerhalb des Lagers und sieht nach dem Rechten. Greif ihn an und locke ihn zu mir.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_Gardist_28_00"); //So, nun müssen wir warten, bis seine Kollegen nachschauen, was mit ihm passiert ist. In der Zeit brauchen wir eine "Feuerregen" Spruchrolle. Ich habe für Notfälle eine in meiner Truhe.
	AI_Output(self, hero, "Info_Mod_Dexter_Gardist_28_01"); //Meine Truhe steht in der Höhle. Ich bleibe in der Zeit hier und warte auf die Gardisten. Wenn ich das Signal gebe, zündest du die Spruchrolle.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_Jetzt_28_00"); //Jetzt, ich versteck mich solange in der Höhle.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_Feuerregen_28_00"); //Wir haben gewonnen! Wir werden uns Alissandro anschliessen. Gehe zu ihm und berichte ihm das.
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_Eroberung_05_28_00"); //Dann dringen wir ...
...
{
	AI_Output(self, hero, "Info_Mod_Dexter_Eroberung_07_28_00"); //... und treten Bartholo und seinen Leuten in den Arsch.
};
...
{
	AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_28_00"); //Bist du gekommen, um deine Strafe zu zahlen?

	if (B_GetTotalPetzCounter(self) > Dexter_LastPetzCounter)
	{
		AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_28_01"); //Ich hatte mich schon gefragt, ob du es überhaupt noch wagst, hierher zu kommen!
		AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_28_02"); //Anscheinend ist es nicht bei den letzten Anschuldigungen geblieben!

		if (Dexter_Schulden < 1000)
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_28_03"); //Ich hatte dich gewarnt! Die Strafe, die du jetzt zahlen musst, ist höher!
		...
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_28_04"); //Du hast mich schwer enttäuscht!
		};
	}
	else if (B_GetGreatestPetzCrime(self) < Dexter_LastPetzCrime)
	{
		AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_28_05"); //Es haben sich einige neue Dinge ergeben.
		
		if (Dexter_LastPetzCrime == CRIME_MURDER)
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_28_06"); //Plötzlich gibt es niemanden mehr, der dich des Mordes bezichtigt.
		};
		
		if (Dexter_LastPetzCrime == CRIME_THEFT)
		|| ( (Dexter_LastPetzCrime > CRIME_THEFT) && (B_GetGreatestPetzCrime(self) < CRIME_THEFT) )
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_28_07"); //Niemand erinnert sich mehr, dich bei einem Diebstahl gesehen zu haben.
		};
		
		if (Dexter_LastPetzCrime == CRIME_ATTACK)
		|| ( (Dexter_LastPetzCrime > CRIME_ATTACK) && (B_GetGreatestPetzCrime(self) < CRIME_ATTACK) )
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_28_08"); //Es gibt keine Zeugen mehr dafür, dass du jemals in eine Schlägerei verwickelt warst.
		};
		
		if (B_GetGreatestPetzCrime(self) == CRIME_NONE)
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_28_09"); //Anscheinend haben sich alle Anklagen gegen dich in Wohlgefallen aufgelöst.
		};
		
		AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_28_10"); //Ich weiß nicht, was da gelaufen ist, aber ich warne dich: Spiel keine Spielchen mit mir.
				
		// ------- Schulden erlassen oder trotzdem zahlen ------
		if (B_GetGreatestPetzCrime(self) == CRIME_NONE)
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_28_11"); //Ich habe mich jedenfalls entschieden, dir deine Schulden zu erlassen.
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_28_12"); //Sieh zu, dass du nicht wieder in Schwierigkeiten kommst.
		...
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_28_13"); //Damit eins klar ist: Deine Strafe musst du trotzdem in voller Höhe zahlen.
			B_Say_Gold (self, hero, Dexter_Schulden);
			AI_Output (self, hero, "Info_Mod_Dexter_PMSchulden_28_14"); //Also, was ist?
		};
	};
...
FUNC VOID Info_Mod_Dexter_PETZMASTER_Info()
{
	...
	{
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_01"); //Gut, dass du zu mir kommst, bevor alles noch schlimmer für dich wird.
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_02"); //Mord ist ein schweres Vergehen!
		...
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_03"); //Ganz zu schweigen von den anderen Sachen, die du angerichtet hast.
		};

		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_06"); //Ich habe kein Interesse daran, dich an den Galgen zu bringen.
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_07"); //Aber es wird nicht leicht sein, die Leute wieder gnädig zu stimmen.
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_08"); //Du könntest deine Reue zeigen, indem du eine Strafe zahlst - natürlich muss die Strafe angemessen hoch sein.
	};
		
	if (B_GetGreatestPetzCrime(self) == CRIME_THEFT) 
	{
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_09"); //Gut, dass du kommst! Du wirst des Diebstahls bezichtigt! Es gibt Zeugen!

		if ((PETZCOUNTER_City_Attack + PETZCOUNTER_City_Sheepkiller) > 0)
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_10"); //Von den anderen Dingen, die mir zu Ohren gekommen sind, will ich gar nicht erst reden.
		};

		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_11"); //Ich werde so ein Verhalten hier nicht dulden!
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_12"); //Du wirst eine Strafe zahlen müssen, um dein Verbrechen wieder gutzumachen!
	...
	{
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_13"); //Wenn du dich mit der Miliz oder sonstwem herumprügelst, ist das eine Sache ...
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_14"); //Aber wenn du unsere Leute angreifst, muss ich dich zur Rechenschaft ziehen.

		if (PETZCOUNTER_City_Sheepkiller > 0)
		{
			AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_15"); //Und die Sache mit den Schafen musste wohl auch nicht sein.
		};

		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_16"); //Wenn ich dir das durchgehen lasse, macht hier bald jeder, was er will.
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_17"); //Also wirst du eine angemessene Strafe zahlen - und die Sache ist vergessen.
	...
	{
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_18"); //Mir ist zu Ohren gekommen, du hättest dich an unseren Schafen vergriffen.
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_19"); //Dir ist klar, dass ich das nicht durchgehen lassen kann.
		AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_28_20"); //Du wirst eine Entschädigung zahlen müssen!
...
func void Info_Mod_Dexter_PETZMASTER_PayNow()
{
	...
	AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_PayNow_28_01"); //Gut! Ich werde dafür sorgen, dass es jeder von uns erfährt - damit wäre dein Ruf einigermaßen wiederhergestellt.
...
func void Info_Mod_Dexter_PETZMASTER_PayLater()
{
	...
	AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_PayLater_28_01"); //Dann sieh zu, dass du das Gold so schnell wie möglich beschaffst.
	AI_Output (self, hero, "Info_Mod_Dexter_PETZMASTER_PayLater_28_02"); //Und ich warne dich: Wenn du dir noch was zu schulden kommen lässt, wird die Sache noch schlimmer für dich!
