...
FUNC VOID Info_Mod_Setta_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Setta_Hi_19_01"); //Mein Name ist Setta. Ich wohne hier seit ein paar Jahren, wohne ich.
	AI_Output(hero, self, "Info_Mod_Setta_Hi_15_02"); //Wie bist du hier hergekommen?
	AI_Output(self, hero, "Info_Mod_Setta_Hi_19_03"); //Ich weiß es nicht mehr genau. Wo kommst du denn her, kommst du?
...
FUNC VOID Info_Mod_Setta_Hi_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Setta_Hi_B_19_01"); //Das habe ich tatsächlich, habe ich. Wenn ich mich recht entsinne, komme ich auch da her, komme ich. Ist denn die ... Barriere noch da?
	AI_Output(hero, self, "Info_Mod_Setta_Hi_B_15_02"); //Nein, sie ist weg. Und daran war ich nicht ganz unbeteiligt.
	AI_Output(self, hero, "Info_Mod_Setta_Hi_B_19_03"); //(staunt) Wow, ein richtiger Held. In meiner bescheidenen Hütte. Was kann ich für dich tun, kann ich?
	AI_Output(hero, self, "Info_Mod_Setta_Hi_B_15_04"); //Wie komme ich wieder weg von hier?
	AI_Output(self, hero, "Info_Mod_Setta_Hi_B_19_05"); //Das kann ich dir nicht sagen, kann ich nicht, ich weiß es nämlich selbst nicht. Sonst wäre ich wohl nicht mehr hier.
	AI_Output(hero, self, "Info_Mod_Setta_Hi_B_15_06"); //Hast du gar keine Idee?
	AI_Output(self, hero, "Info_Mod_Setta_Hi_B_19_07"); //Hm, jetzt wo du es sagst. Frag doch mal den alten Buff. Er lebt in einem Zelt den Weg runter, lebt er.
	AI_Output(hero, self, "Info_Mod_Setta_Hi_B_15_08"); //Danke für die Information.
	AI_Output(self, hero, "Info_Mod_Setta_Hi_B_19_09"); //Keine Ursache, hihi.
...
FUNC VOID Info_Mod_Setta_Hi_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Setta_Hi_A_19_01"); //Oh, wie ein Vogel? Ich liebe Vögel, liebe ich. Aber verarschen kann ich mich alleine, kann ich. Ich bin nicht so tatterig, wie ich aussehe.
