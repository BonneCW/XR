...
FUNC VOID Info_Mod_Orun_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Orun_Hi_03_01"); //Ich bin Baal Orun und kümmere mich um die Herstellung der Sumpfkrautstängel aus Sumpfkraut.
};
...
FUNC VOID Info_Mod_Orun_Cyrco_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Orun_Cyrco_03_01"); //Hä?
	...
	AI_Output(self, hero, "Info_Mod_Orun_Cyrco_03_08"); //Hmm ... Magie ... starke Magie ... schwarze Magie ... böse Magie ...
	AI_Output(hero, self, "Info_Mod_Orun_Cyrco_15_09"); //Und? Was ist?
	AI_Output(self, hero, "Info_Mod_Orun_Cyrco_03_10"); //RUHE!
	AI_Output(self, hero, "Info_Mod_Orun_Cyrco_03_11"); //Hm ... Ich sehe was ... Ein Zettel ... eine Höhle ... sehr starke Magie ... Fremder?
	...
	AI_Output(self, hero, "Info_Mod_Orun_Cyrco_03_15"); //Ach so. Höre: Ich hatte eine Vision. Ich sah diesen Zettel nahe einer Höhle, umgeben von starker schwarzer Magie. Da würde ich nicht allein hingehen.
...
FUNC VOID Info_Mod_Orun_Woher_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Orun_Woher_03_02"); //Doch nachdem ich einen Bürger bei einem Einsatz versehentlich verletzt hatte, wurde ich in die Kolonie geworfen.
