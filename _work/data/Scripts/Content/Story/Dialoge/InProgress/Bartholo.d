...
{
	AI_Output(self, hero, "Info_Mod_Bartholo_Hi_03_00"); //Dich kenne ich doch! Wie war noch mal dein Name?
	AI_Output(hero, self, "Info_Mod_Bartholo_Hi_15_01"); //Ähm... Na ja ...
	AI_Output(self, hero, "Info_Mod_Bartholo_Hi_03_02"); //Was gibt's da herumzudrucksen?
	AI_Output(hero, self, "Info_Mod_Bartholo_Hi_15_03"); //Früher nannte man mich häufig, äh, Rü...
	AI_Output(self, hero, "Info_Mod_Bartholo_Hi_03_04"); //Wie dem auch sei. Was hast du hier verloren?
...
{
	AI_Output(self, hero, "Info_Mod_Bartholo_Laber_03_00"); //Verschwinde!
...
{
	AI_Output(self, hero, "Info_Mod_Bartholo_Verrat_03_00"); //Du hättest schon lange sterben müssen und jetzt, wo du uns gefährlich wirst, hast du dein Recht auf Leben verwirkt.
...
FUNC VOID Info_Mod_Bartholo_KillBuddler_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bartholo_KillBuddler_03_00"); //Du dreckiger Bastard meinst wohl, du könntest dich unbemerkt mit Alissandro in Verbindung setzen?
	AI_Output(self, hero, "Info_Mod_Bartholo_KillBuddler_03_01"); //Doch ich merke alles, und deshalb bekommst du auch deine Strafe.
...
{
	AI_Output(self, hero, "Info_Mod_Bartholo_Sumpfkraut_03_00"); //Ihr bringt mir sicher das Sumpfkraut.

	Snd_Play	("THRILLJINGLE_03.WAV");

	AI_TurnToNpc	(self, Mod_1874_HMG_Makanius_MT);

	AI_Output(self, hero, "Info_Mod_Bartholo_Sumpfkraut_03_01"); //Verdammt, was ist jetzt passiert?
...
FUNC VOID Info_Mod_Bartholo_Eroberung_Info()
{
	...
	AI_Output(self, Mod_1156_GRD_Gardist_MT, "Info_Mod_Bartholo_Eroberung_03_00"); //Was? Verdammt, wie konnte das passieren?
...
FUNC VOID Info_Mod_Bartholo_Anschluss_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bartholo_Anschluss_03_01"); //Aha! Der verloren geglaubte Sohn kehrt zurück, oder wie?
	AI_Output(self, hero, "Info_Mod_Bartholo_Anschluss_03_02"); //Schön, sprich mit Thorus. Er wird sich zwar nicht freuen, dich zu sehen, aber er hat gerade größere Probleme.
	AI_Output(self, hero, "Info_Mod_Bartholo_Anschluss_03_03"); //Deswegen musst du dir wohl keine Sorgen um dein Leben machen.
	AI_Output(hero, self, "Info_Mod_Bartholo_Anschluss_15_04"); //Das klingt ja vielversprechend ...
	AI_Output(self, hero, "Info_Mod_Bartholo_Anschluss_03_05"); //Das ist mehr, als du erwarten kannst. Dass du dich den Wassermagiern anvertraut hast, hat dir hier keine Sympathiepunkte eingebracht.
	AI_Output(self, hero, "Info_Mod_Bartholo_Anschluss_03_06"); //Denk übrigens dran, deine Waffe stecken zu lassen, wenn du zu Thorus gehst. Solltest du den Fehler begehen und sie zücken, werden wir dir kurzen Prozess machen.
};
...
FUNC VOID Info_Mod_Bartholo_Thorus_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bartholo_Thorus_03_01"); //Wenn er auch mit dir sprechen will, sollte das kein Problem sein.
	AI_Output(self, hero, "Info_Mod_Bartholo_Thorus_03_02"); //Aber sei gewarnt: Wenn du in seiner Gegenwart deine Waffe ziehst, bist du schneller tot, als du dir in die Hose scheißen kannst.
};
...
FUNC VOID Info_Mod_Bartholo_WarumNochHier_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bartholo_WarumNochHier_03_01"); //Ich bin Thorus loyal gegenüber. Bald wird es mit dem Lager wieder bergauf gehen.
	AI_Output(self, hero, "Info_Mod_Bartholo_WarumNochHier_03_02"); //Außerdem will ich nicht so enden wie Stone dort draußen...
};
...
{
	AI_Output(self, hero, "Info_Mod_Bartholo_Ende_03_00"); //Ihr habt mich gefunden, jetzt ist es also zu spät. Aber ich werde nicht kampflos aufgeben.
