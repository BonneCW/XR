...
{
	AI_Output(self, hero, "Info_Mod_Cronos_Hi_03_00"); //Du wieder? Hätte nicht gedacht, dass ich dich noch mal wieder sehe.
	AI_Output(self, hero, "Info_Mod_Cronos_Hi_03_01"); //Wenn du was brauchst, komm zu mir. Ich kann dir ein paar Spruchrollen und Tränke verkaufen.
...
FUNC VOID Info_Mod_Cronos_Angriff_01_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Cronos_Angriff_01_03_01"); //Na dann ... Adanos stehe uns bei.
...
{
	AI_Output(self, hero, "Info_Mod_Cronos_Angriff_02_03_00"); //Bei Adanos! Wir haben es tatsächlich geschafft. Lass uns nun zurückgehen.
