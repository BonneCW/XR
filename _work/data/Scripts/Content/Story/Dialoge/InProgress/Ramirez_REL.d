...
{
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_InHaus_03_00"); //Das nenn ich doch mal ein gem�tliches Zuhause, oder?
	...
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_InHaus_03_03"); //Ich hoffe, dass Attila bald zur�ckkommt von seinem Erkundungsgang ... ahh, da h�r ich ihn schon die Treppe herunterkommen.
...
FUNC VOID Info_Mod_Ramirez_REL_Lagerhaus_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus_03_01"); //(zum Helden) Wie w�re es, wenn du dich dorthin begibst und versuchst einen prall gef�llten Sack aus dem Lager mitzunehmen.
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus_03_02"); //Pass aber auf, dass dich die Wachen nicht dabei erwischen.
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus_03_03"); //Vielleicht wirst du dich auch im Lager verstecken m�ssen, bis sie abends endlich weg sind.
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus_03_04"); //Dir f�llt schon was ein.
...
{
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus2_03_00"); //Was ist das? Ich rieche Schinken, K�se, Brot ...
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus2_03_01"); //Ahh, sehr sch�n, du warst im Lager, wie ich sehe.
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus2_03_02"); //Und ich hatte schon bef�rchtet, ich m�sste auf den Markt gehen um mir etwas zu kaufen.

	B_GiveInvItems	(hero, self, ItMi_Fresssack, 1);

	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Lagerhaus2_03_03"); //Lass sehen ... ja, das reicht mindestens f�r die n�chsten 4 Wochen. Gute Arbeit.
...
{
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Glorie2_03_00"); //(ver�rgert) Du kommst viel zu sp�t. Jetzt lohnt es sich gar nicht erst anzufangen.
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Glorie2_03_01"); //Wir m�ssen es auf morgen verschieben ... du Arsch.
...
FUNC VOID Info_Mod_Ramirez_REL_Glorie3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Glorie3_03_01"); //Sobald ich sein Interesse erregt habe, solltest du dir das Kleid schnappen k�nnen.
...
FUNC VOID Info_Mod_Ramirez_REL_Glorie4_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Ramirez_REL_Glorie4_03_00"); //Da bist du endlich. W�hrend du mit deinem Arsch im Bett lagst, haben wir die Wand durchbrochen und einen Tunnel freigelegt.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Ramirez_REL_Glorie4_03_01"); //Super, wir sind durch. Gute Arbeit Jungs. Scheinbar geht es da tats�chlich weiter.
	};
...
{
	AI_Output(self, hero, "Info_Mod_Ramirez_REL_Glorie5_03_00"); //In Ordnung ... die drei Pfund Gold in meinen Taschen reichen auch f�rs erste.
