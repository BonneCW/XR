...
{
	AI_Output(self, hero, "Info_Mod_Bosper_Hi_16_00"); //(unfreundlich) Hey! Was willst du hier?
};
...
FUNC VOID Info_Mod_Bosper_HandelstDu_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_HandelstDu_16_01"); //Ja, aber nicht mit dir. Du bist einer dieser Kolonietypen. Ich vertraue euch nicht.
};
...
FUNC VOID Info_Mod_Bosper_WiesoMisstrauen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_WiesoMisstrauen_16_01"); //Na, du wirst doch nicht ganz grundlos in die Barriere geworfen worden sein.
	AI_Output(self, hero, "Info_Mod_Bosper_WiesoMisstrauen_16_02"); //Mein Geschäft läuft gut genug, dass ich mich nicht mit Gesindel abgeben muss.
};
...
FUNC VOID Info_Mod_Bosper_Lehrling_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_Lehrling_16_01"); //Das kann ich mir vorstellen. Aber ich kann mir nicht vorstellen, dass du dazu würdig bist.
	AI_Output(self, hero, "Info_Mod_Bosper_Lehrling_16_02"); //Dazu müsste ich dir vertrauen.
	AI_Output(hero, self, "Info_Mod_Bosper_Lehrling_15_03"); //Was kann ich tun, damit du mir vertraust?
	AI_Output(self, hero, "Info_Mod_Bosper_Lehrling_16_04"); //Bring mir acht Wolfsfelle.
	AI_Output(hero, self, "Info_Mod_Bosper_Lehrling_15_05"); //(lacht) Vertraust du allen Leuten, die dir acht Wolfsfelle geben?
	AI_Output(self, hero, "Info_Mod_Bosper_Lehrling_16_06"); //Nein, das soll dich nur eine Weile von mir fern halten.
	AI_Output(self, hero, "Info_Mod_Bosper_Lehrling_16_07"); //Ich werde mich so lange umhören, was die anderen Meister zu dir zu sagen haben.
	AI_Output(self, hero, "Info_Mod_Bosper_Lehrling_16_08"); //Abgesehen davon kann ich die Felle momentan gut gebrauchen.
	AI_Output(self, hero, "Info_Mod_Bosper_Lehrling_16_09"); //Der Söldner Wolf hat mir gerade erst meinen ganzen Bestand abgekauft.
	AI_Output(self, hero, "Info_Mod_Bosper_Lehrling_16_10"); //Wahrscheinlich brauchen die Tagediebe auf Onars Hof eine Beschäftigung, bevor sie noch anfangen, auf dumme Ideen zu kommen ...
...
FUNC VOID Info_Mod_Bosper_DeinLehrling_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_DeinLehrling_16_01"); //Nein. Abgesehen davon müsstest du erst Bürger der Stadt sein, um als Lehrling aufgenommen werden zu können.
};
...
FUNC VOID Info_Mod_Bosper_Fell_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_Fell_16_01"); //Ich kann dir beibringen wie man das Tieren das Fell abzieht.
};
...
FUNC VOID Info_Mod_Bosper_FellLernen_Info()
{
	...
	{
		AI_Output (self, other, "Info_Mod_Bosper_FellLernen_16_01"); //Gut. Hör zu. Es ist im Grunde ganz einfach.
		AI_Output (self, other, "Info_Mod_Bosper_FellLernen_16_02"); //Du nimmst eine scharfe Klinge und schneidest dem Vieh den Bauch auf. Noch ein paar kleine Schnitte an den Innenseiten der Beine und dann kannst du's abziehen.
	};
};
...
FUNC VOID Info_Mod_Bosper_Felle_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_Felle_16_01"); //Sieh an, du scheinst ja wenigstens ein geschickter Jäger zu sein.
...
FUNC VOID Info_Mod_Bosper_BereitFuerLehrling_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Bosper_BereitFuerLehrling_16_01"); //Die anderen Meister haben mir versichert, dass du zuverlässig bist.
		AI_Output(self, hero, "Info_Mod_Bosper_BereitFuerLehrling_16_02"); //Ich habe zwar noch Bedenken, aber ... in Ordnung, du bekommst meine Stimme.

		Mod_LehrlingsStimmen += 1;
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Bosper_BereitFuerLehrling_16_03"); //Ich werde warten, was die anderen Meister von dir zu berichten haben, und erst dann mein Urteil fällen.
	};
};
...
FUNC VOID Info_Mod_Bosper_DeinLehrling2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_DeinLehrling2_16_01"); //Eigentlich nehme ich keine Lehrlinge.
	AI_Output(self, hero, "Info_Mod_Bosper_DeinLehrling2_16_02"); //Wenn du Jäger werden willst, geh zu den Waldläufern.
};
...
FUNC VOID Info_Mod_Bosper_Aufnahme_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_16_01"); //Herrje ... Na ja, dann lass es uns ausprobieren.
	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_16_02"); //Aber wenn ich merke, dass du faul wirst oder mich bestiehlst, ist deine Ausbildung sofort abgebrochen. Klar?
...
FUNC VOID Info_Mod_Bosper_Aufnahme_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_A_16_01"); //In diesem Augenblick.
	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_A_16_02"); //Indem ich dir diese Bürgerkleidung überreiche, bist du nun ein Bürger von Khorinis.

	CreateInvItems	(hero, ItAr_Vlk_H, 1);
	B_ShowGivenThings	("Bürgerkleidung erhalten");

	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_A_16_03"); //Als Jäger solltest du zuerst wissen, mit dem Bogen umzugehen.
	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_A_16_04"); //Ein Schwert wird dir nur wenig behilflich sein, es sei denn, du kämpfst gegen aggressive Gegner, die nicht vor dir fliehen.
	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_A_16_05"); //Von einem Hochsitz oder einer anderen erhöhten Position aus beobachtet ein Jäger die Umgebung.
	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_A_16_06"); //Wenn sich ihm ein Tier nähert, spannt er den Bogen oder die Armbrust möglichst lautlos und zielt auf das verwundbarste Körperteil des Tiers.
	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_A_16_07"); //In den meisten Fällen ist dies der Kopf, bei einigen Monstern können aber auch Körper und Extremitäten besonders anfällig sein.
	AI_Output(hero, self, "Info_Mod_Bosper_Aufnahme_A_15_08"); //Einleuchtend.
	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_A_16_09"); //Deine erste Aufgabe wird darin bestehen, mir Keilerfelle zu beschaffen.
	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_A_16_10"); //Achte aber darauf, dass die Felle möglichst unbeschädigt bleiben, soll heißen: ziele auf die Beine.
	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_A_16_11"); //Beschädigte Felle bringen weniger Gold, und man wird sie schlechter los.
	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_A_16_12"); //Natürlich kannst du auch versuchen unbeschädigte Felle über das Totkloppen der Viecher mit stumpfen Waffen zu bekommen.
	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_A_16_13"); //Das ist aber eigentlich eher was für rohe Schläger die auf pure Gewalt setzen und nicht für geschickte Jäger.
	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_A_16_14"); //Außerdem wird es dabei in etwa der Hälfte der Fälle passieren, dass die Haut der Tiere und damit ihr Fell durch die wuchtigen Schläge aufplatzt oder reißt.
	AI_Output(hero, self, "Info_Mod_Bosper_Aufnahme_A_15_15"); //Wo finde ich Keiler?
	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_A_16_16"); //Eigentlich sind sie überall zu finden. Schau dich um, das gehört zu einer erfolgreichen Jagd dazu.
	AI_Output(hero, self, "Info_Mod_Bosper_Aufnahme_A_15_18"); //Und wie viele Felle brauchst du?
	AI_Output(self, hero, "Info_Mod_Bosper_Aufnahme_A_16_19"); //Bringe mir fünf unbeschädigte Felle, und ich will dir zeigen, wie du bessere Pfeile herstellen kannst.
...
FUNC VOID Info_Mod_Bosper_GildenZeug_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Bosper_GildenZeug_16_00"); //Das hätte ich ja nicht gedacht. Vom Halunken zum Gesetzeshüter.
	}
	else if (hero.guild == GIL_VLK)
	{
		AI_Output(self, hero, "Info_Mod_Bosper_GildenZeug_16_01"); //Was willst du bei den Magiern? Über das Bogenschießen können die dir nichts sagen!
	}
	else if (hero.guild == GIL_NOV)
	{
		AI_Output(self, hero, "Info_Mod_Bosper_GildenZeug_16_02"); //Was willst du bei den Magiern? Über das Bogenschießen können die dir nichts sagen!
	}
	else if (hero.guild == GIL_MIL)
	{
		AI_Output(self, hero, "Info_Mod_Bosper_GildenZeug_16_03"); //War ja abzusehen, dass es dich zu den Söldnern zieht. Haben aber gute Bogenschützen, die Jungs.
	}
	else if (hero.guild == GIL_KDF)
	{
		AI_Output(self, hero, "Info_Mod_Bosper_GildenZeug_16_04"); //Lass dir bloß nicht einfallen, hier deinem Gott zu huldigen!
	};
};
...
FUNC VOID Info_Mod_Bosper_LehrlingQuest_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest_16_01"); //(prüfend) Ja, die sind zu gebrauchen.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest_16_02"); //Hier hast du etwas Geld. Aber gib es nicht für Bier und leichte Mädchen aus!

	B_GiveInvItems	(self, hero, ItMi_Gold, (5 * Value_KeilerFur_Rein) / 2);

	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest_16_03"); //Da du dich als einigermaßen geschickt erwiesen hast, will ich dich nun in die Kunst der Pfeilherstellung einführen.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest_16_04"); //Einen normalen Pfeil zu schnitzen, ist selbst für den blutigen Anfänger kein Problem.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest_16_05"); //Allerdings gibt es bestimmte Kniffe, wie du spezialisierte oder verbesserte Pfeile erhältst.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest_16_06"); //Lass uns mit den Widerhaken beginnen.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest_16_07"); //Alles, was du zusätzlich brauchst, ist ein leichtes gebogenes Stück Eisen.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest_16_08"); //Das kannst du bei fast jedem Schmied kaufen.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest_16_09"); //Vorn in den Pfeil ritzt du im gleichen Abstand vier Kerben, die du mit einer klebrigen Flüssigkeit ausfüllst und in die du dann die Eisenstücke steckst.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest_16_10"); //Achte immer darauf, die Balance des Pfeils zu wahren.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest_16_11"); //Unter dem Eisen leidet die Genauigkeit des Pfeils, allerdings kannst du mit ein wenig Glück deinem Gegner damit schwer blutende Wunden zufügen, die ihn immer weiter schwächen.
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest_15_12"); //Kann ich damit auch meine schon fertigen Pfeile aufbessern?
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest_16_13"); //Natürlich. Ich empfehle dir, das an Thorbens Stand zu erledigen.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest_16_14"); //Als Handwerker hat er dort alle nötigen Gerätschaften versammelt.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest_16_15"); //Jetzt solltest du dich erst einmal für eine Weile mit dem vertraut machen, was ich dir erzählt habe.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest_16_16"); //Komm danach wieder, und wir werden an dieser Stelle weitermachen.
...
FUNC VOID Info_Mod_Bosper_LehrlingQuest2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest2_16_01"); //(argwöhnisch) Wo treibst du dich überhaupt rum? In der Stadt bist du ja kaum noch.
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest2_15_02"); //Ich rette die Welt und so.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest2_16_03"); //Verarschen kann ich mich alleine.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest2_16_04"); //Ich brauche aber deine Hilfe.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest2_16_05"); //Abuyin hat vier Schattenläuferfelle bei mir bestellt, aber die Jäger haben mir erst eines gebracht.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest2_16_06"); //Fehlen also noch drei.
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest2_15_07"); //Wofür braucht Abuyin Schattenläuferfelle?
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest2_16_08"); //Er sagt, dass Schattenläufer magische Wesen seien und ihre Felle demnach irgendwelche positiven Schwingungen auf ihn ausüben würden.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest2_16_09"); //Vielleicht hat er aber auch einfach nur zu viel geraucht.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest2_16_10"); //Jedenfalls zahlt er gut für unbeschädigte Felle. Du erinnerst dich daran, worauf du achten musst?
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest2_15_11"); //Immer schön auf die Pranken schießen.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest2_16_12"); //Schattenläufer sind hart im Nehmen. Also pass auf dich auf.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest2_16_13"); //Wenn du mir die Felle gebracht hast, bringe ich dir was Neues bei.
...
FUNC VOID Info_Mod_Bosper_LehrlingQuest3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest3_16_01"); //Gute Qualität. Damit wird Abuyin zufrieden sein.
	...
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest3_16_03"); //In Ordnung, dann hör mir mal gut zu.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest3_16_04"); //Mit herkömmlichen Pfeilen hast du gegen starke Gegner häufig keine Chance, weil deine Reichweite zu gering ist.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest3_16_05"); //Du musst bei der Produktion nur ein paar Feinheiten ändern, und schon erhältst du einen wahrhaften Präzisionspfeil.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest3_16_06"); //Die Befiederung am Ende des Pfeils muss etwa ein Fünftel des Pfeils bedecken. Nimm also mehr Federn als üblich.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest3_16_07"); //Außerdem darf die Spitze etwas kleiner sein, um die Balance des Pfeils zu erhöhen.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest3_16_08"); //Als Alternative bringst du am Ende des Schafts ein Gegengewicht an, das für eine gleichmäßige Verteilung des Gewichts sorgt.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest3_16_09"); //Diese Maßnahmen sorgen zwar dafür, dass der Pfeil etwas an Durchschlagskraft verliert, aber das macht er durch eine deutlich erhöhte Reichweite und eine bessere Handhabbarkeit wieder wett.
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest3_15_10"); //Klingt so, als wäre der Pfeil zu gebrauchen.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest3_16_11"); //Sonst würde ich mir auch nicht die Mühe machen, es dir zu erklären.
	...
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest3_16_13"); //Meinen letzten Lehrling hatte ich vor mehreren Jahren. Ich werde ihn immer in Erinnerung behalten - aber nicht in positiver.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest3_16_14"); //Jetzt ist es aber Zeit für dich zu gehen. Komm bald wieder.
...
FUNC VOID Info_Mod_Bosper_LehrlingQuest4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest4_16_01"); //Du kennst jetzt die für Jäger wichtigsten Pfeil-Modifikationen, bis auf eine.
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest4_15_02"); //Und die wäre?
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest4_16_03"); //Na ja ... (stockt) Das sollte ich dir vielleicht gar nicht sagen.
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest4_15_04"); //Aha.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest4_16_05"); //Ich wurde schon ein Mal betrogen, und ich will es nicht zu einem zweiten Mal kommen lassen.
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest4_15_06"); //Wer hat dich betrogen?
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest4_16_07"); //Mein letzter Lehrling.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest4_16_08"); //Ich habe ihm alles beigebracht, was ist wusste, und als Dank feuerte er drei Explosionspfeile auf mein ehemaliges Haus und setzte es in Brand.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest4_16_09"); //Damals wohnte ich nur unweit der Taverne, an einem Rastplatz der Jäger.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest4_16_10"); //Seitdem habe ich keine Lehrlinge mehr aufgenommen.
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest4_15_11"); //Was ist aus deinem Lehrling geworden?
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest4_16_12"); //(bitter) Ich weiß es nicht. Es war eine junge Frau - sehr talentiert, sehr ehrgeizig.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest4_16_13"); //Ich habe nie wieder von ihr gehört, und ich will es auch nicht.
};
...
FUNC VOID Info_Mod_Bosper_LehrlingQuest5_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest5_16_01"); //Weswegen wurdest du eigentlich in die Barriere geworfen?
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest5_15_02"); //Ich -
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest5_16_03"); //Halt! Sag's nicht. Ich will es gar nicht wissen.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest5_16_04"); //Du hast mich bisher nicht enttäuscht, bist bescheiden und zuverlässig.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest5_16_05"); //Wenn ich jemandem trauen kann, dann dir. Deine Vergangenheit spielt keine Rolle.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest5_16_06"); //Also schön, ich will dir die mächtigsten Geschosse zeigen: die Explosionspfeile.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest5_16_07"); //Diese richten selbst bei Gegnern, die gegen herkömmliche Pfeile weitgehend immun sind, verheerenden Schaden an.
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest5_15_08"); //Und wie stelle ich diese Pfeile her?
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest5_16_09"); //Die Spitze dieser Pfeile besteht aus einem Säckchen mit einem explosiven Gemisch.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest5_16_10"); //Du brauchst ein Stück Kohle, Schwefel und einen Beutel Salpeter.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest5_16_11"); //An einem Alchemietisch stellst du daraus eine Mischung her, verpackst sie sorgfältig und befestigst sie vorn am Pfeil.
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest5_15_12"); //Hört sich gut an.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest5_16_13"); //Probier's aus. Bring mir zwei Trollfelle, dann sehe ich die Prüfung als abgeschlossen an.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest5_16_14"); //Aber ich will die Brandflecken sehen!
...
FUNC VOID Info_Mod_Bosper_LehrlingQuest6_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest6_16_01"); //Dafür hast du hier einen kleinen Lohn.

	B_GiveInvItems	(self, hero, ItMi_Gold, 300);

	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest6_16_02"); //Deine Ausbildung bei mir ist hiermit beendet. Alles, was du wissen musst, habe ich dir erzählt.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest6_16_03"); //Nun wird die Praxis erweisen, ob du mit der Jagd deinen Lebensunterhalt bestreiten können wirst.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest6_16_04"); //Schau doch irgendwann noch mal bei mir vorbei, vielleicht habe ich etwas zu tun für dich.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest6_16_05"); //Ansonsten bleibt mir nur übrig, dich zu deinen Leistungen zu beglückwünschen und dir ein angenehmes Leben zu wünschen.
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest6_15_06"); //Danke. Bis demnächst mal.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest6_16_07"); //Möge deine Sehne immer gespannt bleiben!
...
FUNC VOID Info_Mod_Bosper_LehrlingQuest7_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest7_16_01"); //Das Gespräch mit dir über meinen letzten Lehrling hat mir keine Ruhe gelassen.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest7_16_02"); //Ich hatte ihn schon erfolgreich verdrängt, aber seit ich dir von ihm erzählt habe, habe ich Alpträume und schlafe schlecht.
};
...
FUNC VOID Info_Mod_Bosper_LehrlingQuest8_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest8_16_01"); //Ich ... ich bin nicht ganz schuldlos daran. Damals habe ich nicht die richtigen Worte gefunden.
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest8_15_02"); //Was ist vorgefallen?
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest8_16_03"); //Ich hatte zu ihr eine ... besondere Verbindung.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest8_16_04"); //Am Abend, bevor sie mein Haus in Brand setzte, klärte ich sie darüber auf.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest8_16_05"); //Aber sie wollte nichts davon wissen und schrie mich an.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest8_16_06"); //Daraufhin habe ich ihr weh getan. Ich wusste sofort, dass es falsch war, aber konnte es nicht mehr rückgängig machen.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest8_16_07"); //Dann rannte sie davon. In der Nacht wurde ich schließlich vom Prasseln des Feuers und dem Brandgeruch geweckt.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest8_16_08"); //Ich möchte, dass du sie findest.
};
...
FUNC VOID Info_Mod_Bosper_LehrlingQuest9_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest9_16_01"); //Das stimmte auch lange Zeit. Die Erinnerung an sie bereitet mir noch immer Schmerzen.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest9_16_02"); //Aber gleichzeitig steigt die Sehnsucht in mir, mich mit ihr zu versöhnen.
};
...
FUNC VOID Info_Mod_Bosper_LehrlingQuest10_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest10_16_01"); //Als ich dir sagte, dass ich nicht wüsste, wo sie sei, habe ich nicht vollkommen die Wahrheit gesagt.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest10_16_02"); //Aus verschiedenen Quellen habe ich erfahren, dass sie sich noch immer in dem großen Wald nördlich der Stadt aufhält.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest10_16_03"); //Allerdings scheint sie nicht gewillt, dass sich jemand ihr nähert.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest10_16_04"); //Mehrere Jäger haben mir berichtet, dass sie sich, wenn sie gestört wurde, in ein Tier verwandelt hat.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest10_16_05"); //Ich weiß nicht, wo sie die Kunst des Verwandelns gelernt hat, aber ihr bevorzugtes Tier scheint ein Warg zu sein.
	...
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest10_16_07"); //Natürlich nicht.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest10_16_08"); //Lass dir von einem Magier, Vatras vielleicht, eine Tinktur geben, die bei Berührung zurückverwandelt.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest10_16_09"); //Damit bestreichst du an einem Alchemietisch deine Pfeile.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest10_16_10"); //Schon beim ersten Schuss wird sich dann zeigen, ob es sich um Atalante handelt, meinen letzten Lehrling.
...
FUNC VOID Info_Mod_Bosper_LehrlingQuest11_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest11_16_01"); //Erzähl ihr, dass ich gewillt bin, ihr zu verzeihen, und dass ich sie treffen will.
};
...
FUNC VOID Info_Mod_Bosper_LehrlingQuest12_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest12_16_01"); //Nein! Sag, dass das nicht wahr ist!
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest12_15_02"); //Sie griff mich an, als ich ihr von dir erzählte.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest12_16_03"); //Meine Tochter! Was hast du mir angetan?!
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest12_15_04"); //Deine Tochter? Aber wie ...?
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest12_16_05"); //(wahnsinnig) Du lügst! Sie ist nicht tot. Sie will mich nur nicht wiedersehen, stimmt's?
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest12_16_06"); //Sie will ihren Tod bloß vortäuschen, weil ich sie so gedemütigt habe!
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest12_16_07"); //Atalante, ich konnte dir doch nichts sagen!
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest12_16_08"); //Als ich von dir erfuhr, ließ ich dir alles zukommen, was ich geben konnte.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest12_16_09"); //Und doch wolltest du mir nicht glauben an jenem verhängnisvollen Tag.
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest12_15_10"); //So langsam durchschaue ich die Angelegenheit.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest12_16_11"); //Nein, gar nichts durchschaust du. Niemand, niemand will mich verstehen!
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest12_16_12"); //Und nun - hinfort mit dir, dass du dich mit meiner eigenen Tochter gegen mich verbündest!
	AI_Output(hero, self, "Info_Mod_Bosper_LehrlingQuest12_15_13"); //Ist ja schon gut. Du wirst schon darüber hinwegkommen.
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest12_16_14"); //Niemals!
...
FUNC VOID Info_Mod_Bosper_LehrlingQuest13_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_LehrlingQuest13_16_01"); //(niedergeschlagen) Dann ist sie vielleicht doch nicht mehr im Wald. Was mache ich jetzt bloß?
...
FUNC VOID Info_Mod_Bosper_DragomirFelle_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_DragomirFelle_16_01"); //Gut. Wieviel will er?
	AI_Output(hero, self, "Info_Mod_Bosper_DragomirFelle_15_02"); //Er kassiert, wenn er vorbeikommt.
	AI_Output(self, hero, "Info_Mod_Bosper_DragomirFelle_16_03"); //Auch gut. Hier, etwas Gold.
...
FUNC VOID Info_Mod_Bosper_Job_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_Job_16_01"); //Bring mir alle Tierfelle die du findest. Ich Zahl dir für jedes Fell einen guten Preis.
	AI_Output(self, hero, "Info_Mod_Bosper_Job_16_02"); //Außerdem kann ich dir beibringen wie du Pfeile, Bögen und Armbrüste herstellst.
...
FUNC VOID Info_Mod_Bosper_Schnitzen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_Schnitzen_16_01"); //Ok. Zuerst solltest du dir ein Holzstück bei Thorben kaufen. Dieses nimmst du dann mit an eine Baumsäge und schnitzt es zu etwa 10 Pfeilen.
	AI_Output(self, hero, "Info_Mod_Bosper_Schnitzen_16_02"); //Dann fügst du den Pfeil mit einer Pfeilspitze an einem Amboss zusammen und fertig ist dein Pfeil.
...
FUNC VOID Info_Mod_Bosper_Spitzen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_Spitzen_16_01"); //Geh zu Harad. Wenn er dich fragt, wieso er dich unterrichten solle, dann sage ihm, dass ich dich schicke.
};
...
FUNC VOID Info_Mod_Bosper_OtherHunters_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Bosper_OtherHunters_16_01"); //Wenn du aus dem Osttor gehst, kommst du zu Orlans Taverne.
...
FUNC VOID Info_Mod_Bosper_Anschlagtafel_Info()
{
	...
	&& (Npc_HasItems(hero, ItMi_Ast) >= Mod_Anschlagtafel_Khorinis_Bosper_Ast)
	{
		...
		AI_Output(self, hero, "Info_Mod_Bosper_Anschlagtafel_16_00"); //Was? Zeig her ... Tatsächlich, alles dabei. Ausgesprochen gut gemacht.
		AI_Output(self, hero, "Info_Mod_Bosper_Anschlagtafel_16_01"); //Hier ist deine Entlohnung.

		B_GiveInvItems	(self, hero, ItMi_Gold, Mod_Anschlagtafel_Khorinis_Bosper_Gold);

		AI_Output(self, hero, "Info_Mod_Bosper_Anschlagtafel_16_02"); //Hat mich gefreut mit dir Geschäfte zu machen.
...
FUNC VOID Info_Mod_Bosper_MehrFelle_Info()
{
	...
	|| (Npc_HasItems(hero, ItAt_StonePumaFur_Feuer) > 0)
	{
		...
		|| (Npc_HasItems(hero, ItAt_Addon_KeilerFur_Feuer) > 0)
		{
			AI_Output(self, hero, "Info_Mod_Bosper_MehrFelle_16_01"); //Das Fell von Keilern. Starke Biester sind das.
		...
		|| (Npc_HasItems(hero, ItAt_SheepFur_Feuer) > 0)
		{
			AI_Output (self, hero, "Info_Mod_Bosper_MehrFelle_16_02"); //Schafsfell? Du hast doch nicht etwa bei irgendeinem Bauern die Schafe auf der Weide abgeschlachtet?
		...
		|| (Npc_HasItems(hero, ItAt_ZiegenFur_Feuer) > 0)
		{
			AI_Output (self, hero, "Info_Mod_Bosper_MehrFelle_16_04"); //Ziegenfelle, gute Ware ...
		...
		|| (Npc_HasItems(hero, ItAt_WolfFur_Feuer) > 0)
		{
			AI_Output (self, hero, "Info_Mod_Bosper_MehrFelle_16_05"); //Wolfsfell, das ist gut...
		...
		|| (Npc_HasItems(hero, ItAt_BlackwolfFur_Feuer) > 0)
		{
			AI_Output (self, hero, "Info_Mod_Bosper_MehrFelle_16_06"); //Schwarze Wolfsfelle, sehr schön...
		...
		|| (Npc_HasItems(hero, ItAt_WargFur_Feuer) > 0)
		{
			AI_Output (self, hero, "Info_Mod_Bosper_MehrFelle_16_07"); //Fell von Wargen? Zähe Biester sind das ...
		...
		|| (Npc_HasItems(hero, ItAt_StonePumaFur_Feuer) > 0)
		{
			AI_Output (self, hero, "Info_Mod_Bosper_MehrFelle_16_08"); //Pumafell? Feine Sache ...
		...
		|| (Npc_HasItems(hero, ItAt_OrcdogFur_Feuer) > 0)
		{
			AI_Output (self, hero, "Info_Mod_Bosper_MehrFelle_16_09"); //Fell von Orkhunden? Zähe Biester sind das ...
		...
		|| (Npc_HasItems(hero, ItAt_ShadowFur_Feuer) > 0))
		{
			AI_Output (self, hero, "Info_Mod_Bosper_MehrFelle_16_10"); //Ah, sogar das Fell eines Schattenläufers - ist 'ne Menge wert.
		...
		|| (Npc_HasItems(hero, ItAt_TrollBlackFur_Feuer) > 0)
		{
			...
			{
				AI_Output (self, hero, "Info_Mod_Bosper_MehrFelle_16_11"); //Was zur Hölle ist DAS für ein Fell?
				AI_Output (hero, self, "Info_Mod_Bosper_MehrFelle_15_12"); //Das hab ich einem Troll über die Ohren gezogen.
				AI_Output (self, hero, "Info_Mod_Bosper_MehrFelle_16_13"); //Das ... das ist ein halbes Vermögen wert ...
			...
			|| (Npc_HasItems(hero, ItAt_TrollBlackFur_Feuer) > 0)
			{
				AI_Output (self, hero, "Info_Mod_Bosper_MehrFelle_16_16"); //Sogar das Fell eines schwarzen Trolls!
	...
	{
		AI_Output (self, hero, "Info_Mod_Bosper_MehrFelle_16_18"); //Du weißt doch - ich bin nur an Fellen von Wölfen, Schattenläufern und dergleichen interessiert ...
	};
};
