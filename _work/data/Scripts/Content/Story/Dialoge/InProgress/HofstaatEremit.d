...
FUNC VOID Info_Mod_HofstaatEremit_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_03_01"); //Kommt drauf an.
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_02"); //Auf was?
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_03_03"); //Welchen Eremiten du meinst.
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_04"); //(genervt) Den königliche natürlich.
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_03_05"); //Ja, der bin ich.
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_06"); //Der Magier schickt mich.
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_03_07"); //Welcher?
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_08"); //(genervt) Der königliche.
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_03_09"); //Achso. Und was will er?
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_10"); //Er hat was von einer Pilzlieferung gesagt.
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_03_11"); //Welche Pilzlief ... (wird unterbrochen)
	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_12"); //Die königliche verdammt noch mal!
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_03_13"); //Achso. Dann nimm hier dieses königliche Säckchen voller königlicher Pilzsporen und bring es dem Magier!

	B_GiveInvItems	(self, hero, ItMi_FreudenspenderSporen, 1);

	AI_Output(hero, self, "Info_Mod_HofstaatEremit_Hi_15_14"); //Welchem?
	AI_Output(self, hero, "Info_Mod_HofstaatEremit_Hi_03_15"); //Dem königlichen natürlich!
