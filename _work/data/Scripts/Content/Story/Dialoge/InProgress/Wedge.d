...
{
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_00"); //Sieh an, ein neues Gesicht. Aber warte ... habe ich dich nicht damals vor dem Fall der Barriere schon im neuen Lager gesehen?
	AI_Output(hero, self, "Info_Mod_Wedge_Hi_15_01"); //Ja, das stimmt. Du scheinst ein gutes Gedächtnis zu haben.
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_02"); //Nun, etwas Köpfchen ist nicht gerade von Nachteil, wenn man nicht als Moorleiche enden will.
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_03"); //Denn die beste Art zu einer zu werden, ist es sich im Moor zu verlaufen.
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_04"); //Es bedarf eben mehr, als nur leiser Sohlen, um nicht gleich beim ersten Beutezug als Kadaver zu enden.
	...
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_06"); //Das eine muss aber das andere nicht ausschließen.
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_07"); //Wenn man erst einmal gelernt hat, wie man richtig auftreten muss, kann man auch beim Laufen fast genauso leise sein, als würde man Schleichen.
	AI_Output(hero, self, "Info_Mod_Wedge_Hi_15_08"); //Hört sich nützlich an.
	AI_Output(self, hero, "Info_Mod_Wedge_Hi_28_09"); //Ja, es ist beleibe nicht von Nachteil. Wer die leisen Sohlen beherrscht, lebt besser ... und länger.
};
...
FUNC VOID Info_Mod_Wedge_Lehrer_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Wedge_Lehrer_28_01"); //Na ich weiß nicht ... kannst du überhaupt vernünftig schleichen?
	AI_Output(self, hero, "Info_Mod_Wedge_Lehrer_28_02"); //Mit einem Trampel, der die Füße eines Golems hat, werde ich erst gar nicht meine kostbare Zeit verschwenden.

	if (Mod_Schwierigkeit != 4)
	{
		AI_Output(self, hero, "Info_Mod_Wedge_Lehrer_28_03"); //Apropos kostbar und Zeit ... wenn es dir wirklich ernst ist, wirst du bestimmt 300 Münzen locker machen können.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Wedge_Lehrer_28_04"); //Apropos kostbar und Zeit ... wenn es dir wirklich ernst ist, wirst du bestimmt 1800 Münzen locker machen können.
	};
};
...
FUNC VOID Info_Mod_Wedge_Lernen_Info()
{
	...
	&& (hero.lp < 15)
	{
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_00"); //Sammele erst einmal die nötige Erfahrung, Grünschnabel.
	}
	...
	{
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_01"); //Und das Gold?! Umsonst ist der Tod ...
	}
	else if (Npc_GetTalentSkill(hero, NPC_TALENT_SNEAK) == FALSE)
	{
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_02"); //Anfänger, lern erst mal vernünftig zu schleichen. Mit deinen Schritten übertönst du jeden Troll.
	}
	else
	{
		if (Mod_Schwierigkeit != 4)
		...
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_03"); //Gut, ein Würdiger will lernen seinen Fuß leise und doch Geschwind aufzusetzen.
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_04"); //Du musst darauf achten, sanft mit der Ferse aufzusetzen und den Fuß gleichmäßig abzurollen.
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_05"); //Weiches Schuhwerk ist auch nicht von Nachteil. Ich zeige es dir.

		AI_PlayAni	(self, "T_PLUNDER");

		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_06"); //So, jetzt solltest du nicht mehr so viel Lärm beim Laufen machen.
		AI_Output(self, hero, "Info_Mod_Wedge_Lernen_28_07"); //Viel Spaß mit deiner neuen Fertigkeit.
