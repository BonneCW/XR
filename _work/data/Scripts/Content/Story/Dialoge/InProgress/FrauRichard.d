...
FUNC VOID Info_Mod_FrauRichard_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_FrauRichard_Hi_19_01"); //Ja, danke! Was ist passiert?
	...
	AI_Output(self, hero, "Info_Mod_FrauRichard_Hi_19_03"); //Hast du meinen Mann gesehen? Die Ratten haben ihn und mich entführt.
};
...
FUNC VOID Info_Mod_FrauRichard_InDorf_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_FrauRichard_InDorf_19_01"); //Mehr oder weniger. Ich fühle mich nicht so recht wohl hier.
	AI_Output(self, hero, "Info_Mod_FrauRichard_InDorf_19_02"); //Die Menschen - sie sind so kalt wie die Luft.
	AI_Output(self, hero, "Info_Mod_FrauRichard_InDorf_19_03"); //Selbst tagsüber ist das Dorf wie ausgestorben.
};
...
FUNC VOID Info_Mod_FrauRichard_InDorf2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_FrauRichard_InDorf2_19_01"); //Ich habe es mir schon oft vorgenommen, aber der Weg hoch zum Steinkreis ist so lang und beschwerlich.
	AI_Output(self, hero, "Info_Mod_FrauRichard_InDorf2_19_02"); //In letzter Zeit gab es auch immer mal wieder Meldungen von einer Räuberbande und vermissten Wanderern.
};
...
FUNC VOID Info_Mod_FrauRichard_InDorf3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_FrauRichard_InDorf3_19_01"); //(erfreut) In dem Fall würde ich gern zurück nach Relendel.
	AI_Output(self, hero, "Info_Mod_FrauRichard_InDorf3_19_02"); //Meinetwegen können wir sofort aufbrechen, ich habe hier nichts, an dem ich hänge.
...
{
	AI_Output(self, hero, "Info_Mod_FrauRichard_AtSteinkreis_19_00"); //Wir scheinen Glück gehabt zu haben. Heute ist keine Menschenseele unterwegs.
	...
	AI_Output(self, hero, "Info_Mod_FrauRichard_AtSteinkreis_19_02"); //Und zum zweiten Mal stehe ich in deiner Schuld. Ich danke dir.

	B_GiveInvItems	(self, hero, ItMi_Gold, 100);

	AI_Output(self, hero, "Info_Mod_FrauRichard_AtSteinkreis_19_03"); //Komm mich doch mal in Khorata besuchen!
