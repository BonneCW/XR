...
FUNC VOID Info_Mod_Baldur_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Baldur_Hi_03_01"); //Ich bin Baldur, Jäger im Dienste der Druiden und Waldläufer.
	AI_Output(hero, self, "Info_Mod_Baldur_Hi_15_02"); //Waldläufer? Druiden? Was ...
	AI_Output(self, hero, "Info_Mod_Baldur_Hi_03_03"); //Waldläufer sind eigentlich auch Jäger, aber sie haben sich zum Teil auf Nahkampf festgelegt.
	AI_Output(hero, self, "Info_Mod_Baldur_Hi_15_04"); //Und die Druiden?
	AI_Output(self, hero, "Info_Mod_Baldur_Hi_03_05"); //Das sind die Oberhäupter der Waldläufer. Und auch aller Jäger.
	AI_Output(self, hero, "Info_Mod_Baldur_Hi_03_06"); //Weise Männer, die sich auch in Heilkunde und Magie auskennen.
	AI_Output(self, hero, "Info_Mod_Baldur_Hi_03_07"); //Sie jagen nicht und kämpfen selten, sind naturverbunden und beten zu Adanos.
...
FUNC VOID Info_Mod_Baldur_CyrcoMine_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Baldur_CyrcoMine_03_01"); //Das will  ich meinen! Diese Bande haben wir aber aufgemischt!
	AI_Output(hero, self, "Info_Mod_Baldur_CyrcoMine_15_02"); //Hast du Lust auf eine zweite Runde? Hab noch 'ne Mission.
	AI_Output(self, hero, "Info_Mod_Baldur_CyrcoMine_03_03"); //Ne, lass mal. Hab mich am Arm verletzt. Besser nicht.
};
...
FUNC VOID Info_Mod_Baldur_Felle_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Baldur_Felle_03_01"); //Da liegt ein Haufen. Bedien dich.
	AI_Output(hero, self, "Info_Mod_Baldur_Felle_15_02"); //Ich nehm mal 10 Stück.
	AI_Output(self, hero, "Info_Mod_Baldur_Felle_03_03"); //Nur zu. Brauch ich sie nicht runterschleppen.
...
FUNC VOID Info_Mod_Baldur_AlterMann_Info()
{
	if (Mod_BDT_AlterWaldMann == 0)
	{
		...
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_00"); //Ahh, du meinst den alten Mann des Waldes. Ja, etwas weiß ich über ihn.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_01"); //Er soll Jahrhunderte alt sein und die Tiere des Waldes Rund um Khorata behüten.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_02"); //Zwar sagt man, er sei blind, jedoch gleichzeitig auch magisch begabt.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_03"); //Mehr fällt mir gerade nicht ein. Vielleicht weiß ein anderer mehr.
	...
	else if (Mod_BDT_AlterWaldMann == 1)
	{
		...
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_04"); //Der alte Mann des Waldes? Ja, ich hörte er solle einst ein Diener Adanos gewesen sein.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_05"); //Wobei unklar ist, ob er ein Waldläufer war wie wir, ein Magier des Wassers, oder ein Verwandlungsmagier.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_06"); //Seine magischen Fähigkeiten, wie auch seine starke Bindung zur Tier- und Pflanzenwelt zeugen davon, dass er von allem etwas hat.
	...
	else if (Mod_BDT_AlterWaldMann == 2)
	{
		...
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_07"); //Tja, viel kann ich dir nicht über ihn verraten.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_08"); //Das Problem besteht auch darin, dass er mit keinem Menschen spricht, nicht mal mit uns, auch, wenn wir eigentlich ähnliche Ziele verfolgen.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_09"); //Allein mit den Tieren des Waldes unterhält er sich.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_10"); //Tja, wenn ich ein Keiler wäre, könnte ich dir bestimmt mehr über ihn verraten.
	...
	else if (Mod_BDT_AlterWaldMann == 3)
	{
		...
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_11"); //Der alte Mann des Waldes? Nun, er soll in enger Beziehung zur Tier- und Pflanzenwelt stehen.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_12"); //Man sagt, er leite Rudeltiere wie Keiler, oder Wölfe dazu an, den Wald gegen Eindringlinge zu beschützen.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_13"); //Selbst, so sagt man, fände man ihn häufig in Gestalt eines grünen Wolfes vor.
	...
	else if (Mod_BDT_AlterWaldMann == 4)
	{
		...
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_14"); //Du interessierst dich für Geschichten über den alten Mann des Waldes?
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_15"); //Nun, viel weiß ich nicht über diesen mystischen Kauz.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_16"); //Er soll sich meistens im dunklen Wald aufhalten, aber auch immer in der Nähe von Gewässern, wie Seen.
		AI_Output(self, hero, "Info_Mod_Baldur_AlterMann_03_17"); //Selten hat ihn jemand zu Gesicht bekommen ...
