...
{
	AI_Output(self, hero, "Info_Mod_Alfans_Hi_03_00"); //Hallo Fremder. Du scheinst von weit weg zu kommen.
	AI_Output(self, hero, "Info_Mod_Alfans_Hi_03_01"); //Wenn du nach Lebensmitteln und Kräutern suchst, so soll es dir bei mir an nichts fehlen.
	AI_Output(self, hero, "Info_Mod_Alfans_Hi_03_02"); //Ich habe eine ausgezeichnete Auswahl an allem, was den Körper belebt und ihm Linderung von Leid verschafft.
...
{
	AI_Output(self, hero, "Info_Mod_Alfans_Aufgabe_03_00"); //Sei gegrüßt, da bist da ja wieder.
	AI_Output(self, hero, "Info_Mod_Alfans_Aufgabe_03_01"); //Ich hätte ein Anliegen an dich und wäre überaus dankbar, wenn du mir dabei helfen könntest.
	AI_Output(self, hero, "Info_Mod_Alfans_Aufgabe_03_02"); //Selbstverständlich würde ich dich auch entlohnen.
	AI_Output(hero, self, "Info_Mod_Alfans_Aufgabe_15_03"); //Worum geht es.
	AI_Output(self, hero, "Info_Mod_Alfans_Aufgabe_03_04"); //Nun, ich wandte mich an dich, da du von weit her kommst und somit bewiesen hast, dass du ein exzellenter Fährtensucher bist und den Gefahren der Wildnis trotzen kannst.
	AI_Output(self, hero, "Info_Mod_Alfans_Aufgabe_03_05"); //Es geht um den Einsiedler Halfmar. Bislang kam er selten, jedoch regelmäßig ins unser Dorf und überbrachte mir Kräuter und Pflanzen welche er in der Wildnis fand.
	AI_Output(self, hero, "Info_Mod_Alfans_Aufgabe_03_06"); //Sein letzter Besuch liegt jedoch weit länger zurück, als es üblich ist.
	AI_Output(self, hero, "Info_Mod_Alfans_Aufgabe_03_07"); //Und ich beginne mir Sorgen zu machen ... (nachgeschoben) selbstverständlich nicht nur meiner Waren wegen.
	AI_Output(self, hero, "Info_Mod_Alfans_Aufgabe_03_08"); //Er lebt fernab von hier im Südwesten. Ich wäre dir über die Maßen dankbar, wenn du nach dem Rechten sehen könntest.
	AI_Output(hero, self, "Info_Mod_Alfans_Aufgabe_15_09"); //Nun, ich schaue, was sich machen lässt.
	AI_Output(self, hero, "Info_Mod_Alfans_Aufgabe_03_10"); //Hab Dank. Es soll dir auch nicht zum Nachteil gedeihen.
	AI_Output(self, hero, "Info_Mod_Alfans_Aufgabe_03_11"); //Wenn du den Gleisen folgst, kommst du irgendwann an seiner Hütte vorbei.
...
FUNC VOID Info_Mod_Alfans_Halfmar_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Alfans_Halfmar_03_01"); //Und, was ist mit ihm?
	...
	AI_Output(self, hero, "Info_Mod_Alfans_Halfmar_03_04"); //Ahh, sehr gut. Vielen Dank für die erfreuliche Nachricht.
	AI_Output(self, hero, "Info_Mod_Alfans_Halfmar_03_05"); //Und hier die versprochene Belohnung. Such dir einen Trank aus.
...
{
	AI_Output(self, hero, "Info_Mod_Alfans_Halfmar_Fertig_03_00"); //Es war mir eine Freude. Ich hoffe, wir sehen uns bald wieder.
