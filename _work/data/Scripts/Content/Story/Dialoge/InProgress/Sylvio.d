...
{
	AI_Output(self, hero, "Info_Mod_Sylvio_Hi_03_00"); //Hey, du bist doch der Typ, der im Alten Lager für uns spionieren soll.
	AI_Output(hero, self, "Info_Mod_Sylvio_Hi_15_01"); //Ja, das soll ich.
	AI_Output(self, hero, "Info_Mod_Sylvio_Hi_03_02"); //Ich will dir was sagen: Falls du was herausbekommst, solltest du es zuerst mir berichten, bevor du damit zu Lee rennst, verstanden?
	AI_Output(self, hero, "Info_Mod_Sylvio_Hi_03_03"); //Damit steigst du im Nu zum Orkjäger auf und kannst dir noch zusätzlich Gold uns Erz verdienen. Wir verstehen uns?
...
FUNC VOID Info_Mod_Sylvio_InfosAnLee_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Sylvio_InfosAnLee_03_00"); //Hatte ich nicht gesagt, dass du zuerst zu mir kommen sollst?
	};

	AI_Output(self, hero, "Info_Mod_Sylvio_InfosAnLee_03_01"); //Einer meiner besten Orkjäger wurde bloßgestellt und das färbt wiederum auf mich ab. Und so was gefällt mir ganz und gar nicht.
	AI_Output(self, hero, "Info_Mod_Sylvio_InfosAnLee_03_02"); //Pass besser in Zukunft auf, ob du dir nicht einflussreiche Feinde machst.
};
...
FUNC VOID Info_Mod_Sylvio_Infos_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sylvio_Infos_03_02"); //Das ist interessant. Geh zu Sentenza. Er wird dir die weiteren Anweisungen geben.
...
{
	AI_Output(self, hero, "Info_Mod_Sylvio_Frauenraub_03_00"); //Achja, es hat sich übrigens eine weitere Möglichkeit für dich gefunden, dich zu bewähren.
	AI_Output(self, hero, "Info_Mod_Sylvio_Frauenraub_03_01"); //Geh zu Bullco. Er wird dir alles Weitere mitteilen.
	AI_Output(hero, self, "Info_Mod_Sylvio_Frauenraub_15_02"); //Aber Bullco ist doch kein Orkjäger.
	AI_Output(self, hero, "Info_Mod_Sylvio_Frauenraub_03_03"); //Genau, er ist Drachenjäger. Na und? Für mich zu arbeiten lohnt sich eben. Du findest ihn tagsüber meistens vor der Kneipe.
...
{
	AI_Output(self, hero, "Info_Mod_Sylvio_VelayaWeg_03_00"); //Was?! Du hier? Und ohne Begleitung?
	AI_Output(hero, self, "Info_Mod_Sylvio_VelayaWeg_15_01"); //Es hat leider nicht geklappt.
	AI_Output(self, hero, "Info_Mod_Sylvio_VelayaWeg_03_02"); //Nicht geklappt?! Nachdem du dir das geleistet hast, wird so manch anderes für dich wahrscheinlich auch nicht klappen. Geh mir aus den Augen.
...
{
	AI_Output(self, hero, "Info_Mod_Sylvio_VelayaDabei_03_00"); //Sieh mal einer an, wen man uns hergebracht hat. Sie wird mir schöne Stunden bereiten.
	AI_Output(self, hero, "Info_Mod_Sylvio_VelayaDabei_03_01"); //(Zu dem Helden) Du hast deine Sache mehr als gut gemacht. Damit bist du der Aufnahme in die Reihen der Orkjäger wesentlich näher gekommen.
	AI_Output(self, hero, "Info_Mod_Sylvio_VelayaDabei_03_02"); //Hier deine Entlohnung. Die hast du dir redlich verdient.
...
FUNC VOID Info_Mod_Sylvio_Wettstreit_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sylvio_Wettstreit_03_01"); //Was ... was sagst du?
	...
	AI_Output(self, hero, "Info_Mod_Sylvio_Wettstreit_03_03"); //Du Wicht erdreistest dich ... das wirst du bitter bereuen.
	AI_Output(hero, self, "Info_Mod_Sylvio_Wettstreit_15_04"); //Wollte auch nur Bescheid sagen und wieder zurück zu Lee.
	AI_Output(self, hero, "Info_Mod_Sylvio_Wettstreit_03_05"); //Ok, wenn du einen Wettstreit willst, sollst du einen bekommen.
};
...
{
	AI_Output(self, hero, "Info_Mod_Sylvio_AtStonehenge_03_00"); //Du hier? (zu sich selbst) Verdammt, wo bleibt nur Sentenza mit meinem Schlüssel.
	AI_Output(self, hero, "Info_Mod_Sylvio_AtStonehenge_03_01"); //(Zu dem Helden) Tja, wie es aussieht werde ich dir deinen Schlüssel abnehmen müssen. Du hättest dich besser nicht mit mir anlegen sollen.
