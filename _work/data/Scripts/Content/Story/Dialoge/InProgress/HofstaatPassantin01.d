...
{
	AI_Output(self, hero, "Info_Mod_HofstaatPassantin01_Fluffy_19_00"); //Also, der König hat seinen Hund aber schlecht unter Kontrolle ...
...
{
	AI_Output(self, hero, "Info_Mod_HofstaatPassantin01_Lochgraeber_19_00"); //Hast du gehört? Irgend so ein Grünschnabel hat in nur einer Nacht ein Loch gegraben, das hundert Mal tiefer war, als das unseres Gräbers!
...
{
	AI_Output(self, hero, "Info_Mod_HofstaatPassantin01_Geliebte_19_00"); //Hast du gehört? Anscheinend hat irgend so ein junger Spund es geschafft, die königliche Geliebte zu verführen!
...
{
	AI_Output(self, hero, "Info_Mod_HofstaatPassantin01_Blind_19_00"); //Hast du's schon gehört?! In Khorata können wir kein Freudenspender mehr verkaufen! Die glauben, dass es blind macht!
...
{
	AI_Output(self, hero, "Info_Mod_HofstaatPassantin01_Brunnen_19_00"); //Sag mal, hast du dir das Schloss mal genauer angesehen? Das ist doch irgendwie schäbig und gar nicht prunkvoll.
...
{
	AI_Output(self, hero, "Info_Mod_HofstaatPassantin01_Geschwaecht_19_00"); //Also ... in letzter Zeit läuft ziemlich viel falsch!
