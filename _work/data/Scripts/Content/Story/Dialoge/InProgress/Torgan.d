...
FUNC VOID Info_Mod_Torgan_Dragomir_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Torgan_Dragomir_23_01"); //Von Dragomir? Erzähle, wie sieht es in Khorinis aus?
	...
	AI_Output(self, hero, "Info_Mod_Torgan_Dragomir_23_04"); //Das klingt nicht gut. Ich danke dir für diese wichtige Information. Wir werden den Vorfall besprechen.
	AI_Output(self, hero, "Info_Mod_Torgan_Dragomir_23_05"); //In der Zwischenzeit hätte ich noch eine Aufgabe für dich. Hast du interesse?
...
FUNC VOID Info_Mod_Torgan_Zwischenzeit_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Torgan_Zwischenzeit_23_01"); //Ich habe lange nichts mehr von unseren Spähern hier im Minental gehört. Schau bitte nach ihnen und frage nach, ob sie neue Informationen haben.
...
FUNC VOID Info_Mod_Torgan_Zwischenzeit_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Torgan_Zwischenzeit_B_23_01"); //Gut, das Lager der Späher liegt ziemlich in der Mitte des Tales an einem Pfad, der vom Alten Lager ins Neue Lager führt.
...
FUNC VOID Info_Mod_Torgan_Zwischenzeit_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Torgan_Zwischenzeit_A_23_01"); //Unseren Dank als Waldläufer.
...
FUNC VOID Info_Mod_Torgan_SpaeherTot_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Torgan_SpaeherTot_C_23_02"); //Ich verstehe nicht, warum sie unsere Späher angreifen sollten. Ich muss dies sofort weitergeben.
	...
	AI_Output(self, hero, "Info_Mod_Torgan_SpaeherTot_C_23_04"); //Hier, nimm dies als Entlohnung für deine Mühe.
...
FUNC VOID Info_Mod_Torgan_SpaeherTot_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Torgan_SpaeherTot_A_23_01"); //Was sagst du da? Diese verdammten Nichtsnutze ... rauchen den ganzen Tag Sumpfkraut oder nehmen dieses neue Rauschmittel. Diese unzuerlässigen ...
...
FUNC VOID Info_Mod_Torgan_GardistenZettel_Info()
{
	...
	if (Npc_KnowsInfo(hero, Info_Mod_Torwache_AL_01_Halt))
	{
		...
		AI_Output(self, hero, "Info_Mod_Torgan_GardistenZettel_23_06"); //Nichts? Hm. Wir müssen herausfinden, ob sie wirklich nichts damit zu tun haben, oder ob sie sich doch nur verstellen. Zuzutrauen ist ihnen alles.
	...
	if (Npc_KnowsInfo(hero, Info_Mod_Torwache_NL_01_GardistenInfos))
	{
		...
		AI_Output(self, hero, "Info_Mod_Torgan_GardistenZettel_23_08"); //Das Neue Lager wurde einfach beschossen? Weiß man mehr darüber?
		...
		if (Npc_KnowsInfo(hero, Info_Mod_Nodrak_BierInfos))
		{
			...
			AI_Output(self, hero, "Info_Mod_Torgan_GardistenZettel_23_10"); //Das ist bedenklich. Wir müssen schnell reagieren und diesen Irrtum gar nicht erst wachsen lassen.
	...
	if (Npc_KnowsInfo(hero, Info_Mod_Sancho_GardistenInfos))
	{
		...
		AI_Output(self, hero, "Info_Mod_Torgan_GardistenZettel_23_15"); //Das verstärkt meine Vermutung, dass es vielleicht gar keine Gardisten sind. Keiner von ihnen würde einfach so in der Nähe der Banditen herumstreifen.
	...
	AI_Output(self, hero, "Info_Mod_Torgan_GardistenZettel_23_17"); //Die ganze Situation ist noch zu undurchsichtig, um konkrete Vermutungen anstellen zu können.
	AI_Output(self, hero, "Info_Mod_Torgan_GardistenZettel_23_18"); //Gibt es noch mehr, was uns einen Hinweis auf den Täter geben könnte?
	...
	AI_Output(self, hero, "Info_Mod_Torgan_GardistenZettel_23_24"); //Dieser Zettel ist eindeutig magischer Natur. Bitte nimm ihn zurück und bringe ihn dem Druiden Cyrco.
	AI_Output(self, hero, "Info_Mod_Torgan_GardistenZettel_23_25"); //Du hast die dir anvertrauten Aufgaben mit großem Erfolg erledigt. Von nun an ist dir der Zutritt zu unserem Lager erlaubt, da du uns dein Vertrauen bewiesen hast. Bitte tritt ein.
...
FUNC VOID Info_Mod_Torgan_SomethingInteresting_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Torgan_SomethingInteresting_23_01"); //Erst Dragomir und nun unsere Späher. Du bringst nicht gerade positive Neuigkeiten, das reicht mir erstmal!
};
...
FUNC VOID Info_Mod_Torgan_NochEinAuftrag_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Torgan_NochEinAuftrag_23_01"); //Ich muss zugeben, dass mir nicht ganz wohl dabei ist, Aufgaben an einen Außenstehenden zu verteilen. Doch es scheint, als bliebe mir keine Wahl.
	AI_Output(self, hero, "Info_Mod_Torgan_NochEinAuftrag_23_02"); //Deine Zuverlässigkeit hast du ja bereits bewiesen, ich erwarte von dir äußerste Diskretion über unsere Angelegenheiten.
	AI_Output(hero, self, "Info_Mod_Torgan_NochEinAuftrag_15_03"); //Natürlich.
	AI_Output(self, hero, "Info_Mod_Torgan_NochEinAuftrag_23_04"); //Gut, dann pass auf. Wir müssen unbedingt mehr über diese angeblichen Gardisten herausfinden.
	AI_Output(self, hero, "Info_Mod_Torgan_NochEinAuftrag_23_05"); //Ich kann mir einfach nicht vorstellen, dass das alte Lager uns angreifen sollte und dann die Leiche ihres Kumpanen einfach dort mitsamt Ausrüstung liegen lassen.
	AI_Output(self, hero, "Info_Mod_Torgan_NochEinAuftrag_23_06"); //Bringe in Erfahrung, ob jemand in den anderen Lagern des Minentals mehr über diese „Gardisten“ weiß. Am besten fragst du bei den jeweiligen Torwächtern des Sektenlagers, alten Lagers und Neuen Lagers nach.
	AI_Output(self, hero, "Info_Mod_Torgan_NochEinAuftrag_23_07"); //Beim Alten Lager solltest du besonders vorsichtig sein, wie ich hörte, gibt es dort einige Spannungen.
	AI_Output(self, hero, "Info_Mod_Torgan_NochEinAuftrag_23_08"); //Geh auch ruhig zu den Banditen, falls du weißt, wo diese sich aufhalten. In den letzten Meldungen der Späher haben sie angeblich welche im Süden gesehen.
	AI_Output(self, hero, "Info_Mod_Torgan_NochEinAuftrag_23_09"); //Sobald du etwas herausgefunden hast, komm sofort zu uns zurück.
	AI_Output(hero, self, "Info_Mod_Torgan_NochEinAuftrag_15_10"); //Ich bin schon unterwegs!
	AI_Output(self, hero, "Info_Mod_Torgan_NochEinAuftrag_23_11"); //Und hier, nimm diese Geschwindigkeitstränke. Ich denke, du wirst sie brauchen können.

	B_GiveInvItems	(self, hero, ItPo_Speed, 4);

	AI_Output(self, hero, "Info_Mod_Torgan_NochEinAuftrag_23_12"); //Und eine Spruchrolle habe ich auch wieder für dich.
...
FUNC VOID Info_Mod_Torgan_WeicheFelle_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Torgan_WeicheFelle_23_03"); //Ich hab gehört, dass der Alchemist was Neues mit den Fellen macht. Frag den mal.
...
FUNC VOID Info_Mod_Torgan_Nahkampf_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Torgan_Nahkampf_23_02"); //Da kannst du gleich mal da draußen schauen. Da lungert so ein Typ rum. Könnte ein Söldner sein.
...
{
	AI_Output(self, hero, "Info_Mod_Torgan_Nahkampf2_23_00"); //Schöner Tag heute.
...
FUNC VOID Info_Mod_Torgan_AlterMann_Info()
{
	if (Mod_BDT_AlterWaldMann == 0)
	{
		...
		AI_Output(self, hero, "Info_Mod_Torgan_AlterMann_23_00"); //Ahh, du meinst den alten Mann des Waldes. Ja, etwas weiß ich über ihn.
		AI_Output(self, hero, "Info_Mod_Torgan_AlterMann_23_01"); //Er soll Jahrhunderte alt sein und die Tiere des Waldes Rund um Khorata behüten.
		AI_Output(self, hero, "Info_Mod_Torgan_AlterMann_23_02"); //Zwar sagt man, er sei blind, jedoch gleichzeitig auch magisch begabt.
		AI_Output(self, hero, "Info_Mod_Torgan_AlterMann_23_03"); //Mehr fällt mir gerade nicht ein. Vielleicht weiß ein anderer mehr.
	...
	else if (Mod_BDT_AlterWaldMann == 1)
	{
		...
		AI_Output(self, hero, "Info_Mod_Torgan_AlterMann_23_04"); //Der alte Mann des Waldes? Ja, ich hörte er solle einst ein Diener Adanos gewesen sein.
		AI_Output(self, hero, "Info_Mod_Torgan_AlterMann_23_05"); //Wobei unklar ist, ob er ein Waldläufer war wie wir, ein Magier des Wassers, oder ein Verwandlungsmagier.
		AI_Output(self, hero, "Info_Mod_Torgan_AlterMann_23_06"); //Seine magischen Fähigkeiten, wie auch seine starke Bindung zur Tier- und Pflanzenwelt zeugen davon, dass er von allem etwas hat.
	...
	else if (Mod_BDT_AlterWaldMann == 2)
	{
		...
		AI_Output(self, hero, "Info_Mod_Torgan_AlterMann_23_07"); //Tja, viel kann ich dir nicht über ihn verraten.
		AI_Output(self, hero, "Info_Mod_Torgan_AlterMann_23_08"); //Das Problem besteht auch darin, dass er mit keinem Menschen spricht, nicht mal mit uns, auch, wenn wir eigentlich ähnliche Ziele verfolgen.
		AI_Output(self, hero, "Info_Mod_Torgan_AlterMann_23_09"); //Allein mit den Tieren des Waldes unterhält er sich.
		AI_Output(self, hero, "Info_Mod_Torgan_AlterMann_23_10"); //Tja, wenn ich ein Keiler wäre, könnte ich dir bestimmt mehr über ihn verraten.
	...
	else if (Mod_BDT_AlterWaldMann == 3)
	{
		...
		AI_Output(self, hero, "Info_Mod_Torgan_AlterMann_23_12"); //Man sagt, er leite Rudeltiere wie Keiler, oder Wölfe dazu an, den Wald gegen Eindringlinge zu beschützen.
		AI_Output(self, hero, "Info_Mod_Torgan_AlterMann_23_13"); //Selbst, so sagt man, fände man ihn häufig in Gestalt eines grünen Wolfes vor.
	...
	else if (Mod_BDT_AlterWaldMann == 4)
	{
		...
		AI_Output(self, hero, "Info_Mod_Torgan_AlterMann_23_14"); //Du interessierst dich für Geschichten über den alten Mann des Waldes?
		AI_Output(self, hero, "Info_Mod_Torgan_AlterMann_23_15"); //Nun, viel weiß ich nicht über diesen mystischen Kauz.
		AI_Output(self, hero, "Info_Mod_Torgan_AlterMann_23_16"); //Er soll sich meistens im dunklen Wald aufhalten, aber auch immer in der Nähe von Gewässern, wie Seen.
...
FUNC VOID Info_Mod_Torgan_Asylanten_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Torgan_Asylanten_23_02"); //Das Minental ist ein gefährlicher Ort, und die Lager senden nur wenige eigene Jäger aus, sodass es hier fette Beute für uns zu machen gibt.
...
FUNC VOID Info_Mod_Torgan_WasBewachstDu_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Torgan_WasBewachstDu_23_01"); //Wir sind Waldläufer und Jäger, hier befindet sich zur Zeit eines unserer Lager, die von niemandem Fremden betreten werden sollen.
};
...
FUNC VOID Info_Mod_Torgan_Wegschauen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Torgan_Wegschauen_23_01"); //Nein! Kannst du nicht zuhören? Vielleicht haben einige Jagdtrupps von uns was für dich zu tun, sie mal bei denen nach.
...
FUNC VOID Info_Mod_Torgan_Lernen_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Torgan_Lernen_23_02"); //Ich kann dir im Moment nicht mehr beibringen, als du ohnehin schon weißt. Tut mir Leid.
	};
};
...
FUNC void Info_Mod_Torgan_Lernen_Claws()
{
	if (B_TeachPlayerTalentTakeAnimalTrophy(self, hero, TROPHY_Claws))
	{
		...
		AI_Output(self, hero, "Info_Mod_Torgan_Lernen_Claws_23_01"); //Die Haltung deiner Hand sollte etwas verschränkt sein. Mit einem kräftigen Ruck trennst du dann die Klaue ab.
		AI_Output(self, hero, "Info_Mod_Torgan_Lernen_Claws_23_02"); //Klauen sind immer ein begehrtes Zahlungsmittel bei einem Händler.
	};
...
FUNC void Info_Mod_Torgan_Lernen_Teeth()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Torgan_Lernen_Teeth_23_00"); //Das einfachste, was du Tieren entnehmen kannst, sind seine Zähne. Du fährst mit deinem Messer in seinem Maul um das Gebiss.
		AI_Output(self, hero, "Info_Mod_Torgan_Lernen_Teeth_23_01"); //Dann trennst es geschickt mit einem Ruck vom Schädel des Tieres.
	};
...
FUNC void Info_Mod_Torgan_Lernen_BFSting()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Torgan_Lernen_BFSting_23_00"); //Die Fliege hat am Rücken eine weiche Stelle.
		AI_Output(self, hero, "Info_Mod_Torgan_Lernen_BFSting_23_01"); //Wenn du dort mit der Hand gegen drückst, fährt der Stachel sehr weit aus und du kannst ihn mit dem Messer abtrennen.
	};
...
FUNC void Info_Mod_Torgan_Lernen_Fur()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Torgan_Lernen_Fur_23_00"); //Felle ziehst du am besten ab, indem du einen tiefen Schnitt an den Hinterläufen des Tieres vornimmst.
...
FUNC void Info_Mod_Torgan_Lernen_ReptileSkin()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Torgan_Lernen_ReptileSkin_23_00"); //Wenn du die Haut an den Seiten anschneidest, löst sie sich wie von selbst. Du solltest ab jetzt kein Problem mehr haben, Echsen zu häuten.
	};
...
FUNC void Info_Mod_Torgan_Lernen_Heart()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Torgan_Lernen_Heart_23_00"); //Ein Herz entfernst du dem Tier mit einem gekonnten Schnitt in die Brust. Lohnt sich aber häufig nur bei besonderen Tieren oder magischen Wesen.
	};
...
FUNC void Info_Mod_Torgan_Lernen_FireTongue()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Torgan_Lernen_FireTongue_23_00"); //Die Zunge von einem Feuerwaran schlägst du mit einem Messerhieb aus dem Maul, während du sie mit der anderen Hand festhältst.
	};
...
FUNC void Info_Mod_Torgan_Lernen_BFWing()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Torgan_Lernen_BFWing_23_00"); //Die Flügel einer Fliege entfernst du am besten mit einem Hieb einer scharfen Klinge sehr nah am Körper der Fliege.
		AI_Output(self, hero, "Info_Mod_Torgan_Lernen_BFWing_23_01"); //Du musst nur darauf achten, dass du das feine Gewebe der Flügel nicht verletzt. Sie sind nichts mehr wert, wenn du es nicht vorsichtig machst.
	};
...
FUNC void Info_Mod_Torgan_Lernen_Mandibles()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Torgan_Lernen_Mandibles_23_00"); //Klar, nachdem du das Vieh getötet hast, packst du es an den Beißzangen und reißt sie gerade heraus. Dann kommt die Sekretdrüse mit raus, ohne zu zerreißen.
		AI_Output(self, hero, "Info_Mod_Torgan_Lernen_Mandibles_23_01"); //Ich habe übrigens gehört, dass das so auch mit Feldräubern klappen soll.
	};
...
FUNC void Info_Mod_Torgan_Lernen_DrgSnapperHorn()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Torgan_Lernen_DrgSnapperHorn_23_00"); //Am Stirnansatz des Drachensnappers ist die beste Stelle, ihm das Horn mit einem stabilen Messer aus dem Schädel zu trennen.
	};
