...
{
	AI_Output(self, hero, "Info_Mod_Ferco_Hi_03_00"); //Hey du! Was willst du hier?
};
...
FUNC VOID Info_Mod_Ferco_WerBistDu_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_WerBistDu_03_01"); //Mein Name ist Ferco. Ich bin einer der Torwächter hier, wie du siehst.
};
...
FUNC VOID Info_Mod_Ferco_Guarding_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Guarding_03_01"); //Das hier ist das Lager der Verwandlungsmagier. Ich würde ihnen nicht zu nahe kommen.

	AI_PlayAni(self, "T_SEARCH");

	AI_Output(self, hero, "Info_Mod_Ferco_Guarding_03_02"); //Ich glaube sie spinnen ein wenig.
	AI_Output(hero, self, "Info_Mod_Ferco_Guarding_15_03"); //(zu sich) Das kommt mir doch bekannt vor ... (zu Ferco) Kann ich rein?
	AI_Output(self, hero, "Info_Mod_Ferco_Guarding_03_04"); //Nein, dazu bist du nicht bereit. Wir kennen dich ja gar nicht. Aber wenn du dich nützlich machen willst, kannst du das gerne tun. (lacht) Arbeit haben wir immer zu erledigen.
};
...
FUNC VOID Info_Mod_Ferco_Aufgabe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Aufgabe_03_01"); //Dort unten in einer Höhle hat mal ein Schattenläufer gehaust. Dort müssten einige Überreste zu finden sein. Die könntest du mir bringen, die Magier arbeiten nämlich an einem neuen Verwandlungszauber.
	AI_Output(hero, self, "Info_Mod_Ferco_Aufgabe_15_02"); //Alles klar.
	AI_Output(self, hero, "Info_Mod_Ferco_Aufgabe_03_03"); //Komm wieder, wenn du die Trophäen hast.
...
FUNC VOID Info_Mod_Ferco_Einnehmen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Einnehmen_03_01"); //Ach ja? Dann komm mal her, Bürschchen!
...
FUNC VOID Info_Mod_Ferco_Umgehauen_Info()
{
	if (self.aivar[AIV_LastPlayerAR] == AR_NONE) //Kampf aus Dialog heraus.
	{
		...
		{
			AI_Output(self, hero, "Info_Mod_Ferco_Umgehauen_03_00"); //Mannomann! Du hast ja 'nen ganz schönen Schlag drauf.

			Mod_FercoBesiegt	=	1;
		}
		else if (B_GetAivar(self, AIV_LastFightAgainstPlayer) == FIGHT_WON)
		{
			AI_Output(self, hero, "Info_Mod_Ferco_Umgehauen_03_01"); //Na, du Großmaul?
		};
...
FUNC VOID Info_Mod_Ferco_Loser_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Loser_03_01"); //Was willst du hier? Du bist kräftig, aber nicht sehr intelligent, wie mir scheint.
};
...
{
	AI_Output(self, hero, "Info_Mod_Ferco_NotSpeaking_03_00"); //Du weißt, was du zu tun hast.
};
...
{
	AI_Output(self, hero, "Info_Mod_Ferco_AllesDabei_03_00"); //Was willst du noch?
};
...
FUNC VOID Info_Mod_Ferco_HabAlles_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_HabAlles_03_01"); //Dann zeig mal her.
	...
	AI_Output(self, hero, "Info_Mod_Ferco_HabAlles_03_03"); //Vielen Dank. Du bist in Ordnung, Mann. Hast du Lust noch einen Job zu übernehmen?
...
FUNC VOID Info_Mod_Ferco_ZweiteQuest_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_ZweiteQuest_03_01"); //Irgendein Idiot hat die Klosterruine mal als Fleischwanze durch einen Spalt in der Mauer betreten.
	AI_Output(hero, self, "Info_Mod_Ferco_ZweiteQuest_15_02"); //(betont überrascht) Wer kommt denn auf solche Ideen?
	AI_Output(self, hero, "Info_Mod_Ferco_ZweiteQuest_03_03"); //Ich weiß es nicht. Aber bei der Aktion ist die letzte bekannte Spruchrolle dieser Art verbraucht worden.
	AI_Output(self, hero, "Info_Mod_Ferco_ZweiteQuest_03_04"); //Wäre schön, wenn du eine neue beschaffen könntest.
};
...
FUNC VOID Info_Mod_Ferco_Crazy_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Crazy_03_01"); //Ich habe gesagt, die letzte bekannte. Die Magier glauben, dass es noch einige gibt. Angeblich in kälteren Gebieten, da sie dort gut konserviert wurden.
	AI_Output(hero, self, "Info_Mod_Ferco_Crazy_15_02"); //Warum gehen sie dann nicht in diese kälteren Gebiete und suchen danach?
	AI_Output(self, hero, "Info_Mod_Ferco_Crazy_03_03"); //Sie kommen aus einem Land namens Tugettso. Vielleicht hast du schon davon gehört. Dort sind die Temperaturen höher als hier.
	AI_Output(self, hero, "Info_Mod_Ferco_Crazy_03_04"); //Sie sind gegen solchen Temperaturen nicht widerstandsfähig genug und könnten ihre Arbeit nicht fortsetzen.
...
FUNC VOID Info_Mod_Ferco_Crazy_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Crazy_B_03_01"); //Machst du’s jetzt oder nicht?
...
FUNC VOID Info_Mod_Ferco_Crazy_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Crazy_A_03_01"); //Ich wusste, dass ich mich auf dich verlassen kann. Ich habe von einem Ort namens Gelato gehört.
	AI_Output(self, hero, "Info_Mod_Ferco_Crazy_A_03_02"); //Sprich mal mit Ken. Er weiß vielleicht etwas darüber.
...
{
	AI_Output(self, hero, "Info_Mod_Ferco_CrazyTwo_03_00"); //Was willst du noch?
...
{
	AI_Output(self, hero, "Info_Mod_Ferco_CrazyThree_03_00"); //Sprich mit Ken.
...
{
	AI_Output(self, hero, "Info_Mod_Ferco_Thys_03_00"); //Hast du den Zauber?
	AI_Output(hero, self, "Info_Mod_Ferco_Thys_15_01"); //Ja, ich habe ihn.

	B_GiveInvItems	(hero, self, ItSc_TrfMeatbug, 1);

	AI_Output(self, hero, "Info_Mod_Ferco_Thys_03_02"); //Alles klar, ich werde die Magier davon in Kenntnis setzen. Komm in ein paar Tagen wieder.
...
{
	AI_Output(self, hero, "Info_Mod_Ferco_QuestThree_03_00"); //Faice war sehr erfreut über die Spruchrolle. Hier, das hat er mir für dich mitgegeben.
	...
	AI_Output(self, hero, "Info_Mod_Ferco_QuestThree_03_02"); //Doch, zufällig hat er das.
	AI_Output(self, hero, "Info_Mod_Ferco_QuestThree_03_03"); //Du musst wissen, die Magier kommen aus einem idyllischen Fleckchen Land im Westen. Man kann es ohne weiteres nicht erreichen.
	AI_Output(self, hero, "Info_Mod_Ferco_QuestThree_03_04"); //Aber das wird Turendil dir alles erklären. Du sollst gleich zu ihm gehen.
...
{
	AI_Output(self, hero, "Info_Mod_Ferco_Aufnahmequest_03_00"); //Was kann ich für dich tun?
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Aufnahmequest_03_02"); //Ah, du wurdest also geschickt. Es soll sich ein neuer Bewerber aus dem Alten Lager auf den Weg gemacht haben. Du darfst ihm die erste Prüfungsaufgabe stellen.
...
FUNC VOID Info_Mod_Ferco_Aufnahmequest_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Aufnahmequest_B_03_01"); //Ah, du wurdest also geschickt. Es soll sich ein neuer Bewerber aus dem Alten Lager auf den Weg gemacht haben. Du darfst ihm die erste Prüfungsaufgabe stellen.
...
FUNC VOID Info_Mod_Ferco_Aufnahmequest_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Aufnahmequest_A_03_01"); //Da kommt er schon. Viel Erfolg.
...
FUNC VOID Info_Mod_Ferco_Mud_Info()
{
	...
	{	
		AI_Output(self, hero, "Info_Mod_Ferco_Mud_03_00"); //Was hast du mit ihm gemacht? Du hast ihn in den sicheren Tod geschickt!
	...
	{
		AI_Output(self, hero, "Info_Mod_Ferco_Mud_03_01"); //Gut gemacht, den sehen wir so schnell nicht wieder. (lacht) Du kannst zu Faice gehen. Er wird das Nötige veranlassen.
	...
	{
		AI_Output(self, hero, "Info_Mod_Ferco_Mud_03_03"); //Du willst ihn wohl unbedingt loswerden, was?
	...
	{
		AI_Output(self, hero, "Info_Mod_Ferco_Mud_03_04"); //Das ging ja schnell. Ich denke, das kann man so gelten lassen.
		AI_Output(self, hero, "Info_Mod_Ferco_Mud_03_05"); //Nun geh zu Faice. Er wird das Nötige für deine Aufnahme veranlassen.
		AI_Output(hero, self, "Info_Mod_Ferco_Mud_15_02"); //Vielen Dank.
		...
		{
			AI_Output(self, hero, "Info_Mod_Ferco_Mud_03_06"); //Eins noch: Die Spruchrolle hätte ich gerne.
...
FUNC VOID Info_Mod_Ferco_Mud_F()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Mud_F_03_01"); //Das war schließlich Teil deiner Aufgabe.
...
FUNC VOID Info_Mod_Ferco_Mud_G()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Mud_G_03_01"); //Gut, dann behalte sie halt. Nun aber los.
...
FUNC VOID Info_Mod_Ferco_Mud_E()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Mud_E_03_01"); //Danke. Nun geh schon.
...
FUNC VOID Info_Mod_Ferco_Mud_D()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Mud_D_03_01"); //Nein nein. (lacht) Du kannst zu Faice gehen. Er wird das Nötige für deine Aufnahme veranlassen.
...
FUNC VOID Info_Mod_Ferco_Mud_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Mud_C_03_01"); //Doch, ja. (lacht) Du kannst zu Faice gehen. Er wird das Nötige für deine Aufnahme veranlassen.
	AI_Output(hero, self, "Info_Mod_Ferco_Mud_D_15_02"); //Vielen Dank.
...
FUNC VOID Info_Mod_Ferco_Mud_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Mud_B_03_01"); //Guck nicht so verdrießlich. Wir wollten ihn auch loswerden.
	AI_Output(hero, self, "Info_Mod_Ferco_Mud_B_15_02"); //...
	AI_Output(self, hero, "Info_Mod_Ferco_Mud_B_03_03"); //Wir wollten eigentlich nur wissen, wie du auf ihn reagierst. (lacht) Nun geh zu Faice, er wird das Nötige veranlassen.
...
FUNC VOID Info_Mod_Ferco_Mud_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Mud_A_03_01"); //Vielleicht hat er es, doch das kannst du nicht entscheiden.
...
FUNC VOID Info_Mod_Ferco_Falin_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Falin_03_01"); //Danke, wusste gar nicht, dass ihr Waldläufer jetzt als Kuriere agiert.
...
FUNC VOID Info_Mod_Ferco_Urs_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ferco_Urs_03_01"); //Ahh, ausgezeichnet. Das wird Faice freuen.
	AI_Output(self, hero, "Info_Mod_Ferco_Urs_03_02"); //Hier hast du deine Verwandlungsrune. Viel Spaß damit.
