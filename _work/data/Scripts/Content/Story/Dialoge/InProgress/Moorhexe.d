...
{
	AI_Output(self, hero, "Info_Mod_Moorhexe_Hi_19_00"); //Was, ein lebender Mensch in dem verfluchten Moor, und er vermag mich zu sehen?!
	AI_Output(hero, self, "Info_Mod_Moorhexe_Hi_15_01"); //So scheint es ...
	AI_Output(self, hero, "Info_Mod_Moorhexe_Hi_19_02"); //Was in Beliars Namen hast du hier verloren? Was willst du?
	AI_Output(self, hero, "Info_Mod_Moorhexe_Hi_19_03"); //Ganz bestimmt nicht die Schätze des Sumpfes, sonst hättest du verblendet von Gier dein Leben in einem morastigen Tümpel gelassen.
	...
	AI_Output(self, hero, "Info_Mod_Moorhexe_Hi_19_05"); //Was?! Den Kamm von Lich?! Bei meiner Hexenehre habe ich geschworen, ihn zu verteidigen. Nie wirst du ihn bekommen.
