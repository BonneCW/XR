...
FUNC VOID Info_Mod_Ivan_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ivan_Hi_09_01"); //Keine Ahnung. Wie ist das Wetter?
};
...
FUNC VOID Info_Mod_Ivan_Hasenfuss_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss_09_01"); //Spinnst du? Diese blutrünstigen Viecher würden uns zerfleischen.
	AI_Output(hero, self, "Info_Mod_Ivan_Hasenfuss_15_02"); //Ich habe nicht gesagt, dass du eine Wahl hast.
	AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss_09_03"); //Aber das kannst du doch nicht verlangen! Ich werd's Dad erzählen!
	AI_Output(hero, self, "Info_Mod_Ivan_Hasenfuss_15_04"); //Wann wurdest du das letzte Mal windelweich geprügelt?
	AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss_09_05"); //(fassungslos) Du bist wirklich richtig mies. Glaub ja nicht, dass ich gern mitkomme.
...
FUNC VOID Info_Mod_Ivan_Hasenfuss2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss2_09_01"); //Au ja! Kennst du eine gute Blumenwiese?
...
FUNC VOID Info_Mod_Ivan_Hasenfuss3_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss3_09_00"); //Hier willst du Blumen sammeln? Ist doch alles voller fieser Monster.
		AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss3_09_01"); //Lass uns lieber woanders hin gehen.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss3_09_02"); //Du, ich trau mich wirklich nicht. Kannst du nicht allein jagen gehen?
		AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss3_09_03"); //O-oder hast d-du etwa zu viel Schiss?
	};
...
FUNC VOID Info_Mod_Ivan_Hasenfuss3_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss3_B_09_01"); //(trotzig) Ich habe vom Jagen gar keine Ahnung.
	AI_Output(hero, self, "Info_Mod_Ivan_Hasenfuss3_B_15_02"); //Deswegen stehe ich dir zur Seite.
	AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss3_B_09_03"); //Ähm ... es reicht doch, wenn ich dir zuschaue und lerne, oder?
...
FUNC VOID Info_Mod_Ivan_Hasenfuss3_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss3_A_09_01"); //Du spinnst wohl?!
...
FUNC VOID Info_Mod_Ivan_Hasenfuss3_D()
{
	...
	AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss3_D_09_01"); //(niedergeschlagen) Na gut, versuchen wir's. Sag, wann es losgeht.
...
{
	AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss4_09_00"); //(wütend) Hau ab!
...
FUNC VOID Info_Mod_Ivan_Hasenfuss4_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss4_B_09_01"); //Hast du fünf Heilpflanzen?
...
FUNC VOID Info_Mod_Ivan_Hasenfuss4_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss4_A_09_01"); //(aufbrausend) Mein Vater steckt wieder dahinter! Ich kann es nicht mehr hören!
	AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss4_A_09_02"); //Aber das war das letzte Mal, dass er mich hintergeht!
	AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss4_A_09_03"); //Es gibt schließlich auch andere Orte, an denen ich wohnen kann.
...
FUNC VOID Info_Mod_Ivan_Hasenfuss5_Info()
{
	if (Mod_REL_Hasenfuss == 8)
	{
		AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss5_09_00"); //(prahlerisch) Hast du gesehen, wie ich's denen gegeben habe? Das hat Spaß gemacht!
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Ivan_Hasenfuss5_09_01"); //Und was soll daran jetzt so toll sein?
	};
...
FUNC VOID Info_Mod_Ivan_Freudenspender_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ivan_Freudenspender_09_01"); //Nein, ich nehm das Zeug ... regelmäßig.
