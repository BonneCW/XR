...
FUNC VOID Info_Mod_Fuego_Lehrer_Info()
{
	...
	|| (Mod_Gottstatus == 12))
	{
		AI_Output(self, hero, "Info_Mod_Fuego_Lehrer_13_01"); //Oh ja. Ich kann dir zeigen, wie du deine magische Kraft erweitern kannst.
	...
	|| (Mod_Gottstatus == 4))
	{
		AI_Output(self, hero, "Info_Mod_Fuego_Lehrer_13_02"); //(nasal) Ich unterrichte nur ehrenwerte Schüler. Du bist auf dem falschen Weg.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Fuego_Lehrer_13_03"); //Gegen eine Spende für meinen Orden werde ich dich lehren, deine magische Kraft zu steigern.
...
FUNC VOID Info_Mod_Fuego_BrokenRune_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Fuego_BrokenRune_13_01"); //Das Licht sei mit dir. Was führt dich zu mir?
	...
	AI_Output(self, hero, "Info_Mod_Fuego_BrokenRune_13_03"); //Zeig her. Hm ... sauberer Bruch. Würde sagen ein Teleportzauber.
	AI_Output(hero, self, "Info_Mod_Fuego_BrokenRune_15_04"); //Und? Kannst du mir helfen?
	AI_Output(self, hero, "Info_Mod_Fuego_BrokenRune_13_05"); //Nein. Das ist nicht unser Zauber. Das sollte ein Wassermagier besser können.
	AI_Output(self, hero, "Info_Mod_Fuego_BrokenRune_13_06"); //Im Armenviertel lebt ein Wassermagier. Dem Alter nach sollte er alle Weihen haben.
	AI_Output(hero, self, "Info_Mod_Fuego_BrokenRune_15_07"); //Ich hab von ihm gehört. Ich werde ihn fragen.
	AI_Output(self, hero, "Info_Mod_Fuego_BrokenRune_13_08"); //Tu das. Und Innos sei mit dir.
};
...
{
	AI_Output(self, hero, "Info_Mod_Fuego_Unruhen_13_00"); //(sarkastisch) Ja, vielen Dank auch, dass du uns Lukas beschert hast.
	AI_Output(hero, self, "Info_Mod_Fuego_Unruhen_15_01"); //Gibt's ein Problem damit?
	AI_Output(self, hero, "Info_Mod_Fuego_Unruhen_13_02"); //Allerdings. Er hat Elvira und mich vor die Wahl gestellt, Khorata zu verlassen oder den Glauben zu wechseln.
	AI_Output(self, hero, "Info_Mod_Fuego_Unruhen_13_03"); //Was für eine Entscheidung! Wir werden noch heute unsere Sachen packen und abreisen.
	AI_Output(self, hero, "Info_Mod_Fuego_Unruhen_13_04"); //Lass dich bloß nicht mehr bei uns blicken!
...
FUNC VOID Info_Mod_Fuego_Blutkelch_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Fuego_Blutkelch_13_01"); //Nie gesehen, nie davon gehört.
	AI_Output(self, hero, "Info_Mod_Fuego_Blutkelch_13_02"); //Aber ich könnte Innos um eine Eingebung bitten. Für eine kleine Spende ...
...
FUNC VOID Info_Mod_Fuego_ElviraKey_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Fuego_ElviraKey_13_01"); //Ahh, es erscheint einem Gläubigen Innos natürlich ungewöhnlich, eine Frau in dieser Rolle zu sehen.
		AI_Output(self, hero, "Info_Mod_Fuego_ElviraKey_13_02"); //Ich kann dir aber versichern, dass sie ihren Pflichten als eine Auserwählte Innos mit äußerster Gewissenhaftigkeit nachgeht.
		AI_Output(self, hero, "Info_Mod_Fuego_ElviraKey_13_03"); //Einzig ... nun ...
		AI_Output(hero, self, "Info_Mod_Fuego_ElviraKey_15_04"); //Ja?
		AI_Output(self, hero, "Info_Mod_Fuego_ElviraKey_13_05"); //Sie trinkt den Klosterwein stets alkoholfrei. Hat extra eine Flasche davon in ihrer Truhe.
		AI_Output(self, hero, "Info_Mod_Fuego_ElviraKey_13_06"); //Das ist natürlich nicht wirklich verwerflich, eher eine Angewohnheit die schmunzeln lässt.
		AI_Output(self, hero, "Info_Mod_Fuego_ElviraKey_13_07"); //Aber ich habe schon zu viel geredet. Innos begleite dich auf deinen Wegen.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Fuego_ElviraKey_13_08"); //Sie ist eine wahre Auserwählte Innos, rechtschaffend und stets ihrer Pflicht ergeben.
		AI_Output(hero, self, "Info_Mod_Fuego_ElviraKey_15_09"); //Kannst du mir noch etwas mehr über sie erzählen?
		AI_Output(self, hero, "Info_Mod_Fuego_ElviraKey_13_10"); //(argwöhnisch) Wie, was meinst du? Worauf willst du hinaus?
		AI_Output(self, hero, "Info_Mod_Fuego_ElviraKey_13_11"); //Was es auch immer sein mag… ich würde dir raten besser nicht respektlos zu werden.
		AI_Output(self, hero, "Info_Mod_Fuego_ElviraKey_13_12"); //Und jetzt geh! Ich habe zu tun.
	};
};
...
FUNC VOID Info_Mod_Fuego_ElviraKey2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Fuego_ElviraKey2_13_01"); //Ich nehme deine großzügige Gabe für Innos und seine Kirche dankbar entgegen.
...
FUNC VOID Info_Mod_Fuego_DickeLuft_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Fuego_DickeLuft_13_01"); //Ein paar habe ich noch übrig. Was darf's sein?
	AI_Output(hero, self, "Info_Mod_Fuego_DickeLuft_15_02"); //In ein Schaf.
	AI_Output(self, hero, "Info_Mod_Fuego_DickeLuft_13_03"); //(lacht auf) In ein Schaf? Wieso sollte man sich in so was verwandeln?
	AI_Output(self, hero, "Info_Mod_Fuego_DickeLuft_13_04"); //Das ist ja fast so beknackt wie eine Verwandlung in eine Fleischwanze!
	AI_Output(hero, self, "Info_Mod_Fuego_DickeLuft_15_05"); //Mag ja sein.
	AI_Output(self, hero, "Info_Mod_Fuego_DickeLuft_13_06"); //Da kann ich dir wirklich nicht behilflich sein. Ich habe nur nützliche Zauber.
...
FUNC VOID Info_Mod_Fuego_Freudenspender_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Fuego_Freudenspender_13_01"); //Hmm, eigentlich ist es mir untersagt, aber wenn du's für dich behältst ...
