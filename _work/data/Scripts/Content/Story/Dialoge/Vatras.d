...
FUNC VOID Info_Mod_Vatras_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Hi_16_01"); //Ich bin der Wassermagier Vatras.
};
...
{
	AI_Output(self, hero, "Info_Mod_Vatras_Daemonisch_16_00"); //Was berichtest du? Wir müssen sofort die Sicherheitsmaßnahmen verschärfen ...
...
FUNC VOID Info_Mod_Vatras_Irdorath_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Irdorath_16_02"); //Und da dachtest du an mich?
	AI_Output(self, hero, "Info_Mod_Vatras_Irdorath_16_03"); //Ich habe miterlebt, welche üblen Formen diese Bedrohung annehmen kann, wie sie fast die Stadt verheert hätte.
	AI_Output(self, hero, "Info_Mod_Vatras_Irdorath_16_04"); //Wenn mir die Möglichkeit geboten wird, so ist es nicht nur mein Wille dich dorthin zu begleiten, nein, es ist sogar meine Pflicht zur Errettung von ganz Khorinis.
};
...
FUNC VOID Info_Mod_Vatras_Irdorath2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Irdorath2_16_01"); //Dann werde ich mich nun zum Hafen begeben und dort auf den Beginn unserer Reise warten.
...
FUNC VOID Info_Mod_Vatras_Irdorath3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Irdorath3_16_01"); //Schade. Ich gehe dann wieder zurück. Du weißt wo du mich findest, wenn doch noch ein Platz frei werden sollte.
...
FUNC VOID Info_Mod_Vatras_Irdorath4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Irdorath4_16_01"); //Sehr gut, ich bin dann wieder am Hafen.
...
FUNC VOID Info_Mod_Vatras_Novize_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Novize_16_01"); //Bevor du einer von uns werden kannst musst du uns eine Zeit lang geholfen haben.
	AI_Output(self, hero, "Info_Mod_Vatras_Novize_16_02"); //Wenn du eine große Aufgabe für uns erfüllst, werde ich dich aufnehmen. Dort wirst du Aufgaben für mich und die anderen Wassermagier erledigen.
	AI_Output(self, hero, "Info_Mod_Vatras_Novize_16_03"); //Wenn du uns dann einige Zeit gedient hast werden wir dich in den Kreis des Wassers aufnehmen.
...
FUNC VOID Info_Mod_Vatras_Aufgabe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Aufgabe_16_01"); //In letzter Zeit werden immer mehr Leute vermisst. Finde heraus wo sie sind.
...
FUNC VOID Info_Mod_Vatras_Aufgabe_Wo()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Aufgabe_Wo_16_01"); //Geh in den Hafen und sprich dort mit einem unserer Mitglieder. Sein Name ist Diego.
	AI_Output(self, hero, "Info_Mod_Vatras_Aufgabe_Wo_16_02"); //Sag ihm, dass ich dich schicke, dann wird er dir alles erzählen was er weiß.
...
FUNC VOID Info_Mod_Vatras_ErsteInfos_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_ErsteInfos_16_01"); //Berichte.
	AI_Output(hero, self, "Info_Mod_Vatras_ErsteInfos_15_02"); //Diese Liste habe ich in der Nähe von Freds Haus gefunden.
	AI_Output(self, hero, "Info_Mod_Vatras_ErsteInfos_16_03"); //Zeig her.
	...
	AI_Output(self, hero, "Info_Mod_Vatras_ErsteInfos_16_05"); //Sehr gut. Es sieht so aus als wäre Elvrich ihr nächstes Opfer.
	AI_Output(self, hero, "Info_Mod_Vatras_ErsteInfos_16_06"); //Sprich mit ihm und beschatte ihn.
...
FUNC VOID Info_Mod_Vatras_Fertig_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_01"); //Wer ist es?
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_03"); //Wirklich? Was gibt dir diese Gewissheit?
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_05"); //Und wie ging diese Entführung von statten?
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_07"); //Hmm, nun, das klingt alles noch sehr verworren.
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_08"); //Und vieles bleibt in der Schwärze der Nacht verborgen.
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_09"); //Gewissheit werden wir erst haben, wenn du die Entführten auch gefunden hast.
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_10"); //Dir wurde die Richtung gewiesen. Mach dich auf den Weg und Versuch bei den Dämonenkriegern mehr herauszufinden.
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_11"); //Du findest ihr Lager irgendwo im Minental in den Bergen.
	AI_Output(self, hero, "Info_Mod_Vatras_Fertig_16_12"); //Ich hörte auch, sie sollen eine Mine besitzen. Vielleicht ist das auch ein wichtiger Anhaltspunkt ...
...
FUNC VOID Info_Mod_Vatras_RealInfos_Info()
{
	...
	if (Mod_WM_ElvrichImSumpf == 4)
	{
		...
		AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_02"); //Was, wo befindet er sich jetzt. Noch immer in Gefangenschaft?
		...
		AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_06"); //Hmm ... was du mir berichtest ist von nicht unerheblicher Bedeutung für die Sicherheit Stadt.
		AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_07"); //Wir werden schnellstmöglich die nötigen Schritte einleiten, um diesem üblen Treiben Einhalt zu gebieten ...
	...
	else
	{
		...
		AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_09"); //Bei Adanos (hält kurz inne) ... ich hatte gehofft, sie weilten noch unter den Lebenden ...
		AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_10"); //Nun, zumindest herrscht jetzt Klarheit über ihr Schicksal und wir können alles Notwenige unternehmen, um diesem Treiben innerhalb der Stadtmauern ein Ende zu setzen ...

		B_GivePlayerXP	(400);
	};

	AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_11"); //Wie dem auch sei, du hast deine Sache mehr als gut gemacht und mir bewiesen, dass du unserer Gemeinschaft ein würdiger Mitbruder sein wirst.
	AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_12"); //Deiner Aufnahme in unsere Reihen steht nun nichts mehr im Wege.

	if (Mod_Gilde == 0)
	{
		AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_13"); //Du kannst dich uns nun anschließen.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Vatras_RealInfos_16_14"); //Leider hast du dich bereits für einen anderen Weg entschieden.
	};
...
FUNC VOID Info_Mod_vatras_Aufnahme_Info()
{
	...
	if (hero.level >= 5)
	{
		AI_Output(self, hero, "Info_Mod_vatras_Aufnahme_16_01"); //Du bist bereit dich uns anzuschließen.
		AI_Output(self, hero, "Info_Mod_vatras_Aufnahme_16_02"); //Doch wenn du einmal eine unserer Rüstungen trägst, dann gibt es kein zurück mehr.
		...
		if (Mod_HatPlayerNeutraleKlamotten())
		{
			...
			|| (Mod_Gottstatus <= 4)
			{
				AI_Output(self, hero, "Info_Mod_Vatras_Aufnahme_16_05"); //Du solltest allerdings vorher noch ein paar Taten zu Gunsten von Adanos vollbringen.
			}
			else
			{
		...
		{
			AI_Output(self, hero, "Info_Mod_vatras_Aufnahme_16_04"); //Su solltest dir vorher aber noch eine neutrale Rüstung besorgen.
		};
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_vatras_Aufnahme_16_03"); //Du solltest lieber noch etwas Erfahrung sammeln.
	};
};
...
FUNC VOID Info_Mod_vatras_Aufnahme_Nein()
{
	...
	AI_Output(self, hero, "Info_Mod_vatras_Aufnahme_Nein_16_01"); //Wie du meinst.
...
FUNC VOID Info_Mod_vatras_Aufnahme_Ja()
{
	...
	AI_Output(self, hero, "Info_Mod_vatras_Aufnahme_Ja_16_01"); //Gut. Hier ist deine Robe.
	...
	AI_Output(self, hero, "Info_Mod_vatras_Aufnahme_Ja_16_03"); //Die Novizen haben bei uns einen Kampfstab. Hier ist deiner.

	B_GiveInvItems	(self, hero, ItMw_RangerStaff_Addon, 1);

	AI_Output(self, hero, "Info_Mod_vatras_Aufnahme_Ja_16_04"); //Wenn du eine bessere Waffe brauchst, dann musst du dir eine auf dem Marktplatz kaufen.
	AI_Output(self, hero, "Info_Mod_Vatras_Aufnahme_Ja_16_05"); //Diese Rune sollte dir dazu verhelfen sicher den Gefahren zu trotzen, die auf dem Weg zu meinen Mitbrüdern lauern könnten.
...
FUNC VOID Info_Mod_Vatras_AkilsHof_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_AkilsHof_16_01"); //So berichte mir, was dich zu mir führt.
	...
	AI_Output(self, hero, "Info_Mod_Vatras_AkilsHof_16_04"); //(erschrocken) Was sagst du?! Ein Lakai des Bösen? In diesem Fall werden meine Möglichkeiten kaum ausreichen.
	AI_Output(self, hero, "Info_Mod_Vatras_AkilsHof_16_05"); //Es dürfte sich mehr um eine Form der Besessenheit handeln, als um gewöhnliche Erkrankungen und da versagen meine Künste.
	AI_Output(self, hero, "Info_Mod_Vatras_AkilsHof_16_06"); //Du tätest gut daran dich zum Kloster der Feuermagier zu eilen dort dein Anliegen nochmals vorzutragen.
	AI_Output(self, hero, "Info_Mod_Vatras_AkilsHof_16_07"); //Achja, gegen Ehnim’s Leiden sollte dieser einfache Heiltrank helfen.

	B_GiveInvItems	(self, hero, ItPo_Health_01, 1);

	AI_Output(self, hero, "Info_Mod_Vatras_AkilsHof_16_08"); //Geh jetzt, du weißt, was du zu tun hast.
...
FUNC VOID Info_Mod_Vatras_Hexenfluch_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_16_01"); //Ja, ich spüre durchaus, dass du im Bann eines üblen Zaubers zu sein scheinst. Was ist geschehen?
	AI_Output(hero, self, "Info_Mod_Vatras_Hexenfluch_15_02"); //Eine Frau in Orlans Taverne hat tückische Magie auf mich gewirkt.
	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_16_03"); //Was?! Eine Frau?! Das hört sich für mich ganz nach ... einer Hexe an.

	AI_TurnAway	(self, hero);

	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_16_04"); //(nachdenklich zu sich selbst) Hier auf Khorinis ...

	AI_TurnToNpc	(self, hero);

	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_16_05"); //(wieder zum Helden) Was genau ist vorgefallen?
...
FUNC VOID Info_Mod_Vatras_Hexenfluch_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_C_16_01"); //Was?! Ja, wirklich unwürdig hast du dich gebärdet. (Etwas ruhiger) Aber ich halte dir zu gute, dass du mir die Wahrheit sagst.
	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_C_16_02"); //Ich hoffe, dass du aus deinem Fehler gelernt hast. Begib dich jetzt ins Kloster zu Pyrokar, da ich dir bei diesem Anliegen leider nicht helfen kann.
...
FUNC VOID Info_Mod_Vatras_Hexenfluch_B()
{
	...
	if (Mod_AttraktiveFrau == 2)
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_B_16_01"); //Ja, ist dem so? Es könnte tatsächlich sein, da Hexen zu solchem Werk in der Lage sind. Ich kann aber dennoch nicht erkennen, dass es der Wahrheit entspricht.
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_B_16_02"); //Wenn du dich schon auf unsittliche Weise mit dämonischen Dirnen einlässt – und das aus freien Stücken - so gestehe es wenigstens.
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_B_16_03"); //Und während du ins Kloster zu Pyrokar gehst, der dir bei deinem Anliegen helfen kann solltest du gut über dein Verhalten nachdenken.
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_B_16_04"); //Und jetzt geh mir aus den Augen.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_B_16_05"); //Hmm, ich kann in deinen Augen erkennen, dass du die Wahrheit sagst.
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_B_16_06"); //Es entspricht auch tatsächlich dem Wesen der Hexen Einfluss auf ihre Opfer nehmen zu können.
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_B_16_07"); //Leider bin ich nicht dazu in der Lage dir bei diesem Anliegen zu helfen. Begib dich am besten auf direktem Weg ins Kloster zu Pyrokar.
...
FUNC VOID Info_Mod_Vatras_Hexenfluch_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_A_16_01"); //(streng) Ich kann nicht erkennen, dass du mir die Wahrheit sagst.
	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_A_16_02"); //Wenn du dich schon auf unsittliche Weise mit dämonischen Dirnen einlässt, so gestehe es wenigstens.
...
FUNC VOID Info_Mod_Vatras_Hexenfluch_E()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_E_16_01"); //Ich will sehr für dich hoffen, dass du aus deinen Fehlern lernst.
	AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_E_16_02"); //Geh jetzt ins Kloster zu Pyrokar. Bei ihm wirst du Hilfe finden.
...
FUNC VOID Info_Mod_Vatras_Hexenfluch_D()
{
	...
	if (Mod_AttraktiveFrau == 2)
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_D_16_01"); //Ja, wirklich? Ich bin tief betrübt wie auch erzürnt, dass du mich erneut so schamlos belügst.
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_D_16_02"); //Und jetzt geh mir aus den Augen dreckiger Lügner.

		B_GivePlayerXP	(-100);
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_D_16_03"); //Hmm, ich spüre zumindest darin Wahrheit in deinen Worten. Nun, du hättest gut daran getan gleich aufrichtig zu sein.
		AI_Output(self, hero, "Info_Mod_Vatras_Hexenfluch_D_16_04"); //Gehe jetzt ins Kloster zu Pyrokar. Er kann dir bei deinem Problem  helfen.
	};
...
FUNC VOID Info_Mod_Vatras_NovizenTrank_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_NovizenTrank_16_01"); //Eine Medizin für die Feuer Novizen? Welches Leiden gilt es zu kurieren?
	...
	AI_Output(self, hero, "Info_Mod_Vatras_NovizenTrank_16_04"); //Ah, das schwarze Fieber. Nimm diesen Trank, er sollte helfen.
...
FUNC VOID Info_Mod_Vatras_TempelDicht_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_TempelDicht_16_01"); //Sprich, mein Sohn.
	...
	AI_Output(self, hero, "Info_Mod_Vatras_TempelDicht_16_05"); //Das sind wahrlich schreckliche Neuigkeiten. Ich würde dir den Schlüssel gerne geben, doch leider wurde er vor einiger Zeit geraubt.
	AI_Output(hero, self, "Info_Mod_Vatras_TempelDicht_15_06"); //Was? Wer hat den Schlüssel gestohlen?
	AI_Output(self, hero, "Info_Mod_Vatras_TempelDicht_16_07"); //Es war ein Mitglied des ominösen Blutkultes. Der Blutkult ist eine Gruppe abscheulicher Wesen, die eine Störung des Gleichgewichtes herbeisinnen.
	AI_Output(hero, self, "Info_Mod_Vatras_TempelDicht_15_08"); //Wohin kann der Dieb geflohens sein?
	AI_Output(self, hero, "Info_Mod_Vatras_TempelDicht_16_09"); //Es gibt eine Höhle nahe Orlans Taverne. Wenn ich mich recht entsinne ist dort eines der Verstecke des Blutkultes. Versuche dort dein Glück.
	AI_Output(hero, self, "Info_Mod_Vatras_TempelDicht_15_10"); //Danke für den Hinweis.
	AI_Output(self, hero, "Info_Mod_Vatras_TempelDicht_16_11"); //Eins noch! Der Blutkult hat unbekannte Fähigkeiten und Kräfte, die sogar uns beängstigen. Du solltest vorsichtig sein.
	AI_Output(hero, self, "Info_Mod_Vatras_TempelDicht_15_12"); //Das werde ich. Ich werde nun aufbrechen.
	AI_Output(self, hero, "Info_Mod_Vatras_TempelDicht_16_13"); //Mögest du heil zurückkehren!
...
FUNC VOID Info_Mod_Vatras_TempelDicht2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_TempelDicht2_16_01"); //Sehr gut, mein Sohn. Du bist ein außergewöhnlicher Krieger.
	...
	AI_Output(self, hero, "Info_Mod_Vatras_TempelDicht2_16_03"); //Tu dies, aber beeile dich. Die Zeit ist nicht unser Verbündeter.
...
FUNC VOID Info_Mod_Vatras_Kristall_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Kristall_16_01"); //Ein wertvoller Gegenstand. Ich werde dafür sorgen, dass er seinen rechtmäßigen Platz einnimmt.
	AI_Output(self, hero, "Info_Mod_Vatras_Kristall_16_02"); //Diese Tat ermöglicht es dir, dich uns anzuschließen.
...
FUNC VOID Info_Mod_Vatras_Sweetwater_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Sweetwater_16_01"); //Ganz recht. Ich habe Kunde erhalten, dass Saturas deine Hilfe braucht.
	AI_Output(self, hero, "Info_Mod_Vatras_Sweetwater_16_02"); //Ist schon etwas her. Du solltest dich beeilen.
...
FUNC VOID Info_Mod_Vatras_Zeremoniendolch_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Zeremoniendolch_16_01"); //Nur soviel, dass in Jharkendar Aufzeichnungen über ein solches Relikt gefunden wurden. Du kennst Jharkendar?
	AI_Output(hero, self, "Info_Mod_Vatras_Zeremoniendolch_15_02"); //Ja, ich habe doch das Portal geöffnet.
	AI_Output(self, hero, "Info_Mod_Vatras_Zeremoniendolch_16_03"); //Dann rede mit Merdarion. Er kann dir sicher mehr sagen.
	AI_Output(hero, self, "Info_Mod_Vatras_Zeremoniendolch_15_04"); //Danke, Magier.
	AI_Output(self, hero, "Info_Mod_Vatras_Zeremoniendolch_16_05"); //Moment noch. Wenn du rübergehst, kannst du gleich paar Dinge mitnehmen.
	AI_Output(self, hero, "Info_Mod_Vatras_Zeremoniendolch_16_06"); //Normalerweise macht Cavalon das, aber der ist lange nicht mehr hier gewesen.
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Zeremoniendolch_16_08"); //Dann sag ihm, er soll gefälligst hier erscheinen. Ich habe noch mehr zu transportieren.
	AI_Output(hero, self, "Info_Mod_Vatras_Zeremoniendolch_15_09"); //Das mach ich doch. Was soll ich mitnehmen?
	AI_Output(self, hero, "Info_Mod_Vatras_Zeremoniendolch_16_10"); //Hier. Diesen Beutel gibst du dem Magier Cronos.
...
FUNC VOID Info_Mod_Vatras_BosperLehrling_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_BosperLehrling_16_01"); //Tinkturen sind nicht mein Spezialgebiet.
		AI_Output(self, hero, "Info_Mod_Vatras_BosperLehrling_16_02"); //Ich kann dir eine Rückverwandlungs-Spruchrolle geben, die du dann noch von einem Alchemiekundigen in ihre Bestandteile zerlegen lassen musst.
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_BosperLehrling_16_04"); //Du glaubst doch nicht ernsthaft, dass ich einem Satansanhänger wie dir helfe?
		...
		AI_Output(self, hero, "Info_Mod_Vatras_BosperLehrling_16_06"); //(zweifelnd) Na ja, Tinkturen sind nicht mein Spezialgebiet.
		AI_Output(self, hero, "Info_Mod_Vatras_BosperLehrling_16_07"); //Ich könnte dir eine Rückverwandlungs-Spruchrolle verkaufen, die du dann noch von einem Alchemiekundigen in ihre Bestandteile zerlegen lassen müsstest.
		AI_Output(hero, self, "Info_Mod_Vatras_BosperLehrling_15_08"); //Wie viel willst du haben?
		AI_Output(self, hero, "Info_Mod_Vatras_BosperLehrling_16_09"); //300 Goldstücke. Und keine Verhandlungen.
	};
};
...
FUNC VOID Info_Mod_Vatras_Kreis1_Info ()
{
	...
	{
		AI_Output (self, hero, "Info_Mod_Vatras_Kreis1_16_01"); //Der erste Kreis erlaubt es dir, Runen, die du erschaffen hast, anzuwenden.
		AI_Output (self, hero, "Info_Mod_Vatras_Kreis1_16_02"); //Du kannst jetzt die Formeln der Zaubersprüche lernen, um deine eigenen Runen herzustellen.
...
FUNC VOID Info_Mod_Vatras_Kreis2_Info ()
{
	...
	if (Kapitel >= 2)
	{
		...
		{
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis2_16_01"); //Tritt nun in den zweiten Kreis und lerne, noch mächtigere Zauber zu wirken.
	...
	{
		AI_Output (self, hero, "Info_Mod_Vatras_Kreis2_16_02"); //Die Zeit ist noch nicht gekommen.
	};
};	
///////////////////////////////////////////////////////////////////////
//	Info TECH_CIRCLE_03
...
FUNC VOID Info_Mod_Vatras_Kreis3_Info ()
{
	...
	if (Kapitel >= 3)
	{
		...
		{
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis3_16_01"); //Ja, die Zeit ist gekommen. Tritt ein in den dritten Kreis der Magie. Neue Zauber erwarten dich.
	...
	{
		AI_Output (self, hero, "Info_Mod_Vatras_Kreis3_16_02"); //Es ist noch nicht an der Zeit für dich, den dritten Kreis zu lernen.
	};
};		
...
FUNC VOID Info_Mod_Vatras_Kreis4_Info ()
{
	...
	if (Kapitel >= 4)
	{
		...
		{
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis4_16_01"); //Gut. Alle Zeichen sind erfüllt. Tritt nun ein in den vierten Kreis, auf dass dir die Macht der neuen Zauber inne ist.
	...
	{
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis4_16_02"); //Noch ist es nicht soweit.
	};
};
...
FUNC VOID Info_Mod_Vatras_Kreis5_Info()
{
	...
	if (Kapitel >= 5)
	{
		...
		{
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis5_16_01"); //Dann tritt nun ein, in den fünften Kreis der Magie. Du wirst nun mächtigere Zauber als je zuvor beherrschen.
	...
	{
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis5_16_02"); //Die Zeit ist noch nicht reif dafür.
	};
};
...
FUNC VOID Info_Mod_Vatras_Kreis6_Info()
{
	...
	if (Kapitel >= 6)
	{
		...
		{
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis6_16_01"); //Viel Zeit ist vergangen, seit du den Bund mit Innos eingegangen bist. Viel ist geschehen und wir finden keine Ruhe.
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis6_16_02"); //Du bist der Erwählte Adanos'. Und als solcher wirst du alle Kraft brauchen, um deine Kämpfe zu bestehen.
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis6_16_03"); //Ich weihe dich nun, Erwählter. Du trittst in den sechsten Kreis.
			AI_Output (self, hero, "Info_Mod_Vatras_Kreis6_16_04"); //Die Zauberformeln des letzten Kreises kannst du nun von Nefarius lernen, wenn du es wünscht.
	...
	{
		AI_Output (self, hero, "Info_Mod_Vatras_Kreis6_16_05"); //Noch ist es nicht an der Zeit dafür. Wenn du ein Stück weiter auf dem Weg gegangen bist, den Beliar dir zeigt, dann werde ich dich unterweisen.
	};
};
...
FUNC VOID Info_Mod_Vatras_Lehrer_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Vatras_Lehrer_16_01"); //Ich kann dir dabei sicher behilflich sein.
...
FUNC VOID Info_Mod_Vatras_Lernen_BACK()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Lernen_BACK_16_01"); //Deine magischen Kenntnisse sind jetzt so gut, dass ich dir nichts mehr beibringen kann.
	};
	Info_ClearChoices	(Info_Mod_Vatras_Lernen);
};
...
FUNC VOID Info_Mod_Vatras_Ruestung_Info()
{
	...
	&& (Mod_Gilde < 10)
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Ruestung_16_02"); //Ich hab gehört, dass beim See nordwestlich der Ausgrabungsstätte ein Rudel Wassersnapper hausen soll. Mit deren Haut könnte ich deine Wasser Novizenrobe sicher ein wenig verbessern.
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Ruestung_16_03"); //Ich hab gehört, dass beim Weg zur Ausgrabungsstätte ein Wasserläufer sein soll. Mit dessen Fell könnte ich deine Wassermagierrobe sicher ein wenig verbessern.
...
FUNC VOID Info_Mod_Vatras_Ruestung_WNOV_S ()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Ruestung_WNOV_S_16_01"); //Alles klar.
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Ruestung_WNOV_S_16_02"); //Du musst schon eine Wasser Novizenrobe haben, sonst kann ich sie dir nicht verbessern.
	}
	else if (Npc_HasItems(hero, ItAt_Wassersnapperhaut) == 0)
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Ruestung_WNOV_S_16_03"); //Wenn du nicht die Snapperhaut hast, kann ich deine Rüstung nicht verbessern.
	};
...
FUNC VOID Info_Mod_Vatras_Ruestung_KDW_S ()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Ruestung_KDW_S_16_01"); //Alles klar.
	...
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Ruestung_RIT_S_16_02"); //Du musst schon eine Wassermagierrobe haben, sonst kann ich sie dir nicht verbessern.
	}
	else if (Npc_HasItems(hero, ItAt_WaterShadowFur) == 0)
	{
		AI_Output(self, hero, "Info_Mod_Vatras_Ruestung_RIT_S_16_03"); //Wenn du nicht das Wasserläuferfell hast, kann ich deine Rüstung nicht verbessern.
	};
