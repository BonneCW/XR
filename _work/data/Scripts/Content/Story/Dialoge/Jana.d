...
{
	AI_Output(self, hero, "Info_Mod_Jana_BerndTot_19_00"); //AAAAAAAAAAAAAAHHHHH!!!
	AI_Output(hero, self, "Info_Mod_Jana_BerndTot_15_01"); //Beruhige dich, ist ja schon gut! Ich bin von der Miliz.
	AI_Output(self, hero, "Info_Mod_Jana_BerndTot_19_02"); //Das hab ich mir bei IHM auch gedacht!
	AI_Output(hero, self, "Info_Mod_Jana_BerndTot_15_03"); //Wovon redest du?
	AI_Output(self, hero, "Info_Mod_Jana_BerndTot_19_04"); //Na von dem Typ, der Bernd abgeschlachtet hat!
	AI_Output(hero, self, "Info_Mod_Jana_BerndTot_15_05"); //Das war ein Milize?
	AI_Output(self, hero, "Info_Mod_Jana_BerndTot_19_06"); //Ja, hörst du mir eigentlich nicht zu, dass du alles nochmal fragst? Das war so 'n dunkler Typ, der eine Milizuniform trug!
	AI_Output(hero, self, "Info_Mod_Jana_BerndTot_15_07"); //Der ist einfach rein spaziert und hat Bernd niedergestreckt?
	AI_Output(self, hero, "Info_Mod_Jana_BerndTot_19_08"); //Ja, glaubst du ich hätte mich ihm in den Weg gestellt? War ja selbst damit beschäftigt mich Bernd zu erwehren und der Typ sah um einiges gefährlicher aus.
	AI_Output(hero, self, "Info_Mod_Jana_BerndTot_15_09"); //Geht’s auch etwas genauer als "Dunkler Typ mit Milizuniform"?
	AI_Output(self, hero, "Info_Mod_Jana_BerndTot_19_10"); //Nein, das ist alles was ich noch weiß, ich hätte ja beinahe 'nen Herzinfarkt bekommen.
	...
	AI_Output(self, hero, "Info_Mod_Jana_BerndTot_19_12"); //Jetzt wo du’s sagst ... er hat irgendein komisches Zeug gelabert. Irgendwas von wegen "Ein Guter Milize schützt stets die Schwächeren.", das hat er immer wieder wiederholt.
...
FUNC VOID Info_Mod_Jana_Shakir_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Jana_Shakir_19_01"); //Auf dich sicher nicht. Und was geht's dich an?
	AI_Output(hero, self, "Info_Mod_Jana_Shakir_15_02"); //Nun, ich suche eine Dame für ... gewissermaßen ... zur Entspannung ...
	AI_Output(self, hero, "Info_Mod_Jana_Shakir_19_03"); //(laut) Scher dich, du Strolch, und mach's dir selber!
	AI_Output(self, hero, "Info_Mod_Jana_Shakir_19_04"); //Ich bin eine ehrbare Frau, die auf ihren Mann wartet.
	AI_Output(self, hero, "Info_Mod_Jana_Shakir_19_05"); //Wenn der zurückkommt, kannst du was erleben!
	AI_Output(hero, self, "Info_Mod_Jana_Shakir_15_06"); //Bitte vielmals um Entschuldigung. Ich dachte nur ...
	AI_Output(self, hero, "Info_Mod_Jana_Shakir_19_07"); //Ist offensichtlich nicht deine starke Seite.
	AI_Output(self, hero, "Info_Mod_Jana_Shakir_19_08"); //Probiers oben in der Unterstadt. Die Nichte von Thorben, die Gritta, braucht immer Geld. Hat überall Schulden.
	AI_Output(self, hero, "Info_Mod_Jana_Shakir_19_09"); //(laut) Aber sag nicht, dass ich das gesagt habe!
...
{
	AI_Output(self, hero, "Info_Mod_Jana_Beutel_19_00"); //Junger Mann, bleib' doch kurz stehen.
...
FUNC VOID Info_Mod_Jana_Beutel_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Jana_Beutel_A_19_01"); //Ich war gerade einkaufen, und nun ist mein Einkaufsbeutel so schwer, dass ich ihn nicht mehr tragen kann.
	AI_Output(self, hero, "Info_Mod_Jana_Beutel_A_19_02"); //Wärst du so freundlich, ihn mir nach Hause zu bringen?
...
FUNC VOID Info_Mod_Jana_Beutel_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Jana_Beutel_C_19_01"); //Im Hafenviertel, im Haus zwischen Fellan und der Lagerhalle.
	AI_Output(self, hero, "Info_Mod_Jana_Beutel_C_19_02"); //Stell den Beutel einfach irgendwo ab.
...
FUNC VOID Info_Mod_Jana_Beutel2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Jana_Beutel2_19_01"); //Ich danke dir, junger Mann. Nimm diese Münzen als Dank.
