...
FUNC VOID Info_Mod_Marcos_IR_Hebel_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Marcos_IR_Hebel_04_00"); //Natürlich. Wenn wir dadurch vielleicht weiterkommen ...
...
FUNC VOID Info_Mod_Marcos_IR_Heiltrank_Info()
{
	...
	{
		Info_AddChoice	(Info_Mod_Marcos_IR_Heiltrank, "Essenz der Heilung", Info_Mod_Marcos_IR_Heiltrank_Health_04);
	};
	if (Npc_HasItems(hero, ItPo_Health_01) >= 1)
	{
		Info_AddChoice	(Info_Mod_Marcos_IR_Heiltrank, "Elixier der Heilung", Info_Mod_Marcos_IR_Heiltrank_Health_03);
	};
	if (Npc_HasItems(hero, ItPo_Health_02) >= 1)
	{
		Info_AddChoice	(Info_Mod_Marcos_IR_Heiltrank, "Extrakt der Heilung", Info_Mod_Marcos_IR_Heiltrank_Health_02);
	};
	if (Npc_HasItems(hero, ItPo_Health_01) >= 1)
	{
		Info_AddChoice	(Info_Mod_Marcos_IR_Heiltrank, "Essenz der Heilung", Info_Mod_Marcos_IR_Heiltrank_Health_01);
	};
	if (Npc_HasItems(hero, ItPo_Health_07) >= 1)
	{
		Info_AddChoice	(Info_Mod_Marcos_IR_Heiltrank, "Trank der leichten Heilung", Info_Mod_Marcos_IR_Heiltrank_Health_07);
	};
	if (Npc_HasItems(hero, ItPo_Health_06) >= 1)
	{
		Info_AddChoice	(Info_Mod_Marcos_IR_Heiltrank, "Leichter Heiltrank", Info_Mod_Marcos_IR_Heiltrank_Health_06);
	};
	if (Npc_HasItems(hero, ItPo_Health_05) >= 1)
	{
		Info_AddChoice	(Info_Mod_Marcos_IR_Heiltrank, "Trank der schnellen Heilung", Info_Mod_Marcos_IR_Heiltrank_Health_05);
	};
};
