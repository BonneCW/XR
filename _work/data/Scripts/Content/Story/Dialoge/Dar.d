...
{
	AI_Output(self, hero, "Info_Mod_Dar_Miguel_03_00"); //(unruhig) Hey, was machst du hier?! Oder bringst du mir die Ware von den Banditen?
	AI_Output(hero, self, "Info_Mod_Dar_Miguel_15_01"); //Ähhm, ja, das soll ich.
	AI_Output(self, hero, "Info_Mod_Dar_Miguel_03_02"); //Na los, dann her mit dem Trank.
