...
{
	AI_Output(self, hero, "Info_Mod_Garett_Hi_28_00"); //Hey Neuer, brauchst 'ne Waffe?
...
FUNC VOID Info_Mod_Garett_Befreiung_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Garett_Befreiung_28_01"); //Wieso?
	...
	AI_Output(self, hero, "Info_Mod_Garett_Befreiung_28_03"); //(lacht) Achso. Das ist ja was Anderes.
	AI_Output(hero, self, "Info_Mod_Garett_Befreiung_15_04"); //Also hast du etwas?
	AI_Output(self, hero, "Info_Mod_Garett_Befreiung_28_05"); //Allerdings. Wenn es wieder zu einem Angriff der Untoten kommen sollte, haben wir kaum Waffen um uns zu verteidigen.
	AI_Output(self, hero, "Info_Mod_Garett_Befreiung_28_06"); //Ich benötige zehn Entermesser, um wieder genug Vorrat zu haben.
	AI_Output(hero, self, "Info_Mod_Garett_Befreiung_15_07"); //Woher bekomm ich die Entermesser?
	AI_Output(self, hero, "Info_Mod_Garett_Befreiung_28_08"); //Geh' am Strand entlang, dort liegen noch einige Waffen herum. Da müsstest du fündig werden.
...
FUNC VOID Info_Mod_Garett_Befreiung2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Garett_Befreiung2_28_01"); //Danke, hier hast du eine Belohnung.
...
FUNC VOID Info_Mod_Garett_Blutkelch_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Garett_Blutkelch_28_01"); //Was soll das sein. Ich kenne nur die gemeine Spitzhacke. Und davon hab ich keine.
