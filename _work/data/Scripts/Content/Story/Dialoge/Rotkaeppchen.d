...
FUNC VOID Info_Mod_Rotkaeppchen_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Rotkaeppchen_Hi_19_01"); //(einfältig) So langsam mache ich mir auch Sorgen.
	AI_Output(self, hero, "Info_Mod_Rotkaeppchen_Hi_19_02"); //Ich habe das Gefühl, dass mich seit einiger Zeit ein großer Wolf verfolgt. Er ist dort hinten, Richtung abgebranntes Lager.
	AI_Output(self, hero, "Info_Mod_Rotkaeppchen_Hi_19_03"); //Ich traue mich nicht an ihm vorbei, und laufe deswegen immer tiefer in den Wald hinein.
...
FUNC VOID Info_Mod_Rotkaeppchen_Grossmutter_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Rotkaeppchen_Grossmutter_19_01"); //Ja, wieso fragst du? Ich will sie demnächst mal wieder besuchen, sie ist doch so allein.
};
...
FUNC VOID Info_Mod_Rotkaeppchen_WolfTot_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Rotkaeppchen_WolfTot_19_01"); //Hast du ihn vertrieben?
	AI_Output(hero, self, "Info_Mod_Rotkaeppchen_WolfTot_15_02"); //So kann man es nennen.
	AI_Output(self, hero, "Info_Mod_Rotkaeppchen_WolfTot_19_03"); //Dann kann ich jetzt endlich wieder zurück nach Hause!
	AI_Output(self, hero, "Info_Mod_Rotkaeppchen_WolfTot_19_04"); //Danke, dafür bekommst du die Hälfte der Pilze, die ich gepflückt habe!
	AI_Output(self, hero, "Info_Mod_Rotkaeppchen_WolfTot_19_05"); //Sieh nur, was ich für Prachtexemplare gefunden habe!
