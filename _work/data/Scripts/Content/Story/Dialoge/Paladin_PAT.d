...

{
...

	{
		...
		Info_AddChoice	(Info_Mod_Paladin_PAT_Heiltrank, "Essenz der Heilung", Info_Mod_Paladin_PAT_Heiltrank_Health_04);
...

	{
		...
		Info_AddChoice	(Info_Mod_Paladin_PAT_Heiltrank, "Elixier der Heilung", Info_Mod_Paladin_PAT_Heiltrank_Health_03);
...

	{
		...
		Info_AddChoice	(Info_Mod_Paladin_PAT_Heiltrank, "Extrakt der Heilung", Info_Mod_Paladin_PAT_Heiltrank_Health_02);
...

	{
		...
		Info_AddChoice	(Info_Mod_Paladin_PAT_Heiltrank, "Essenz der Heilung", Info_Mod_Paladin_PAT_Heiltrank_Health_01);
...

	{
		...
		Info_AddChoice	(Info_Mod_Paladin_PAT_Heiltrank, "Trank der leichten Heilung", Info_Mod_Paladin_PAT_Heiltrank_Health_07);
...

	{
		...
		Info_AddChoice	(Info_Mod_Paladin_PAT_Heiltrank, "Leichter Heiltrank", Info_Mod_Paladin_PAT_Heiltrank_Health_06);
...

	{
		...
		Info_AddChoice	(Info_Mod_Paladin_PAT_Heiltrank, "Trank der schnellen Heilung", Info_Mod_Paladin_PAT_Heiltrank_Health_05);
