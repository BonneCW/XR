...
FUNC VOID Info_Mod_Elsbeth_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Elsbeth_Hi_19_01"); //Ich komme vom Alten Lager. Ich wollte nicht so, wie der Baron wollte.
	AI_Output(hero, self, "Info_Mod_Elsbeth_Hi_15_02"); //Und dann hat er dich vor die Tür gesetzt.
	AI_Output(self, hero, "Info_Mod_Elsbeth_Hi_19_03"); //Gewissermaßen. Bin bei den Pennern draußen neben dem Tor gelandet.
	AI_Output(self, hero, "Info_Mod_Elsbeth_Hi_19_04"); //Irgendwann kam dann dieser Baldur vorbei und hat mich hierher mitgenommen.
	AI_Output(hero, self, "Info_Mod_Elsbeth_Hi_15_05"); //Bist du froh darüber?
	AI_Output(self, hero, "Info_Mod_Elsbeth_Hi_19_06"); //Und ob. Hier wird man als Frau repektiert, obwohl das ruppige Kerle sind.
...
{
	AI_Output(self, hero, "Info_Mod_Elsbeth_Ambi_19_00"); //Ich sehe, du bist dauernd auf Achse.
	...
	AI_Output(self, hero, "Info_Mod_Elsbeth_Ambi_19_02"); //Und doch bist du immer freundlich, wie mir scheint.
	AI_Output(hero, self, "Info_Mod_Elsbeth_Ambi_15_03"); //Na ja. Ich kann auch anders.
	AI_Output(self, hero, "Info_Mod_Elsbeth_Ambi_19_04"); //Ich finde dich jedenfalls sympatisch. Du darfst mich Beth nennen.
	AI_Output(hero, self, "Info_Mod_Elsbeth_Ambi_15_05"); //Das freut mich, Beth. Vielleicht kann ich dir auch einen Gefallen tun?
	AI_Output(self, hero, "Info_Mod_Elsbeth_Ambi_19_06"); //Das kannst du. Mir geht das Holz für den Herd aus.
	AI_Output(self, hero, "Info_Mod_Elsbeth_Ambi_19_07"); //Neue Äste könnte ich gebrauchen. So ein Dutzend sollten reichen.
...
FUNC VOID Info_Mod_Elsbeth_Holz_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Elsbeth_Holz_19_01"); //Das ist lieb. Danke schön.
	AI_Output(hero, self, "Info_Mod_Elsbeth_Holz_15_02"); //Gern geschehen, aber ich muss jetzt weiter.
	AI_Output(self, hero, "Info_Mod_Elsbeth_Holz_19_03"); //Dann wünsche ich dir Erfolg bei deinen Aufgaben.
