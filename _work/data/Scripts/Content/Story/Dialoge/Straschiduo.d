...
{
	AI_Output(self, hero, "Info_Mod_Straschiduo_Hi_02_00"); //Was?! Wer wagt es die heiligen Hallen unserer Bruderschaft des Blutkultes zu betreten?
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_Hi_02_01"); //Wäre ich über dein Erscheinen nicht so verblüfft, so würde ich dich auf der Stelle töten. Also sprich rasch: Wer bist du und was machst du hier?
...
FUNC VOID Info_Mod_Straschiduo_Hi_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_Hi_C_02_01"); //Du erstaunst mich und wirfst einige Fragen auf. Wer bist du?
...
FUNC VOID Info_Mod_Straschiduo_Hi_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_Hi_B_02_01"); //Du strapazierst meine Geduld. Wir sind die magisch begabte und überaus einflussreiche Gemeinschaft des Blutkultes. Das sollte dir vorerst reichen! Und jetzt sprich!!!
...
FUNC VOID Info_Mod_Straschiduo_Hi_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_Hi_A_02_01"); //Hahaha, dass ich nicht lache. Du Wicht willst uns vernichten?! An deinem Blute werden wir uns laben. Los, Brüder, hackt ihn in Stücke!
...
FUNC VOID Info_Mod_Straschiduo_Hi_F()
{
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_Hi_F_02_01"); //Hmm, ... Und so sprich: welchem Gott huldigst du?
...
{
	AI_Output(hero, self, "Info_Mod_Straschiduo_Hi_E_15_00"); //Ich bin ein ergebener Diener Beliar’s.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Hi_E_02_01"); //Der ergebene Diener eines Gottes?! Keine Qualifikation, die für dich spricht ... Los Mitbrüder, macht diesen gottesfürchtigen Lakaien alle.
...
FUNC VOID Info_Mod_Straschiduo_Hi_D()
{
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_Hi_D_02_01"); //Was?! Ein Diener Adanos’ wagt es unsere heiligen Hallen zu besudeln?! Los, Mitbrüder, weidet ihn aus!
...
{
	AI_Output(self, hero, "Info_Mod_Straschiduo_Hi_K_02_00"); //Ja, das sind doch schon mal günstige Voraussetzungen. Und damit, dass du es überhaupt bis zu uns geschafft hast, hast du bereits einen würdigen Beweis deiner Fähigkeiten geliefert.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Hi_K_02_01"); //Nun, bevor wir dich jedoch in unsere Reihen aufnehmen, werde ich dich noch einigen kleinen Prüfungen unterziehen, die einen letzten Beleg liefern sollen für deinen Willen unserer Gemeinschaft zu dienen und damit in den Genuss ihrer machtvollen Mittel zu kommen.
...
FUNC VOID Info_Mod_Straschiduo_Hi_H()
{
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_Hi_H_02_01"); //Hmm, dass es nach so langer Zeit überhaupt noch Angehörige dieser Gattung gibt ...?! Nun, nicht mehr lange.
...
FUNC VOID Info_Mod_Straschiduo_Hi_G()
{
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_Hi_G_02_01"); //Soso. Aber die längste Zeit. Mitbrüder ...
...
FUNC VOID Info_Mod_Straschiduo_Hi_M()
{
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_Hi_M_02_01"); //(argwöhnisch)Wirklich? Dann beantworte mir doch mal einige Fragen! Wer bist du?
...
FUNC VOID Info_Mod_Straschiduo_Hi_L()
{
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_Hi_L_02_01"); //Hahaha, das ich nicht lache.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Hi_L_02_02"); //Wer uns über den Weg läuft kommt nicht umhin seinen Tribut zu entrichten.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Hi_L_02_03"); //Los Brüder, zerhackt ihn!
...
FUNC VOID Info_Mod_Straschiduo_WhatToDo_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_WhatToDo_02_01"); //Für unsere Rituale benötigen wir immer wieder frisches Blut. Bringe mir also fünf Flaschen Blut getöteter Menschen.
	AI_Output(self, hero, "Info_Mod_Straschiduo_WhatToDo_02_02"); //Damit die Rituale auch die gewünschte Wirkung haben, müssen wir vorher noch Fliegenpilze zu uns nehmen. Bring mir davon sechs Stück.
	AI_Output(self, hero, "Info_Mod_Straschiduo_WhatToDo_02_03"); //Ja, und dann wären noch diese lästigen Wassermagier mit ihren Lakaien ...  mache einen ihrer Magier oder Krieger ausfindig, töte ihn und bringe mir seine Waffe.
	AI_Output(self, hero, "Info_Mod_Straschiduo_WhatToDo_02_04"); //Wenn du das getan hast erhältst du Zugang zu unseren anderen Räumen und kommst deinem Beitritt in unsere Bruderschaft ein großes Stück näher.
...
FUNC VOID Info_Mod_Straschiduo_AllesDa_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_AllesDa_02_01"); //Sehr, gut, lass sehen. Fünf Fläschchen Blut, Fliegenpilze, in Ordnung, und dann – tatsächlich – die Waffe eines Lakaien des Wassers. Ein elender Diener Adanos’ weniger.
	AI_Output(self, hero, "Info_Mod_Straschiduo_AllesDa_02_02"); //Ja, nun sind dir auch unsere anderen Räumlichkeiten zugänglich und die letzten Vorbereitungen für das Ritual deiner Aufnahme können beginnen.
...
FUNC VOID Info_Mod_Straschiduo_LetzteVorbereitungen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_LetzteVorbereitungen_02_01"); //Ja, nimm diese Zähne eines Erzdämons, säe sie auf der rot markierten Stelle von Sekobs Feld aus und ernte, was dem Boden entwächst.

	B_GiveInvItems	(self, hero, ItAt_ErzdemonTooth, 1);

	Wld_SendTrigger	("EVT_BLUTKULT_SAATMARKIERUNG");

	AI_Output(self, hero, "Info_Mod_Straschiduo_LetzteVorbereitungen_02_02"); //Bring alles zu mir und werde einer unserer Brüder.
	AI_Output(self, hero, "Info_Mod_Straschiduo_LetzteVorbereitungen_02_03"); //Nimm noch diese Spitzhacke, damit sollte es leichter sein, die Samen zu säen.

	B_GiveInvItems	(self, hero, ItMw_2H_AXe_L_01, 1);

	B_LogEntry	(TOPIC_MOD_ADANOS_UNHEIL, "Rätselhaft. Die Zähne auf Sekob’s Feld aussäen, wo es rot markiert ist und die Früchte ernten, die dem Boden entwachsen.");
};
...
FUNC VOID Info_Mod_Straschiduo_Gemeinschaft_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_Gemeinschaft_02_01"); //Nun gut, obwohl ich dir natürlich nicht alles preisgeben kann.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Gemeinschaft_02_02"); //Du bist noch kein vollwertiges Mitglied unserer Gemeinschaft und überdies haben wir gerade ein, ähh, großes Projekt am Laufen, das unsere volle Aufmerksamkeit erfordert und keine großen Ausschweife erlaubt.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Gemeinschaft_02_03"); //Nun denn. Wir sind eine uralte Gemeinschaft, weit Älter als du dir zu dem gegebenen Zeitpunkt vorstellen kannst. Ursprünglich lebten wir auf einem anderen Teil von Khorinis.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Gemeinschaft_02_04"); //Aber die Kultur, die dort einst wohnhaft war, starb aus, ähhm, widrigen Gründen aus, sodass wir Opfer für unsere Rituale – wir tragen nicht umsonst den Namen Blutkult – vorerst nicht mehr fanden.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Gemeinschaft_02_05"); //Ok, ich muss einräumen, dass wir vielleicht auch unseren Teil zu dem Untergang dieser Kultur beigetragen hatten (lacht gehässig).
	AI_Output(self, hero, "Info_Mod_Straschiduo_Gemeinschaft_02_06"); //Wir begaben uns aus diesem Grund in einen Jahrhunderte währenden Schlaf bis wir Leben und magische Energie auf diesem Teil von Khorinis spürten, und uns hierher begaben.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Gemeinschaft_02_07"); //Wir mussten aber feststellen, dass die Bedingungen noch nicht  unseren Bedürfnissen entsprachen und ruhten wiederum viele Jahre, bis vor kurzer Zeit eine erhebliche magische Erschütterung uns aus unserem Schlaf riss.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Gemeinschaft_02_08"); //Erschütterungen dieser Art lassen nämlich auf Umstürze im Gefüge der Welt hoffen, die uns das Blut und die Energien vieler Lebewesen zur Verfügung stellen können und somit auf gute Bedingungen hoffen lassen.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Gemeinschaft_02_09"); //Ja, und dann trat noch jemand mit uns in Kontakt, der fast genauso alt ist, wie wir ...
	AI_Output(hero, self, "Info_Mod_Straschiduo_Gemeinschaft_15_10"); //Von wem sprichst du?
	AI_Output(self, hero, "Info_Mod_Straschiduo_Gemeinschaft_02_11"); //Ähhm, das erläutere ich bei anderer Gelegenheit näher. (herrisch) Geh, jetzt deinen Aufgaben nach. Du weißt, was du zu tun hast.
};
...
FUNC VOID Info_Mod_Straschiduo_Ernte_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_Ernte_02_01"); //Hervorragend. Nur noch eine Sache musst du jetzt noch erledigen.
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_Ernte_02_03"); //(lacht) Nein, diesmal nichts dergleichen. Jetzt lernst du zur Abwechslung die Freuden des Gaumens kennen.
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_Ernte_02_05"); //Siehst du, auch das kommt bei uns nicht zu kurz. Hier ist das Rezept ... und 4 Flaschen Blut, wie auch 3 Fliegenpilze die du dafür benötigen wirst.
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_Ernte_02_07"); //Nachdem du es zubereitet und verzehrt hast, musst noch mal zu mir kommen, damit wir dich zu einem vollwertigen Mitglied unserer Gemeinschaft machen.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Ernte_02_08"); //Und, ach ja, bevor du es isst, solltest du darauf achten, dass dein Vorrat an Lebensenergie gut gefüllt ist. Es könnte dich sonst umhauen.
...
FUNC VOID Info_Mod_Straschiduo_Halbinfernalischer_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Straschiduo_Halbinfernalischer_02_01"); //Ahh, ausgezeichnet. Spürst du die dämonischen Kräfte in dir?
	AI_Output(hero, self, "Info_Mod_Straschiduo_Halbinfernalischer_15_02"); //Öhh, ich denke schon.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Halbinfernalischer_02_03"); //Dann tritt nun in unsere Mitte.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Halbinfernalischer_02_04"); //(zu den Umstehenden) Brüder, es ist nun an der Zeit einen neuen Mitstreiter in unsere Gemeinschaft aufzunehmen, einen, der sich wahrhaft als würdig erwiesen hat.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Halbinfernalischer_02_05"); //Ja, Äonen ist es her, dass wir das letzte Mal ein neues Mitglied willkommen geheißen haben.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Halbinfernalischer_02_06"); //Und nachdem einer unserer Brüder ins Minental aufbrach, um dort nach Möglichkeiten für Tod und Zerstörung Ausschau zu halten, ist uns ein weiterer Mitbruder vor Ort umso mehr willkommen.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Halbinfernalischer_02_07"); //(Zum Helden) Nun, so wisse denn, dass wir für das Erscheinen der Geschöpfe auf dem Plateau verantwortlich sind, obwohl du vermutlich schon selbst zu der Vermutung gestoßen bist.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Halbinfernalischer_02_08"); //Wir erschufen diese Geschöpfe durch gemeinsame Zusammenarbeit mit Hexen indem wir frei werdende Energien Beliars’ und Innos’ aufnahmen, und daraus diese Geschöpfe formten.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Halbinfernalischer_02_09"); //So ein Narr der Wassermagier hat uns  unwissentlich in die Hände gespielt, als er ein Ritual vollzog, um gesegnete und verfluchte Böden zu reinigen. (lacht gehässig)
	AI_Output(self, hero, "Info_Mod_Straschiduo_Halbinfernalischer_02_10"); //(spottet) Ha, die Erhaltung des Gleichgewichts. Nicht so lange es uns gibt. Nun, wie dem auch sei, leider ist der Kontakt zu den Hexen irgendwie abgebrochen.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Halbinfernalischer_02_11"); //Deine erste Aufgabe wird es sein herauszufinden, was vorgefallen ist. Und danach wirst du noch als Bote denjenigen aufsuchen, unter dessen Anleitung sich unser Bündnis mit den Hexen formte und der dieses herrlich abscheuliche Werk erst möglich machte.
	AI_Output(self, hero, "Info_Mod_Straschiduo_Halbinfernalischer_02_12"); //Aber das alles erst nach dem Ritual. Lasst uns jetzt anfangen.
...
{
	AI_Output(self, hero, "Info_Mod_Straschiduo_RitualDontWork_02_00"); //Verdammt, irgendwas scheint das Ritual zu hemmen. Lass mich nachdenken.
...
{
	AI_Output(self, hero, "Info_Mod_Straschiduo_Adanos_02_00"); //(entgeistert) Allein die Präsenz Adanos’ würde vermögen das Ritual zu unterbinden. (hasserfüllt) Ein Diener Adanos’!!!
...
FUNC VOID Info_Mod_Straschiduo_Blut_Info()
{
	...
	{
		AI_Output (self, other, "Info_Mod_Straschiduo_Blut_02_01"); //Gut. Hör zu. Es ist im Grunde ganz einfach.
		AI_Output (self, other, "Info_Mod_Straschiduo_Blut_02_02"); //Du nimmst eine scharfe Klinge und schneidest in irgendwo auf, am besten an der Hauptschlagader. Dann hältst du ein Fläschchen darunter und fängst das Blut ein.
	};
};
...
FUNC VOID Info_Mod_Straschiduo_Zunge_Info()
{
	...
	{
		AI_Output (self, other, "Info_Mod_Straschiduo_Zunge_02_01"); //Die Zunge von einem Feuerwaran schlägst du mit einem Messerhieb aus dem Maul, während du sie mit der anderen Hand festhältst.
	};
};
...
FUNC VOID Info_Mod_Straschiduo_Herz_Info()
{
	...
	{
		AI_Output (self, other, "Info_Mod_Straschiduo_Herz_02_01"); //Ein Herz entfernst du dem Tier mit einem gekonnten Schnitt in die Brust. Lohnt sich aber häufig nur bei besonderen Tieren oder magischen Wesen.
	};
};
...
{
	AI_Output (self, hero,"Info_Mod_Straschiduo_FirstWarn_02_00"); //HALT! Du darfst noch nicht vorbei.
...
{
	AI_Output (self, hero,"Info_Mod_Straschiduo_SecondWarn_02_00"); //Ich sag's dir zum letzten Mal. Einen Schritt weiter und du bist tot!
...
func void Info_Mod_Straschiduo_Attack_Info()
{
	...
	AI_Output (self, hero,"Info_Mod_Straschiduo_Attack_02_00"); //Du hast es so gewollt ...
