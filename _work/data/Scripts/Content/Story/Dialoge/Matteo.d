...
{
	AI_Output(self, hero, "Info_Mod_Matteo_Hi_09_00"); //(eifrig) Ein Kunde, ein Kunde! Tritt ein, Fremder, und stöbere in meinen erlesenen Waren!
...
FUNC VOID Info_Mod_Matteo_Angebot_Kissen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_Angebot_Kissen_09_01"); //Was genau? Vielleicht eine Fellmütze? Ich hätte da ...
	AI_Output(hero, self, "Info_Mod_Matteo_Angebot_Kissen_15_02"); //Nein, nein. Was zum Kopf drauflegen beim Schlafen.
	AI_Output(self, hero, "Info_Mod_Matteo_Angebot_Kissen_09_03"); //Aha. Und was soll das sein?
	AI_Output(hero, self, "Info_Mod_Matteo_Angebot_Kissen_15_04"); //Wenn ich das wüsste. Vielleicht ein Sack mit trockenem Gras drin.
	AI_Output(self, hero, "Info_Mod_Matteo_Angebot_Kissen_09_05"); //Sowas hab ich nicht. Vielleicht die Bauern ...
...
{
	AI_Output(self, hero, "Info_Mod_Matteo_ThorbenLehrling_09_00"); //Ach, hallo. Weißt du, wo Thorben ist?
	AI_Output(hero, self, "Info_Mod_Matteo_ThorbenLehrling_15_01"); //Ich bin seine Vertretung. Du willst deine Tische abholen?
	AI_Output(self, hero, "Info_Mod_Matteo_ThorbenLehrling_09_02"); //Richtig, richtig. Thorben und ich hatten einen Preis von 100 Goldmünzen ausgehandelt.
...
FUNC VOID Info_Mod_Matteo_ThorbenLehrling_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_ThorbenLehrling_B_09_01"); //Wie ich sehe, kann man dir nicht so einfach etwas vormachen. Na schön, hier hast du die 150 Goldmünzen.
...
FUNC VOID Info_Mod_Matteo_ThorbenLehrling_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_ThorbenLehrling_A_09_01"); //Na, das nenn ich mal schnellen Service. Einen wunderschönen Tag wünsche ich noch!
...
FUNC VOID Info_Mod_Matteo_ThorbenLehrling_D()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Matteo_ThorbenLehrling_D_09_01"); //Wieso nicht? Ich bin heute eh in Spenderlaune. Bitteschön, und einen schönen Tag noch.
	...
	{
		AI_Output(self, hero, "Info_Mod_Matteo_ThorbenLehrling_D_09_02"); //Ich bin zu lange im Geschäft, um auf die Nummer hereinzufallen.
...
FUNC VOID Info_Mod_Matteo_ThorbenLehrling_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_ThorbenLehrling_C_09_01"); //Gut, gut, dann wäre das ja geregelt. Richte Thorben einen Gruß von mir aus!
...
FUNC VOID Info_Mod_Matteo_OberesViertel_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_OberesViertel_09_01"); //Kein Problem! Warte, vielleicht doch. Ach nein, das kriegen wir schon hin!
	AI_Output(hero, self, "Info_Mod_Matteo_OberesViertel_15_02"); //Worum geht es?
	AI_Output(self, hero, "Info_Mod_Matteo_OberesViertel_09_03"); //Um in das Obere Viertel zu kommen, musst du entweder Bürger der Stadt sein - oder du schließt dich der Miliz an. (hastig) Wovon ich dir abraten würde.
	AI_Output(self, hero, "Info_Mod_Matteo_OberesViertel_09_04"); //Die einfachste Möglichkeit, den Bürgerstatus zu erreichen, ist, von einem der Meister als Lehrling angenommen zu werden.
	AI_Output(self, hero, "Info_Mod_Matteo_OberesViertel_09_05"); //Vorzugsweise bei mir, ich benötige dringend einen Lehrling!
	AI_Output(self, hero, "Info_Mod_Matteo_OberesViertel_09_06"); //Bevor ich dich anstellen kann, brauche ich aber die Zustimmung aller anderen Handwerksmeister, das wären Bosper, Thorben, Harad und Constantino.
	AI_Output(self, hero, "Info_Mod_Matteo_OberesViertel_09_07"); //Es wird also deine Aufgabe sein, sie zu überzeugen!
...
FUNC VOID Info_Mod_Matteo_Miliz_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_Miliz_09_01"); //Wenn du dich der Miliz anschließen willst, dann solltest du zu Lord Andre gehen.
	AI_Output(self, hero, "Info_Mod_Matteo_Miliz_09_02"); //Er entscheidet, wer bei der Miliz aufgenommen wird.
};
...
FUNC VOID Info_Mod_Matteo_Andre_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_Andre_09_01"); //In der Kaserne.
};
...
FUNC VOID Info_Mod_Matteo_Auftrag_2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_Auftrag_2_09_01"); //Wenn du schon fragst: ja!
...
FUNC VOID Info_Mod_Matteo_WieLehrling_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_WieLehrling_09_01"); //(druckst herum) Na ja, die brauchen doch gar keine!
	AI_Output(self, hero, "Info_Mod_Matteo_WieLehrling_09_02"); //Harad und Thorben haben schon welche, Constantino würde am liebsten allein in seinem Haus verrotten, und Bosper ... wird nicht gut auf dich zu sprechen sein.
	AI_Output(self, hero, "Info_Mod_Matteo_WieLehrling_09_03"); //Glaub mir, bei mir bist du schon am besten aufgehoben!
...
FUNC VOID Info_Mod_Matteo_Aufnahme_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_09_01"); //(erfreut) Ich darf dich willkommen heißen?
...
FUNC VOID Info_Mod_Matteo_Aufnahme_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_B_09_01"); //(beleidigt) Das ist nun der Dank für mein Entgegenkommen?
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_B_09_02"); //Nein - sag nichts. Ich will nichts hören!
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_B_09_03"); //Sieh zu, dass du rauskommst, und lass dich nicht mehr blicken!
...
FUNC VOID Info_Mod_Matteo_Aufnahme_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_A_09_01"); //Und das soll nicht zu deinem Schaden sein!
	...
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_A_09_04"); //In den praktischen wirst du mir etwas zur Hand gehen und lernen, dass der Beruf nicht nur aus Vergnügen besteht.
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_A_09_05"); //Zusätzlich bekommst du nun natürlich das Bürgerrecht verliehen - das war es doch, was du wolltest?
	AI_Output(hero, self, "Info_Mod_Matteo_Aufnahme_A_15_06"); //Kann jedenfalls nicht schaden.
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_A_09_07"); //Fein, fein. Dann beginnen wir gleich hier und jetzt mit unserer ersten Lehrstunde:
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_A_09_08"); //Du wirst dich sicher wundern, warum mein Obst immer so frisch und wohlgerundet aussieht ... Oh, ich schweife in Gedanken ab! (lacht)
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_A_09_09"); //Selbstverständlich sehen nicht alle meine Lieferungen so appetitlich aus - leider!
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_A_09_10"); //Deshalb greift der gewiefte Händler zu einem Trick: Die schadhafte Ware wird einfach nicht offen präsentiert!
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_A_09_11"); //Vor mir auf dem Warentisch beispielsweise - nimm die oberste Schicht Pilze weg, und die darunter liegende würdest du mit spitzen Fingern nicht mehr anfassen.
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_A_09_12"); //Trotzdem werden sie gekauft, weil viele Kunden nicht genau nachschauen. Das ist unser Vorteil!
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_A_09_13"); //Was lernen wir daraus? Präsentation ist alles! Achte also auch darauf, dass dein Geschäft gepflegt aussieht.
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_A_09_14"); //Ein Tipp von mir: Schmiere die Auslageflächen mit Fett ein, das lässt sie im Sonnenlicht glänzen und poliert wirken.
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_A_09_15"); //Geht schneller, als sie tatsächlich zu polieren. (lacht)
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_A_09_16"); //An diese Einführung anschließend habe ich gleich die erste Aufgabe für dich.
	AI_Output(hero, self, "Info_Mod_Matteo_Aufnahme_A_15_17"); //(stöhnt) Ich soll putzen?
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_A_09_18"); //Nein, nein, das kriege ich schon allein hin. Aber ich habe einen Korb mit Äpfeln bekommen.
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_A_09_19"); //Du wirst die Äpfel sortieren nach Auslegetauglichkeit - am besten in zwei Teile, die tauglichen und die untauglichen.
	AI_Output(self, hero, "Info_Mod_Matteo_Aufnahme_A_09_20"); //Den Korb findest du dort hinten auf dem Tisch. Sag Bescheid, sobald du fertig bist.
...
FUNC VOID Info_Mod_Matteo_GildenZeug_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Matteo_GildenZeug_09_00"); //Sieh mal einer an, zu den Milizionären bist du gegangen!
	}
	else if (hero.guild == GIL_VLK)
	{
		AI_Output(self, hero, "Info_Mod_Matteo_GildenZeug_09_01"); //Dich hat's wohl zu den Innos-Typen verschlagen, wie? (lacht)
	}
	else if (hero.guild == GIL_NOV)
	{
		AI_Output(self, hero, "Info_Mod_Matteo_GildenZeug_09_02"); //Wie ich sehe, hast du bei deiner Fraktion eine gute Wahl getroffen.
	}
	else if (hero.guild == GIL_MIL)
	{
		AI_Output(self, hero, "Info_Mod_Matteo_GildenZeug_09_03"); //Söldner willst du werden? Lass dir bloß nicht einfallen, meine Warentransporte zu überfallen!
	}
	else if (hero.guild == GIL_KDF)
	{
		AI_Output(self, hero, "Info_Mod_Matteo_GildenZeug_09_04"); //Du verehrst Beliar? Da hätte ich dich schon für klüger gehalten ...
	};
};
...
FUNC VOID Info_Mod_Matteo_LehrlingQuest_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest_09_01"); //(freudig) Das ging ja schnell! Lass mal sehen ... (holt einen Apfel hervor) Ja, saubere Arbeit nenne ich das! Das hilft mir ungemein!
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest_09_02"); //Komm bald mal wieder vorbei, dann können wir unsere Arbeit fortsetzen!
...
FUNC VOID Info_Mod_Matteo_LehrlingQuest2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_01"); //Ich habe auch gerade etwas Zeit. Lass mich kurz nachdenken ... Dieses Mal wird es um den Konkurrenzkampf gehen.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_02"); //Wie du sicher weißt, gibt es viele Händler hier in der Stadt.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_03"); //Nun kann man sich sicher fragen, warum es diese Vielfalt gibt und der eine den anderen nicht ausstechen kann.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_04"); //Die Antwort darauf ist: die Spezialisierung.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_05"); //Jeder Händler hat ein eigenes Angebot, und bestimmte Waren gibt es nur bei bestimmten Händlern.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_06"); //So hat jeder von uns seine Daseinsberechtigung.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_07"); //Zusätzlich gibt es aber noch andere Möglichkeiten, sich Wettbewerbsvorteile zu verschaffen:
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_08"); //Man kann etwa Waren besonderer Qualität anbieten - wie ich es tue - oder besonders günstig sein.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_09"); //Hauptsache ist, dass dafür Nachfrage besteht.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_10"); //Aufmerksam machst du die Kunden durch Werbung. Darin hast du ja schon deine ersten Erfahrungen gesammelt.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_11"); //In der praktischen Übung soll es heute um das, äh, Abwerben gehen.
	AI_Output(hero, self, "Info_Mod_Matteo_LehrlingQuest2_15_12"); //Abwerben von deinen Konkurrenten?
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_13"); //Richtig! Ich habe mir da schon etwas Feines ausgedacht.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_14"); //Du erinnerst dich an die Äpfel, die du beim letzten Mal sortiert hast?
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_15"); //Eine Menge davon sind wirklich nicht zu gebrauchen.
	AI_Output(hero, self, "Info_Mod_Matteo_LehrlingQuest2_15_16"); //Was soll ich damit tun?
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_17"); //Ich gebe dir, warte mal, fünf der fauligen Äpfel, und du legst sie fünf Lebensmittelhändlern  in Khorinis in ihr Angebot. Jedem einen, ganz gerecht.

	B_GiveInvItems	(self, hero, ItFo_Apple_Matteo_Schlecht, 5);

	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_18"); //Am besten verwickelst du sie vorher in ein Gespräch, und wenn sie kurz wegschauen - schwupps -, hast du ihren Stand präpariert.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_09_19"); //Wenn dann jemand an ihren Stand kommt und den Apfel sieht ... habe ich schon gewonnen! (lacht)
...
FUNC VOID Info_Mod_Matteo_LehrlingQuest2_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest2_B_09_01"); //Darüber brauchst du dir keine Gedanken zu machen. Wir haben uns schon viel üblere Streiche gespielt.
...
{
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest3_09_00"); //Sieh an, meine Idee fruchtet! Die Kunden strömen in mein Geschäft wie der Rauch in die Lunge eines Sektenspinners.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest3_09_01"); //Ich muss dir wieder für deine Hilfe danken!
	AI_Output(hero, self, "Info_Mod_Matteo_LehrlingQuest3_15_02"); //Wann setzen wir den Unterricht fort?
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest3_09_03"); //In nächster Zeit sieht es wahrscheinlich schlecht aus.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest3_09_04"); //Meine Verlobung mit Valentine steht kurz bevor, und wir haben ... anderes zu tun. Wenn du verstehst, was ich meine ... (lacht)
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest3_09_05"); //Du darfst mich natürlich trotzdem gern besuchen kommen. Ich sage dir schon Bescheid, wenn's weitergeht. Lass es dir so lange gutgehen!
...
FUNC VOID Info_Mod_Matteo_LehrlingQuest4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_09_01"); //Ist mal wieder an der Zeit, was?
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_09_02"); //Ich muss dich aber vorwarnen: Zum nächsten Thema kann ich dir nur eine kleine praktische Übung anbieten, viel mehr gibt es nicht her.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_09_03"); //Heute geht es um die Preispolitik.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_09_04"); //Wir unterscheiden hierbei den Verkäuferpreis vom Käuferpreis.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_09_05"); //Der Verkäuferpreis ist der, zu dem ich gern verkaufen würde, sodass mir nach Abzug aller Ankaufs- und Nebenkosten ein ordentlicher Gewinn übrig bleibt.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_09_06"); //Diesen Preis muss ich dann jedoch erstens noch an die Konkurrenten anpassen.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_09_07"); //Ich kann einfach günstiger verkaufen oder den Preis absichtlich erhören, damit die Käufer denken, bei mir gebe es gute Qualität - was, wie du weißt, bei mir der Fall ist.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_09_08"); //Die Käufer sind der nächste Faktor. Ich verkaufe meine Waren direkt neben dem Eingang zum Oberen Viertel, habe also auch von dort Kunden.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_09_09"); //Die sind schon eher bereit, ordentlich was abzudrücken, als die armen Schlucker aus dem Hafenviertel.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_09_10"); //Letzter Punkt, auf den du achten musst, ist der Umgebungspreis.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_09_11"); //Das heißt ganz einfach: Verkaufst du nur teure Sachen, kannst den den Preis selbst bei den billigen anheben.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_09_12"); //Ein teures Produkt neben lauter günstigen anzubieten, hat dagegen wenig Sinn.
	AI_Output(hero, self, "Info_Mod_Matteo_LehrlingQuest4_15_13"); //Ich denke, ich hab's verstanden.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_09_14"); //Na fein! Dann will ich jetzt mal anhand dreier Fragen prüfen, ob du die Materie beherrschst!
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_09_15"); //Los geht's! Wer wird das teurere Brot verkaufen - Fenia aus dem Hafenviertel oder ich?
...
{
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_C_09_00"); //Weiter: Ich verkaufe günstig Handwerkerzubehör und habe eine Goldschatulle gefunden.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_C_09_01"); //Werde ich sie neben meinen anderen Produkten nun über oder unter Wert verkaufen?
...
{
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_F_09_00"); //Und drittens: Ich bekomme meine Waren, schlage auf meinen Einkaufspreis ein paar Golmünzen drauf und verkaufe sie weiter.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_F_09_01"); //Welchen Preis habe ich dabei außer Acht gelassen?
...
FUNC VOID Info_Mod_Matteo_LehrlingQuest4_I()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_I_09_00"); //(eingeschnappt) Mann, Mann, wofür erzähl ich dir eigentlich was, wenn du eh nichts behältst? Na ja, ist ja dein Problem.
	}
	else if (Mod_Matteo_Fragen == 1)
	{
		AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_I_09_01"); //Da ist aber nicht viel bei dir hängen geblieben. Oder du taugst nicht als Händler. Immer schön fleißig lernen!

		B_GivePlayerXP	(50);
	}
	else if (Mod_Matteo_Fragen == 2)
	{
		AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_I_09_02"); //Das hört sich doch schon ganz gut an. Noch nicht ganz fehlerfrei, aber aus dir kann noch was werden!

		B_GivePlayerXP	(100);
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_I_09_03"); //Sehr gut, tadellose Leistung!

		B_GivePlayerXP	(200);
	};

	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest4_I_09_04"); //Das war es dann auch schon wieder für dieses Mal. Komm doch bald wieder!
...
{
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest5_09_00"); //Du, sag mal - diese Plakate von dir ...
	AI_Output(hero, self, "Info_Mod_Matteo_LehrlingQuest5_15_01"); //... Waren eine Verunglimpfungskampagne.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest5_09_02"); //Na, da bin ich aber erleichtert.
};
...
FUNC VOID Info_Mod_Matteo_LehrlingQuest6_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_01"); //Und ich bin auch noch hier. (lacht) Hast auf deinen ganzen Wanderungen doch noch mal Zeit für den alten Matteo gefunden?
	AI_Output(hero, self, "Info_Mod_Matteo_LehrlingQuest6_15_02"); //Ausnahmsweise.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_03"); //Na, da bin ich aber froh! Bist ja schon eine kleine Berühmtheit!
	AI_Output(hero, self, "Info_Mod_Matteo_LehrlingQuest6_15_04"); //So ist das Leben ...
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_05"); //Klingst fast, als hättest du es eilig. Dann will ich dich nicht allzu lange mit dem heutigen Thema belästigen.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_06"); //Heute werde ich dir erzählen, wie du hier in Khorinis an besondere Ware kommst.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_07"); //Damit meine ich Ware, die andere Händler nicht bekommen, Ware, mit der ich so erfolgreich geworden bin.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_08"); //Mein Geheimnis sozusagen.
	AI_Output(hero, self, "Info_Mod_Matteo_LehrlingQuest6_15_09"); //Das klingt ja mal spannend.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_10"); //Glaub ich dir! Ein Wort: Geheimnis - damit bekommt man volle Aufmerksamkeit!
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_11"); //Und es ist sogar so geheim, dass es nicht mal die Stadtwache erfahren muss.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_12"); //Der normale Warenaustausch wird von den Paladinen kontrolliert.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_13"); //Durch die zwei Stadttore kommen Nahrungsmittel, Bergbauprodukte und ab und zu Handwerksprodukte.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_14"); //In der Stadt selbst wird hauptsächlich Handwerksbedarf hergestellt, und natürlich Waffen.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_15"); //Aus Myrtana kommen über den Seeweg selten Lieferungen, und wenn, dann werden sie sofort von Lord Hagen eingesackt.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_16"); //Und dann gibt's da noch die Piraten ...
	AI_Output(hero, self, "Info_Mod_Matteo_LehrlingQuest6_15_17"); //Ich verstehe.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_18"); //Nicht wahr? Jharkendar bietet eine Fülle von exotischen Produkten, und der Grog der Piraten ist auch nicht zu verachten!
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_19"); //Der Umschlagplatz ist ein Strand nördlich von Khorinis. Dort treffe ich mich wöchentlich mit ihnen und kaufe ihnen ihr Gut ab.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_20"); //Gerade heute müsste ich mich wieder mit ihnen treffen.
	AI_Output(hero, self, "Info_Mod_Matteo_LehrlingQuest6_15_21"); //Arbeit für mich.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_22"); //Hehe, du hast es erkannt. An denen kannst du dann gleich dein Handelsgeschick ausprobieren, knallharte Verhandlungspartner sind das.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_23"); //Hier hast du 300 Goldmünzen für zwei Kisten mit Grog. Alles, was du niedriger raushandeln kannst, gehört dir.

	B_GiveInvItems	(self, hero, ItMi_Gold, 300);

	AI_Output(hero, self, "Info_Mod_Matteo_LehrlingQuest6_15_24"); //Dann mache ich mich mal auf den Weg.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest6_09_25"); //Tu das. Viel Erfolg!
...
FUNC VOID Info_Mod_Matteo_LehrlingQuest7_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest7_09_01"); //Danke, Mann. Ehrlich gesagt mag ich das Piratengesocks nicht. Aber der Grog verkauft sich gut!
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest7_09_02"); //Damit ist deine Lehrzeit bei mir nun beendet. Ich habe dir alles erzählt, was du wissen musst, um als Händler bestehen zu können.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest7_09_03"); //Und du hast mir gut unter die Arme gegriffen. Das will ich nicht ganz unbelohnt lassen.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest7_09_04"); //Du sollst diesen glänzenden Ring haben. Er wird deine Verhandlungspartner ganz schön beeindrucken!

	B_GiveInvItems	(self, hero, ItRi_Verhandlungsring, 1);

	AI_Output(hero, self, "Info_Mod_Matteo_LehrlingQuest7_15_05"); //Vielen Dank.
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest7_09_06"); //Keine Ursache. Und nun mach's gut!
...
FUNC VOID Info_Mod_Matteo_LehrlingQuest8_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Matteo_LehrlingQuest8_09_01"); //Dass ich dich noch mal wiedersehe! Gut, gut, alles bestens. Und du bist noch fleißig auf Reisen?
