...
FUNC VOID Info_Mod_Thofeistos_Orksoeldner_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Thofeistos_Orksoeldner_05_01"); //Nun, an sich schon, da du jetzt zu den Orkjägern gehörst ...
	AI_Output(hero, self, "Info_Mod_Thofeistos_Orksoeldner_15_02"); //Aber was?
	AI_Output(self, hero, "Info_Mod_Thofeistos_Orksoeldner_05_03"); //Mir ist gerade mal wieder das Erz ausgegangen. Wenn du dein Schwert haben willst, so gehe zu unserer Mine und hole mir eine Kiste Erz.
...
FUNC VOID Info_Mod_Thofeistos_Erzkiste_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Thofeistos_Erzkiste_05_01"); //Sehr gut. Hier hast du das Schwert, das dir gebührt, Orkschlächter genannt.
	...
	AI_Output(self, hero, "Info_Mod_Thofeistos_Erzkiste_05_03"); //Es ist das Beste, was du bei mir bekommen kannst. Bessere Waffen wirst du dir schon selbst anfertigen müssen.
	AI_Output(hero, self, "Info_Mod_Thofeistos_Erzkiste_15_04"); //(verwirrt) Ähh, du hast die Waffe schon?! Aber wieso ...
	AI_Output(self, hero, "Info_Mod_Thofeistos_Erzkiste_05_05"); //Ach, ich hatte gerade keine Zeit und war mir zu gemütlich, um selbst die Kiste zu holen. Hier hast du zwei Erzbrocken als Dank.
...
FUNC VOID Info_Mod_Thofeistos_Seeungeheuer_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Thofeistos_Seeungeheuer_05_01"); //Zeig her ...

	B_GiveInvItems	(hero, self, ItAt_Seeungeheuerschuppen, 11);

	AI_Output(self, hero, "Info_Mod_Thofeistos_Seeungeheuer_05_02"); //... tatsächlich.
	AI_Output(self, hero, "Info_Mod_Thofeistos_Seeungeheuer_05_03"); //Du bist ein noch größerer Krieger, als ich ursprünglich vermutet hatte.
	AI_Output(self, hero, "Info_Mod_Thofeistos_Seeungeheuer_05_04"); //Nicht vielen Menschen wäre es gelungen, so ein Ungetüm zu bezwingen.
	AI_Output(self, hero, "Info_Mod_Thofeistos_Seeungeheuer_05_05"); //Komm morgen wieder. Dann werde ich deine Rüstung fertig haben.
...
FUNC VOID Info_Mod_Thofeistos_Urs_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Thofeistos_Urs_05_01"); //(euphorisch) Was, der magische Hammer?! Gib schon her, ich muss ihn gleich ausprobieren.
	...
	AI_Output(self, hero, "Info_Mod_Thofeistos_Urs_05_02"); //Fantastisch, der Stahl erhitzt sich ja unter den Schlägen fast von selbst.
	AI_Output(self, hero, "Info_Mod_Thofeistos_Urs_05_03"); //Ein großartiges Stück, das eines Erzschmelzers in Nordmar würdig wäre.
	AI_Output(self, hero, "Info_Mod_Thofeistos_Urs_05_04"); //20 Brocken waren ausgemacht? Hier, nimm 30 ... und selbst dies spiegelt den wahren Wert dieses Stückes nicht wirklich wieder.
...
FUNC VOID Info_Mod_Thofeistos_Teacher_Info()
{
	...
	&& (Mod_Gilde != 19)
	{
		AI_Output(self, hero, "Info_Mod_Thofeistos_Teacher_05_01"); //Erweise dich erst mal als würdig. Nicht jeden Dahergelaufenen weihe ich darin ein, magisches Erz zu bearbeiten.
	}
	else
	{
		if (Mod_Gilde == 5)
		|| (Mod_Gilde == 19)
		{
			...
			if (Mod_NL_Thofeistos_Lehrer == 0)
			{
				...
				AI_Output(self, hero, "Info_Mod_Thofeistos_Teacher_05_02"); //Du hast bewiesen, dass du sowohl über die Fertigkeiten des Kampfes verfügst, als auch über Verstand und Geschick.
				AI_Output(self, hero, "Info_Mod_Thofeistos_Teacher_05_03"); //Damit hast du dich dafür qualifiziert, etwas über die Kunst zu erlernen magisches Erz zu verarbeiten.
				AI_Output(self, hero, "Info_Mod_Thofeistos_Teacher_05_04"); //Natürlich werde ich dich nicht in alles einweisen.
				AI_Output(self, hero, "Info_Mod_Thofeistos_Teacher_05_05"); //Zum einen fehlt mir dafür die Zeit, zum anderen ist dieses Wissen nur den allergrößten Kriegern vorbehalten.
			};
...
{
	AI_Output(self, hero, "Info_Mod_Thofeistos_Teacher_Geschoss_GoldErz_05_00"); //Nimm drei Erzbrocken und erhitze diese mit einem Goldbrocken.
	AI_Output(self, hero, "Info_Mod_Thofeistos_Teacher_Geschoss_GoldErz_05_01"); //Dadurch lässt sich das magische Erz überhaupt erst weich genug machen, um Pfeil- und Bolzenspitzen daraus zu schmieden.
	AI_Output(self, hero, "Info_Mod_Thofeistos_Teacher_Geschoss_GoldErz_05_02"); //Das Material reicht für etwa 100 Pfeile oder Bolzen.
...
FUNC VOID Info_Mod_Thofeistos_Teacher_Waffe_Dragonhunter()
{
	...
	AI_Output(self, hero, "Info_Mod_Thofeistos_Teacher_Waffe_Dragonhunter_05_05"); //Je nach Größe der Waffe benötigt man zwischen fünf und sieben Phiolen Drachenblut.
	AI_Output(self, hero, "Info_Mod_Thofeistos_Teacher_Waffe_Dragonhunter_05_06"); //Eine Waffe aus reinem Erz herzustellen, ist jedoch eine ungleich größere Kunst.
...
FUNC VOID Info_Mod_Thofeistos_Teacher_Geschoss_Dragonhunter()
{
	...
	AI_Output(self, hero, "Info_Mod_Thofeistos_Teacher_Geschoss_Dragonhunter_05_04"); //Geeignet sind vor allem die Sehnen an den Gelenken der Arme und Beine dieser Viecher, am Hals kann man auch brauchbares Material finden.
	AI_Output(self, hero, "Info_Mod_Thofeistos_Teacher_Geschoss_Dragonhunter_05_05"); //Du musst längs schneiden, zwischen den Schuppen, um dich vorsichtig zu den Sehnen vorzuarbeiten.
...
{
	AI_Output(self, hero, "Info_Mod_Thofeistos_Teacher_Armor_Dragon_05_00"); //Nun, das zu erklären habe ich keine Zeit. Präge dir diese Bauanleitung aufmerksam ein, dann wirst du wissen, wie vorzugehen ist.
...
{
	AI_Output(self, hero, "Info_Mod_Thofeistos_Teacher_Armor_Dragon2_05_00"); //Um die perfekte Rüstung zu erschaffen, musst du noch geschickter vorgehen, um weitere 16 Erz und sieben Schuppen mit der Rüstung zu verbinden.
	AI_Output(self, hero, "Info_Mod_Thofeistos_Teacher_Armor_Dragon2_05_01"); //Daneben benötigst du noch vier Phiolen Drachenblut zum Härten der Rüstung.
