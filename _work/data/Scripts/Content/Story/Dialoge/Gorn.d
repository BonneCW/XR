...
{
	AI_Output(self, hero, "Info_Mod_Gorn_Hi_03_00"); //Ich glaub’s ja nicht ... du?! Dich kann auch wirklich kein Monster oder Erzdämon erledigen ...
	AI_Output(hero, self, "Info_Mod_Gorn_Hi_15_01"); //Freut mich auch dich zu sehen.
	AI_Output(self, hero, "Info_Mod_Gorn_Hi_03_02"); //Mann ... da werden einige Erinnerungen wach. Was wir alles zusammen erlebt haben.
	AI_Output(self, hero, "Info_Mod_Gorn_Hi_03_03"); //Es ist, als wäre es erst gestern gewesen, wo wir die Gardisten mit einem Arschtritt aus unserer Mine vertrieben haben.
	AI_Output(hero, self, "Info_Mod_Gorn_Hi_15_04"); //Oder gemeinsam den fetten Troll in der Klosterfestung erledigt haben.
	AI_Output(self, hero, "Info_Mod_Gorn_Hi_03_05"); //Klar, wie könnte ich das fette Biest vergessen. Und schon wieder bist du zur rechten Zeit am rechten Ort.
	AI_Output(hero, self, "Info_Mod_Gorn_Hi_15_06"); //Wieso?
	AI_Output(self, hero, "Info_Mod_Gorn_Hi_03_07"); //Nun, ich hatte mir gerade vorgenommen die verfluchte Festung da oben einzunehmen. Viele Schätze soll es da zu holen geben, aber eben auch voller untoter Mistkerle.
	AI_Output(self, hero, "Info_Mod_Gorn_Hi_03_08"); //Hartes Stück Arbeit, dachte ich mir. Bis du gekommen bist. Mit dir sollte es ein Spaziergang werden.
};
...
FUNC VOID Info_Mod_Gorn_GotoCastlemine_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_GotoCastlemine_03_01"); //Nichts anderes hatte ich von dir erwartet. Dann zeigen wir es diesen Bastarden mal.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_AtCastlemine_03_00"); //So, das war es also. Ein paar Goldmünzen sind zusammengekommen, aber doch nicht ganz so viel, wie ich erhofft hatte.
	AI_Output(self, hero, "Info_Mod_Gorn_AtCastlemine_03_01"); //Und die Mine scheint auch verschüttet zu sein. Zu holen gibt es hier auf jeden Fall nichts mehr.
	AI_Output(self, hero, "Info_Mod_Gorn_AtCastlemine_03_02"); //War aber trotzdem ein Riesenspaß mit dir mal wieder unterwegs zu sein ... und Grund genug mich mit den anderen Jungs zu treffen, um einige Dinge zu besprechen.
	AI_Output(self, hero, "Info_Mod_Gorn_AtCastlemine_03_03"); //Kannst du mir einen Gefallen tun?
	AI_Output(hero, self, "Info_Mod_Gorn_AtCastlemine_15_04"); //Klar, worum geht's?
	AI_Output(self, hero, "Info_Mod_Gorn_AtCastlemine_03_05"); //Sag Diego, Milten und Lester bescheid, dass wir uns in Taverne 'Zur Toten Harpie' treffen.
	AI_Output(self, hero, "Info_Mod_Gorn_AtCastlemine_03_06"); //Da du auch einer von uns geworden bist, kannst du natürlich auch kommen.
	AI_Output(self, hero, "Info_Mod_Gorn_AtCastlemine_03_07"); //Und solltest jemals Hilfe brauchen, kannst du zu uns kommen, dann werden wir versuchen, dir zu helfen.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_Daemonisch_03_00"); //Hey, wieder auf der Suche nach Abenteuern?
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Daemonisch_03_02"); //Ach, Pepe ist mit paar Söldner in den Wald gegangen um Wölfe zujagen und ist dann durchgedreht und abgehauen.
	AI_Output(self, hero, "Info_Mod_Gorn_Daemonisch_03_03"); //Lares kann dir mehr darüber erzählen. Jedenfalls fressen die Jungs aus dem Wald seit dem für drei.
	AI_Output(self, hero, "Info_Mod_Gorn_Daemonisch_03_04"); //Thekla kommt kaum mit dem Kochen nach und ist schon außer sich.
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Daemonisch_03_06"); //Mach's gut.
...
FUNC VOID Info_Mod_Gorn_Irdorath_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Irdorath_03_02"); //Ein Trip zu einer Insel? Man, du bist immer für eine Überraschung gut ...
	AI_Output(self, hero, "Info_Mod_Gorn_Irdorath_03_03"); //Tja, der Orkjäger Cord wäre bestimmt dabei.
	AI_Output(self, hero, "Info_Mod_Gorn_Irdorath_03_04"); //Trainiert ja den ganzen Tag wie ein Verrückter und würde sich die Chance auf so ein Abenteuer bestimmt nicht entgehen lassen.
	AI_Output(self, hero, "Info_Mod_Gorn_Irdorath_03_05"); //Und dann vielleicht noch Bennet, da es bestimmt nicht schlecht wäre, einen Schmied mit an Bord zu haben, wenn man ein paar scharfe Klingen braucht.
...
FUNC VOID Info_Mod_Gorn_Irdorath2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Irdorath2_03_01"); //Du sagst es. Bei einen abenteuerlichen Trip wie diesen sage ich bestimmt nicht nein ...
	AI_Output(hero, self, "Info_Mod_Gorn_Irdorath2_15_02"); //Dann freut es mich dich an Bord willkommen zu heißen.
	AI_Output(self, hero, "Info_Mod_Gorn_Irdorath2_03_03"); //Ich mach mich sofort auf den Weg zum Hafen.
...
FUNC VOID Info_Mod_Gorn_Irdorath3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Irdorath3_03_01"); //Schade. Ich gehe dann wieder zurück. Du weißt wo du mich findest, wenn doch noch ein Platz frei werden sollte.
...
FUNC VOID Info_Mod_Gorn_Irdorath4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Irdorath4_03_01"); //Sehr gut, ich bin dann wieder am Hafen.
...
FUNC VOID Info_Mod_Gorn_Treffen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_03_00"); //Schön, dass ihr alle gekommen seid. Ich fand die Zeit reif für ein neues Treffen. Wie ist es euch ergangen?
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_03_04"); //(lacht) Seit wann versuchst du dich als Prophet, Diego?
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_03_08"); //Es soll nur kommen! Ich kann mir nichts vorstellen, dem wir nicht gewachsen sind.
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_03_13"); //Du weißt hoffentlich, dass du das nicht allein durchstehen musst. Auf uns kannst du zählen, und wenn wir alle dabei draufgehen sollten.
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Treffen_03_17"); //Und die Axt bereit.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_04_03_00"); //Ohh man, diese schrecklichen Ungetüme auf dem Plateau, da wagen wir uns lieber nicht heran.
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_04_03_01"); //Die Untoten auf Sekobs sind zwar auch nicht ohne, aber doch zu schaffen.
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_04_03_02"); //Lares zögert aber noch etwas, wartet auf den richtigen Augenblick zum Angriff ...
};
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_03_00"); //Hey, die Untoten bei Sekobs Hof haben sich zerstreut. Jetzt könnten wir sie aufmischen.
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_03_01"); //Wenn du mitmachst müsste unsere Schlagkraft ausreichen.
...
FUNC VOID Info_Mod_Gorn_Hexen_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_B_03_01"); //Hmm, schade, hätte ich nicht gedacht, dass du dir das entgehen lassen willst.
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_B_03_02"); //Dann müssen wir eben noch etwas mit dem Angriff warten, bis wir Verstärkung bekommen.
...
FUNC VOID Info_Mod_Gorn_Hexen_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_A_03_01"); //Sehr gut, ich habe auch nichts anderes von dir erwartet. Dann kann es ja losgehen.
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_A_03_02"); //Wir sammeln uns dann an der Kreuzung. Wie in alten Zeiten.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_02_03_00"); //Auf geht’s, treten wir diesen Untoten in den Hintern.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_Hexen_03_03_00"); //Na also, denen haben wir es gezeigt. War mir ein Vergnügen mal wieder an deiner Seite gekämpft zu haben.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_BalrogGigantTot_03_00"); //Hey, ich habe gehört, die Monster und Riesen auf dem Plateau sind weg ... und irgendwie glaube ich, dass du nicht ganz unbeteiligt daran warst.
	AI_Output(self, hero, "Info_Mod_Gorn_BalrogGigantTot_03_01"); //Tolle Leistung. Ich wäre gerne mit von der Party gewesen, als du diesen Ungetümen den Hintern versohlt hast.
};
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_Drachen_03_00"); //Man, ohh man. Da glaubt man im Minental allen Herausforderungen getrotzt zu haben, die es auf der Welt gibt und dann stehen diese Riesenechsen vor der Tür.
	AI_Output(hero, self, "Info_Mod_Gorn_Drachen_15_01"); //Nun, ohne neue Herausforderungen würde doch alles eintönig und sinnlos.
	AI_Output(self, hero, "Info_Mod_Gorn_Drachen_03_02"); //Wie immer unerschütterlich vor jeder noch so großen Aufgabe. Ja, da hast du wohl Recht.
	AI_Output(self, hero, "Info_Mod_Gorn_Drachen_03_03"); //Und ich bin mir auch sicher, dass sich wieder eine Gelegenheit finden wird gemeinsam ein Abenteuer zu bestreiten. Pass auf dich auf.
...
FUNC VOID Info_Mod_Gorn_Knucker_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Knucker_03_01"); //Ach, du hast gut reden. Ich und Cord wurden dazu verdonnert am Rande des Waldes Wache zu schieben, seit dem einige Schafe draufgegangen sind und zwei Bauern verschwanden.
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Knucker_03_03"); //Ja, wenn Wölfe dazu in der Lage sind den Schafen ihr Blut, bis auf den letzten Tropfen auszusaugen, dann schon.
	AI_Output(self, hero, "Info_Mod_Gorn_Knucker_03_04"); //Genauso wie die Bauern, die Nachts wie in Trance in den Wald gingen und verschwanden ...
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Knucker_03_06"); //Du meinst in den Wald gehen und nachsehen? Ich weiß nicht. Immerhin müsste ich meinen Posten dafür verlassen ...
	AI_Output(hero, self, "Info_Mod_Gorn_Knucker_15_07"); //Ach komm, wegen der fünf Minuten, die wir den Wald erkunden ...
	AI_Output(self, hero, "Info_Mod_Gorn_Knucker_03_08"); //Und wenn irgendwelche der dämonischen Viecher, die sich hier zurzeit herumtreiben während dessen angreifen? Nein, so geht das wirklich nicht.
	AI_Output(self, hero, "Info_Mod_Gorn_Knucker_03_09"); //(überlegt) Hmm, aber ab nächsten Abend werde ich abgelöst. Dann können wir loslegen und den Wald unsicher machen.
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Knucker_03_11"); //Worauf du dich verlassen kannst.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_WaldSpaziergang_03_00"); //Da bist du ja. Wollen wir dann mal losziehen?
	AI_Output(hero, self, "Info_Mod_Gorn_WaldSpaziergang_15_01"); //Ja, lass uns nicht noch mehr Zeit vergeuden.
	AI_Output(self, hero, "Info_Mod_Gorn_WaldSpaziergang_03_02"); //Na dann, folge mir.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_NichtsLosImWald_03_00"); //Na, besonders viel war hier noch nicht los, außer den paar Viechern.
	AI_Output(self, hero, "Info_Mod_Gorn_NichtsLosImWald_03_01"); //Wir sollten mal bei der Krypta vorbeischauen.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_VorKrypta_03_00"); //Meine Fresse, siehst du auch diese ganzen Untoten auf dem Friedhof der Krypta? Vielleicht haben die ja was mit dem Verschwinden der Bauern zu tun.
	AI_Output(self, hero, "Info_Mod_Gorn_VorKrypta_03_01"); //Na dann los, lass uns die aufmischen.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_Hel_03_00"); //Verdammt, wo ist sie hin?
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_WaldFertig_03_00"); //(außer Atem) Boah, die war vielleicht ein hartes Biest. Gegen die ist sogar Thekla sanft wie ein Lamm.
	AI_Output(self, hero, "Info_Mod_Gorn_WaldFertig_03_01"); //Naja, so schnell werde ich nicht mehr über die Kampfeskünste von Frauen lachen.
	...
	AI_Output(self, hero, "Info_Mod_Gorn_WaldFertig_03_03"); //Und ich kann nun endlich wieder anderen Dingen nachgehen, als den ganzen Tag untätig vor der Kapelle herumzustehen. Hey, ich bin dir was schuldig.
	...
	AI_Output(self, hero, "Info_Mod_Gorn_WaldFertig_03_05"); //Na dann, bis zum nächsten Mal. Pass auf dich auf.
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand_03_00"); //Wie ich sehe, benutzt du Zweihänder immer noch mit beiden Händen, Kumpel.
	AI_Output(hero, self, "Info_Mod_Gorn_ZweihandAlsEinhand_15_01"); //Ja. Was ist daran falsch?
	AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand_03_02"); //Für einen normalen Krieger ist es unmöglich, aber so starke Kerle wie du und ich können Zweihänder wie Einhänder führen.
	AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand_03_03"); //Wenn du Lust und Zeit hast, zeig ich dir, wie's geht.
};
...
FUNC VOID Info_Mod_Gorn_ZweihandAlsEinhand2_Info()
{
	...
	&& (hero.lp >= 5))
	{
		AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand2_03_01"); //Das Wichtigste ist, dass das Gefühl von Einhändern und Zweihändern unterschiedlich ist.
		AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand2_03_02"); //Der Schwerpunkt der Waffe ist bei Zweihändern weiter von deinem Körper entfernt.
		AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand2_03_03"); //Deswegen solltest du darauf aufpassen, den Arm nie vollständig durchzustrecken, denn dann wird das Gewicht der Waffe zu groß.
		AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand2_03_04"); //Winkle den Arm leicht an, und du solltest keine Probleme haben.
		AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand2_03_05"); //Worauf wartest du noch? Ich will dich üben sehen!
	...
	{
		AI_Output(self, hero, "Info_Mod_Gorn_ZweihandAlsEinhand2_03_06"); //Komm wieder, wenn du bereit bist.
	};
};
...
FUNC VOID Info_Mod_Gorn_Standfest_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Standfest_03_01"); //Da gibt es schon einen Weg. Hast du etwas Zeit?
};
...
FUNC VOID Info_Mod_Gorn_Standfest2_Info()
{
	...
	&& (hero.lp >= 5))
	{
		AI_Output(self, hero, "Info_Mod_Gorn_Standfest2_03_01"); //Am Ende zählt nur die richtige Mischung aus Stärke und Geschicklichkeit.
		AI_Output(self, hero, "Info_Mod_Gorn_Standfest2_03_02"); //Wenn du siehst, dass einer der Gegner zu einem mächtigen Schlag ausholt, bereitest du dich vor.
		AI_Output(self, hero, "Info_Mod_Gorn_Standfest2_03_03"); //Kurz bevor er dich erwischt, machst du dich klein und verlegst deinen Körperschwerpunkt Richtung Boden.
		AI_Output(self, hero, "Info_Mod_Gorn_Standfest2_03_04"); //Wenn du dann noch deine gesamte Kraft gegen den Schlag stellst, wird er zwar immer noch schmerzhaft, aber du segelst nicht mehrere Meter durch die Luft.
		AI_Output(hero, self, "Info_Mod_Gorn_Standfest2_15_05"); //Ich denke, ich hab's verstanden. Danke.
		AI_Output(self, hero, "Info_Mod_Gorn_Standfest2_03_06"); //Gern geschehen.
	...
	{
		AI_Output(self, hero, "Info_Mod_Gorn_Standfest2_03_07"); //Komm wieder, wenn du bereit bist.
	};
};
...
FUNC VOID Info_Mod_Gorn_Hilfe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_03_01"); //Wobei?
...
FUNC VOID Info_Mod_Gorn_Hilfe_Kristall()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_Kristall_03_01"); //Hmm, lass mich überlegen. Viel fällt mir auf die Schnelle auch nicht ein ... aber warte mal.
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_Kristall_03_02"); //Ich habe mal Lee über einen Paladin sprechen hören, den er von früher kannte. Der fette Lothar im oberen Viertel soll ein ziemlicher Schluckspecht sein.
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_Kristall_03_03"); //Er bläst sich gerne auf, nimmt es jedoch mit der Disziplin nicht so eng ...
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_Kristall_03_04"); //Bei ihm könntest du vielleicht etwas erfahren.
...
FUNC VOID Info_Mod_Gorn_Hilfe_MinecrawlerSekret()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_MinecrawlerSekret_03_01"); //Lester hat mir mal erzählt, dass in den Eiern der Minecrawler ein stärkeres Sekret ist als in den Zangen.
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_MinecrawlerSekret_03_02"); //Ich hatte zwei Minecrawlereier aus der Freien Mine, als wir sie zusammen von den Gardisten befreit haben, aber ich hab sie Milten gegeben.
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_MinecrawlerSekret_03_03"); //Ich konnte mit den Eiern nichts anfangen, aber er als Magier kann sie sicher gebrauchen. Geh mal zu ihm und frag ihn, vielleicht hat er sie ja noch.
...
FUNC VOID Info_Mod_Gorn_Hilfe_Alvares()
{
	...
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_Alvares_03_01"); //Einen Söldneranwärter ... hmm, auf den Bauernhöfen wird es wohl kaum einen qualifizierten Kämpfer geben.
	AI_Output(self, hero, "Info_Mod_Gorn_Hilfe_Alvares_03_02"); //Am ehesten solche, die schon von den Stadtwachen wegen ihrer Taten einkassiert wurden.
};
...
{
	AI_Output(self, hero, "Info_Mod_Gorn_EXIT_03_00"); //Mögest du nie deinen Meister finden!
