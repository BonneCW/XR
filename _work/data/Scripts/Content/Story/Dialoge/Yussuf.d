...
FUNC VOID Info_Mod_Yussuf_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Yussuf_Hi_05_01"); //Du stehst vor ihm. Was liegt an?
	AI_Output(hero, self, "Info_Mod_Yussuf_Hi_15_02"); //Ich suche Stimmen für meine Aufnahme bei euch.
	AI_Output(self, hero, "Info_Mod_Yussuf_Hi_05_03"); //Das trifft sich gut, ich suche nämlich auch Stimmen. Will bei den Kriegern mitmachen. Diese Gaunereien hier langweilen mich.
	AI_Output(hero, self, "Info_Mod_Yussuf_Hi_15_04"); //Aber da musst du doch die Krieger fragen, nicht mich.
	AI_Output(self, hero, "Info_Mod_Yussuf_Hi_05_05"); //Schon. Aber du könntest mir bei einer schwierigen Aufgabe zur Hand gehen.
	AI_Output(self, hero, "Info_Mod_Yussuf_Hi_05_06"); //Wenn ich dann dafür eine Stimme kriege, kriegst du meine.
...
FUNC VOID Info_Mod_Yussuf_Hi_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Yussuf_Hi_B_05_01"); //Ich melde mich, wenn ich dich brauche.
...
FUNC VOID Info_Mod_Yussuf_Hi_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Yussuf_Hi_A_05_01"); //Und für was sind wir Gauner?
	...
	AI_Output(self, hero, "Info_Mod_Yussuf_Hi_A_05_04"); //Wohl nicht. Aber dann ist nichts mit meiner Stimme. Und halt's Maul wegen dieser Sache.
...
{
	AI_Output(self, hero, "Info_Mod_Yussuf_Blutkelch_05_00"); //Was machst du denn hier? Du hast doch meine Stimme noch nicht.
	...
	AI_Output(self, hero, "Info_Mod_Yussuf_Blutkelch_05_02"); //Alter Streber! Aber dann könnten wir doch diesmal zusammenarbeiten.
	...
	AI_Output(self, hero, "Info_Mod_Yussuf_Blutkelch_05_04"); //Das trifft sich gut. Ich muss auch in die Stadt.
	AI_Output(hero, self, "Info_Mod_Yussuf_Blutkelch_15_05"); //Und was hast du zu tun?
	AI_Output(self, hero, "Info_Mod_Yussuf_Blutkelch_05_06"); //Ich soll die Kisten im Hof vom Händler Matteo plündern. Der Hohe Rat vermutet da Kleidung drin, die können wir gut gebrauchen.
	AI_Output(hero, self, "Info_Mod_Yussuf_Blutkelch_15_07"); //Steht da nicht eine Wache?
	AI_Output(self, hero, "Info_Mod_Yussuf_Blutkelch_05_08"); //Schon, aber das ist kein Problem für mich.
	AI_Output(hero, self, "Info_Mod_Yussuf_Blutkelch_15_09"); //Hast du eine Verkleidung?
	AI_Output(self, hero, "Info_Mod_Yussuf_Blutkelch_05_10"); //Natürlich. Lass uns gehen. Wir schauen erst mal nach den Klamotten.
...
{
	AI_Output(self, hero, "Info_Mod_Yussuf_Blutkelch2_05_00"); //Der Ritter hier könnte was bemerken. Du musst ihn ablenken. Den Rest mache ich.
...
{
	AI_Output(self, hero, "Info_Mod_Yussuf_Blutkelch3_05_00"); //Das war mal 'ne leichte Sache. Los weg hier, bevor noch einer was merkt.
	AI_Output(hero, self, "Info_Mod_Yussuf_Blutkelch3_15_01"); //Gehen wir doch gleich in die Oberstadt.
	AI_Output(self, hero, "Info_Mod_Yussuf_Blutkelch3_05_02"); //Du weißt, wo der Richter steckt?
	AI_Output(hero, self, "Info_Mod_Yussuf_Blutkelch3_15_03"); //Gewiss. Er hat allerdings ne Wache vom Haus.
	AI_Output(self, hero, "Info_Mod_Yussuf_Blutkelch3_05_04"); //Die könnte doch ich diesmal ablenken.
...
FUNC VOID Info_Mod_Yussuf_Blutkelch4_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Yussuf_Blutkelch4_05_01"); //Hab verstanden.
...
{
	AI_Output(self, hero, "Info_Mod_Yussuf_Blutkelch5_05_00"); //Den haben wir schön reingelegt. Wie geht's dem Richter?
	AI_Output(hero, self, "Info_Mod_Yussuf_Blutkelch5_15_01"); //Nicht gut. Er steht jetzt vor seinem Richter.
	AI_Output(self, hero, "Info_Mod_Yussuf_Blutkelch5_05_02"); //Ein Mordskerl bist du.
...
{
	AI_Output(self, hero, "Info_Mod_Yussuf_Blutkelch6_05_00"); //Ich werde meine Klamotten abliefern.
	AI_Output(hero, self, "Info_Mod_Yussuf_Blutkelch6_15_01"); //Und ich gehe zum Hohen Rat. Bis ein andermal.
	AI_Output(self, hero, "Info_Mod_Yussuf_Blutkelch6_05_02"); //Mach's gut!
...
{
	AI_Output(self, hero, "Info_Mod_Yussuf_Assassinengold_05_00"); //Teufelskerl! Du bist der Star im Lager. Wie machst du das?
	AI_Output(hero, self, "Info_Mod_Yussuf_Assassinengold_15_01"); //Hast du schon mal was von Motivation gehört?
	AI_Output(self, hero, "Info_Mod_Yussuf_Assassinengold_05_02"); //Eh. Nein.
