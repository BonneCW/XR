...
{
	AI_Output(self, hero, "Info_Mod_Angar_Hi_04_00"); //(überrascht) Du? Ich hätte nicht gedacht dich jemals wieder zu sehen.
	AI_Output(self, hero, "Info_Mod_Angar_Hi_04_01"); //Hast du den Schläfer besiegt?
...
FUNC VOID Info_Mod_Angar_Irdorath_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Irdorath_04_02"); //Was?! Dann muss ich dich unter allen Umständen begleiten.
	AI_Output(self, hero, "Info_Mod_Angar_Irdorath_04_03"); //Erst wenn dieser Unhold vernichtet ist, wurde der Tod unseres einstigen geistigen Anführers, Y'Berion, gesühnt.
};
...
FUNC VOID Info_Mod_Angar_Irdorath2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Irdorath2_04_01"); //Ich werde dort auf dich warten.
...
FUNC VOID Info_Mod_Angar_Fanatiker_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Fanatiker_04_01"); //Die meisten sind nach dem Tod von Y'Berion vom Glauben an den Schläfer abgegangen, doch einige sind aufgebrochen, den Schläfer zu finden.
	AI_Output(self, hero, "Info_Mod_Angar_Fanatiker_04_02"); //Es waren mehrere Grüppchen. Einige sind zusammen mit Cor Kalom damals in den Tempel gegangen, die anderen sind nach dem Fall der Barriere nach Khorinis aufgebrochen.
	AI_Output(self, hero, "Info_Mod_Angar_Fanatiker_04_03"); //Vermutlich haben sie sich in den Wäldern um die Stadt versteckt.

	if (Mod_Import_Dusty == LOG_SUCCESS)
	|| (Mod_Import_Dusty == -1)
	{
		AI_Output(self, hero, "Info_Mod_Angar_Fanatiker_04_04"); //Sprich am besten mit Dusty, er jagt momentan in den Wäldern um Khorinis. Des nachts solltest du ihn in der Stadt finden.
	...
	{
		AI_Output(self, hero, "Info_Mod_Angar_Fanatiker_04_05"); //Sprich am besten mit Lester, der kennt sich in der Gegend besser aus.
...
FUNC VOID Info_Mod_Angar_Namib_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Namib_04_01"); //Sehr gut. Aber leider ist Gor Na Vid nicht da. Du musst stattdessen das Kommando über die zweite Gruppe übernehmen. Schaffst du das?
	AI_Output(hero, self, "Info_Mod_Angar_Namib_15_02"); //Ich denke schon.
	AI_Output(self, hero, "Info_Mod_Angar_Namib_04_03"); //Ausgezeichnet. Dein Trupp muss zu Balors Sumpfkrautfeld. Ach ja, eins wäre da noch. Bevorzugst du Waffen oder Magie?
...
FUNC VOID Info_Mod_Angar_Namib_Waffen()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Namib_Waffen_04_01"); //Nahkampf oder Fernkampf?
...
FUNC VOID Info_Mod_Angar_Namib_Nahkampf()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Namib_Nahkampf_04_01"); //Einhand oder Zweihand?
...
FUNC VOID Info_Mod_Angar_Namib_Einhand()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Namib_Einhand_04_01"); //Gut, hier nimm dieses Keule.
...
FUNC VOID Info_Mod_Angar_Namib_Zweihand()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Namib_Zweihand_04_01"); //Gut, hier nimm dieses Keule.
...
FUNC VOID Info_Mod_Angar_Namib_Fernkampf()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Namib_Fernkampf_04_01"); //Armbrust oder Bogen?.
...
FUNC VOID Info_Mod_Angar_Namib_Armbrust()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Namib_Armbrust_04_01"); //Gut, hier nimm diese Armbrust und ein paar Bolzen dazu.
...
FUNC VOID Info_Mod_Angar_Namib_Bogen()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Namib_Bogen_04_01"); //Gut, hier nimm diesen Bogen und ein paar Pfeile dazu.
...
FUNC VOID Info_Mod_Angar_Namib_Magie()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Namib_Magie_04_01"); //Gut, hier nimm diese Spruchrollen.
...
{
	AI_Output(self, hero, "Info_Mod_Angar_SSUD_04_00"); //Gut, dass du gekommen bist. Mit untoten Sumpfhaien hatten wir nicht gerechnet.
	AI_Output(hero, self, "Info_Mod_Angar_SSUD_15_01"); //Ja, wir waren auch ziemlich überrascht.
	AI_Output(self, hero, "Info_Mod_Angar_SSUD_04_02"); //Du solltest jetzt zu Baal Namib gehen und im Bericht erstatten.
...
FUNC VOID Info_Mod_Angar_Wambo_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Wambo_04_01"); //(erfreut) Wambo?! Dass der sich noch an mich erinnert!
	...
	AI_Output(self, hero, "Info_Mod_Angar_Wambo_04_03"); //Du meinst ...
	AI_Output(hero, self, "Info_Mod_Angar_Wambo_15_04"); //Ja. Wambo plagen bis heute Gewissensbisse.
	AI_Output(self, hero, "Info_Mod_Angar_Wambo_04_05"); //(mit erstickter Stimme) Ich hatte nie erwartet, sie wiederzusehen.
	AI_Output(self, hero, "Info_Mod_Angar_Wambo_04_06"); //Aber jetzt ist auch alle Hoffnung hinüber.
	AI_Output(self, hero, "Info_Mod_Angar_Wambo_04_07"); //(gefasst) Danke für deinen Botendienst. Ich ... ich muss jetzt erst mal allein sein.
...
{
	AI_Output(self, hero, "Info_Mod_Angar_Hueterklinge_04_00"); //Du bist jetzt also Templer, aber vollwertig bist du erst, wenn du deine eigene Hüterklinge führen wirst.
	AI_Output(hero, self, "Info_Mod_Angar_Hueterklinge_15_01"); //Und woher bekomme ich die?
	AI_Output(self, hero, "Info_Mod_Angar_Hueterklinge_04_02"); //Kommt darauf an, ob du ein Einhand- oder ein Zweihandschwert möchtest.
...
{
	AI_Output(self, hero, "Info_Mod_Angar_Hueterklinge_C_04_00"); //Du musst die nötigen Rohstoffe in der Schmiede vorbeibringen.
	AI_Output(hero, self, "Info_Mod_Angar_Hueterklinge_C_15_01"); //Und wo um alles in der Welt, soll ich all diese Sachen bekommen?
	AI_Output(self, hero, "Info_Mod_Angar_Hueterklinge_C_04_02"); //Das herauszufinden wird der erste Schritt deiner Aufgabe sein.
	AI_Output(self, hero, "Info_Mod_Angar_Hueterklinge_C_04_03"); //Frag doch einfach andere Templer, woher sie das Zeug bekommen haben.
...
FUNC VOID Info_Mod_Angar_Hueterklinge_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Hueterklinge_B_04_01"); //Für eine zweihändig führbare Hüterklinge brauchst du 8 Brocken magisches Erz, 6 tReisfressende Heilpflanzen vom Reislord, einen Dolch, der das Blut von 4 Königen getrunken hat und das Fleisch eines Scavangers, der nicht aus einem Ei geschlüpft ist.
...
FUNC VOID Info_Mod_Angar_Hueterklinge3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Hueterklinge3_04_01"); //Was gibt’s?
	...
	if (self.aivar[AIV_Verhandlung] == TRUE)
	{
		...
		AI_Output(self, hero, "Info_Mod_Angar_Hueterklinge3_04_03"); //Ich verstehe, nun, Gor Na Kar ist wohl der Templer mit am meisten Kampferfahrung, Gor Na Mon wurde bereits in jungen Jahren Templer, hat also für sein Alter schon sehr viel mitgemacht.
		AI_Output(self, hero, "Info_Mod_Angar_Hueterklinge3_04_04"); //Der älteste Templer ist Gor Na Drak, allerdings ist er schon ziemlich senil und viel Nützliches wirst du von ihm nicht mehr hören.
	...
	else
	{
		...
		AI_Output(self, hero, "Info_Mod_Angar_Hueterklinge3_04_06"); //Du willst mich wohl für dumm verkaufen? Besorg dir gefälligst eine eigene Hüterlkinge!
	};
};
...
FUNC VOID Info_Mod_Angar_Hueterklinge4_Info()
{
	...
	|| (Npc_HasItems(hero, ItMw_FalscheHueterklinge_1H) == 1))
	{
		...
		|| (Npc_HasItems(hero, ItMw_AlteHueterklinge_1H) == 1)
		{
			AI_Output(self, hero, "Info_Mod_Angar_Hueterklinge4_04_01"); //Die sieht mir aber ziemlich alt aus ...
		}
		else
		{
			AI_Output(self, hero, "Info_Mod_Angar_Hueterklinge4_04_02"); //Hüterklinge? Dafür sieht sie aber ziemlich gewöhnlich aus ...
		};

		AI_Output(self, hero, "Info_Mod_Angar_Hueterklinge4_04_03"); //Wie dem auch sei, du hast deine Aufgabe erfüllt. Du bist jetzt ein vollwertiger Templer.

		B_GivePlayerXP	(200);
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Angar_Hueterklinge4_04_04"); //Wahrlich ein wunderschönes Schwert ... ich bin beeindruckt! Du bist ein würdiger Templer!
...
{
	AI_Output(self, hero, "Info_Mod_Angar_Eroberung_03_04_00"); //Ihr werdet dabei von zwei meiner Templer begleitet.
...
FUNC VOID Info_Mod_Angar_Hueterklinge2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Hueterklinge2_04_01"); //So einfach mach ich es dir auch wieder nicht.
};
...
{
	AI_Output (self, hero, "Info_Mod_Angar_PMSchulden_04_00"); //Bist du gekommen, um deine Strafe zu zahlen?

	if (B_GetTotalPetzCounter(self) > Angar_LastPetzCounter)
	{
		AI_Output (self, hero, "Info_Mod_Angar_PMSchulden_04_01"); //Ich hatte mich schon gefragt, ob du es überhaupt noch wagst, hierher zu kommen!
		AI_Output (self, hero, "Info_Mod_Angar_PMSchulden_04_02"); //Anscheinend ist es nicht bei den letzten Anschuldigungen geblieben!

		if (Angar_Schulden < 1000)
		{
			AI_Output (self, hero, "Info_Mod_Angar_PMSchulden_04_03"); //Ich hatte dich gewarnt! Die Strafe, die du jetzt zahlen musst, ist höher!
		...
		{
			AI_Output (self, hero, "Info_Mod_Angar_PMSchulden_04_04"); //Du hast mich schwer enttäuscht!
		};
	}
	else if (B_GetGreatestPetzCrime(self) < Angar_LastPetzCrime)
	{
		AI_Output (self, hero, "Info_Mod_Angar_PMSchulden_04_05"); //Es haben sich einige neue Dinge ergeben.
		
		if (Angar_LastPetzCrime == CRIME_MURDER)
		{
			AI_Output (self, hero, "Info_Mod_Angar_PMSchulden_04_06"); //Plötzlich gibt es niemanden mehr, der dich des Mordes bezichtigt.
		};
		
		if (Angar_LastPetzCrime == CRIME_THEFT)
		|| ( (Angar_LastPetzCrime > CRIME_THEFT) && (B_GetGreatestPetzCrime(self) < CRIME_THEFT) )
		{
			AI_Output (self, hero, "Info_Mod_Angar_PMSchulden_04_07"); //Niemand erinnert sich mehr, dich bei einem Diebstahl gesehen zu haben.
		};
		
		if (Angar_LastPetzCrime == CRIME_ATTACK)
		|| ( (Angar_LastPetzCrime > CRIME_ATTACK) && (B_GetGreatestPetzCrime(self) < CRIME_ATTACK) )
		{
			AI_Output (self, hero, "Info_Mod_Angar_PMSchulden_04_08"); //Es gibt keine Zeugen mehr dafür, dass du jemals in eine Schlägerei verwickelt warst.
		};
		
		if (B_GetGreatestPetzCrime(self) == CRIME_NONE)
		{
			AI_Output (self, hero, "Info_Mod_Angar_PMSchulden_04_09"); //Anscheinend haben sich alle Anklagen gegen dich in Wohlgefallen aufgelöst.
		};
		
		AI_Output (self, hero, "Info_Mod_Angar_PMSchulden_04_10"); //Ich weiß nicht, was da gelaufen ist, aber ich warne dich: Spiel keine Spielchen mit mir.
				
		// ------- Schulden erlassen oder trotzdem zahlen ------
		if (B_GetGreatestPetzCrime(self) == CRIME_NONE)
		{
			AI_Output (self, hero, "Info_Mod_Angar_PMSchulden_04_11"); //Ich habe mich jedenfalls entschieden, dir deine Schulden zu erlassen.
			AI_Output (self, hero, "Info_Mod_Angar_PMSchulden_04_12"); //Sieh zu, dass du nicht wieder in Schwierigkeiten kommst.
		...
		{
			AI_Output (self, hero, "Info_Mod_Angar_PMSchulden_04_13"); //Damit eins klar ist: Deine Strafe musst du trotzdem in voller Höhe zahlen.
			B_Say_Gold (self, hero, Angar_Schulden);
			AI_Output (self, hero, "Info_Mod_Angar_PMSchulden_04_14"); //Also, was ist?
		};
	};
...
FUNC VOID Info_Mod_Angar_PETZMASTER_Info()
{
	...
	{
		AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_01"); //Gut, dass du zu mir kommst, bevor alles noch schlimmer für dich wird.
		AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_02"); //Mord ist ein schweres Vergehen!
		...
		{
			AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_03"); //Ganz zu schweigen von den anderen Sachen, die du angerichtet hast.
		};

		AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_06"); //Ich habe kein Interesse daran, dich an den Galgen zu bringen.
		AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_07"); //Aber es wird nicht leicht sein, die Leute wieder gnädig zu stimmen.
		AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_08"); //Du könntest deine Reue zeigen, indem du eine Strafe zahlst - natürlich muss die Strafe angemessen hoch sein.
	};
		
	if (B_GetGreatestPetzCrime(self) == CRIME_THEFT) 
	{
		AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_09"); //Gut, dass du kommst! Du wirst des Diebstahls bezichtigt! Es gibt Zeugen!

		if ((PETZCOUNTER_City_Attack + PETZCOUNTER_City_Sheepkiller) > 0)
		{
			AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_10"); //Von den anderen Dingen, die mir zu Ohren gekommen sind, will ich gar nicht erst reden.
		};

		AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_11"); //Ich werde so ein Verhalten hier im Lager nicht dulden!
		AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_12"); //Du wirst eine Strafe zahlen müssen, um dein Verbrechen wieder gutzumachen!
	...
	{
		AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_14"); //Wenn du dich mit unseren Brüdern anlegst, muss ich dich zur Rechenschaft ziehen.

		if (PETZCOUNTER_City_Sheepkiller > 0)
		{
			AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_15"); //Und die Sache mit den Schafen musste wohl auch nicht sein.
		};

		AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_16"); //Wenn ich dir das durchgehen lasse, macht hier bald jeder, was er will.
		AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_17"); //Also wirst du eine angemessene Strafe zahlen - und die Sache ist vergessen.
	...
	{
		AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_18"); //Mir ist zu Ohren gekommen, du hättest dich an unseren Schafen vergriffen.
		AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_19"); //Dir ist klar, dass ich das nicht durchgehen lassen kann.
		AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_04_20"); //Du wirst eine Entschädigung zahlen müssen!
...
func void Info_Mod_Angar_PETZMASTER_PayNow()
{
	...
	AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_PayNow_04_01"); //Gut! Ich werde dafür sorgen, dass es jeder im Lager erfährt - damit wäre dein Ruf einigermaßen wiederhergestellt.
...
func void Info_Mod_Angar_PETZMASTER_PayLater()
{
	...
	AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_PayLater_04_01"); //Dann sieh zu, dass du das Gold so schnell wie möglich beschaffst.
	AI_Output (self, hero, "Info_Mod_Angar_PETZMASTER_PayLater_04_02"); //Und ich warne dich: Wenn du dir noch was zu schulden kommen lässt, wird die Sache noch schlimmer für dich!
...
FUNC VOID Info_Mod_Angar_Lehrer_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Lehrer_04_00"); //Ich kann dir helfen stärker zu werden. Außerdem kann ich dich im Kampf mit Zweihändern unterweisen.
...
FUNC VOID Info_Mod_Angar_Lernen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Angar_Lernen_04_01"); //Was willst du lernen?

	Info_ClearChoices	(Info_Mod_Angar_Lernen);

	Info_AddChoice 		(Info_Mod_Angar_Lernen, DIALOG_BACK, Info_Mod_Angar_Lernen_BACK);
	Info_AddChoice		(Info_Mod_Angar_Lernen, B_BuildLearnString_New(PRINT_LearnSTR5	, B_GetLearnCostAttribute_New(hero, ATR_STRENGTH), ATR_STRENGTH)	, Info_Mod_Angar_Lernen_Stärke_5);
	Info_AddChoice		(Info_Mod_Angar_Lernen, B_BuildLearnString_New(PRINT_LearnSTR1	, B_GetLearnCostAttribute(hero, ATR_STRENGTH), ATR_STRENGTH)	, Info_Mod_Angar_Lernen_Stärke_1);
...
FUNC VOID Info_Mod_Angar_Lernen_Stärke_5()
{
...
FUNC VOID Info_Mod_Angar_Lernen_Stärke_1()
{
