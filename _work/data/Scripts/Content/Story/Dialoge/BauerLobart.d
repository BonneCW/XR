FUNC VOID Info_Mod_BauerLobart_VinoBrennerei()
{
	...
	AI_Output(self, hero, "Info_Mod_BauerLobart_VinoBrennerei_04_01"); //(unsicher) Ähh, nun, ich weiß ja nicht ... (zu sich selbst) aber wenn ihm nun doch was zugestoßen ist ...
	AI_Output(hero, self, "Info_Mod_BauerLobart_VinoBrennerei_15_02"); //Spuck’s schon aus. Vielleicht kann ich ja helfen.
	AI_Output(self, hero, "Info_Mod_BauerLobart_VinoBrennerei_04_03"); //(zögerlich) Nun gut ... Vino hat im großen Wald eine Brennerei eingerichtet ... in der Nähe von einem Steinkreis glaube ich.
	AI_Output(self, hero, "Info_Mod_BauerLobart_VinoBrennerei_04_04"); //Er geht dort ab und zu mal hin, um sich anschließend in der Stadt mit dem Selbstgebrannten ein paar Münzen hinzu zu verdienen ... oder bringt uns Landarbeitern auch mal was mit für den Feierabend.
	AI_Output(self, hero, "Info_Mod_BauerLobart_VinoBrennerei_04_05"); //So jetzt weißt du es. Erzähl es aber bitte niemandem weiter.
...
FUNC VOID Info_Mod_BauerLobart_VinoBrennerei2()
{
	...
	AI_Output(self, hero, "Info_Mod_BauerLobart_VinoBrennerei2_04_01"); //Ja, ich weiß. Aber wem hätten wir davon erzählen sollen?
	AI_Output(self, hero, "Info_Mod_BauerLobart_VinoBrennerei2_04_02"); //Lobart würde ihm die Hölle heiß machen, wenn er das mitbekäme ... und Mika, der alles vor der Stadt im Auge behält, ist nicht gerade zimperlich, wenn es um Rauschmittel geht.
	AI_Output(self, hero, "Info_Mod_BauerLobart_VinoBrennerei2_04_03"); //Vino könnte dafür geradewegs in den Knast wandern ...
};
...
FUNC VOID Info_Mod_BauerLobart_VinoBrennerei3()
{
	...
	AI_Output(self, hero, "Info_Mod_BauerLobart_VinoBrennerei3_04_01"); //Achja, stimmt, das hatte ich noch nicht erwähnt.
	AI_Output(self, hero, "Info_Mod_BauerLobart_VinoBrennerei3_04_02"); //Er berichtete mal, hinter Jack’s Leuchtturm eine seltsame Plattform gefunden zu haben.
	AI_Output(self, hero, "Info_Mod_BauerLobart_VinoBrennerei3_04_03"); //Die bringt ihn angeblich direkt in diese abgelegene Höhle, vorbei an allen Monstern.
};
