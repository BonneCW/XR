...
FUNC VOID Info_Mod_Snaf_Hi_Info()
{
	...
	{
		AI_Output(self, hero, "Info_Mod_Snaf_Hi_06_00"); //Hey, ich kenne dich doch. Du hast mir doch mal die Zutaten für mein Fleischwanzenragout gebracht.
		AI_Output(hero, self, "Info_Mod_Snaf_Hi_15_01"); //Ja ...
		AI_Output(self, hero, "Info_Mod_Snaf_Hi_06_02"); //Ich muss mich nochmal bei dir dafür bedanken. Ich habe mit dem Fleischwanzenragout gut verdient.
		AI_Output(self, hero, "Info_Mod_Snaf_Hi_06_03"); //Als Dank werde ich dir ein paar meiner neuen Waren verkaufen. Natürlich habe ich auch Fleischwanzenragout.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Snaf_Hi_06_04"); //Hey, Neuer. Wenn du Hunger hast, kannst du bei mir vorbeischauen, ich hab da ein paar echte Spezialitäten im Angebot.
		AI_Output(self, hero, "Info_Mod_Snaf_Hi_06_05"); //Unter anderem mein berühmtes Fleischwanzenragout.
	};
...
FUNC VOID Info_Mod_Snaf_WoherZutaten_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Snaf_WoherZutaten_06_01"); //Fleischwanzen gibt's immer genug. Außerdem bringen die Jäger genug Grünfutter mit von ihren Jagden.
	AI_Output(self, hero, "Info_Mod_Snaf_WoherZutaten_06_02"); //Und sonst ... was man so findet. Manchmal ist es besser, nicht zu viel drüber nachzudenken, was drin ist.
};
...
FUNC VOID Info_Mod_Snaf_Lagermusik_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Snaf_Lagermusik_06_01"); //(wollüstig) Oh, du weißt ja gar nicht, wie ich so etwas vermisse.
	AI_Output(self, hero, "Info_Mod_Snaf_Lagermusik_06_02"); //Abends am Marktplatz zusammenkommen, einer schlägt die Saiten, einer die Trommel, und alle singen was Melancholisches vom heiteren Leben am Hof des Königs.
	AI_Output(hero, self, "Info_Mod_Snaf_Lagermusik_15_03"); //Gravo will eine ganze Gruppe aufbauen. Willst du teilnehmen?
	AI_Output(self, hero, "Info_Mod_Snaf_Lagermusik_06_04"); //Er will richtig auftreten? Nee, dazu fehlt mir die Zeit. Ich kann doch meinen Kochtopf nicht außer Acht lassen.
	AI_Output(self, hero, "Info_Mod_Snaf_Lagermusik_06_05"); //Aber er kann sich sicher sein, wer der erste Besucher seiner Auftritte sein wird!
};
