...
FUNC VOID Info_Mod_Aaron_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_01"); //Verfluchter Beliar-Anhänger! Lange habe ich versucht dich zu töten, und jetzt kommst du zu mir in die Kirche?
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_02"); //Ich werde diesen heiligen Ort nicht mit deinem Blut entweihen!
	AI_Output(hero, self, "Info_Mod_Aaron_Hi_15_03"); //Du nennst mich Beliar-Anhänger? Wie kommst du darauf, dass ich Beliar angehöre?
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_04"); //(überraschtes schweigen) ...
	AI_Output(hero, self, "Info_Mod_Aaron_Hi_15_05"); //Kann es sein, dass Tojan dir das gesagt hat?
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_06"); //Woher weißt du das?
	...
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_09"); //(überrascht) Was?
	AI_Output(hero, self, "Info_Mod_Aaron_Hi_15_10"); //Tojan treibt ein falsches Spiel mit uns.
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_11"); //Du versuchst nur mich durcheinander zu bringen, um mir dann dein Messer durch den Rücken rammen zu können!
	...
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_13"); //HA! Ich wusste es. Du musst ein Schwarzmagier sein. Jeder unserer Brüder weiß, dass nicht das hier der heiligste Ort der Innoskriche ist. Es ist ...
	AI_Output(hero, self, "Info_Mod_Aaron_Hi_15_14"); //Die Kapelle auf der Anhöhe. Ich bin durch diese Kapelle gekommen.
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_15"); //Du lügst doch!
	...
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_17"); //... mein Tagebuch? Du warst tatsächlich dort. Dann kannst du kein Beliar-Anhänger sein. Dann ... wurde das Kloster nicht infiltriert?
	AI_Output(hero, self, "Info_Mod_Aaron_Hi_15_18"); //Doch, ich fürchte schon. Aber von jemandem, den ich nicht verdächtigt hätte.
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_19"); //Du meinst ...
	AI_Output(hero, self, "Info_Mod_Aaron_Hi_15_20"); //... Tojan.
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_21"); //Du hast Recht. Es passt alles.

	B_Say	(hero, self, "$WASMACHENWIRJETZT");

	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_22"); //Wir werden ihm eine Falle stellen. Komm morgen Nacht auf den Marktplatz.
	AI_Output(self, hero, "Info_Mod_Aaron_Hi_03_23"); //Vorher solltest du allerdings noch zu Tojan gehen und ihn auf mich hinweisen.
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_Falle_03_00"); //Da bist du ja!

	B_Say	(hero, self, "$WASMACHENWIRJETZT");

	AI_Output(self, hero, "Info_Mod_Aaron_Falle_03_01"); //Wir werden aus Tojan herauskriegen, weswegen er hier im Kloster ist.
	AI_Output(hero, self, "Info_Mod_Aaron_Falle_15_02"); //Und wie willst du das anstellen?
	AI_Output(self, hero, "Info_Mod_Aaron_Falle_03_03"); //Mit einem Trick. Wir spielen ihm vor, dass du mich getötet hast.
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_KillTojan_03_00"); //Geh zur Seite, ich werde ihn jetzt töten!
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_TojanDead_03_00"); //Es stimmt ... Er war mein Sohn.
	AI_Output(hero, self, "Info_Mod_Aaron_TojanDead_15_01"); //Dann bist du Ragons Sohn?
	AI_Output(self, hero, "Info_Mod_Aaron_TojanDead_03_02"); //Ja ... Und mein Name ist nicht Aaron, sondern Garan.
	AI_Output(hero, self, "Info_Mod_Aaron_TojanDead_15_03"); //Und die Hexenkönigin?
	AI_Output(self, hero, "Info_Mod_Aaron_TojanDead_03_04"); //Ich kann mich nicht genau an sie erinnern ... Irgendetwas fehlt noch in meinem Gedächtnis ... Doch das ist jetzt unwichtig.
	AI_Output(self, hero, "Info_Mod_Aaron_TojanDead_03_05"); //Nun muss ich an meinen Platz in der Innoskirche zurückkehren. Ich werde mit meinen vier Brüdern die Barriere zerstören.
	AI_Output(self, hero, "Info_Mod_Aaron_TojanDead_03_06"); //Ich weiß nicht, wie ich dir jemals danken kann!
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_Barriere_03_00"); //Ah, hallo, Bruder. Wie du siehst habe ich den Platz meines Vaters eingenommen.
	AI_Output(hero, self, "Info_Mod_Aaron_Barriere_15_01"); //Freut mich, das zu sehen.
	AI_Output(self, hero, "Info_Mod_Aaron_Barriere_03_02"); //Wir überlegen gerade einen Zauber, mit dem wir die Barriere zerstören können.
	AI_Output(self, hero, "Info_Mod_Aaron_Barriere_03_03"); //Wir sollten nicht länger als einen Tag dafür brauchen. Komm morgen um diese Zeit wieder.
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_BarriereWeg_03_00"); //Es ist vollbracht, die Barriere ist zerstört!
	AI_Output(hero, self, "Info_Mod_Aaron_BarriereWeg_15_01"); //Das sind gute Nachrichten.
	AI_Output(self, hero, "Info_Mod_Aaron_BarriereWeg_03_02"); //In der Tat, Bruder. Du kannst nun nach Khorinis zurückkehren. Nimm diese zwei Runen.
	...
	AI_Output(self, hero, "Info_Mod_Aaron_BarriereWeg_03_03"); //Mit ihnen kannst du dich zur Kapelle und hier in die Kirche teleportieren.
...
FUNC VOID Info_Mod_Aaron_Back_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_00"); //Nun, wie du vielleicht weißt, wurde der Rat der Götter einberufen. Das bedeutet, dass die Schwarzmagier uns nicht weiter belagern dürfen.
	AI_Output(hero, self, "Info_Mod_Aaron_Back_15_01"); //Und wieso sind sie hier im Kloster?
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_02"); //Nun, leider werden wir immer noch belagert, nur nicht mehr von den Schwarzmagiern.
	AI_Output(hero, self, "Info_Mod_Aaron_Back_15_03"); //Von wem dann?
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_04"); //Von den Hexen.
	AI_Output(hero, self, "Info_Mod_Aaron_Back_15_05"); //Was? Von Hexen? Du meinst also von der Mutter Tojans?
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_06"); //Es sieht so aus, ja.
	AI_Output(hero, self, "Info_Mod_Aaron_Back_15_07"); //Ja, aber das kann den Schwarzmagiern doch eigentlich egal sein, oder?
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_08"); //Nicht direkt. Die Hexen sind seit langer Zeit Verbündete der Schwarzmagier.
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_09"); //Das heißt, wenn uns die Hexen angreifen, wäre es nicht anders, als wenn uns die Schwarzmagier selbst angreifen würden.
	AI_Output(hero, self, "Info_Mod_Aaron_Back_15_10"); //Und das zwingt sie sozusagen uns zu helfen.
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_11"); //Genau. Eigentlich würden wir diese Hilfe nicht annehmen, aber die Hexen sind in einer Überzahl, die wir alleine nicht schaffen würden.
	AI_Output(hero, self, "Info_Mod_Aaron_Back_15_12"); //Ich verstehe. Also was hast du jetzt vor?
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_13"); //Nun, es trifft sich gut, dass du gerade kommst. Die Hexen haben die insgesamt fünf Lager der Schwarzmagier übernommen.
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_14"); //Und du wirst die Hexen dort angreifen.
	...
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_16"); //Natürlich nicht alleine. Im Klosterhof wartet bereits eine Gruppe auf deine Befehle!
	AI_Output(self, hero, "Info_Mod_Aaron_Back_03_17"); //Und jetzt beeil dich. Je schneller du die Lager vernichtest, desto besser!
...
FUNC VOID Info_Mod_Aaron_Hexen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Aaron_Hexen_03_01"); //Das dürfte fürs Erste reichen. Doch jetzt müssen wir schnell handeln!

	B_Say	(hero, self, "$WASMEINSTDU");

	AI_Output(self, hero, "Info_Mod_Aaron_Hexen_03_03"); //Wir schlagen der Schlange den Kopf ab! Wir müssen die Hexenkönigin vernichten.
	AI_Output(hero, self, "Info_Mod_Aaron_Hexen_15_04"); //Du meinst also die ...
	AI_Output(self, hero, "Info_Mod_Aaron_Hexen_03_05"); //Ja, die Mutter von Tojan. Sie wird jetzt für alles büßen!
	AI_Output(self, hero, "Info_Mod_Aaron_Hexen_03_06"); //Ich beauftrage dich mit der Aufgabe dies zu tun, Bruder. Sei stark!
	AI_Output(self, hero, "Info_Mod_Aaron_Hexen_03_07"); //Und jetzt geh, vernichte die Hexenkönigin. Sie hat sich im alten Turm niedergelassen. Aber pass auf, sie wird streng bewacht.
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_Door_03_00"); //Du bist schon wieder zurück? Hast du die Hexenkönigin vernichtet?
	AI_Output(hero, self, "Info_Mod_Aaron_Door_15_01"); //Nein. Ich komme nicht durch die Tür.
	AI_Output(self, hero, "Info_Mod_Aaron_Door_03_02"); //Hast du versucht sie zu brechen?
	AI_Output(hero, self, "Info_Mod_Aaron_Door_15_03"); //Ja, aber es ging nicht.
	AI_Output(self, hero, "Info_Mod_Aaron_Door_03_04"); //Nun, dann werde ich mit dir kommen und die Tür öffnen.
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_DoorIn_03_00"); //Seltsam ...
	AI_Output(hero, self, "Info_Mod_Aaron_DoorIn_15_01"); //Das sah jetzt aber nicht sehr schwierig aus.
	AI_Output(self, hero, "Info_Mod_Aaron_DoorIn_03_02"); //War es auch nicht. Egal. Wir müssen weiter. AH!

	B_Say	(hero, self, "$WASISTDENN");

	AI_Output(self, hero, "Info_Mod_Aaron_DoorIn_03_03"); //Ich habe meine Rune verloren. Sie muss noch unten an der Treppe liegen. Ich werde sie schnell holen.
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_Blut_03_00"); //Braucht man nicht unser beider Blut, um unsere Mutter wieder zu erwecken?
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_Kill_03_00"); //Los, lass sie uns töten!
...
{
	AI_Output(self, hero, "Info_Mod_Aaron_Party_03_00"); //Danke, mein Freund. Ohne dich hätte ich nie herausgefunden, wer ich wirklich bin.
	AI_Output(self, hero, "Info_Mod_Aaron_Party_03_01"); //Ich würde dich gerne reich belohnen.
	AI_Output(self, hero, "Info_Mod_Aaron_Party_03_02"); //Doch kann ich dir nicht viel geben, du musst mit diesem Geschenk zufrieden sein.
	...
	AI_Output(self, hero, "Info_Mod_Aaron_Party_03_03"); //Das, mein Freund, ist das Vermächtnis meines Vaters. Das, wonach er sein ganzes Leben gesucht hat. Die sechste Träne Innos'.
	AI_Output(hero, self, "Info_Mod_Aaron_Party_15_04"); //Er hat sie tatsächlich gefunden?
	AI_Output(self, hero, "Info_Mod_Aaron_Party_03_05"); //Ja. Und er versteckte sie hier in diesem Kloster, bevor er sich mit meiner Mutter einließ. Du sollst sie haben.
	AI_Output(self, hero, "Info_Mod_Aaron_Party_03_06"); //Und jetzt lass uns feiern!
