...
{
	AI_Output(self, hero, "Info_Mod_Leonhard_Hi_09_00"); //(erschrocken) Hey! Was schleichst du hier herum? Willst mich wohl erschrecken?
};
...
FUNC VOID Info_Mod_Leonhard_Aufgabe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Leonhard_Aufgabe_09_01"); //Ich warte, um Leuten wie dir ein gutes Angebot zu machen. Ein Angebot zu deinem und meinem Vorteil.
	AI_Output(self, hero, "Info_Mod_Leonhard_Aufgabe_09_02"); //Bin nur gerade kurz eingenickt. Ich warte ja schon etwas länger.
...
FUNC VOID Info_Mod_Leonhard_Aufgabe_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Leonhard_Aufgabe_A_09_01"); //Zwei Kumpel von mir sind im Gefängnis gelandet, völlig unrechtmäßig.
	AI_Output(self, hero, "Info_Mod_Leonhard_Aufgabe_A_09_02"); //Und jetzt will ich dem Richter die Gelegenheit geben, seinen Fehler wieder gut zu machen.
	AI_Output(self, hero, "Info_Mod_Leonhard_Aufgabe_A_09_03"); //Dafür sollst du ihm einfach nur eine Nachricht übermitteln, klar?
	AI_Output(self, hero, "Info_Mod_Leonhard_Aufgabe_A_09_04"); //Pass auf, dass niemand anderes sie liest, und guck selbst auch nicht rein. Steht eh nichts Spannendes drin.
	AI_Output(self, hero, "Info_Mod_Leonhard_Aufgabe_A_09_05"); //Eine Aufwandsentschädigung für dich ist natürlich auch drin.
...
FUNC VOID Info_Mod_Leonhard_Aufgabe_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Leonhard_Aufgabe_C_09_01"); //Der Richter und ich ... wir sind nicht die besten Freunde.
	AI_Output(self, hero, "Info_Mod_Leonhard_Aufgabe_C_09_02"); //Ich hoffe, das reicht dir an Erklärung. Wie steht's nun?
...
FUNC VOID Info_Mod_Leonhard_Unfrieden_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Leonhard_Unfrieden_09_01"); //Ja, deine Belohnung ... Mit der Belohnung gibt's noch ein kleines Problem.
	AI_Output(self, hero, "Info_Mod_Leonhard_Unfrieden_09_02"); //Die hat nämlich jemand anderes. Aber wir müssen sie nur noch gemeinsam beschaffen gehen.
...
FUNC VOID Info_Mod_Leonhard_Unfrieden_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Leonhard_Unfrieden_B_09_01"); //Du solltest es dir wirklich nochmal anders überlegen.
...
FUNC VOID Info_Mod_Leonhard_Unfrieden_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Leonhard_Unfrieden_A_09_01"); //In der Gaststätte hat sich Ruprecht, ein ... Verbrecher, eingenistet.
	AI_Output(self, hero, "Info_Mod_Leonhard_Unfrieden_A_09_02"); //Er schläft in einem der Betten im ersten Stock.
	AI_Output(self, hero, "Info_Mod_Leonhard_Unfrieden_A_09_03"); //Neben seinem Bett hortet er sein erbeutetes Gold in einer Truhe.
	AI_Output(self, hero, "Info_Mod_Leonhard_Unfrieden_A_09_04"); //Die musst du tagsüber in einem unbeobachteten Moment ausräumen und uns den Inhalt bringen.
	AI_Output(self, hero, "Info_Mod_Leonhard_Unfrieden_A_09_05"); //Dann erhältst du deinen gerechten Anteil.
...
FUNC VOID Info_Mod_Leonhard_Unfrieden_D()
{
	...
	AI_Output(self, hero, "Info_Mod_Leonhard_Unfrieden_D_09_01"); //Dann wird auch nichts aus der Belohnung. Überleg's dir.
...
FUNC VOID Info_Mod_Leonhard_RuprechtsTruhe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Leonhard_RuprechtsTruhe_09_01"); //Das ist nicht so viel, wie ich erwartet habe. (überlegt) Ich glaube, das ziehe ich dir vom Lohn ab. Wir schulden dir nichts.
	AI_Output(hero, self, "Info_Mod_Leonhard_RuprechtsTruhe_15_02"); //Das ist nicht dein Ernst.
	AI_Output(self, hero, "Info_Mod_Leonhard_RuprechtsTruhe_09_03"); //Verpiss dich!
...
{
	AI_Output(self, hero, "Info_Mod_Leonhard_Endres_09_00"); //Ey, haste mal 'nen Augenblick Zeit?
	AI_Output(hero, self, "Info_Mod_Leonhard_Endres_15_01"); //Worum geht's?
	AI_Output(self, hero, "Info_Mod_Leonhard_Endres_09_02"); //Hab gehört, du ermittelst in dem komplizierten Fall, wer Endres umgelegt hat.
	AI_Output(hero, self, "Info_Mod_Leonhard_Endres_15_03"); //Könnte sein.
	AI_Output(self, hero, "Info_Mod_Leonhard_Endres_09_04"); //Da wollt ich dir nur mitteilen, dass einem meiner Informanten ein Erpresserbrief vom Heiler an Juliana ... in die Hände gefallen ist.
	AI_Output(self, hero, "Info_Mod_Leonhard_Endres_09_05"); //Wahrscheinlich erpresst er sie mit Endres' Leiche, rückt sie erst gegen Bezahlung raus oder so.
	AI_Output(self, hero, "Info_Mod_Leonhard_Endres_09_06"); //Du weißt ja, arm ist Juliana nicht.
	AI_Output(hero, self, "Info_Mod_Leonhard_Endres_15_07"); //Wieso hat Juliana die Erpressung nicht gemeldet?
	AI_Output(self, hero, "Info_Mod_Leonhard_Endres_09_08"); //Tja, bei einer Erpressung hat man normalerweise was gegen die erpresste Person in der Hand, ne?
	AI_Output(self, hero, "Info_Mod_Leonhard_Endres_09_09"); //Das wird sich der Heiler schon genau überlegt haben, ob er ein ausreichendes Druckmittel hat.
	AI_Output(self, hero, "Info_Mod_Leonhard_Endres_09_10"); //Naja, wollt's nur gesagt haben. Also Dreck haben die beide am Stecken, so viel ist sicher.
	AI_Output(hero, self, "Info_Mod_Leonhard_Endres_15_11"); //Danke für die Informationen. Aber wieso erzählst du mir davon?
	AI_Output(self, hero, "Info_Mod_Leonhard_Endres_09_12"); //Ich bin immerhin ein anständiger Bürger, oder nicht? Und gibt's nicht für solche Hinweise 'ne kleine Belohnung?
	AI_Output(hero, self, "Info_Mod_Leonhard_Endres_15_13"); //Wenn du richtig liegst, bestimmt.
	AI_Output(self, hero, "Info_Mod_Leonhard_Endres_09_14"); //Dann hören wir noch voneinander.
...
{
	AI_Output(self, hero, "Info_Mod_Leonhard_Endres02_09_00"); //Na, hab gehört, mein Tipp hat dir 'ne ganze Ecke weitergeholfen.
	AI_Output(hero, self, "Info_Mod_Leonhard_Endres02_15_01"); //Das lässt sich nicht leugnen.
	AI_Output(self, hero, "Info_Mod_Leonhard_Endres02_09_02"); //Kann ich mit einer Belohnung rechnen?
...
FUNC VOID Info_Mod_Leonhard_Endres02_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Leonhard_Endres02_C_09_01"); //Oha, Mann, danke! Weißte was, dafür darfst du in Zukunft Wertsachen bei mir loswerden. Gegen Gold, versteht sich.
...
FUNC VOID Info_Mod_Leonhard_Endres02_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Leonhard_Endres02_B_09_01"); //Damit kann ich mich gerade noch zufrieden geben.
...
FUNC VOID Info_Mod_Leonhard_Endres02_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Leonhard_Endres02_A_09_01"); //Puh, das ist ein Genickschlag, du Arsch.
...
FUNC VOID Info_Mod_Leonhard_Bierhexen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Leonhard_Bierhexen_09_01"); //Na und?
	AI_Output(hero, self, "Info_Mod_Leonhard_Bierhexen_15_02"); //Wieso?
	AI_Output(self, hero, "Info_Mod_Leonhard_Bierhexen_09_03"); //Weil ich voll war. Wir hatten mitbekommen, dass der Braumeister sein erstes Bier fertig hatte, und haben ihm nachts einen Besuch abgestattet.
	AI_Output(self, hero, "Info_Mod_Leonhard_Bierhexen_09_04"); //War echt geil, muss man schon sagen, für das Bier würde ich beinahe was zahlen.
	AI_Output(self, hero, "Info_Mod_Leonhard_Bierhexen_09_05"); //Haben ordentlich Spaß gehabt.
	AI_Output(self, hero, "Info_Mod_Leonhard_Bierhexen_09_06"); //Aber wie das so ist, macht sich irgendwann die Blase bemerkbar.
	AI_Output(self, hero, "Info_Mod_Leonhard_Bierhexen_09_07"); //Wir wollten nicht offensichtlich in die Ecke machen, deshalb hat einer einen Sack aufgehalten und die anderen haben sich erleichtert.
	AI_Output(self, hero, "Info_Mod_Leonhard_Bierhexen_09_08"); //An den Rest des Abends kann ich mich nicht erinnern, aber komisch, dass dem Braumeister nie aufgefallen ist, dass wir sein ganzes Bier gesoffen haben, oder? (lacht)
...
FUNC VOID Info_Mod_Leonhard_Bierhexen_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Leonhard_Bierhexen_B_09_01"); //(höhnisch) Ja, ja, glaub ich aber auch.
...
FUNC VOID Info_Mod_Leonhard_Bierhexen_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Leonhard_Bierhexen_A_09_01"); //Hast du 'nen Knall? Was denkste, warum ich es jedem erzähle?
	AI_Output(self, hero, "Info_Mod_Leonhard_Bierhexen_A_09_02"); //Weil es mir schnurz ist, ob der Braumeister davon weiß oder nicht. Der kann mir nichts.
...
{
	AI_Output(self, hero, "Info_Mod_Leonhard_Bierhexen2_09_00"); //Was glotzt du so? Noch nie einen Menschen bei ehrlicher Arbeit gesehen?
	AI_Output(hero, self, "Info_Mod_Leonhard_Bierhexen2_15_01"); //Sieht bei dir ein wenig ungewöhnlich aus, ja.
	AI_Output(self, hero, "Info_Mod_Leonhard_Bierhexen2_09_02"); //Schnauze halten!
...
FUNC VOID Info_Mod_Leonhard_Freudenspender_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Leonhard_Freudenspender_09_01"); //Wie teuer?
	AI_Output(hero, self, "Info_Mod_Leonhard_Freudenspender_15_02"); //10 Goldmünzen.
	AI_Output(self, hero, "Info_Mod_Leonhard_Freudenspender_09_03"); //Her damit!
