...
{
	AI_Output(self, hero, "Info_Mod_Abuyin_Hi_06_00"); //Fremder, komm zu Abuyin ins Reich der tausend Sinne.
	AI_Output(self, hero, "Info_Mod_Abuyin_Hi_06_01"); //Hier kannst du die verschiedensten Tabaksorten rauchen und ganz neue Erfahrungen sammeln.
	AI_Output(self, hero, "Info_Mod_Abuyin_Hi_06_02"); //Setz dich einfach an eine der Wasserpfeifen und wähle eine der unvergleichlichen Geschmacksrichtungen.
};
...
{
	AI_Output(self, hero, "Info_Mod_Abuyin_NewTabak_06_00"); //Sohn des Schicksals, du wirst interessiert sein zu hören, dass mein Angebot erweitert ist.
	AI_Output(self, hero, "Info_Mod_Abuyin_NewTabak_06_01"); //Mach eine Pause und genieße den neuen Tabak aus dem fernen Varant.
};
...
FUNC VOID Info_Mod_Abuyin_Flugblaetter_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Abuyin_Flugblaetter_06_01"); //Ich habe vorausgesehen, dass du kommen würdest.
	AI_Output(self, hero, "Info_Mod_Abuyin_Flugblaetter_06_02"); //Vielleicht werd ich mal bei Matteo vorbeischauen.
...
FUNC VOID Info_Mod_Abuyin_Plagenquest_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Abuyin_Plagenquest_06_01"); //Ja, ich bin auch im Besitz eines solchen, Sohn des Abendlandes, wenn du den Genuss danach verspürst ...
	AI_Output(hero, self, "Info_Mod_Abuyin_Plagenquest_15_02"); //Wie viel kosten zwei Portionen von diesem Tabak?
	AI_Output(self, hero, "Info_Mod_Abuyin_Plagenquest_06_03"); //100 Goldmünzen. Aber ich weiß, dass du diesen Betrag gerne bezahlen wirst.
	...
	if (Mod_Verhandlungsgeschick > 0)
	{
		...
		{
			AI_Output(self, hero, "Info_Mod_Abuyin_Plagenquest_06_05"); //Habe ich gesagt 100 Goldmünzen? Ich meinte natürlich 50.
			AI_Output(self, hero, "Info_Mod_Abuyin_Plagenquest_06_06"); //Abuyin irrt sich nie.
		...
		{
			AI_Output(self, hero, "Info_Mod_Abuyin_Plagenquest_06_07"); //Gewiss nicht.
	...
	AI_Output(self, hero, "Info_Mod_Abuyin_Plagenquest_06_09"); //Bitte sehr.
