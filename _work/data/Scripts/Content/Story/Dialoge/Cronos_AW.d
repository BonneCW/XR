...
FUNC VOID Info_Mod_Cronos_AW_Artefakt_01_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_03_01"); //Ahh, Saturas hat dir davon berichtet ... Nun, es sind eher Vermutungen, leise Hoffnungen, als echte Spuren.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_03_02"); //Ach, es ist eigentlich sehr unwahrscheinlich, fast töricht ernsthaft in Erwägung zu ziehen, dass etwas dran sein könnte.
...
{
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_D_03_00"); //Die Umschreibungen über dieses Untier erinnerten mich an Geschehnisse, die bereits mehr als 200 Jahre zurückliegen.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_D_03_01"); //Die Überlieferungen geben preis, dass damals ein mächtiges Artefakt – der Kristall der Absorption - in einem Adanostempel auf der Insel Khorinis gelagert gewesen sein soll.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_D_03_02"); //Doch ein trügerischer und gieriger Novize bemächtigte sich der Schätze des Tempels, brachte den Hüter dieser Heiligtümer um und verscharrte seinen Leichnam in der Wildnis.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_D_03_03"); //Als die anderen Adanosmagier nun den Raub der Schätze bemerkten und das Verschwinden ihres Hüters, kamen viele zu der Vermutung, dass er es war, der den Schatz raubte und dann floh.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_D_03_04"); //Doch einem der Wassermagier sandte Adanos einen Traum, in welchem der Ermordete sein Schicksal beklagte: dass er von einem Diener Adanos gemeuchelt und seine sterblichen Überreste dem Verzehr von wilden Tieren preisgegeben worden waren.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_D_03_05"); //Infolge dessen leitete man eine Untersuchung ein, in welcher sich die Hinweise auf den schändlichen Novizen verdichteten.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_D_03_06"); //Als man diesen nun verhörte, schwor er, nichts von allem zu wissen und beschwor offen Adanos, er möge doch Zeugnis von seinem reinen Wesen abgeben.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_D_03_07"); //Adanos soll durch das frevelhafte Verhalten des Novizen so erzürnt gewesen sein, dass er ihn im gleichen Augenblick vor den Augen aller in die blutrünstige Bestie verwandelte, die seinem Wesen entsprach.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_D_03_08"); //Die Magier richteten erschrocken ihre Magie gegen das Untier, was jedoch keine Wirkung zu haben schien.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_D_03_09"); //Fauchend nahm es Reißaus und entfloh in die umliegenden Wälder. Dort soll es noch einige Male Jägern begegnet sein, deren Waffen ebenfalls wirkungslos blieben.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_D_03_10"); //Unter den Sachen des Novizen fanden die Magier indessen einige der geraubten Schätze, jedoch nicht das bedeutsame Artefakt.
	...
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_D_03_12"); //Ja, so die Vermutung. Nur verschwand das Untier nach einigen Jahren spurlos.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_D_03_13"); //Und jetzt, nach so vielen Jahrzehnten, der erste mögliche Hinweis, obwohl doch so unwahrscheinlich.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_D_03_14"); //Das Wesen könnte ja einen völlig anderen Ursprung haben, und selbst wenn es dem der Überlieferungen entsprechen sollte, wäre es immer noch fraglich, ob das Artefakt sich noch in seinem Besitz befindet.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_D_03_15"); //Abgesehen davon, dass der göttliche Schutzzauber verhindert, seiner elenden Existenz ein Ende zu bereiten ...
...
FUNC VOID Info_Mod_Cronos_AW_Artefakt_01_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_B_03_01"); //Nun, zuerst waren es nur Gerüchte, die von einer blutrünstigen Bestie berichteten, welche mit einem unbändigen Appetit auf Fleisch über das Land ziehen soll.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_B_03_02"); //Es wurde berichtet, sie würde weder durch gewöhnliche Waffen noch durch von Menschen gewirkte Magie Schaden erleiden.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_B_03_03"); //Ich schenkte diesen Berichten zunächst nicht viel Beachtung, hielt es für Hirngespinste und Flunkereien einfacher Leute.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_B_03_04"); //Aber in letzter Zeit häuften sich solche Meldungen und sogar Bauernhöfe rund um die Stadt und Onars Hof sollen schon von der Bestie überfallen worden sein.
...
FUNC VOID Info_Mod_Cronos_AW_Artefakt_01_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_C_03_01"); //So hab doch ein wenig Geduld. Ich wollte gerade darauf zu sprechen kommen.
...
FUNC VOID Info_Mod_Cronos_AW_Artefakt_01_F()
{
	...
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_F_03_01"); //(erfreut) Im Stillen hatte ich gehofft, dass du dich dazu bereit erklären würdest. Aber setze dich bei deiner Suche um Adanos willen keinen unnötigen Risiken aus.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_F_03_02"); //Versuch zunächst bei den kleineren Bauernhöfen und den Jägern der Umgebung mehr in Erfahrung zu bringen.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_F_03_03"); //Vielleicht stellt sich ja dann schon heraus, ob überhaupt etwas an der Sache dran ist, oder nicht. Aber falls doch ... hier hast du einige Spruchrollen und Tränke, die dir auf der Suche bestimmt nützlich sein werden.
	...
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_F_03_04"); //Und vergiss nicht, dieses Wesen soll jeder Art von Menschenhand gewirkter Magie und geführter Waffen standhalten können.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_F_03_05"); //Deine Wassermagie wird ihm also – wenn überhaupt - nur kurze Zeit Einhalt gebieten können ...
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_F_03_06"); //Und nun wünsche ich dir viel Erfolg. Adanos möge dich auf deinen Wegen behüten.
...
FUNC VOID Info_Mod_Cronos_AW_Artefakt_01_E()
{
	...
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_01_E_03_01"); //(enttäuscht) Ja, du hast wohl Recht, es ist vernünftiger ...
...
FUNC VOID Info_Mod_Cronos_AW_Artefakt_02_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_02_03_01"); //(ungläubig) Was?! Du willst mich doch auf den Arm nehmen ...

	B_GiveInvItems	(hero, self, ItMi_AbsorbKristall, 1);

	Npc_RemoveInvItems	(self, ItMi_AbsorbKristall, 1);

	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_02_03_02"); //Nicht möglich ... wo, wie ...
	AI_Output(hero, self, "Info_Mod_Cronos_AW_Artefakt_02_15_03"); //Zwischen viel Unrat und Schmutz.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_02_03_04"); //Ich weiß nicht, was ich sagen soll. Den Wert dieses Dienstes, den du der Gemeinschaft Adanos' erwiesen hast, kann ich kaum in Worte fassen.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_02_03_05"); //Ich muss mich darüber mit meinen Brüdern beraten. Komm morgen wieder.
...
{
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_03_03_00"); //Wie wir feststellen mussten, hat der Kristall zwar leider mittlerweile seine Kraft eingebüßt.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_03_03_01"); //Aber die Möglichkeiten, ihm wieder seine Kraft zu schenken, haben wir noch kaum ergründet.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_03_03_02"); //Nun aber zu deiner mehr als verdienten Belohnung. Myxir hat zuletzt einige alte Schriften übersetzt und daraus diese Anleitung zum Schmieden eines magischen Ringes unseres Herrn gewonnen.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_03_03_03"); //Hier, du sollst der Erste sein, dem die Macht dieses Ringes zuteil wird.

	B_GiveInvItems	(self, hero, ItWr_Bauplan_AdanosRing, 1);

	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_03_03_04"); //Ansonsten überlasse ich dir noch als würdigen Diener Adanos’ einige unserer wertvollen Spruchrollen und Tränke. Nutze sie weise.
	...
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_03_03_05"); //Achso, wie töricht von mir, bei aller Aufregung um den Kristall unseres Herrn vergaß ich ganz, mich nach dem Schicksal des verfluchten Novizen zu erkundigen.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_03_03_06"); //So berichte: Wie steht es um die verwünschte Kreatur.
	...
	if (Mod_Untier_Tot == FALSE)
	{
		...
		AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_03_03_08"); //Hmm, ich will hoffen, dass sie die Umgebung in Zukunft nicht zu sehr verheeren wird ...
	}
	else
	{
		AI_Output(hero, self, "Info_Mod_Cronos_AW_Artefakt_03_15_09"); //Sie wird kein Unheil mehr anrichten.
		AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_03_03_10"); //Du willst doch damit nicht etwas sagen, dass du sie bezwingen konntest?
		AI_Output(hero, self, "Info_Mod_Cronos_AW_Artefakt_03_15_11"); //Nicht allen Mitteln vermochte der Schutzzauber zu widerstehen.
		AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_03_03_12"); //Erneut macht mich deine Kühnheit fast sprachlos. Damit hast du ganz Khornis einen großen Dienst erwiesen.
		AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_03_03_13"); //Hier, nimm diesen Trank und eine Rune deiner Wahl als Belohnung.
...
FUNC VOID Info_Mod_Cronos_AW_Artefakt_05_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Artefakt_05_03_01"); //Was?! Nicht möglich ... Bring ihn schnell zu Satruras. Er kann eine mächtige waffe im kampf gegen die Ungetüme sein.
};
...
FUNC VOID Info_Mod_Cronos_AW_Zeremoniendolch_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Zeremoniendolch_03_01"); //Adanos sei Dank! Uns geht die Verpflegung aus.
	AI_Output(hero, self, "Info_Mod_Cronos_AW_Zeremoniendolch_15_02"); //Vatras wird sicher bald mehr schicken können.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_Zeremoniendolch_03_03"); //Das ist gut, danke.
...
FUNC VOID Info_Mod_Cronos_AW_Gast_Info()
{
	if (Mod_Saturas_Gast == 1)
	{
		...
		AI_Output(self, hero, "Info_Mod_Cronos_AW_Gast_03_01"); //Nein, aber ich bin erbost über die Dreistigkeit, mit der uns vor unseren Augen wichtiges Material entwendet wird.
		AI_Output(self, hero, "Info_Mod_Cronos_AW_Gast_03_02"); //Ohne die Laborwasserflaschen kann ich nicht arbeiten!
	}
	else
	{
		AI_Output(hero, self, "Info_Mod_Cronos_AW_Gast_15_03"); //Ist dir heute Nacht etwas aufgefallen? Ein Dieb hat euch beklaut.
		AI_Output(self, hero, "Info_Mod_Cronos_AW_Gast_03_04"); //Beklaut? Hier? Aber ich habe tatsächlich etwas gesehen.
		AI_Output(self, hero, "Info_Mod_Cronos_AW_Gast_03_05"); //Ich konnte die ganze Nacht schlecht schlafen.
		AI_Output(self, hero, "Info_Mod_Cronos_AW_Gast_03_06"); //Merdarion schnarcht wie verrückt und Riordian grunzt und stöhnt.
		AI_Output(self, hero, "Info_Mod_Cronos_AW_Gast_03_07"); //Einmal meinte ich ein leises Rascheln zu hören, also habe ich mich umgedreht und eine Bewegung dort hinten in den Ruinen gesehen.
		AI_Output(self, hero, "Info_Mod_Cronos_AW_Gast_03_08"); //Wenn das der Dieb war, kann er was erleben!
...
FUNC VOID Info_Mod_Cronos_AW_TiereZaehmen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Cronos_AW_TiereZaehmen_03_01"); //Du willst Tiere zähmen? Hmm, das ist nicht ganz leicht.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_TiereZaehmen_03_02"); //Besonders Tiere die dem Menschen feindlich gesonnen sind, stellen selbst für erfahrene Magier eine Herausforderung dar ...
	AI_Output(hero, self, "Info_Mod_Cronos_AW_TiereZaehmen_15_03"); //Wie sieht es mit Wildziegen aus?
	AI_Output(self, hero, "Info_Mod_Cronos_AW_TiereZaehmen_03_04"); //Diese Geschöpfe sind so lange neutral, bis man sie angreift. Das macht es wesentlich leichter auf ihren Geist einzuwirken.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_TiereZaehmen_03_05"); //Ich könnte dir Spruchrollen für diesen Zweck herstellen. Dafür bräuchte ich allerdings einige Zutaten.
	AI_Output(hero, self, "Info_Mod_Cronos_AW_TiereZaehmen_15_06"); //Was benötigst du?
	AI_Output(self, hero, "Info_Mod_Cronos_AW_TiereZaehmen_03_07"); //Hmm, es könnte eigentlich schon reichen, wenn du mir zwei Stück rohes Ziegenfleisch und ein Ziegenfell besorgst.
	AI_Output(self, hero, "Info_Mod_Cronos_AW_TiereZaehmen_03_08"); //Hier in den Bergen habe ich irgendwo Wildziegen blöken hören ...
...
FUNC VOID Info_Mod_Cronos_AW_TiereZaehmen2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Cronos_AW_TiereZaehmen2_03_01"); //Sehr gut. Komm morgen wieder, dann sollte die Herstellung abgeschlossen sein.
...
{
	AI_Output(self, hero, "Info_Mod_Cronos_AW_TiereZaehmen3_03_00"); //Gut, dass du kommst. Hier hast du die Spruchrolle.

	B_GiveInvItems	(self, hero, ItSc_ZiegeZaehmen, 1);

	AI_Output(self, hero, "Info_Mod_Cronos_AW_TiereZaehmen3_03_01"); //War einfacher, als gedacht die Zutaten mit dem Papier zu verbinden.
