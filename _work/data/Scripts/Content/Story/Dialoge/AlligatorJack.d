...
FUNC VOID Info_Mod_AlligatorJack_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Hi_03_01"); //Als Jäger ist man meist allein. Allerdings sind meine Kumpels nicht weit.
	AI_Output(hero, self, "Info_Mod_AlligatorJack_Hi_15_02"); //Da hinten, wo ich die Palisaden sehe?
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Hi_03_03"); //Genau. Dort ist unser Piratenlager.
	AI_Output(hero, self, "Info_Mod_AlligatorJack_Hi_15_04"); //Piraten ... interessant. Was meinst du, könnte man bei euch mitmachen?
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Hi_03_05"); //Möglich. Da must du Käpt'n Greg fragen. Übrigens, mich nennt man Alligator Jack.
...
{
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Beerdigung_03_00"); //(zu sich selbst) Was, wie, wo bin ich? Zuletzt die Banditen und dann alles dunkel.

	AI_PlayAni	(self, "T_SEARCH");

	AI_Output(self, hero, "Info_Mod_AlligatorJack_Beerdigung_03_01"); //Und was ist mit euch passiert? Steht hier herum und gafft, als hättet ihr einen Geist gesehen.
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Beerdigung_03_02"); //Und Bäume, Blumen, Kaninchen? Was zur Seejungfrau ist hier passiert?
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Beerdigung_03_03"); //Kaum bin ich mal ne Stunde bewusstlos scheint das Lager gleich völlig zu verkommen.
...
FUNC VOID Info_Mod_AlligatorJack_Sweetwater_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Sweetwater_03_01"); //Ja, das bin ich. Und Jäger bin ich. (stolz) Vor allem aber Pirat.
	AI_Output(hero, self, "Info_Mod_AlligatorJack_Sweetwater_15_02"); //Und was ist mit den Alligatoren?
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Sweetwater_03_03"); //Es sind ganz einfach zu viele geworden. Da müssen Muttertiere dabei sein.
	AI_Output(hero, self, "Info_Mod_AlligatorJack_Sweetwater_15_04"); //Was ist, wenn ich dich unterstütze?
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Sweetwater_03_05"); //Dann könnten wir's wagen, denke ich.
	AI_Output(hero, self, "Info_Mod_AlligatorJack_Sweetwater_15_06"); //Dann bleibe dicht bei mir. Nicht losstürmen oder so was.
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Sweetwater_03_07"); //Wem sagst du das, Kollege?
...
{
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Sweetwater2_03_00"); //Puh, zähe Biester.
	...
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Sweetwater2_03_02"); //Danke für das Lob. Man hört so was nicht oft hier.
	...
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Sweetwater2_03_04"); //Wird gemacht. Und danke noch mal.
...
FUNC VOID Info_Mod_AlligatorJack_Todesangst_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Todesangst_03_01"); //Geht so. Du willst ins Lager?
	AI_Output(hero, self, "Info_Mod_AlligatorJack_Todesangst_15_02"); //Genau. Warum fragst du?
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Todesangst_03_03"); //Du wirst dich wundern. Der Alte ist verrückt geworden.
	AI_Output(hero, self, "Info_Mod_AlligatorJack_Todesangst_15_04"); //Der Kapitän?
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Todesangst_03_05"); //Ja. Wahrscheinlich lässt dich Henry gar nicht rein. Wirst schon sehen.
};
...
FUNC VOID Info_Mod_AlligatorJack_Todesangst2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_AlligatorJack_Todesangst2_03_01"); //Hab ich's nicht gesagt? Der Chef spinnt. Gehen wir.
