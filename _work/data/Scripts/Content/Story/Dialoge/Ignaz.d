...
INSTANCE Info_Mod_Ignaz_Flugblätter (C_INFO)
{
	npc		= Mod_584_NONE_Ignaz_NW;
	nr		= 1;
	condition	= Info_Mod_Ignaz_Flugblätter_Condition;
	information	= Info_Mod_Ignaz_Flugblätter_Info;
	permanent	= 0;
	important	= 0;
	description	= "Ich hab hier ein Flugblatt für dich.";
};

FUNC INT Info_Mod_Ignaz_Flugblätter_Condition()
{
...
FUNC VOID Info_Mod_Ignaz_Flugblätter_Info()
{
	AI_Output(hero, self, "Info_Mod_Ignaz_Flugblätter_15_00"); //Ich hab hier ein Flugblatt für dich.

	B_GiveInvItems	(hero, self, MatteoFlugblätter, 1);

	AI_Output(self, hero, "Info_Mod_Ignaz_Flugblätter_14_01"); //Oh danke. Mal sehen ...

	B_UseFakeScroll();

	AI_Output(self, hero, "Info_Mod_Ignaz_Flugblätter_14_02"); //Ah ja. Vielleicht werd ich mal bei Matteo vorbeischauen.
