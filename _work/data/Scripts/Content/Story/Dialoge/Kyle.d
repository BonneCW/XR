...
FUNC VOID Info_Mod_Kyle_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Kyle_Hi_01_01"); //Wie's mir geht? Absolut beschissen! Von morgens bis abends schufte ich mir den Buckel krumm, und wir haben noch nicht ein Mal was Genießbares geerntet.
};
...
FUNC VOID Info_Mod_Kyle_SchatzImSchlammsee_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Kyle_SchatzImSchlammsee_01_02"); //Das hab ich Gravo nur geflüstert, damit er was zu tun hat und nicht tausend Mal pro Tag durch meine Hütte rennt.
	AI_Output(self, hero, "Info_Mod_Kyle_SchatzImSchlammsee_01_03"); //Den anderen konnte ich das ja verklickern, aber bei Gravo hat's nichts geholfen, dass ich meinen Nachttopf in die eine Tür gestellt hab.
	AI_Output(self, hero, "Info_Mod_Kyle_SchatzImSchlammsee_01_04"); //Soll er jetzt schön lange nach irgendwas buddeln. Wer weiß, vielleicht findet er ja irgendwann 'ne Wasserader!
...
FUNC VOID Info_Mod_Kyle_Lagermusik_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Kyle_Lagermusik_01_01"); //(verdutzt) Ne alte Münze oder was?
	AI_Output(hero, self, "Info_Mod_Kyle_Lagermusik_15_02"); //Nein. Garaz und Pacho haben ihre Musikinstrumente dort gelagert.
	AI_Output(self, hero, "Info_Mod_Kyle_Lagermusik_01_03"); //(verblüfft) Vielleicht sollte ich als Wahrsager arbeiten?
	AI_Output(self, hero, "Info_Mod_Kyle_Lagermusik_01_04"); //Hier mal meine nächste Voraussage: Gravo wird wieder wie früher tagtäglich durch meine Hütte latschen.
	AI_Output(hero, self, "Info_Mod_Kyle_Lagermusik_15_05"); //Glaube ich kaum. Er will jetzt aufs Musikmachen umsteigen.
	AI_Output(self, hero, "Info_Mod_Kyle_Lagermusik_01_06"); //Ja? Das wäre ja wirklich fantastisch. Hoffentlich schön weit weg von mir.
};
...
FUNC VOID Info_Mod_Kyle_KGBuddler_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Kyle_KGBuddler_01_01"); //Hör bloß auf! Diese ewige Plackerei in der alten Mine war furchtbar.
