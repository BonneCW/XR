...
{
	AI_Output(self, hero, "Info_Mod_Opolos_Daemonisch_01_00"); //Hmm, ja Babo, hat sich wirklich rasch erholt. Nur etwas frische Luft schnappen und er ist wie ausgewechselt.
	AI_Output(hero, self, "Info_Mod_Opolos_Daemonisch_15_01"); //Frische Luft schnappen? Was meinst du?
	AI_Output(self, hero, "Info_Mod_Opolos_Daemonisch_01_02"); //Na ja, andere Novizen haben ihn, glaube ich, zu einem kleinen Spaziergang ermuntert. Und danach war er wie neu ...
	AI_Output(self, hero, "Info_Mod_Opolos_Daemonisch_01_03"); //Ja, ja, die Jungs gehen in letzter Zeit ziemlich oft raus, irgendwelche Erledigungen in der Taverne oder der Stadt.
	AI_Output(self, hero, "Info_Mod_Opolos_Daemonisch_01_04"); //Ich jedoch muss hier bleiben und die Schafe hüten. Na ja, wenigstens hat mich die Magenerkrankung nicht erwischt.
	AI_Output(hero, self, "Info_Mod_Opolos_Daemonisch_15_05"); //Magenerkrankung?
	AI_Output(self, hero, "Info_Mod_Opolos_Daemonisch_01_06"); //Ja, einige Novizen haben seit ein paar Tagen Magenprobleme und können kaum noch was Essen.
	AI_Output(self, hero, "Info_Mod_Opolos_Daemonisch_01_07"); //Sogar den Klosterwein nach dem Gebet vertragen sie vorläufig nicht.
	AI_Output(self, hero, "Info_Mod_Opolos_Daemonisch_01_08"); //Sind wegen der Sache auch etwas abgemagert und können nur noch leichte Aufgaben erfüllen, wie eben die Botengänge.
...
FUNC VOID Info_Mod_Opolos_Drachenangriff_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Opolos_Drachenangriff_01_01"); //(betrunken) Meinen Aufgaben?!
	AI_Output(self, hero, "Info_Mod_Opolos_Drachenangriff_01_02"); //Als die Horde Dämonen über unser Kloster hereinbrach, wurden alle Schafe gefressen, die ich doch behüten sollte.
	AI_Output(self, hero, "Info_Mod_Opolos_Drachenangriff_01_03"); //Man hat mich nun aus dem Kloster geworfen, da man mir vorwarf, dass ich meiner Aufgabe nicht gewissenhaft genug nachgekommen sei.
	AI_Output(self, hero, "Info_Mod_Opolos_Drachenangriff_01_04"); //(kurze Pause) Ach, Innos scheint in diesen finsteren Tagen wirklich fern zu sein.
};
...
{
	AI_Output(self, hero, "Info_Mod_Opolos_Unkraut_01_00"); //He, wie ich gesehen habe, hast du das ganze Unkraut um die Weinreben rausgerissen.
	AI_Output(hero, self, "Info_Mod_Opolos_Unkraut_15_01"); //Ja, wieso?
	AI_Output(self, hero, "Info_Mod_Opolos_Unkraut_01_02"); //Nun, weil sie meinen Schafen sehr gut schmecken. Wie du siehst, findest du auch auf der Wiese kein einziges Unkrautpflänzchen.
	AI_Output(self, hero, "Info_Mod_Opolos_Unkraut_01_03"); //Zu den Reben konnte ich sie natürlich nicht schicken, da sie diese sonst mit gefressen hätten.
	AI_Output(self, hero, "Info_Mod_Opolos_Unkraut_01_04"); //Aber da du sie ja alle rausgerissen hast ...
	...
	AI_Output(self, hero, "Info_Mod_Opolos_Unkraut_01_06"); //Super.
	...
	AI_Output(self, hero, "Info_Mod_Opolos_Unkraut_01_07"); //Ja, das schmeckt ihnen... Danke dir.
