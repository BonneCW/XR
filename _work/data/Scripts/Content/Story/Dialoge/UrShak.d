...
{
	AI_Output(self, hero, "Info_Mod_UrShak_Hi_04_00"); //Fremder seien gegrüßt von mir.
	AI_Output(hero, self, "Info_Mod_UrShak_Hi_15_01"); //Ur-Shak, ich bins.
	AI_Output(self, hero, "Info_Mod_UrShak_Hi_04_02"); //Du seien Freund. Du mich haben gerettet vor Krieger aus Orkstadt. Ich dir noch immer seien sehr dankbar.
};
...
FUNC VOID Info_Mod_UrShak_WasHier_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_UrShak_WasHier_04_01"); //Nachdem Freund hat vernichtet Krushak, Ur Shak haben getroffen Tarrok. Zusammen haben beschlossen zu gründen neuen Klan.
	AI_Output(self, hero, "Info_Mod_UrShak_WasHier_04_02"); //Als Lager wir haben genommen alte Festung in Felsen. Hier wir seien geschützt vor böse Orks.
};
...
FUNC VOID Info_Mod_UrShak_Foki_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Foki_04_01"); //Hier auf Podest ein Fokus haben gestanden, doch eines Nachts es weg war.
	AI_Output(self, hero, "Info_Mod_UrShak_Foki_04_02"); //Als Fokus verschwunden war, Ur Shak sein gegangen zu Freund Xardas. Er haben erklärt, dass es fünf Fokus geben.
	AI_Output(self, hero, "Info_Mod_UrShak_Foki_04_03"); //Er Ur Shak geben Karte, wo eingezeichnet alle Standorte von Fokusse. Daraufhin Ur Shak haben geschickt Tarrok zu suchen Fokus bei Steine.
	AI_Output(self, hero, "Info_Mod_UrShak_Foki_04_04"); //Doch auch diese Fokusse bereits sein weg. Xardas vermuten, dass Orks haben gestohlen Fokus, um Krushak wieder zu erwecken.
	AI_Output(self, hero, "Info_Mod_UrShak_Foki_04_05"); //Doch das nicht dürfen passieren. Freund müssen finden restliche Fokusse und holen die von Orks.
	AI_Output(hero, self, "Info_Mod_UrShak_Foki_15_06"); //Ich suche die Foki ja sowieso.
	AI_Output(self, hero, "Info_Mod_UrShak_Foki_04_07"); //Freund suchen auch nach Fokus? Dann Ur Shak werden helfen Freund so gut er können.
	AI_Output(self, hero, "Info_Mod_UrShak_Foki_04_08"); //Ranad viel wissen darüber. Er noch immer manchmal beobachten Lager von Orks.
	AI_Output(self, hero, "Info_Mod_UrShak_Foki_04_09"); //Zur Zeit er befinden sich oben in Festung. Gehen zu ihm und sprechen mit ihm. Er sicher haben viele Informationen für Freund.
...
FUNC VOID Info_Mod_UrShak_Mitmachen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Mitmachen_04_01"); //Das heißen Krushak nicht sein zurück?
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Mitmachen_04_03"); //Sein gut.
};
...
{
	AI_Output(self, hero, "Info_Mod_UrShak_Oschust_04_00"); //Hallo, Freund. Ranad Ur Shak berichten, dass Orks gefangen genommen Menschen aus Lager in Bergen.
	AI_Output(self, hero, "Info_Mod_UrShak_Oschust_04_01"); //Außerdem wollen starten Angriff auf Lager und auf Magier zu bekommen Amulett.
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Oschust_04_03"); //Werden sein schwere Aufgabe. Gut bewacht von Orks sie sind in Orkstadt in unterirdischer Höhle.
	AI_Output(self, hero, "Info_Mod_UrShak_Oschust_04_04"); //Ur Shak wissen, dass du sein starker Krieger. Aber das nicht allein reichen, um können deine Freunde zu befreien.
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Oschust_04_06"); //Ur Shak gerne helfen Freund und wünschen Erfolg bei schwerer Aufgabe.
...
{
	AI_Output(self, hero, "Info_Mod_UrShak_Xeres_04_00"); //Gut, dass Freund kommen. Ur Shak schlechte Nachrichten haben. Orks aus Stadt haben neues Führer. Sehen aus wie Mensch, sein aber nicht ganz lebendig.
	AI_Output(self, hero, "Info_Mod_UrShak_Xeres_04_01"); //Er Orks wollen machen zu seine Armee. Freund müssen verhindern.
...
{
	AI_Output(self, hero, "Info_Mod_UrShak_Karte_04_00"); //Ur Shak sehen, Freund haben schlechte Karte. Ur Shak werden machen ganz.

	Npc_RemoveInvItems	(hero, ItWrWorldmap, 1);
	CreateInvItems	(hero, ItWrWorldmap_Orc, 1);

	AI_Output(self, hero, "Info_Mod_UrShak_Karte_04_01"); //Jetzt Karte sein ganz.
};
...
FUNC VOID Info_Mod_UrShak_Biftek_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek_04_01"); //Ja. Aber jeder Ork können sich gewöhnen an Kräuter und Pilze, er nur nicht wollen.
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek_04_03"); //(überlegt) Ur Shak da fallen ein altes Rezept herzustellen einen Ersatz für Fleisch. Orks nennen es To-Fu.
	AI_Output(hero, self, "Info_Mod_UrShak_Biftek_15_04"); //Was heißt das?
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek_04_05"); //Heißen nichts, ist Name.
	AI_Output(hero, self, "Info_Mod_UrShak_Biftek_15_06"); //Und wie bereitet man dieses To-Fu zu?
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek_04_07"); //Ur Shak müssen schauen in seinen Zetteln. (sucht)
	
	AI_PlayAni(self, "r_Roam1");
	
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek_04_08"); //Da, er haben sogar Rezept Mensch können verstehen.
	
	B_GiveInvItems(self, hero, ItWr_TofuRezept, 1);
	
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek_04_09"); //Mensch müssen suchen So-Ja-Pflanze und ernten ihre Schoten. In den Schoten er finden kleine Bohnen. Ur Shak nicht wissen, ob auch hier So-Ja-Pflanzen wachsen, aber in Gebiet von Orks auf jeden Fall.
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek_04_10"); //In Rezept stehen, man müssen nehmen So-Ja-Presse herzustellen To-Fu. Aber Mensch können auch nutzen Alchemietisch.
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek_04_11"); //Wenn fertig, sagen Biftek, dass Fleisch für ihn haben, und er keinen Unterschied wird merken.
...
FUNC VOID Info_Mod_UrShak_Biftek2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek2_04_01"); //Ur Shak sein überrascht. Er erwarten größere Probleme.
	...
	AI_Output(self, hero, "Info_Mod_UrShak_Biftek2_04_03"); //Sein dankbar für Hilfe von Mensch!
...
{
	AI_Output(self, hero, "Info_Mod_UrShak_PolochTretor_04_00"); //Ur Shak hören, Tretor und Poloch jetzt beste Freunde, und Mensch haben seine Finger im Spiel.
	AI_Output(hero, self, "Info_Mod_UrShak_PolochTretor_15_01"); //Ja, auf Kosten ein paar blauer Flecke.
	AI_Output(self, hero, "Info_Mod_UrShak_PolochTretor_04_02"); //Mensch nehmen, was Ur Shak finden in Bergfestung. Orks nicht können gebrauchen.
