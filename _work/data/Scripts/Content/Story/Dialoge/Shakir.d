...
FUNC VOID Info_Mod_Shakir_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Shakir_Hi_02_01"); //Ja, das bin ich. Aber wer bist du denn? Dich habe ich hier noch nie gesehen!
	AI_Output(hero, self, "Info_Mod_Shakir_Hi_15_02"); //Ich bin ...
	AI_Output(self, hero, "Info_Mod_Shakir_Hi_02_03"); //Auch egal. Ich frage mich nur was du hier zu suchen hast.
	AI_Output(hero, self, "Info_Mod_Shakir_Hi_15_04"); //Amir hat mich zu eurem Lager geführt, da ich ihm einen Gefallen getan habe.
	AI_Output(hero, self, "Info_Mod_Shakir_Hi_15_05"); //Er meinte, das ich mich euch anschließen sollte.
	AI_Output(hero, self, "Info_Mod_Shakir_Hi_15_06"); //Am Tor habe ich dann mit Zahit darüber gesprochen, der am Ende gemeint hat, das ich dich aufsuchen sollte.
	AI_Output(self, hero, "Info_Mod_Shakir_Hi_02_07"); //(grinst) Ah, Frischfleisch. Bevor du dich uns anschließen kannst musst du noch aber einiges tun.
	AI_Output(self, hero, "Info_Mod_Shakir_Hi_02_08"); //ich sage dir, da hast du dir einiges vorgenommen.
...
FUNC VOID Info_Mod_Shakir_GaunerWerden_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Shakir_GaunerWerden_02_01"); //Im Grunde ist es ganz einfach. Du musst hier in unserem Viertel alle wichtigen Gauner auf deine Seite bringen.
	AI_Output(hero, self, "Info_Mod_Shakir_GaunerWerden_15_02"); //Und was heißt das konkret?
	AI_Output(self, hero, "Info_Mod_Shakir_GaunerWerden_02_03"); //Erfülle für jeden eine Aufgabe, um so Stimmen zu sammeln.
	AI_Output(self, hero, "Info_Mod_Shakir_GaunerWerden_02_04"); //Wenn du alle Gauner überzeugt hast, auch mich, kannst du dich bei mir melden und ich nehme dich bei uns auf.
	AI_Output(self, hero, "Info_Mod_Shakir_GaunerWerden_02_05"); //Dann wirst du zur Assassinengemeinschaft gehören.
	AI_Output(hero, self, "Info_Mod_Shakir_GaunerWerden_15_06"); //Wer gehört alles zu den Gaunern, die ich überzeugen muss?
	AI_Output(self, hero, "Info_Mod_Shakir_GaunerWerden_02_07"); //Folgende Mitglieder musst du überzeugen: Zeki, Ramsi, Aabid, Yasin, Yussuf und natürlich mich.
	AI_Output(hero, self, "Info_Mod_Shakir_GaunerWerden_15_08"); //Das sind ja eine ganze Menge Leute.
	AI_Output(self, hero, "Info_Mod_Shakir_GaunerWerden_02_09"); //(lacht) Du willst unser Vertrauen, also musst du auch etwas dafür tun.
	AI_Output(hero, self, "Info_Mod_Shakir_GaunerWerden_15_10"); //(seufzt) Na gut, dann werde ich mich darum kümmern.
	AI_Output(self, hero, "Info_Mod_Shakir_GaunerWerden_02_11"); //(hämisch) Viel Spaß beim Stimmen sammeln.
...
{
	AI_Output(self, hero, "Info_Mod_Shakir_Frau_02_00"); //Da bist du ja. Hab bis jetzt nur Gutes über dich gehört.

	if (Mod_ASS_Yussuf == 1)
	{
		AI_Output(hero, self, "Info_Mod_Shakir_Frau_15_01"); //Das freut mich. Aber mit Yussuf bin ich nicht einig geworden.
		AI_Output(self, hero, "Info_Mod_Shakir_Frau_02_02"); //Will heißen?
		AI_Output(hero, self, "Info_Mod_Shakir_Frau_15_03"); //Seine Aufgabe fand ich nicht nicht korrekt. Den Anderen gegenüber.
		AI_Output(self, hero, "Info_Mod_Shakir_Frau_02_04"); //Hoppla! Ein Gauner mit Gewissen! Was ganz was Neues hier.
	}
	else
	{
	...
	AI_Output(self, hero, "Info_Mod_Shakir_Frau_02_07"); //Nun gut erst mal. Höre, was meine Prüfung ist:
	AI_Output(self, hero, "Info_Mod_Shakir_Frau_02_08"); //Zuerst 'ne Frage: Wann hast du das letzte Mal mit 'ner Frau geschlafen?
	AI_Output(hero, self, "Info_Mod_Shakir_Frau_15_09"); //O Himmel! Das war in meinem letzten Leben. Da hatte ich mal Bromor besucht.
	AI_Output(self, hero, "Info_Mod_Shakir_Frau_02_10"); //Den Puff im Hafen?
	AI_Output(hero, self, "Info_Mod_Shakir_Frau_15_11"); //Genau. Ich hab's nicht bereut.
	AI_Output(self, hero, "Info_Mod_Shakir_Frau_02_12"); //Da sind wir beim Problem. Du musst wissen, dass ich in Varant zwei Frauen hatte.
	AI_Output(self, hero, "Info_Mod_Shakir_Frau_02_13"); //Nun geht mir hier einiges ab. Du weißt schon, was ich meine ...
	AI_Output(hero, self, "Info_Mod_Shakir_Frau_15_14"); //Gewiss. Ich soll dir nun Weiber beschaffen.
	AI_Output(self, hero, "Info_Mod_Shakir_Frau_02_15"); //Also eine würde schon reichen.
	...
	AI_Output(self, hero, "Info_Mod_Shakir_Frau_02_17"); //Das ist nicht das Problem. Aber man kennt mich dort. Vor allem die Miliz.
	AI_Output(hero, self, "Info_Mod_Shakir_Frau_15_18"); //Aha. Schon unangenehm aufgefallen.
	AI_Output(self, hero, "Info_Mod_Shakir_Frau_02_19"); //Das will ich meinen. Du bringst die Schöne in die Höhle vom Getränkepanscher hier in der Nähe.
	AI_Output(hero, self, "Info_Mod_Shakir_Frau_15_20"); //Und der kann dann schon mal ...
	AI_Output(self, hero, "Info_Mod_Shakir_Frau_02_21"); //Bist du verrückt? Der macht eh nichts, ist viel zu beschäftigt.
...
FUNC VOID Info_Mod_Shakir_Frau2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Shakir_Frau2_02_01"); //Wirklich? Du bist ein Mordskerl.
	...
	AI_Output(self, hero, "Info_Mod_Shakir_Frau2_02_04"); //Bin schon weg. Du wartest hier.
...
{
	AI_Output(self, hero, "Info_Mod_Shakir_GaunerWerden2_02_00"); //Wow! Das war's. Aber Hallo!
	...
	if (Mod_ASS_Yussuf == 1)
	{
		...
		AI_Output(self, hero, "Info_Mod_Shakir_GaunerWerden2_02_02"); //Ich bin über alles unterrichtet und halte dich für absolut geeignet, unserem Verein beizutreten.
	}
	else
	{
		AI_Output(hero, self, "Info_Mod_Shakir_GaunerWerden2_15_03"); //Freut mich. Ich habe noch den Yussuf.
		AI_Output(self, hero, "Info_Mod_Shakir_GaunerWerden2_02_04"); //Vergiss ihn. Du bist erst kurz bei uns und hast schon so viel erledigt. Schneller als sonst ein Anwärter.
		AI_Output(self, hero, "Info_Mod_Shakir_GaunerWerden2_02_05"); //Ich halte dich für absolut geeignet, unserem Verein beizutreten.
	...
	{
		AI_Output(self, hero, "Info_Mod_Shakir_GaunerWerden2_02_06"); //Wenn du willst, kannst du dich uns nun anschließen.
	...
	{
		AI_Output(self, hero, "Info_Mod_Shakir_GaunerWerden2_02_07"); //Leider gehörst du schon zu vielen Gemeinschaften an.
	};
...
FUNC VOID Info_Mod_Shakir_GaunerWerden3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Shakir_GaunerWerden3_02_01"); //Hier hast du deine Gaunerkluft. Du meldest dich bei dem Krieger Masut.
...
{
	AI_Output(self, hero, "Info_Mod_Shakir_Assassinengold_02_00"); //Willkommen zurück. Warst du erfolgreich?
...
{
	AI_Output(self, hero, "Info_Mod_Shakir_Zeremoniendolch_02_00"); //Gibt's was Neues?
	AI_Output(hero, self, "Info_Mod_Shakir_Zeremoniendolch_15_01"); //Nein. Hast du was?
	AI_Output(self, hero, "Info_Mod_Shakir_Zeremoniendolch_02_02"); //Und ob! Da hinten braut sich was zusammen, denke ich.
	AI_Output(hero, self, "Info_Mod_Shakir_Zeremoniendolch_15_03"); //Wie meinst du das?
	AI_Output(self, hero, "Info_Mod_Shakir_Zeremoniendolch_02_04"); //Die Krieger sind irgendwie unruhig. Immer wieder rennt hier einer raus oder kommt zurückgehastet. Sogar tagsüber.
	AI_Output(self, hero, "Info_Mod_Shakir_Zeremoniendolch_02_05"); //Wo doch sonst kaum jemand am Tag das Lager verlässt ...
...
FUNC VOID Info_Mod_Shakir_Blutkelch_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Shakir_Blutkelch_02_01"); //In Kriegerrüstung! Hätte dich fast nicht erkannt. Wie hast du ...?
	...
	AI_Output(self, hero, "Info_Mod_Shakir_Blutkelch_02_03"); //Ja, da ist erstmal der Mufid, und dann noch einer. Weiß allerdings nicht, wie der heißt.
	AI_Output(self, hero, "Info_Mod_Shakir_Blutkelch_02_04"); //Die waren schon halbe Nächte unterwegs.
	AI_Output(hero, self, "Info_Mod_Shakir_Blutkelch_15_05"); //Aha. Und, haben die was gesagt?
	AI_Output(self, hero, "Info_Mod_Shakir_Blutkelch_02_06"); //Nee, hatten es nur eilig.
...
FUNC VOID Info_Mod_Shakir_NachSchlacht_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Shakir_NachSchlacht_02_01"); //Was ist bloß los da drinnen?
