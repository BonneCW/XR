...
{
	AI_Output(self, hero, "Info_Mod_Ramirez_Hi_03_00"); //Was willst du hier?
};
...
FUNC VOID Info_Mod_Ramirez_Dieb_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ramirez_Dieb_03_00"); //Du gehörst also zu uns.
	AI_Output(self, hero, "Info_Mod_Ramirez_Dieb_03_01"); //Ich kann dir beibringen, wie du Schlösser knackst.
...
FUNC VOID Info_Mod_Ramirez_Cassia_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ramirez_Cassia_03_01"); //Da muss man dich nur ansehen und sich vorstellen, dass du die Kaserne knacken willst.
	AI_Output(hero, self, "Info_Mod_Ramirez_Cassia_15_02"); //Kann ich mich irgendwie beweisen?
	AI_Output(self, hero, "Info_Mod_Ramirez_Cassia_03_03"); //Du könntest Attilas Job übernehmen, nur für eine kurze Zeit, um den größten Unruhestifter aufzusuchen.
	AI_Output(hero, self, "Info_Mod_Ramirez_Cassia_15_04"); //Aber dann kommst du mit in die Kaserne.
	AI_Output(self, hero, "Info_Mod_Ramirez_Cassia_03_05"); //Wenn du es schaffst, eine Bande im Hafenviertel zu erledigen und mir den Ring von ihrem Anführer zu bringen, werde ich mitkommen.
	AI_Output(hero, self, "Info_Mod_Ramirez_Cassia_15_06"); //Und wo treiben die sich rum?
	AI_Output(self, hero, "Info_Mod_Ramirez_Cassia_03_07"); //Überall, du musst sie erst finden.
...
FUNC VOID Info_Mod_Ramirez_Bandenchef_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ramirez_Bandenchef_03_01"); //Tatsächlich, hätte ich dir nicht zugetraut.
	AI_Output(self, hero, "Info_Mod_Ramirez_Bandenchef_03_02"); //Hab eben noch mit dem Gedanken gespielt, dass du schon tot bist.
	AI_Output(hero, self, "Info_Mod_Ramirez_Bandenchef_15_03"); //Also traust du mir jetzt und wirst mich in die Kaserne begleiten?
	AI_Output(self, hero, "Info_Mod_Ramirez_Bandenchef_03_04"); //Ja, ich hab dir mein Wort gegeben. Sag aber vorher noch Cassia Bescheid.
...
FUNC VOID Info_Mod_Ramirez_ZuAndre_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ramirez_ZuAndre_03_01"); //Gut, geh voraus, ich folge dir.
...
FUNC VOID Info_Mod_Ramirez_Flucht_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ramirez_Flucht_03_01"); //Na endlich, ich dachte schon, du lässt uns hier für immer drinnen.
	AI_Output(hero, self, "Info_Mod_Ramirez_Flucht_15_02"); //Geht leise raus, der Weg ist frei.
	AI_Output(self, hero, "Info_Mod_Ramirez_Flucht_03_03"); //Wir treffen uns bei Cassia. Ach nochwas: Wenn du grade dabei bist, raube noch die Truhe bei Lord Andre aus.
	AI_Output(self, hero, "Info_Mod_Ramirez_Flucht_03_04"); //Ich hab mitbekommen, dass angeblich das gesamte Gold in seiner Truhe ist.
	AI_Output(hero, self, "Info_Mod_Ramirez_Flucht_15_05"); //Aber dann ist Schluss.
	AI_Output(self, hero, "Info_Mod_Ramirez_Flucht_03_06"); //Dann haben wir es ihnen richtig heimgezahlt.
...
{
	AI_Output(self, hero, "Info_Mod_Ramirez_WelcomeBack_03_00"); //Da ist unser Befreier. Am besten du gehst nochmal zu Lord Andre und erzählst ihm irgendein Märchen über unsere Flucht und gibst die Sache als Miliz auf.
...
FUNC VOID Info_Mod_Ramirez_AndreFertig_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Ramirez_AndreFertig_03_01"); //Sehr gut, alles nimmt ein gutes Ende. Attila ist wieder frei, Meldor wird nicht mehr gestört und die Miliz wurde um einiges ärmer.
	AI_Output(self, hero, "Info_Mod_Ramirez_AndreFertig_03_02"); //Dann hast du noch bei vielen anderen Kleinigkeiten geholfen. Ich glaube wir wären ohne dich nie so weit gekommen.
	AI_Output(hero, self, "Info_Mod_Ramirez_AndreFertig_15_03"); //Jetzt übertreibst du es aber.
	AI_Output(self, hero, "Info_Mod_Ramirez_AndreFertig_03_04"); //Du hast mir bewiesen, dass du einer der besten Diebe in unseren Reihen bist!
	...
	AI_Output(self, hero, "Info_Mod_Ramirez_AndreFertig_03_06"); //Gut, schau aber ab und zu mal hier unten vorbei.
...
FUNC VOID Info_Mod_Ramirez_Lernen_Info()
{
	...
	{
		AI_Output (self, hero, "Info_Mod_Ramirez_Lernen_03_01"); //Wenn du ein Schloss knacken willst solltest du auf jedenfall genug Dietriche dabei haben. Außerdem solltest du ziemlich geschickt sein.
	};
};
...
FUNC VOID Info_Mod_Ramirez_EXIT_Info()
{
	if (Npc_KnowsInfo(hero, Info_Mod_Ramirez_Dieb))
	{
		AI_Output(self, hero, "Info_Mod_Ramirez_EXIT_03_00"); //Komm uns nicht mit leeren Händen nach Hause!
	};
