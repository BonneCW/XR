...
FUNC VOID Info_Mod_Sancho_Alissandro_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_Alissandro_03_01"); //(noch gelangweilter) Falsches Passwort.
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_03_01"); //Hi, was willst du?
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_15_02"); //Ich bin auf der Suche nach Informationen.
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_03_03"); //Das kostet dich eine Kleinigkeit.
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_C_03_01"); //Dann verschwinde endlich!
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_B_03_01"); //Nun, weil du es bist sind es jetzt 80.
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_E()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_E_03_01"); //Dann verschwinde endlich!
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_D()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_D_03_01"); //Oh, es fehlen noch 20 Gold. Tut mir echt leid, Kumpel, aber du musst dich verzählt haben.
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_G()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_G_03_01"); //Vergiss es, Kumpel. Zieh bloß Leine, bevor ich dir deinen unverschämten Schädel spalte!
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_I()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_I_03_01"); //Was?
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_01"); //Was möchtest du nun wissen?
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_A_15_02"); //Sind hier in letzter Zeit ein paar Gardisten aufgetaucht?
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_03"); //Zufällig ja.
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_A_15_04"); //Wo sind sie hingegangen?
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_05"); //Nirgendwo hin.
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_A_15_06"); //Also sind sie noch hier?
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_07"); //Im Prinzip ja.
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_A_15_08"); //Kann ich sie sprechen?
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_09"); //Nein.
	
	B_Say	(hero, self, "$WIESONICHT");

	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_11"); //Weil du dann erstmal bei 'nem Rudel Snapper anfangen müsstest ihre Einzelteile zu suchen.
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_A_15_12"); //Sie sind von Snappern getötet wurden?
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_13"); //Nein.
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_A_15_14"); //Wie jetzt? Du sagtest doch eben ...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_15"); //... das sie von ihnen gefressen wurden! Getötet haben wir sie. (lacht dreckig)
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_17"); //Niemand von uns hatte sie bisher im Minental gesehen, aber so ungewöhnlich ist das nun auch wieder nicht. Sie hatten einen Zettel bei sich gehabt.
	AI_Output(hero, self, "Info_Mod_Sancho_GardistenInfos_A_15_18"); //Kann ich den Zettel mal sehen?
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_A_03_19"); //Natürlich. Das würde dich dann weitere 50 Gold kosten.
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_K()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_K_03_01"); //50 Gold oder lass es bleiben. Du möchtest den Zettel und ich habe ihn, mir ist es gleich.
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_L()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_L_03_01"); //Na gut, hier nimm den Zettel. Ich kann ihn eh nicht lesen.

	B_GiveInvItems	(self, hero, ItWr_MagicPaper, 1);

	Mod_SanchoHatZettel = 2;

	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_L_03_02"); //Und jetzt lenk mich nicht weiter ab.
...
FUNC VOID Info_Mod_Sancho_GardistenInfos_J()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_J_03_01"); //Na gut, hier nimm den Zettel. Ich kann ihn eh nicht lesen.

	B_GiveInvItems	(self, hero, ItWr_MagicPaper, 1);

	Mod_SanchoHatZettel = 2;

	AI_Output(self, hero, "Info_Mod_Sancho_GardistenInfos_J_03_02"); //Und jetzt lenk mich nicht weiter ab.
...
FUNC VOID Info_Mod_Sancho_Umgehauen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_Umgehauen_03_01"); //Au, du hast einen ganz schön harten Schlag drauf. Der kommt von ein paar Gardisten, die hier neulich vorbeigekommen sind.
	AI_Output(self, hero, "Info_Mod_Sancho_Umgehauen_03_02"); //Behalte ihn, ich kann ihn eh nicht gebrauchen. Und jetzt lass mich in Frieden.
...
FUNC VOID Info_Mod_Sancho_WasFuerLosung_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_WasFuerLosung_03_01"); //(genervt) Das Losungswort, das es dir erlaubt ins Lager zu kommen, ohne dass du von mir und den Jungs drinnen ins Stücke gehackt wirst, du Einfallspinsel.
};
...
FUNC VOID Info_Mod_Sancho_WasFuerLosung2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_WasFuerLosung2_03_01"); //Hey man, langsam gehst du mir auf die Nerven.
	AI_Output(self, hero, "Info_Mod_Sancho_WasFuerLosung2_03_02"); //Wenn du das verdammte Losungswort haben willst, wirst du unseren Jungs in Khorinis helfen müssen.
	AI_Output(self, hero, "Info_Mod_Sancho_WasFuerLosung2_03_03"); //Aber glaub bloß nicht, dass du einfach hingehen kannst und es bekommst.
	AI_Output(self, hero, "Info_Mod_Sancho_WasFuerLosung2_03_04"); //Falls sie mal wirklich irgendwann deine Hilfe benötigen werden, dann sprechen sie dich schon an.
	AI_Output(self, hero, "Info_Mod_Sancho_WasFuerLosung2_03_05"); //Und jetzt nerv mich nicht weiter.
};
...
{
	AI_Output(self, hero, "Info_Mod_Sancho_Nek_03_00"); //(rau) Was suchst du hier?
	AI_Output(hero, self, "Info_Mod_Sancho_Nek_15_01"); //Ich habe Neks Amulett. Schau.

	B_GiveInvItems	(hero, self, ItAm_Nek, 1);

	AI_Output(self, hero, "Info_Mod_Sancho_Nek_03_02"); //Tatsache. Hier ist dein Gold.
...
FUNC VOID Info_Mod_Sancho_Dam_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_01"); //Du gibst einfach nicht locker, oder?
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_02"); //Ok, dann hätte ich einen Vorschlag für dich.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_03"); //Wenn du das hinbekommen solltest, dürften auch die anderen nichts dagegen haben, dass du in unser Lager darfst, selbst, wenn du noch nicht zu uns gehörst.
	AI_Output(hero, self, "Info_Mod_Sancho_Dam_15_04"); //Ich höre ...
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_05"); //Ok, du hast mir ja das Amulett gebracht. Weißt du, was es damit auf sich hat?
	...
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_07"); //Ha, und das glaubst du wirklich.
	AI_Output(hero, self, "Info_Mod_Sancho_Dam_15_08"); //Eigentlich ... ja .
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_09"); //Dann hör mal zu, Junge.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_10"); //Nicht er hat das Amulett mit seinem Namen gekennzeichnet ... sondern das Amulett ihn mit dessen Namen.
	AI_Output(hero, self, "Info_Mod_Sancho_Dam_15_11"); //Was?!
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_12"); //Das Amulett ist kein gewöhnliches Schutzamulett.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_13"); //Es gehört zu einer Gattung von Artefakten mit unglückseligen Eigenschaften.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_14"); //Das Nek-Amulett für seinen Teil ergreift mit der Zeit Besitz von seinem Träger ... und bringt ihm früher oder später den Tod.
	AI_Output(hero, self, "Info_Mod_Sancho_Dam_15_15"); //Was ...?! Aber das würde zumindest einiges erklären ...
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_16"); //Jedenfalls haben diese Stücke bei Schwarzmagiern und Okkultisten einen hohen Sammlerwert.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_17"); //Sie stammen aus einem verfluchten Moor in Relendel.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_18"); //Und dort muss sich auch noch der andere Teil des Amulettes befinden, der quasi die Rückseite des Nek-Amulettes darstellt ... zumindest hat es das.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_19"); //Nek war vor der Zeit in der Kolonie Schatzsucher im Moor ... und er erzählte einmal von einem anderen Amulett ...
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_20"); //Da er es jedoch nicht bei sich trug, könnte es noch dort sein.
	AI_Output(hero, self, "Info_Mod_Sancho_Dam_15_21"); //Und dieses soll ich jetzt finden.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam_03_22"); //Genau. Was sagst du?
};
...
FUNC VOID Info_Mod_Sancho_Dam2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_Dam2_03_01"); //Gut. Der andere Teil ist das Dam-Amulett. Es bringt dem Träger Verdammnis.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam2_03_02"); //Dieses Set – Tod und Verdammnis – dürfte noch einen wesentlich höheren Wert haben, als die Einzelstücke.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam2_03_03"); //Wenn du es mir besorgst, wird sicher keiner mehr im Lager was dagegen haben, dass du im Lager vorbeischaust und mit unseren Jungs handelst ... wie auch immer.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam2_03_04"); //Gibt genug in unserem Lager, was von Wert und Nutzen ist.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam2_03_05"); //Hör dich am besten in der Schenke zur goldenen Gülle um, die beim Moor liegt.
	AI_Output(self, hero, "Info_Mod_Sancho_Dam2_03_06"); //Alles klar? Ok. Dann mach dich auf den Weg.
...
FUNC VOID Info_Mod_Sancho_Dam3_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_Dam3_03_01"); //(ungläubig) Was?! Kann nicht sein. Zeig her!

	B_GiveInvItems	(hero, self, ItAm_Dam, 1);

	AI_Output(self, hero, "Info_Mod_Sancho_Dam3_03_02"); //Tatsächlich. Das nenn ich mal saubere Arbeit. Hätte nicht gedacht, dass du das Moor überlebst.

	if (self.aivar[AIV_PASSGATE] == FALSE)
	{
		AI_Output(self, hero, "Info_Mod_Sancho_Dam3_03_03"); //Damit hast du dir den Einlass in unser Lager mehr als verdient ... auch, wenn du damit noch kein Bandit bist.
		AI_Output(self, hero, "Info_Mod_Sancho_Dam3_03_04"); //Aber da kann ich dir einen Tipp geben. Einer unserer Jungs hat sich in der Hafenstadt postiert.
		AI_Output(self, hero, "Info_Mod_Sancho_Dam3_03_05"); //Er hält nach fähigen und erfahrenen Männern Ausschau, solchen, die bereits einer großen Gilde angehören.
		AI_Output(self, hero, "Info_Mod_Sancho_Dam3_03_06"); //Aber sollte nicht grad die Stadtwache sein ...
...
FUNC VOID Info_Mod_Sancho_Parole_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_Parole_03_01"); //Gut, du darfst passieren.
...
FUNC VOID Info_Mod_Sancho_Asylanten_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Sancho_Asylanten_03_01"); //(lacht) Das weißt du noch nicht?
	AI_Output(self, hero, "Info_Mod_Sancho_Asylanten_03_02"); //(vertraulich) Wir schleichen uns nachts an das Alte Lager heran, schalten die Wachen heimlich aus und stürmen dann die Burg.
	AI_Output(hero, self, "Info_Mod_Sancho_Asylanten_15_03"); //Tatsächlich?
	AI_Output(self, hero, "Info_Mod_Sancho_Asylanten_03_04"); //Für wie dumm hältst du mich, dass ich unsere Pläne ausplaudere?
	AI_Output(self, hero, "Info_Mod_Sancho_Asylanten_03_05"); //Soll ich mich gleich freiwillig in den Knast einweisen lassen?
	AI_Output(hero, self, "Info_Mod_Sancho_Asylanten_15_06"); //Aber ihr habt nicht vor, als nächstes nach Khorinis zu ziehen?
	AI_Output(self, hero, "Info_Mod_Sancho_Asylanten_03_07"); //Das lass mal unsere Sorge sein. (lacht) Aber ich sag dir Bescheid, wenn es so weit ist, Junge.
	AI_Output(self, hero, "Info_Mod_Sancho_Asylanten_03_08"); //(leise) Spinner.
...
func void Info_Mod_Sancho_FirstWarn_Info()
{
	...
	{
		AI_Output (self, hero,"Info_Mod_Sancho_FirstWarn_03_00"); //HALT! Niemand darf das Lager ohne Losungswort betreten.
	}
	else
	{
		AI_Output (self, hero,"Info_Mod_Sancho_FirstWarn_03_01"); //(gelangweilt) Passwort?
	};
...
{
	AI_Output (self, hero,"Info_Mod_Sancho_SecondWarn_03_00"); //Ich sag's dir zum letzten Mal. Einen Schritt weiter und du begibst dich in die Welt des Schmerzes!
...
func void Info_Mod_Sancho_Attack_Info()
{
	...
	AI_Output (self, hero,"Info_Mod_Sancho_Attack_03_00"); //Du hast es so gewollt ...
