...
{
	AI_Output(self, hero, "Info_Mod_Gildo_Unkraut_07_00"); //He, du, wir k�nnten mal wieder deine Hilfe gebrauchen ...
	AI_Output(hero, self, "Info_Mod_Gildo_Unkraut_15_01"); //Wovon werdet ihr bedroht?
	AI_Output(self, hero, "Info_Mod_Gildo_Unkraut_07_02"); //Unkraut ... die Felder sind voll davon. Du hast uns schon damals bei der R�benernte geholfen und bist genau der Richtige f�r die Aufgabe.
...
FUNC VOID Info_Mod_Gildo_Unkraut_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Gildo_Unkraut_B_07_01"); //Ich meinte ja nur. Aber wenn du dir zu fein daf�r bist, dann wird sich eben jemand anders die 20 Goldm�nzen verdienen.
...
FUNC VOID Info_Mod_Gildo_Unkraut2_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Gildo_Unkraut2_07_01"); //Gut gemacht. Daf�r bekommst du auch einen Batzen Geld. Viel Spa� damit.
...
FUNC VOID Info_Mod_Gildo_Pickpocket_DoIt()
{
	...
	else
	{
		...
		Info_AddChoice	(Info_Mod_Gildo_Pickpocket, DIALOG_PP_BESCHIMPFEN, Info_Mod_Gildo_Pickpocket_Beschimpfen);
		Info_AddChoice	(Info_Mod_Gildo_Pickpocket, DIALOG_PP_BESTECHUNG, Info_Mod_Gildo_Pickpocket_Bestechung);
		Info_AddChoice	(Info_Mod_Gildo_Pickpocket, DIALOG_PP_HERAUSREDEN, Info_Mod_Gildo_Pickpocket_Herausreden);
	};
};

FUNC VOID Info_Mod_Gildo_Pickpocket_Beschimpfen()
{
...
FUNC VOID Info_Mod_Gildo_Pickpocket_Bestechung()
{
...
FUNC VOID Info_Mod_Gildo_Pickpocket_Herausreden()
{
