...
FUNC VOID Info_Mod_Aabid_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Aabid_Hi_01_00"); //Mein Name ist Aabid. Ich bin einer der Gauner hier und gleichzeitig Händler für außergewöhnliche Sorten von Tabak und Sumpfkrautstängeln.
	AI_Output(hero, self, "Info_Mod_Aabid_Hi_15_01"); //Interessant. Kann ich mal dein Angebot sehen?
	AI_Output(self, hero, "Info_Mod_Aabid_Hi_01_02"); //Nein, das geht leider nicht.
	AI_Output(hero, self, "Info_Mod_Aabid_Hi_15_03"); //Wieso nicht?
	AI_Output(self, hero, "Info_Mod_Aabid_Hi_01_04"); //Ich warte schon seit einiger Zeit auf die Lieferung von drei Sumpfkrautpaketen, aber die Kerle haben mich anscheinend vergessen und ich komme einfach nicht aus dem Versteck.
};
...
FUNC VOID Info_Mod_Aabid_Aufgabe_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Aabid_Aufgabe_01_01"); //Das wäre wirklich gut, wenn du das machen würdest. Aber warum willst du das machen?
	...
	AI_Output(self, hero, "Info_Mod_Aabid_Aufgabe_01_04"); //Wenn du alle Pakete bekommen kannst, dann werde ich dir natürlich meine Stimme geben.
	AI_Output(hero, self, "Info_Mod_Aabid_Aufgabe_15_05"); //Abgemacht. Wo soll ich die Pakete abholen?
	AI_Output(self, hero, "Info_Mod_Aabid_Aufgabe_01_06"); //Alle drei Händler findest du in der Stadt. Ihre Namen sind Meldor, Borka und zuletzt Jason, ein Milizionär.
	AI_Output(hero, self, "Info_Mod_Aabid_Aufgabe_15_07"); //Jemand von der Miliz handelt mit Sumpfkraut?
	AI_Output(self, hero, "Info_Mod_Aabid_Aufgabe_01_08"); //Meinst du die halten sich alle an ihre Regeln?
	AI_Output(hero, self, "Info_Mod_Aabid_Aufgabe_15_09"); //Nein. Also gut, ich werde die drei mal aufsuchen.
	AI_Output(self, hero, "Info_Mod_Aabid_Aufgabe_01_10"); //Gut. Komm wieder, wenn du die Pakete hast.
...
FUNC VOID Info_Mod_Aabid_HabPakete_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Aabid_HabPakete_01_01"); //(ungläubig) Du verarscht mich!
	...
	AI_Output(self, hero, "Info_Mod_Aabid_HabPakete_01_04"); //Das sind tatsächlich alle, wie hast du das nur gemacht?
	AI_Output(hero, self, "Info_Mod_Aabid_HabPakete_15_05"); //Reine Intuition, würde ich sagen.
	AI_Output(self, hero, "Info_Mod_Aabid_HabPakete_01_06"); //Ich kann dir nicht genug danken. Hier, nimm dieses Gold als Zeichen meiner Dankbarkeit.

	B_GiveInvItems	(self, hero, ItMi_Gold, 500);

	AI_Output(self, hero, "Info_Mod_Aabid_HabPakete_01_07"); //Außerdem bekommst du meine Stimme.
