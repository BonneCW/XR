...
FUNC VOID Info_Mod_HofstaatHundefutter_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_HofstaatHundefutter_Hi_08_01"); //Aaalter. Was soll der Scheiﬂ?
	AI_Output(self, hero, "Info_Mod_HofstaatHundefutter_Hi_15_02"); //Was meinst du?
	AI_Output(self, hero, "Info_Mod_HofstaatHundefutter_Hi_08_03"); //Siehst du nicht, dass ich arbeite? Du neeeervst!
	AI_Output(self, hero, "Info_Mod_HofstaatHundefutter_Hi_15_04"); //Du hast ziemlich viel Freudenspender intus, oder?
	AI_Output(self, hero, "Info_Mod_HofstaatHundefutter_Hi_08_05"); //Fr ... Freu ... h‰? Aaaaaalter ... Endlich, der Boss!
