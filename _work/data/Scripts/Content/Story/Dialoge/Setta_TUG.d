...
FUNC VOID Info_Mod_Setta_TUG_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Setta_TUG_Hi_19_00"); //Ich habe mich wieder erinnert, habe ich. Nur deinetwegen waren wir in dem Tal!
...
FUNC VOID Info_Mod_Setta_TUG_Trador_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Setta_TUG_Trador_19_01"); //Vor zwei Jahren war ich noch Tänzerin für Gomez, war ich. Trador war einer der Hofmagier.
	AI_Output(self, hero, "Info_Mod_Setta_TUG_Trador_19_02"); //Mit ein paar anderen Leuten hat er ein Attentat auf Corristo geplant, hat er, aber ich habe das mitbekommen und gemeldet.
	AI_Output(self, hero, "Info_Mod_Setta_TUG_Trador_19_03"); //Er hat mich aber noch erwischt, hat er, und mich mit einer Teleporterrune in das Tal verfrachtet.
	AI_Output(self, hero, "Info_Mod_Setta_TUG_Trador_19_04"); //Ich baute mir ein Häuschen und entdeckte den alten Buff, entdeckte ich.
	AI_Output(self, hero, "Info_Mod_Setta_TUG_Trador_19_05"); //Ich hab ihm angeboten, bei mir zu nächtigen, hab ich, aber er wollte in seinem Zelt schlafen.
	AI_Output(self, hero, "Info_Mod_Setta_TUG_Trador_19_06"); //Durch dein Auftauchen wurde mir der Mut zum Handeln zurückgegeben, wurde er.
	AI_Output(self, hero, "Info_Mod_Setta_TUG_Trador_19_07"); //Vielen Dank! Was soll deine Belohnung sein?
...
FUNC VOID Info_Mod_Setta_TUG_Trador_C()
{
	...
	AI_Output(self, hero, "Info_Mod_Setta_TUG_Trador_C_19_01"); //So viel? Ich muss schauen, ob ich so viel habe, muss ich. Ja, hier.
...
FUNC VOID Info_Mod_Setta_TUG_Trador_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Setta_TUG_Trador_B_19_01"); //Hier. Ich weiß, dass das Gold in guten Händen ist, weiß ich.
...
FUNC VOID Info_Mod_Setta_TUG_Trador_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Setta_TUG_Trador_A_19_01"); //Vielen, vielen Dank! Ich werde das nie vergessen, nie.
