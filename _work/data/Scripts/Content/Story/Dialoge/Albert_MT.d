...
{
	AI_Output(self, hero, "Info_Mod_Albert_Hi_07_00"); //Ich wurde schon informiert. Du bist wohl der Typ, der sich um eine Aufnahme bei uns bemüht.
	AI_Output(self, hero, "Info_Mod_Albert_Hi_07_01"); //Der Teleporter funktioniert folgendermaßen: Ich gebe dir gleich einen Stein, den du auf das Podest dort legen musst, um den Teleporter zu aktivieren. Hast du das soweit verstanden?
...
FUNC VOID Info_Mod_Albert_Hi_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_Hi_B_07_01"); //Ich gebe dir gleich einen Stein, den du auf das Podest dort legen musst, um den Teleporter zu aktivieren. Hast du das soweit verstanden?
...
FUNC VOID Info_Mod_Albert_Hi_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_Hi_A_07_01"); //Wenn du an unserem Heimatort bist, solltest du sofort mit Genn sprechen, er wird dir alles über die Goblinplage erzählen.
	AI_Output(hero, self, "Info_Mod_Albert_Hi_A_15_02"); //Okay. Gib mir den Stein.
	AI_Output(self, hero, "Info_Mod_Albert_Hi_A_07_03"); //Hier hast du ihn.
...
{
	AI_Output(self, hero, "Info_Mod_Albert_Matronen_07_00"); //Und? Wie ist es gelaufen?
	...
	AI_Output(self, hero, "Info_Mod_Albert_Matronen_07_02"); //Das freut mich. Geh am Besten zu Turendil und erzähle ihm die guten Neuigkeiten.
...
{
	AI_Output(self, hero, "Info_Mod_Albert_Faice_07_00"); //Schnell, wir haben nicht viel Zeit.
...
FUNC VOID Info_Mod_Albert_Faice_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_Faice_B_07_01"); //Dann beeile dich.
...
FUNC VOID Info_Mod_Albert_Faice_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_Faice_A_07_01"); //Hier hast du ihn. Pass auf dich auf.
...
{
	AI_Output(self, hero, "Info_Mod_Albert_Mendulus_07_00"); //Schnell, du musst dich beeilen. Faice geht es gar nicht gut. Rede mit Turendil, er ist bei Faice.
	AI_Output(hero, self, "Info_Mod_Albert_Mendulus_15_01"); //Ich mache mich sofort auf den Weg.
	AI_Output(self, hero, "Info_Mod_Albert_Mendulus_07_02"); //Bitte beeile dich.
...
{
	AI_Output(self, hero, "Info_Mod_Albert_Gift_07_00"); //Wieder nach Tugettso, mein Freund?
...
FUNC VOID Info_Mod_Albert_Gift_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_Gift_B_07_01"); //Wir sehen uns.
...
FUNC VOID Info_Mod_Albert_Gift_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_Gift_A_07_01"); //Hier hast du ihn. Pass auf dich auf.
...
{
	AI_Output(self, hero, "Info_Mod_Albert_Trador_07_00"); //Na endlich kommst du, Turendil wartet schon auf dich.
...
FUNC VOID Info_Mod_Albert_TeleporterFurt_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_TeleporterFurt_07_01"); //Ähm ...
	AI_Output(hero, self, "Info_Mod_Albert_TeleporterFurt_15_02"); //Gibt es ein Problem?
	AI_Output(self, hero, "Info_Mod_Albert_TeleporterFurt_07_03"); //Ja, so Leid es mir tut.
	AI_Output(self, hero, "Info_Mod_Albert_TeleporterFurt_07_04"); //Aufgrund der Störungen, die in letzter Zeit öfter vorgekommen sind, kann ich es nicht mit meinem Gewissen vereinbaren, dich in den möglicherweise sicheren Tod zu schicken.
...
FUNC VOID Info_Mod_Albert_TeleporterFurt_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_TeleporterFurt_B_07_01"); //Das weiß ich noch nicht. Aber in der Zwischenzeit kannst du nachsehen, ob du Furt findest.

	if (Mod_VMG_FaiceGifty_Gift == 13)
	{
		AI_Output(self, hero, "Info_Mod_Albert_TeleporterFurt_B_07_02"); //Ich habe gesehen, wie er in Richtung Altes Lager davon gerannt ist.
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_Albert_TeleporterFurt_B_07_03"); //Ich habe gehört, dass er in der Nähe des Alten Lagers gesehen worden ist. Schau mal dort 	nach.
	};

	AI_Output(hero, self, "Info_Mod_Albert_TeleporterFurt_B_15_04"); //Ich mache mich sofort auf den Weg.
	AI_Output(self, hero, "Info_Mod_Albert_TeleporterFurt_B_07_05"); //Ich werde dir Bescheid geben, wenn das Portal sicher ist.
...
FUNC VOID Info_Mod_Albert_TeleporterFurt_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_TeleporterFurt_A_07_01"); //(unterbricht) Das ist mir egal. Es geht hier um Menschenleben.
...
FUNC VOID Info_Mod_Albert_FurtTot_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_FurtTot_07_01"); //Wo ist er denn?
	...
	AI_Output(self, hero, "Info_Mod_Albert_FurtTot_07_04"); //Ich weiß ehrlich gesagt nicht, ob ich mich freuen oder ob ich betrübt sein soll.
	AI_Output(self, hero, "Info_Mod_Albert_FurtTot_07_05"); //Immerhin habe ich ihn einige Zeit lang geglaubt zu kennen. Ich werde Turendil davon berichten.
	AI_Output(self, hero, "Info_Mod_Albert_FurtTot_07_06"); //Danke, dass du zu mir gekommen bist.
	AI_Output(hero, self, "Info_Mod_Albert_FurtTot_15_07"); //Wie sieht es mit dem Aufladestein aus?
	AI_Output(self, hero, "Info_Mod_Albert_FurtTot_07_08"); //Komm am Besten morgen wieder, dann kann ich dich vielleicht schon teleportieren.
	AI_Output(hero, self, "Info_Mod_Albert_FurtTot_15_09"); //Alles klar.
	AI_Output(self, hero, "Info_Mod_Albert_FurtTot_07_10"); //Wir sehen uns.
...
FUNC VOID Info_Mod_Albert_TeleportWaldschluchtAktiv_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_TeleportWaldschluchtAktiv_07_01"); //Ich denke, wir können einen Versuch wagen. Bist du bereit?
	AI_Output(hero, self, "Info_Mod_Albert_TeleportWaldschluchtAktiv_15_02"); //Ja. Gib mir den Stein.
	AI_Output(self, hero, "Info_Mod_Albert_TeleportWaldschluchtAktiv_07_03"); //Ich habe das Portal bereits aktiviert. Du musst es nur noch durschreiten.
	AI_Output(self, hero, "Info_Mod_Albert_TeleportWaldschluchtAktiv_07_04"); //Hier hast du trotzdem noch einen Aufladestein.
...
{
	AI_Output(self, hero, "Info_Mod_Albert_WaldschluchtBack_07_00"); //Ah, es scheint geklappt zu haben.
...
FUNC VOID Info_Mod_Albert_Pruefung_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_Pruefung_07_01"); //Ich habe schon gehört, dass du endlich unsere Techniken erlernst, um ein geachtetes Mitglied zu werden. Sehr lobenswert. Hier ist der Stein.
	
	B_GiveInvItems	(self, hero, ItMi_TugettsoStein, 1);

	AI_Output(hero, self, "Info_Mod_Albert_Pruefung_15_02"); //Gut, ich mache mich dann auf den Weg.
	AI_Output(self, hero, "Info_Mod_Albert_Pruefung_07_03"); //Viel Erfolg!
};
...
FUNC VOID Info_Mod_Albert_Skinner_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_Skinner_07_01"); //(erfreut) Ahh, fabelhaft, dann können wir endlich mit unseren Studien beginnen. Hier ist die vereinbarte Bezahlung, mit einer Spruchrolle zusätzlich für den zuverlässigen Boten.
...
FUNC VOID Info_Mod_Albert_Amulett_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_Amulett_07_01"); //(ungeduldig) Zeig her.

	B_GiveInvItems	(hero, self, ItAm_MegaAmulett2, 1);

	AI_Output(self, hero, "Info_Mod_Albert_Amulett_07_02"); //Hmm ... bei Adanos, tatsächlich, das ist es. Meine Brüder werden sehr erfreut darüber sein.
	AI_Output(self, hero, "Info_Mod_Albert_Amulett_07_03"); //Da es unserer Gemeinschaft von großem Nutzen sein wird, werde ich dir den Rest der Bezahlung trotz des Vorfalls geben.
	AI_Output(self, hero, "Info_Mod_Albert_Amulett_07_04"); //Ich hoffe aber, dass so etwas in Zukunft nicht mehr vorkommen wird.
...
FUNC VOID Info_Mod_Albert_Oschust_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_Oschust_07_01"); //Wie das? So berichte mir, was vorgefallen ist.
	...
	AI_Output(self, hero, "Info_Mod_Albert_Oschust_07_04"); //Was?! Welche Niedertracht sich mit diesen üblen Kreaturen einzulassen.
	AI_Output(self, hero, "Info_Mod_Albert_Oschust_07_05"); //Aber in wie fern betrifft das alles uns? Wollen die Orks uns jetzt womöglich das Amulett entreißen?
	...
	AI_Output(self, hero, "Info_Mod_Albert_Oschust_07_07"); //Dann gibt es keine Zeit zu verlieren. Warte hier, ich werde meinen Brüdern bescheid geben.
...
{
	AI_Output(self, hero, "Info_Mod_Albert_KommeMit_07_00"); //Nun denn, ich habe mich mit meinen Brüdern beraten und wir haben beschlossen, dass ich dich begleite, deine Freunde zu retten.
...
{
	AI_Output(self, hero, "Info_Mod_Albert_KommeMit_C_07_00"); //Hierzu kommt jetzt das Amulett der Extension zum Einsatz.
	AI_Output(self, hero, "Info_Mod_Albert_KommeMit_C_07_01"); //Es hat folgende Eigenschaft: Jeden Zauber, den der Träger auf sich wirkt, erfahren auch alle seine Kampfgefährten, was es zu einem äußerst mächtigen Werkzeug macht.
	AI_Output(self, hero, "Info_Mod_Albert_KommeMit_C_07_02"); //Ohne weiter Worte zu verlieren: Ich werde uns in Blutfliegen verwandeln. Folge mir einfach, ich bringe uns auf dem schnellsten Weg in die Orkstadt.
	AI_Output(self, hero, "Info_Mod_Albert_KommeMit_C_07_03"); //Nach allem was ich aus meinen bisherigen Exkursionen als Blutfliege weiß, gibt es dort ein unterirdisches Höhlensystem, wo sich eigentlich deine Freunde befinden sollte ... falls sie noch, sollte es Adanos Wille sein, am Leben sind.
	AI_Output(self, hero, "Info_Mod_Albert_KommeMit_C_07_04"); //Und jetzt lass uns ohne Verzug aufbrechen.
...
FUNC VOID Info_Mod_Albert_KommeMit_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_KommeMit_B_07_01"); //Hier ist es auch keine rohe Gewalt, die uns zum Erfolg verhelfen kann, sondern der geschickte Einsatz von Magie.
...
{
	AI_Output(self, hero, "Info_Mod_Albert_OrkCity_07_00"); //So, hier müsste sich wohl der Eingang ins unterirdische Höhlensystem befinden.
	AI_Output(self, hero, "Info_Mod_Albert_OrkCity_07_01"); //Geh voran, du bist der stärkere Kämpfer. Ich folge dir.
...
{
	AI_Output(self, hero, "Info_Mod_Albert_FluchtHappy_07_00"); //So, von hier aus kann ich uns alle mit dieser Teleportspruchrolle und dem Amulett aus der Orkstadt herausteleportieren.
...
{
	AI_Output(self, hero, "Info_Mod_Albert_Safety_07_00"); //(erleichtert) So, das wäre geschafft. Ich werde nun rasch zu meinen Brüdern zurückkehren, ihnen von dem Vorgefallenen berichten und uns auf einen möglichen Angriff einstellen.
	AI_Output(self, hero, "Info_Mod_Albert_Safety_07_01"); //Ihr wiederum tätet gut daran ebenfalls zu eurem Lager eilen, da der Feind jeder Zeit zuschlagen kann.
...
FUNC VOID Info_Mod_Albert_Hexen_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_Hexen_07_01"); //Unseren naturverbundenen Brüdern bin ich gerne bereit zu helfen.
	AI_Output(self, hero, "Info_Mod_Albert_Hexen_07_02"); //Ich will dich jedoch darum bitten, uns das Amulett wieder zurückzubringen, wenn ihr euer Problem bewältigt habt.
...
FUNC VOID Info_Mod_Albert_HexenBack_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_HexenBack_07_01"); //Ich danke dir. Wie es scheint, hat es euch sehr geholfen.
};
...
FUNC VOID Info_Mod_Albert_Asylanten_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_Asylanten_07_01"); //In unserer Heimatdimension wurden wir von einer wahren Armee von Goblins heimgesucht.
	AI_Output(self, hero, "Info_Mod_Albert_Asylanten_07_02"); //Durch einen alten Teleporter konnte sich ein Großteil von uns hierher absetzen und sucht nun nach Hilfe.
...
FUNC VOID Info_Mod_Albert_Asylanten_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_Asylanten_B_07_01"); //Es ist aussichtslos. Wir sind hier in einem Gebiet mit einem sonderbaren Menschenschlag geraten.
	AI_Output(self, hero, "Info_Mod_Albert_Asylanten_B_07_02"); //Die erste Gruppe, auf die wir stießen, verbirgt sich flussabwärts hinter einer hohen Palisade.
	AI_Output(self, hero, "Info_Mod_Albert_Asylanten_B_07_03"); //Der Wächter, der uns fragte, weshalb wir kämen, lachte uns schallend aus und wünschte uns Beliar an den Hals.
	AI_Output(self, hero, "Info_Mod_Albert_Asylanten_B_07_04"); //Eine andere Gruppierung empfing uns herzlich und lauschte unserem Wehklagen, zog sich dann rauchend zu einer Besprechung zurück und schickte uns mit ernster Miene nach Hause.
	AI_Output(self, hero, "Info_Mod_Albert_Asylanten_B_07_05"); //Abgesehen von einzelnen Jägern oder Gesetzlosen konnten wir sonst niemanden ausmachen, den wir hätten bitten können.
	AI_Output(self, hero, "Info_Mod_Albert_Asylanten_B_07_06"); //Seitdem bleibt uns nichts übrig, als zu hoffen.
...
FUNC VOID Info_Mod_Albert_Asylanten_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_Asylanten_A_07_01"); //Sie verteidigen unser Dorf, wenn es sein muss. Wir werden es nicht kampflos aufgeben!
...
{
	AI_Output(self, hero, "Info_Mod_Albert_Fokus_07_00"); //Was suchst du hier oben?
	...
	AI_Output(self, hero, "Info_Mod_Albert_Fokus_07_02"); //Oh ja, an den erinnere ich mich gut. Der hat uns einige Probleme bereitet.
	...
	AI_Output(self, hero, "Info_Mod_Albert_Fokus_07_04"); //Gut zu wissen. Mehrere von uns haben versucht, ihn vom Sockel zu heben, und haben Blessuren und sogar Knochenbrüche davon getragen.
	AI_Output(hero, self, "Info_Mod_Albert_Fokus_15_05"); //Wo ist der Fokus jetzt?
	AI_Output(self, hero, "Info_Mod_Albert_Fokus_07_06"); //Wir haben ihn den Felsen hinab ins Meer geworfen.
	AI_Output(self, hero, "Info_Mod_Albert_Fokus_07_07"); //Jedenfalls hätten wir es getan, wenn es nach mir gegangen wäre.
	AI_Output(self, hero, "Info_Mod_Albert_Fokus_07_08"); //So haben wir einfach eine Kiste drüber gestülpt und danach fest verschlossen. Es ist eine der Truhen dort drüben.
	AI_Output(hero, self, "Info_Mod_Albert_Fokus_15_09"); //Darf ich den Fokus mitnehmen?
	AI_Output(self, hero, "Info_Mod_Albert_Fokus_07_10"); //Warte mal. Das war noch nicht das einzige Problem, das wir hatten.
	AI_Output(self, hero, "Info_Mod_Albert_Fokus_07_11"); //Gestern kam dann plötzlich eine unheimliche Gestalt des Wegs und fragte uns nach dem Teil.
	AI_Output(self, hero, "Info_Mod_Albert_Fokus_07_12"); //Mir wurde ganz schwummrig, als der Typ aufkreuzte. Dem hätte ich nie verraten, dass wir den Fokus noch besitzen!
	AI_Output(self, hero, "Info_Mod_Albert_Fokus_07_13"); //Deswegen habe ich ihm vorgelogen, wir hätten ihn tatsächlich ins Meer geschmissen. Da ist er dann wieder abgezogen.
	AI_Output(self, hero, "Info_Mod_Albert_Fokus_07_14"); //Drittes Problem: Wir wollten den Fokus danach selbst so schnell wie möglich loswerden.
	AI_Output(self, hero, "Info_Mod_Albert_Fokus_07_15"); //Zwei von uns haben sich die Truhe gegriffen, nur um dann merken zu müssen, dass der Schutzzauber nun auf sie übergesprungen ist!
	AI_Output(self, hero, "Info_Mod_Albert_Fokus_07_16"); //Die beiden sind meterweit geflogen.
	AI_Output(self, hero, "Info_Mod_Albert_Fokus_07_17"); //Wenn du es also schaffst, den Zauber zu brechen, dann bitte, bitte, nimm den Fokus mit.
...
FUNC VOID Info_Mod_Albert_WerBistDu_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_WerBistDu_07_00"); //Mein Name ist Albert. Ich bewache diese Plattform.
	AI_Output(hero, self, "Info_Mod_Albert_WerBistDu_15_01"); //Was ist das für eine Plattform?
	AI_Output(self, hero, "Info_Mod_Albert_WerBistDu_07_02"); //Früher war es eine Fassung für die Fokussteine, hab ich gehört.
	AI_Output(self, hero, "Info_Mod_Albert_WerBistDu_07_03"); //Wir benutzen es jedoch als 	Teleporter nach Tugettso und wieder zurück.
...
FUNC VOID Info_Mod_Albert_WerBistDu_B()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_WerBistDu_B_07_01"); //Das zeige ich dir, wenn du bereit bist.
...
FUNC VOID Info_Mod_Albert_WerBistDu_A()
{
	...
	AI_Output(self, hero, "Info_Mod_Albert_WerBistDu_A_07_01"); //Unser Heimatdorf. Wenn du mehr darüber wissen willst, frag Turendil danach.
