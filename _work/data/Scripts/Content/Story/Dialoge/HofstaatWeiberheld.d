...
FUNC VOID Info_Mod_HofstaatWeiberheld_Hi_Info()
{
	...
	AI_Output(self, hero, "Info_Mod_HofstaatWeiberheld_Hi_09_02"); //Die hofstädtischen Frauen sind nicht wie die Frauen die du kennst.
	...
	AI_Output(self, hero, "Info_Mod_HofstaatWeiberheld_Hi_09_06"); //Naja ... Die hofstädtischen Frauen sind anders.
	AI_Output(self, hero, "Info_Mod_HofstaatWeiberheld_Hi_09_07"); //Ich bin der königliche Frauenheld. Und glaub mir, die Frauen, die du kennst sind anders als die hierzulande!
	AI_Output(hero, self, "Info_Mod_HofstaatWeiberheld_Hi_15_08"); //Ja, soviel hab ich auch mitbekommen, aber wie unterscheiden sie sich von den anderen Frauen?
	AI_Output(self, hero, "Info_Mod_HofstaatWeiberheld_Hi_09_09"); //Die Frauen?
	AI_Output(hero, self, "Info_Mod_HofstaatWeiberheld_Hi_15_10"); //Ja ...
	AI_Output(self, hero, "Info_Mod_HofstaatWeiberheld_Hi_09_11"); //Achso ... Ich hab ein Buch geschrieben.
	AI_Output(hero, self, "Info_Mod_HofstaatWeiberheld_Hi_15_12"); //Schön für dich ...
	AI_Output(self, hero, "Info_Mod_HofstaatWeiberheld_Hi_09_13"); //Darin stehen alle Eigenheiten der hofstädtischen Frauen.
	AI_Output(hero, self, "Info_Mod_HofstaatWeiberheld_Hi_15_14"); //Verkaufst du es mir?
	AI_Output(self, hero, "Info_Mod_HofstaatWeiberheld_Hi_09_15"); //Na gut ... aber pass auf, ich bin verdammt guter Feilscher, also pass auf.
	AI_Output(hero, self, "Info_Mod_HofstaatWeiberheld_Hi_15_16"); //Wie viel willst du?
	AI_Output(self, hero, "Info_Mod_HofstaatWeiberheld_Hi_09_17"); //32 Milliarden 435 Millionen 684 Tausend 341 Goldstücke.
	AI_Output(hero, self, "Info_Mod_HofstaatWeiberheld_Hi_15_18"); //Ein bisschen überteuert ...
	AI_Output(self, hero, "Info_Mod_HofstaatWeiberheld_Hi_09_19"); //Na gut ... Zwei Goldstücke.

	Info_ClearChoices	(Info_Mod_HofstaatWeiberheld_Hi);

	Info_AddChoice	(Info_Mod_HofstaatWeiberheld_Hi, "Immer noch zuviel ...", Info_Mod_HofstaatWeiberheld_Hi_B);
...
{
	AI_Output(hero, self, "Info_Mod_HofstaatWeiberheld_Hi_D_15_00"); //Immer noch zuviel ...
...
FUNC VOID Info_Mod_HofstaatWeiberheld_Hi_C()
{
	...
	AI_Output(self, hero, "Info_Mod_HofstaatWeiberheld_Hi_C_09_01"); //(lacht) Dich hab ich aber über'n Tisch gezogen.
...
FUNC VOID Info_Mod_HofstaatWeiberheld_Hi_B()
{
	...
	if (Hlp_Random(100) < Mod_Verhandlungsgeschick)
	{
		...
		Info_AddChoice	(Info_Mod_HofstaatWeiberheld_Hi, "Immer noch zuviel ...", Info_Mod_HofstaatWeiberheld_Hi_F);
		Info_AddChoice	(Info_Mod_HofstaatWeiberheld_Hi, "Gekauft.", Info_Mod_HofstaatWeiberheld_Hi_E);
	}
	else
	{
		AI_Output(self, hero, "Info_Mod_HofstaatWeiberheld_Hi_B_09_01"); //Nene, so viel muss schon sein.
...
FUNC VOID Info_Mod_HofstaatWeiberheld_Hi_F()
{
	...
	if (Hlp_Random(100) < Mod_Verhandlungsgeschick)
	{
		...
		Info_AddChoice	(Info_Mod_HofstaatWeiberheld_Hi, "Immer noch zuviel ...", Info_Mod_HofstaatWeiberheld_Hi_H);
...
FUNC VOID Info_Mod_HofstaatWeiberheld_SabineWillNicht_Info()
{
	...
	AI_Output(hero, self, "Info_Mod_HofstaatWeiberheld_SabineWillNicht_15_02"); //Naja, ich weiß nicht was ich sagen soll ...
	...
	AI_Output(self, hero, "Info_Mod_HofstaatWeiberheld_SabineWillNicht_09_09"); //Ne ... letztens hab ich mein Haus verloren, bei dem Versuch, jemandem meine gesammelten Werke zu verkaufen.
};
...
FUNC VOID Info_Mod_HofstaatWeiberheld_Geliebte_Info()
{
	...
	AI_Output(hero, self, "Info_Mod_HofstaatWeiberheld_Geliebte_15_01"); //Ich brauche nochmal deine Hilfe.
	...
	AI_Output(self, hero, "Info_Mod_HofstaatWeiberheld_Geliebte_09_04"); //Na klar, kein Problem, die königliche Geliebte verführen, dass ist ga ... DU WILLST WAS? UNMÖGLICH!
	...
	AI_Output(self, hero, "Info_Mod_HofstaatWeiberheld_Geliebte_09_10"); //Ach was! (Leiser) Es gibt das Gerücht, dass der königliche Trunkenbold zur Zeit des letzten Festes es geschafft hat.
