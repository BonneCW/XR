...
{	
	...
	damageTotal  		= 	Damage_Wolfsmesser+SHARPENED;
	damagetype 			=	DAM_EDGE;
	range    			=  	Range_Wolfsmesser;		
...
{	
	...
	damageTotal  		= 	Damage_Stab05+SHARPENED;
	damagetype 			=	DAM_BLUNT;
	range    			=  	RANGE_Stab05;		
...
{	
	...
	damageTotal			= 	Damage_Machete+SHARPENED;
	damagetype			=	DAM_EDGE;		
	range    			=  	Range_Machete;	
...
{	
	...
	damageTotal			= 	Damage_AltMachete+SHARPENED;
	damagetype			=	DAM_EDGE;		
	range    			=  	Range_AltMachete;	
...
{	
	...
	damageTotal			= 	Damage_Hacker+SHARPENED;
	damagetype			=	DAM_EDGE;		
	range    			=  	Range_Hacker;	
...
{	
	...
	damageTotal			= 	Damage_AltHacker+SHARPENED;
	damagetype			=	DAM_EDGE;		
	range    			=  	Range_AltHacker;	
...
{	
	...
	damageTotal  		= 	Damage_PIR2hAxe+SHARPENED;
	damagetype 			=	DAM_EDGE;
	range    			=  	Range_PIR2hAxe;		
...
{	
	...
	damageTotal  		= 	Damage_PIR2hSword+SHARPENED;
	damagetype 			=	DAM_EDGE;
	range    			=  	Range_PIR2hAxe;		
...
{	
	...
	damageTotal  		= 	Damage_PIR1hAxe+SHARPENED;
	damagetype 			=	DAM_EDGE;
...
{	
	...
	damageTotal  		= 	Damage_PIR1hSword+SHARPENED;
	damagetype 			=	DAM_EDGE;
	range    			=  	Range_PIR1hSword;		
...
{	
	...
	damageTotal  		= 	Damage_VLKSchwert+SHARPENED;
	damagetype 			=	DAM_EDGE;
	range    			=  	RANGE_VLKSchwert;		
...
{	
	...
	damageTotal  		= 	Damage_Betty+SHARPENED;
	damagetype 			=	DAM_EDGE;	
	range    			=  	Range_ElBastardo;		
