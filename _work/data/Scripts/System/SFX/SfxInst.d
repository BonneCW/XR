...
INSTANCE 		GAMESTART					(C_SFX_DEF)		{file="default.wav";							vol=127;						};
INSTANCE 		NEWGAME						(C_SFX_DEF)		{file="default.wav";							vol=0;							};
...
INSTANCE XR_Vogelzwitschern_01     	(C_SFX_DEF) {file= "XR_Vogelzwitschern_01.wav";		vol = 127;	};
INSTANCE URIZIELRITUAL			(C_SFX_DEF) {file= "urizielritual.wav";			vol=127;	};
INSTANCE XR_BOSSKAMPF			(C_SFX_DEF) {file= "XR_Bosskampf.wav";			vol=127;	loop=1;	};
INSTANCE SKULLS				(C_SFX_DEF) {file= "skulls.wav";			vol=127;	};
INSTANCE AMBIENT_SCREAM			(C_SFX_DEF) {file= "Ambient_Scream.wav";		vol=127;	};
INSTANCE AMBIENT_SCREAM02		(C_SFX_DEF) {file= "Ambient_Scream02.wav";		vol=127;	};
INSTANCE AMBIENT_SCREAM03		(C_SFX_DEF) {file= "Ambient_Scream03.wav";		vol=127;	};
INSTANCE AMBIENT_SCREAM04		(C_SFX_DEF) {file= "Ambient_Scream04.wav";		vol=127;	};
INSTANCE AMBIENT_SCREAM05		(C_SFX_DEF) {file= "Ambient_Scream05.wav";		vol=127;	};
INSTANCE AMBIENT_SCREAM06		(C_SFX_DEF) {file= "Ambient_Scream06.wav";		vol=127;	};
...
/* Niesen */
				INSTANCE NIESEN		(C_SFX_DEF) {file= "Niesen.wav";			vol = 127;			};
...
/* Spider */                                                                                                         		
				INSTANCE SPI_Ambient	 					(C_SFX_DEF) {file= "SPI_Ambient01.wav";				vol = 70;			};
				INSTANCE SPI_Ambient_A1	 				(C_SFX_DEF) {file= "SPI_Ambient02.wav";				vol = 60;			};

				INSTANCE SPI_Attack						(C_SFX_DEF) {file= "SPI_Attack01.wav";				vol = 120;			};
				INSTANCE SPI_Attack_A1	 				(C_SFX_DEF) {file= "SPI_Attack02.wav";				vol = 120;			};
				INSTANCE SPI_Attack_A2	 				(C_SFX_DEF) {file= "SPI_Attack03.wav";				vol = 120;			};
				
				INSTANCE SPI_Walk	 					(C_SFX_DEF) {file= "SPI_Walk01.wav";				vol = 40;			};
				INSTANCE SPI_Walk_A1	 					(C_SFX_DEF) {file= "SPI_Walk02.wav";				vol = 40;			};

				INSTANCE SPI_Warn	 					(C_SFX_DEF) {file= "SPI_Warn01.wav";				vol = 120;			};

				INSTANCE SPI_Hurt	 					(C_SFX_DEF) {file= "SPI_Hurt01.wav";				vol = 80;			};
				INSTANCE SPI_Hurt_A1	 					(C_SFX_DEF) {file= "SPI_Hurt02.wav";				vol = 80;			};
				
				INSTANCE SPI_Die	 						(C_SFX_DEF) {file= "SPI_Die01.wav";					vol = 80;			};
...
INSTANCE 		ALRAUNE_DIE					(C_SFX_DEF)		{file="Alraune_Die01.wav";		vol=80;						};
INSTANCE 		ALRAUNE_AMB					(C_SFX_DEF)		{file="Alraune_Ambient01.wav";		vol=80;						};
INSTANCE 		ALRAUNE_AMB_A1					(C_SFX_DEF)		{file="Alraune_Ambient02.wav";		vol=80;						};
...
// AARGH
				...
				INSTANCE SVM_27_AARGH					(C_SFX_DEF) {file= "svm_27_aargh_1.wav";				vol = 107;			};				
				INSTANCE SVM_27_AARGH_1					(C_SFX_DEF) {file= "svm_27_aargh_2.wav";				vol = 107;			};				
				INSTANCE SVM_27_AARGH_2					(C_SFX_DEF) {file= "svm_27_aargh_3.wav";				vol = 107;			};				
				INSTANCE SVM_27_AARGH_3					(C_SFX_DEF) {file= "svm_27_aargh_3.wav";				vol = 107;			};				
				INSTANCE SVM_27_AARGH_4					(C_SFX_DEF) {file= "svm_27_aargh_3.wav";				vol = 107;			};				
...
INSTANCE IRDORATHMAGIERVOICE (C_SFX_DEF) {file= "IRDORATHMAGIERVOICE.WAV"; vol=110; };